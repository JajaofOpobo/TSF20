...
public class FacesBufferedList {
    ...
    public FacesBufferedList(ShortBuffer shortBuffer, int i) {
        ByteBuffer byteBufferAllocateDirect = ByteBuffer.allocateDirect(shortBuffer.limit() * 2);
        byteBufferAllocateDirect.order(ByteOrder.nativeOrder());
        this.mBuffer = byteBufferAllocateDirect.asShortBuffer();
        this.mBuffer.put(shortBuffer);
        this.mNumElements = i;
    }

    public FacesBufferedList(int i) {
        ByteBuffer byteBufferAllocateDirect = ByteBuffer.allocateDirect(i * 3 * 2);
        byteBufferAllocateDirect.order(ByteOrder.nativeOrder());
        this.mBuffer = byteBufferAllocateDirect.asShortBuffer();
    }
