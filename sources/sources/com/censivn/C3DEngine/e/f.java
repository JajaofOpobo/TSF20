...
public class f extends com.censivn.C3DEngine.e.a implements b {
        ...
        while (true) {
            try {
                ...
                if (iCountTokens != 0) {
                    ...
                    } else if (strNextToken.equals("mtllib")) {
                        a(stringTokenizer.nextToken());
                    } else if (strNextToken.equals("usemtl")) {
                        this.d = stringTokenizer.nextToken();
                    } else if (strNextToken.equals("o")) {
    ...
    private void a(String str) {
        ...
        if (iLastIndexOf > -1) {
            stringBuffer2 = stringBuffer2.replace(iLastIndexOf, iLastIndexOf + 1, "_");
        }
                ...
                if (line != null) {
                    ...
                    if (strArrSplit.length != 0) {
                        ...
                        if (str4.equals("newmtl")) {
                            ...
                            this.m.get(str3).c = new Color4(Float.parseFloat(strArrSplit[1]) * 255.0f, Float.parseFloat(strArrSplit[2]) * 255.0f, Float.parseFloat(strArrSplit[3]) * 255.0f, 255.0f);
                            str2 = str3;
                            str3 = str2;
                        } else {
                            if (str4.equals("map_Kd") && strArrSplit.length > 1) {
                                this.m.get(str3).b = strArrSplit[1];
                                StringBuffer stringBuffer3 = new StringBuffer(this.c);
                                stringBuffer3.append(":drawable/");
                                StringBuffer stringBuffer4 = new StringBuffer(strArrSplit[1]);
                                int iLastIndexOf2 = stringBuffer4.lastIndexOf(".");
                                if (iLastIndexOf2 > -1) {
                                    stringBuffer3.append(stringBuffer4.substring(0, iLastIndexOf2));
                                } else {
    ...
    private class a extends h {
        ...
        public a(f fVar, String str, String str2, int i) {
            ...
            this.f = iCountTokens >= 2 && !z2;
            if (iCountTokens == 3 || (iCountTokens == 2 && z2)) {
                z = true;
            }
            this.g = z;
            this.b = new int[i];
