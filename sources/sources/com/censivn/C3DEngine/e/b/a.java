package com.censivn.C3DEngine.e.IModelParser;

/* loaded from: classes.dex */
public class a extends com.censivn.C3DEngine.e.IModelParser {
    private float C;
    private float D;
    private float E;
    private float F;
    ...
    public a(float f, float f2, b bVar) {
        this(f, f2, com.censivn.C3DEngine.a.GestureDetector, bVar);
    }
