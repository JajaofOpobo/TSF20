package com.censivn.C3DEngine.b.f.ninepatch;

import com.censivn.C3DEngine.b.f.GridRenderable;

/* JADX INFO: loaded from: C:\Users\Jaja\AndroidStudioProjects\TSF20\resources-Prime\classes.dex */
public class NinePatchRenderable extends GridRenderable {
    private float a;
    private float d;
    private float e;
    private float f;
    ...
    public NinePatchRenderable(float f, float f2, NinePatchBounds bVar) {
        this(f, f2, com.censivn.C3DEngine.b.b.ScreenConstants.b, bVar);
    }

    public NinePatchRenderable(float f, float f2, float f3, NinePatchBounds bVar) {
    ...
    public void a(NinePatchBounds bVar) {
        a(bVar, true);
    }

    private void a(NinePatchBounds bVar, boolean z) {
        float f = bVar.a;
        float f2 = bVar.b;
        float f3 = bVar.c;
        float f4 = bVar.d;
