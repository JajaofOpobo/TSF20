package com.censivn.C3DEngine.b.f._b;

import com.censivn.C3DEngine.b.f.GridRenderable;

/* JADX INFO: loaded from: C:\Users\Jaja\AndroidStudioProjects\TSF20\resources-Prime\classes.dex */
public class AltNinePatchRenderable extends GridRenderable {
    private float a;
    private float d;
    private float e;
    private float f;
    ...
    public AltNinePatchRenderable(float f, float f2, AltNinePatchBounds bVar) {
        this(f, f2, com.censivn.C3DEngine.b.b.ScreenConstants.b, bVar);
    }

    public AltNinePatchRenderable(float f, float f2, float f3, AltNinePatchBounds bVar) {
    ...
    public void a(AltNinePatchBounds bVar) {
        a(bVar, true);
    }

    private void a(AltNinePatchBounds bVar, boolean z) {
        float f = bVar.a;
        float f2 = bVar.b;
        float f3 = bVar.c;
        float f4 = bVar.d;
