package com.censivn.C3DEngine.b.f.sprite;
...
public class TextureSpriteRenderable extends BaseRenderable {
    private int a;
    public int b;
    private float c;
    private float d;
    private SpriteItemData e;
    private ArrayList<SpriteItemData> f;
    ...
    public TextureSpriteRenderable(int i, int i2, int i3, boolean z) {
        this(i, i2, i3, i3, null, z);
    }

    public TextureSpriteRenderable(int i, int i2, int i3) {
        this(i, i2, i3, i3, null, false);
    }

    public TextureSpriteRenderable(int i, int i2, int i3, int i4) {
        this(i, i2, i3, i4, null, false);
    }

    public TextureSpriteRenderable(int i, int i2, int i3, int i4, IRenderable iVar, boolean z) {
    ...
    private void a(float f, float f2, int i, int i2, Color4 color4) {
        ...
        for (int i14 = 0; i14 < this.a; i14++) {
            SpriteItemData bVar = new SpriteItemData(this);
            bVar.J = i14;
            bVar.a = i14 * 2;
            bVar.b = bVar.a + 1;
            bVar.c = bVar.a + i13;
        ...
        final com.censivn.C3DEngine.b.f.sprite.TextureSpriteRenderable self = this;
        this.j = new com.censivn.C3DEngine.b.d.MouseEventListener(this.g == null ? this : this.g) { // from class: com.censivn.C3DEngine.b.f.sprite.TextureSpriteRenderable.1
    ...
    public void a(SpriteItemData bVar) {
        float f;
        float f2;
        float f3;
        float f4;
    ...
    private void c(SpriteItemData bVar) {
    ...
    public void b(SpriteItemData bVar) {
        c(bVar);
    ...
    private void a(SpriteItemData bVar, float f) {
        if (this.k) {
    ...
    public SpriteItemData a(int i) {
        return this.f.get(i);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public SpriteItemData a(float f, float f2) {
        for (int i = 0; i < this.a; i++) {
            SpriteItemData bVar = this.f.get(i);
