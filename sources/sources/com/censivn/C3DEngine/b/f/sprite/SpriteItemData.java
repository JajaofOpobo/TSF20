...
public class SpriteItemData implements com.censivn.C3DEngine.b.g._b.ITweenTarget {
    ...
    public Number3d G;
    public int J;
    private TextureSpriteRenderable K;
    private VButtonItem L;
    private AbstractTween M;
    private float N;
    private float O;
    private Object R;
    public int a;
    ...
    public SpriteItemData(TextureSpriteRenderable aVar) {
        this.K = aVar;
    }
    ...
    public AbstractTween getTweenChild() {
        return this.M;
    }

    @Override // com.censivn.C3DEngine.b.g._b.ITweenTarget
    public void setTweenChild(AbstractTween cVar) {
        this.M = cVar;
    }
}
