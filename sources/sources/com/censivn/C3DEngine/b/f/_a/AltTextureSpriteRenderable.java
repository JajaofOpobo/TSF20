package com.censivn.C3DEngine.b.f._a;
...
public class AltTextureSpriteRenderable extends BaseRenderable {
    private int a;
    public int b;
    private float c;
    private float d;
    private AltSpriteItemData e;
    private ArrayList<AltSpriteItemData> f;
    ...
    private void a(float f, float f2, int i, int i2, Color4 color4) {
        ...
        for (int i14 = 0; i14 < this.a; i14++) {
            AltSpriteItemData bVar = new AltSpriteItemData(this);
            bVar.J = i14;
            bVar.a = i14 * 2;
            bVar.b = bVar.a + 1;
            bVar.c = bVar.a + i13;
        ...
        this.j = new com.censivn.C3DEngine.b.d.MouseEventListener(this.g == null ? this : this.g) { // from class: com.censivn.C3DEngine.b.f._a.AltTextureSpriteRenderable.1
    ...
    public void a(AltSpriteItemData bVar) {
        float f;
        float f2;
        float f3;
        float f4;
    ...
    private void c(AltSpriteItemData bVar) {
    ...
    public void b(AltSpriteItemData bVar) {
        c(bVar);
    ...
    private void a(AltSpriteItemData bVar, float f) {
        if (this.k) {
    ...
    public b a(float f, float f2) {
        for (int i = 0; i < this.a; i++) {
            AltSpriteItemData bVar = this.f.get(i);
