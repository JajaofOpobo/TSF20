...
public class TextureFactory {
    ...
    public TextureElement a(int i, int i2, boolean z) {
        TextureElement textureElement = new TextureElement(com.censivn.C3DEngine.C3DEngine.e().a(i, i2, z), z);
    ...
    public TextureElement a(Bitmap bitmap, boolean z) {
        TextureElement textureElement = new TextureElement(com.censivn.C3DEngine.C3DEngine.e().a(bitmap, z), z);
    ...
    public void a(TextureElement textureElement, int i, int i2, int i3) {
        Bitmap bitmapA = x.a(i, i2, i3);
        a(textureElement, bitmapA);
        bitmapA.recycle();
    }

    public void a(TextureElement textureElement, int i) {
        Bitmap bitmapA = x.a(i);
        a(textureElement, bitmapA);
        bitmapA.recycle();
    }
    ...
    public void a(TextureElement textureElement, Bitmap bitmap) {
        if (textureElement != null) {
            if (textureElement.id == 0) {
                textureElement.id = com.censivn.C3DEngine.C3DEngine.e().a(bitmap, textureElement.mipMap);
                textureElement.width = bitmap.getWidth();
                textureElement.height = bitmap.getHeight();
                this.b++;
                ...
                if (textureElement.id != 0) {
                    this.b--;
                    com.censivn.C3DEngine.C3DEngine.e().a(textureElement.id);
                }
                textureElement.id = com.censivn.C3DEngine.C3DEngine.e().a(bitmap, textureElement.mipMap);
                textureElement.width = bitmap.getWidth();
                textureElement.height = bitmap.getHeight();
                ...
                com.censivn.C3DEngine.C3DEngine.e().a(textureElement.id, bitmap, 0, 0);
            }
            textureElement.width = bitmap.getWidth();
            textureElement.height = bitmap.getHeight();
        }
