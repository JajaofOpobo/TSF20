...
public class e {
    ...
    private void f() {
        Home homeB = Home.b();
        int iAt = com.tsf.shell.manager.b.e.at();
        if (iAt == -1) {
            int requestedOrientation = homeB.getRequestedOrientation();
            try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (Build.VERSION.SDK_INT >= 16) {
                                    LauncherAccessibilityService launcherAccessibilityServiceA = LauncherAccessibilityService.a();
