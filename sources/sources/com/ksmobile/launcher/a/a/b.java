...
public class b {
    ...
    private void b(String str) {
        com.cm.kinfoc.a.b bVarA = com.cm.kinfoc.a.b.A();
        String strValueOf = String.valueOf(bVarA.y());
        if (strValueOf.length() > 20) {
            strValueOf = strValueOf.substring(0, 19);
        }
        String strSubstring = bVarA.t() + "x" + bVarA.u();
        if (strSubstring.length() > 20) {
            strSubstring = strSubstring.substring(0, 19);
        }
        e(true, "tsflauncher_active", "vga", strSubstring, "dpi", strValueOf, "cores", bVarA.w(), "mem", bVarA.x());
    }
