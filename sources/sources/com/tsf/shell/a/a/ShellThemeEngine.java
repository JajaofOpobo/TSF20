...
public class ShellThemeEngine extends Dialog {
    ...
    public void a(int i, int i2, String str, final DialogInterface.OnClickListener onClickListener) {
        if (this.a instanceof Activity) {
            setOnKeyListener(new DialogInterface.OnKeyListener() { // from class: com.tsf.shell.ShellCallbackDispatcher.a.c.1
            ...
            findViewById(ShellContentManager.b.perm_ok).setOnClickListener(new View.OnClickListener() { // from class: com.tsf.shell.ShellCallbackDispatcher.a.c.2
