...
public class AppIconEditorActivity extends FragmentActivity {
    ...
    public static class a extends android.support.v4.app.k implements View.OnClickListener {
        ...
        public void a(Bundle bundle) {
            ...
            Bundle bundleH = h();
            if (bundleH != null) {
                Bitmap bitmap = (Bitmap) bundleH.getParcelable("icon");
                int i = bundleH.getInt("iconStartX");
                int i2 = bundleH.getInt("iconStartY");
                this.aj = Bitmap.createBitmap(bundleH.getInt("iconWidth"), bundleH.getInt("iconHeight"), Bitmap.Config.ARGB_8888);
                new Canvas(this.aj).drawBitmap(bitmap, -i, i2, (Paint) null);
                this.ak = bundleH.getString("name");
                this.al = bundleH.getString("package");
            }
        }
