...
public class ThemeElementManager extends Fragment implements View.OnClickListener {
    private PackageManager a;
    private GridView b;
    private int c;
    private int d;
    private com.tsf.shell.plugin.themepicker.theme.ThemeElementParser e;
    private a f;
    ...
    public void a(Bundle bundle) {
        ...
        this.e = new com.tsf.shell.plugin.themepicker.theme.ThemeElementParser(this.a, i());
        this.e.a(f.e.ic_preload_large);
        this.f = new ThemeElementParser(i(), listQueryIntentActivities);
    }
    ...
    public class View 
        ...
        this.b.setOnScrollListener(new AbsListView.OnScrollListener() { // from class: com.tsf.shell.plugin.themepicker.theme.ThemeElementManager.1
        ...
        this.b.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.tsf.shell.plugin.themepicker.theme.ThemeElementManager.2
