...
public class ThemePickerData extends com.tsf.shell.plugin.themepicker.utils.PercentToAlphaConverter {
    private Context a;
    private Context b;
    private Resources e;
    ...
    private void a(ResolveInfo resolveInfo, Context context) {
        this.a = context;
        if (resolveInfo == null) {
            ThemePickerEvent.b("resolveInfo is null Error");
        }
    ...
    */
    protected android.graphics.Bitmap a(java.lang.Integer r5) throws java.lang.Throwable {
        /*
            r4 = this;
            r0 = 0
            ...
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.b(r1)
            r2 = 16
        ...
        L6d:
            ...
            goto L4f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.plugin.themepicker.ThemePickerData.a(java.lang.Integer):android.graphics.Bitmap");
    }

    protected Bitmap a(String str) {
        Bitmap bitmapDecodeStream = null;
        ThemePickerEvent.b("Start processBitmap:" + str);
        try {
            Thread.sleep(16L);
            try {
                InputStream inputStreamOpen = this.b.getAssets().open("theme/icon/" + str + ".png");
                bitmapDecodeStream = BitmapFactory.decodeStream(new BufferedInputStream(inputStreamOpen));
            ...
            ThemePickerEvent.b("InterruptedException Error:" + str);
            return null;
        }
    }
