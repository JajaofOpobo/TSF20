...
public class ThemeUtilsConfig extends ThemeUtilsProcessor {
    protected int a;
    protected int b;
    ...
    private Bitmap b(int i) {
        com.tsf.shell.plugin.themepicker.ThemePickerEvent.a("ImageResizer", "processBitmap - " + i);
    ...
    private static void a(BitmapFactory.Options options, c cVar) {
        ...
        if (cVar != null && (bitmapA = cVar.a(options)) != null) {
