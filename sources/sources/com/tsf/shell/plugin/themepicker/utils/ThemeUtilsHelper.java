...
public class ThemeUtilsHelper extends ThemeUtilsConfig {
    private b e;
    private File f;
    private boolean g;
    ...
    private void a(Context context) {
        b(context);
        this.f = ThemeUtilsRenderer.a(context, "http");
    }
    ...
    private void j() {
        ...
        synchronized (this.h) {
            if (ThemeUtilsRenderer.a(this.f) > 10485760) {
                try {
                    this.e = ThemeUtilsManager.a(this.f, 1, 1, 10485760L);
                    com.tsf.shell.plugin.themepicker.ThemePickerEvent.a("ImageFetcher", "HTTP cache initialized");
                } catch (IOException e) {
                    this.e = null;
                }
                this.g = false;
    ...
    protected void b() {
        ...
        synchronized (this.h) {
            if (this.e != null && !this.e.a()) {
                try {
                    this.e.c();
                    com.tsf.shell.plugin.themepicker.ThemePickerEvent.a("ImageFetcher", "HTTP cache cleared");
                } catch (IOException e) {
                    com.tsf.shell.plugin.themepicker.ThemePickerEvent.c("ImageFetcher", "clearCacheInternal - " + e);
                }
                this.e = null;
                this.g = true;
                j();
    ...
    protected void c() {
        ...
        synchronized (this.h) {
            if (this.e != null) {
                try {
                    this.e.b();
                    com.tsf.shell.plugin.themepicker.ThemePickerEvent.a("ImageFetcher", "HTTP cache flushed");
                } catch (IOException e) {
                    com.tsf.shell.plugin.themepicker.ThemePickerEvent.c("ImageFetcher", "flush - " + e);
                }
            }
        }
    }
    ...
    */
    protected void d() {
        /*
            ...
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.a(r0, r2)     // Catch: java.io.IOException -> L23 java.lang.Throwable -> L3d
        L21:
        ...
        L23:
            ...
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.c(r2, r0)     // Catch: java.lang.Throwable -> L3d
            goto L21
        L3d:
            r0 = move-exception
            monitor-exit(r1)     // Catch: java.lang.Throwable -> L3d
    ...
    private void b(Context context) {
        ...
        if (activeNetworkInfo == null || !activeNetworkInfo.isConnectedOrConnecting()) {
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.c("ImageFetcher", "checkConnection - no connection found");
        }
    }
    ...
    */
    public boolean a(java.lang.String r9, java.io.OutputStream r10) throws java.lang.Throwable {
        ...
        L32:
            ...
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.c(r4, r0)     // Catch: java.lang.Throwable -> L94
            if (r2 == 0) goto L4f
            r2.disconnect()
        L4f:
            if (r3 == 0) goto L54
