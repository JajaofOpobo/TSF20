...
public class ThemeUtilsDrawable extends BitmapDrawable {
    private int a;
    private int b;
    private boolean c;
    ...
    private synchronized void a() {
        if (this.a <= 0 && this.b <= 0 && this.c && b()) {
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.a("CountingBitmapDrawable", "No longer being used or cached so recycling. " + toString());
            getBitmap().recycle();
        }
    }
