...
public abstract class ThemeUtilsProcessor {
    ...
    public void a(Object obj, ImageView imageView) {
        if (obj != null) {
            ...
            if (bitmapDrawableA != null) {
                ...
                b bVar = new ThemeUtilsManager(obj, imageView);
                imageView.setImageDrawable(new ThemeUtilsParser(this.d, this.e, bVar));
    ...
    public static boolean b(Object obj, ImageView imageView) {
        ...
        if (obj2 == null || !obj2.equals(obj)) {
            bVarB.a(true);
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.c("ImageWorker", "--------------------cancelPotentialWork - cancelled work for " + obj);
            return true;
        }
        return false;
    }
    ...
    public void h() {
        new ThemeUtilsRenderer().c(2);
    }

    public void i() {
        new ThemeUtilsRenderer().c(3);
    }
}
