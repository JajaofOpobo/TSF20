...
public class ThemeUtilsRenderer {
    ...
    private void a(a aVar) {
        this.d = aVar;
        if (this.d.f) {
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.a("ImageCache", "Memory cache created (size = " + this.d.a + ")");
    ...
    */
    public void a() {
        ...
        L24:
            ...
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.a(r0, r2)     // Catch: java.io.IOException -> L4f java.lang.Throwable -> L6e
        L45:
            r0 = 0
        ...
        L4f:
            ...
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.c(r2, r0)     // Catch: java.lang.Throwable -> L6e
            goto L45
        L6e:
            r0 = move-exception
            monitor-exit(r1)     // Catch: java.lang.Throwable -> L6e
    ...
    public void a(String str, BitmapDrawable bitmapDrawable) {
        ...
        synchronized (this.e) {
            if (this.b != null) {
                ...
                try {
                    try {
                        ThemeUtilsManager.c cVarA = this.b.a(C);
                        if (cVarA == null) {
                            ThemeUtilsManager.a aVarB = this.b.b(C);
                            if (aVarB != null) {
    ...
    public class BitmapDrawable 
        ...
        if (bitmapDrawableA != null) {
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.a("ImageCache", "Memory cache hit");
        }
    ...
    */
    public android.graphics.Bitmap b(java.lang.String r9) {
        ...
        L14:
            ...
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.a(r2, r5)     // Catch: java.io.IOException -> L47 java.lang.Throwable -> L69
            r2 = 0
        ...
        L49:
            ...
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.c(r5, r1)     // Catch: java.lang.Throwable -> L78
            if (r2 == 0) goto L45
    ...
    public void b() {
        if (this.c != null) {
            this.c.a();
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.a("ImageCache", "Memory cache cleared");
        }
        synchronized (this.e) {
            this.f = true;
            if (this.b != null && !this.b.a()) {
                try {
                    this.b.c();
                    com.tsf.shell.plugin.themepicker.ThemePickerEvent.a("ImageCache", "Disk cache cleared");
                } catch (IOException e) {
    ...
    public void c() {
        synchronized (this.e) {
            if (this.b != null) {
                try {
                    this.b.b();
                    com.tsf.shell.plugin.themepicker.ThemePickerEvent.a("ImageCache", "Disk cache flushed");
                } catch (IOException e) {
                    com.tsf.shell.plugin.themepicker.ThemePickerEvent.c("ImageCache", "flush - " + e);
                }
            }
        }
    }
    ...
    */
    public void d() {
        /*
            ...
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.a(r0, r2)     // Catch: java.io.IOException -> L20 java.lang.Throwable -> L3a
        L1e:
        ...
        L20:
            ...
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.c(r2, r0)     // Catch: java.lang.Throwable -> L3a
            goto L1e
        L3a:
            r0 = move-exception
            monitor-exit(r1)     // Catch: java.lang.Throwable -> L3a
    ...
    private static boolean a(Bitmap bitmap, BitmapFactory.Options options) {
        return !ThemeUtilsConstants.f() ? bitmap.getWidth() == options.outWidth && bitmap.getHeight() == options.outHeight && options.inSampleSize == 1 : ((options.outWidth / options.inSampleSize) * (options.outHeight / options.inSampleSize)) * a(bitmap.getConfig()) <= bitmap.getAllocationByteCount();
    }
    ...
    public static int a(BitmapDrawable bitmapDrawable) {
        ...
        if (ThemeUtilsConstants.f()) {
            return bitmap.getAllocationByteCount();
        }
        if (ThemeUtilsConstants.d()) {
