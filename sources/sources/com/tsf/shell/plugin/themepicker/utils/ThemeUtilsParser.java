...
public abstract class ThemeUtilsParser<Params, Progress, Result> {
    ...
    private volatile d j = ThemeUtilsHelper.PENDING;
    ...
    static {
        c = ThemeUtilsConstants.c() ? new ThemeUtilsRenderer() : Executors.newSingleThreadExecutor(a);
        d = Executors.newFixedThreadPool(2, a);
        f = new ThemeUtilsManager();
        g = c;
    }
    ...
    public final a<Params, Progress, Result> a(Executor executor, Params... paramsArr) {
        if (this.j != ThemeUtilsHelper.PENDING) {
            switch (this.j) {
                case RUNNING:
    ...
    public void e(Result result) {
        ...
        this.j = ThemeUtilsHelper.FINISHED;
    }
