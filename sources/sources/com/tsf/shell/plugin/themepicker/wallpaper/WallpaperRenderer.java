...
public class WallpaperRenderer extends Fragment implements View.OnClickListener, k.h {
    private int a;
    private TextView ai;
    private k.g aj;
    private int b;
    private int c;
    private a d;
    private com.tsf.shell.plugin.themepicker.wallpaper.WallpaperData e;
    private GridView f;
    private Handler g;
    ...
    public void a(Bundle bundle) {
        ...
        this.e = new com.tsf.shell.plugin.themepicker.wallpaper.WallpaperData(this.h, i(), this.a, this.b);
        this.e.a(f.e.ic_preload_large);
        this.d = new WallpaperData(i());
        this.g = new Handler();
    ...
    public class View 
        ...
        this.f.setOnScrollListener(new AbsListView.OnScrollListener() { // from class: com.tsf.shell.plugin.themepicker.wallpaper.WallpaperRenderer.1
        ...
        this.f.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.tsf.shell.plugin.themepicker.wallpaper.WallpaperRenderer.2
    ...
    public void a(final List<Integer> list, final String str, final String str2) {
        if (list != null && list.size() != 0) {
            this.g.post(new Runnable() { // from class: com.tsf.shell.plugin.themepicker.wallpaper.WallpaperRenderer.3
