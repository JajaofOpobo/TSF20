...
public class ThemePreviewData extends ThemePreviewConfig {
    ...
    public class View 
        ...
        String strD = com.tsf.shell.plugin.themepicker.ThemePickerRenderer.d(contextA);
        ...
        String strF = com.tsf.shell.plugin.themepicker.ThemePickerRenderer.f(contextA);
        ...
        String strE = com.tsf.shell.plugin.themepicker.ThemePickerRenderer.e(contextA);
