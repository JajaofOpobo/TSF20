...
public class ThemePreviewPanel extends Fragment implements ThemePreviewConfig.b {
    ...
    public void a(Bundle bundle) {
        super.a(bundle);
        ThemePreviewRenderer.a aVar = new ThemePreviewRenderer.a(i(), "thumbs");
        aVar.a(0.25f);
        this.a = new com.tsf.shell.plugin.themepicker.utils.LazyBitmapFactory(i(), 480, 720);
        this.a.a(i().f(), aVar);
        this.f = new ThemePreviewData();
    ...
    public void M() {
        ThemePreviewConfig.a(i(), "http://gcm.tsfui.com/recommend_theme.xml", this);
    }
    ...
    @Override // com.tsf.shell.plugin.themepicker.ThemePickerRenderer.b
    public void a(List<ThemePreviewConfig.e> list) {
        if (list != null) {
            final GridView gridView = (GridView) this.b.findViewById(f.C0155f.gridView1);
            this.c = new ThemePreviewManager(list, i());
            gridView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.tsf.shell.plugin.themepicker.themepreview.ThemePreviewPanel.1
    ...
    private class b extends BaseAdapter implements AdapterView.OnItemClickListener {
        private List<ThemePreviewConfig.e> b;
        private Context c;
        private int d = 0;
        private int e = 0;
