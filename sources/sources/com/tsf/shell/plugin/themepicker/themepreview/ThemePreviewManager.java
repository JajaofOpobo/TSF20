...
public class ThemePreviewManager extends com.tsf.shell.plugin.themepicker.utils.SelectionDotRenderer {
    ...
    protected Bitmap a(ResolveInfo resolveInfo) {
        try {
            Thread.sleep(16L);
            Context contextA = ThemePreviewConfig.a(this.e, resolveInfo.activityInfo.packageName);
            Resources resources = contextA.getResources();
            ArrayList<Integer> arrayListA = ThemePreviewConfig.a(contextA);
            if (arrayListA != null && arrayListA.size() > 0) {
                return a(resources, arrayListA.get(0).intValue());
            }
            ArrayList<Integer> arrayListB = ThemePreviewConfig.b(contextA);
            ...
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.b("InterruptedException Error:" + resolveInfo);
            return null;
        }
    }
    ...
    private Bitmap a(a aVar) {
        Resources resources = ThemePreviewConfig.a(this.e, aVar.a).getResources();
        try {
            Thread.sleep(16L);
    ...
    */
    private android.graphics.Bitmap a(android.content.res.Resources r4, int r5) throws java.lang.Throwable {
        ...
        L34:
            ...
            goto L16
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.plugin.themepicker.themepreview.ThemePreviewManager.a(android.content.res.Resources, int):android.graphics.Bitmap");
    }
