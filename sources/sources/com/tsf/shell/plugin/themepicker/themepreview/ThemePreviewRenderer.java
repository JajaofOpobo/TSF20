...
public class ThemePreviewRenderer extends Fragment implements ThemePreviewConfig.f {
    private com.tsf.shell.plugin.themepicker.themepreview.ThemePreviewManager a;
    private ViewGroup b;
    private b c;
    ...
    public void a(Bundle bundle) {
        super.a(bundle);
        com.tsf.shell.plugin.themepicker.ThemePickerEvent.b("ThemePreviewLocalFragment onCreate  ");
        this.a = new com.tsf.shell.plugin.themepicker.themepreview.ThemePreviewManager(i(), (int) TypedValue.applyDimension(1, 160.0f, j().getDisplayMetrics()), (int) TypedValue.applyDimension(1, 284.0f, j().getDisplayMetrics()));
        this.e = new ThemePreviewData();
    ...
    @Override // android.support.v4.app.Fragment
    public void q() {
        com.tsf.shell.plugin.themepicker.ThemePickerEvent.b("ThemePreviewLocalFragment onResume");
        this.a.a(false);
        super.q();
    }
    ...
    public void a(List<ResolveInfo> list) {
        ...
        this.c = new ThemePreviewManager(list, i());
        gridView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.tsf.shell.plugin.themepicker.themepreview.ThemePreviewRenderer.1
