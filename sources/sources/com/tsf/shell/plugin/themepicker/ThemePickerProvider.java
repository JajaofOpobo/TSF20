...
public class ThemePickerProvider extends Fragment implements View.OnClickListener {
    private GridView a;
    private a b;
    ...
    public void a(Bundle bundle) {
        super.a(bundle);
        this.b = new ThemePickerParser(i());
    }
    ...
    private class a extends BaseAdapter implements AdapterView.OnItemClickListener {
        ...
        public void b(int i) {
            ThemePickerEvent.b("mNumColumns:" + i);
            this.d = i;
        }
        ...
        public View c() {
            if (i < this.d) {
                ...
                if (view == null) {
                    view = LayoutInflater.from(viewGroup.getContext()).inflate(ThemePickerResources.h.theme_preview_gallery_app_item, viewGroup, false);
                }
