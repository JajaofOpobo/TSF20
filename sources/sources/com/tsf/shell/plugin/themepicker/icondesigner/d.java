...
public class d {
    ...
    public Bitmap a(Context context, String str, int i) throws Throwable {
        long jCurrentTimeMillis = System.currentTimeMillis();
        ArrayList<Integer> arrayListA = a(context, str);
        com.tsf.shell.plugin.themepicker.e.b("parse cost :" + (System.currentTimeMillis() - jCurrentTimeMillis) + "   size:" + arrayListA.size());
    ...
    */
    ...
    public static ArrayList<Integer> a(Context context, int i) {
        ...
        if (arrayListC != null) {
            com.tsf.shell.plugin.themepicker.e.b("getThemeIconFromAsset:" + arrayListC.size());
            return arrayListC;
        }
        ArrayList<Integer> arrayListB = b(context, i);
        if (arrayListB != null) {
            com.tsf.shell.plugin.themepicker.e.b("getThemeIconFromXML:" + arrayListB.size());
            return arrayListB;
        }
        return null;
    }
