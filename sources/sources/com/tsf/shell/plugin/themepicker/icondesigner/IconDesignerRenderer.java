...
public class IconDesignerRenderer {
    private Map<String, ArrayList<Integer>> a = new HashMap();

    private ArrayList<Integer> a(Context context, String str) {
        ArrayList<Integer> arrayListA = this.a.get(str);
        if (arrayListA == null) {
            arrayListA = a(k.a(context, str), 16);
            if (arrayListA == null) {
                arrayListA = new ArrayList<>();
            }
            this.a.put(str, arrayListA);
        }
        return arrayListA;
    }
    ...
    public Bitmap a(Context context, String str, int i) {
        ...
        while (true) {
            ...
            Bitmap bitmapA = a(contextA.getResources(), arrayListA.get(i3).intValue());
            float fMax = Math.max(f3 / bitmapA.getWidth(), f3 / bitmapA.getHeight());
            canvas.save();
            canvas.scale(fMax, fMax);
            canvas.drawBitmap(bitmapA, (((i3 % 4) * f2) / fMax) + ((f4 / fMax) / 2.0f) + ((f / fMax) / 2.0f), (((i3 / 4) * f2) / fMax) + ((f4 / fMax) / 2.0f) + ((f / fMax) / 2.0f), paint);
            canvas.restore();
            bitmapA.recycle();
            i2 = i3 + 1;
        }
    ...
    */
    private static android.graphics.Bitmap a(android.content.res.Resources r3, int r4) throws java.lang.Throwable {
        /*
            r0 = 0
        ...
        L34:
            ...
            goto L16
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.plugin.themepicker.ThemePickerManagercondesigner.d.a(android.content.res.Resources, int):android.graphics.Bitmap");
    }

    public static ArrayList<Integer> a(Context context, int i) {
        ArrayList<Integer> arrayListC = c(context, i);
        if (arrayListC != null) {
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.b("getThemeIconFromAsset:" + arrayListC.size());
            return arrayListC;
        }
        ArrayList<Integer> arrayListB = b(context, i);
        if (arrayListB != null) {
            com.tsf.shell.plugin.themepicker.ThemePickerEvent.b("getThemeIconFromXML:" + arrayListB.size());
            return arrayListB;
        }
        return null;
    }
