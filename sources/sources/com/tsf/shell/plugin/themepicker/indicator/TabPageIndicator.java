...
public class TabPageIndicator extends HorizontalScrollView implements c {
    ...
    public TabPageIndicator(Context context, AttributeSet attributeSet) {
        ...
        this.c = new View.OnClickListener() { // from class: com.tsf.shell.plugin.themepicker.indicator.TabPageIndicator.1
            ...
            public void onClick(View view) {
                ...
                int iA = ((b) view).a();
                TabPageIndicator.this.e.setCurrentItem(iA);
                if (currentItem == iA && TabPageIndicator.this.i != null) {
                    TabPageIndicator.this.i.a(iA);
                }
            }
        };
    ...
    public void a() {
        ...
        int iB = adapter.b();
        for (int i = 0; i < iB; i++) {
            CharSequence charSequenceC = adapter.c(i);
            a(i, charSequenceC == null ? a : charSequenceC, aVar != null ? aVar.a(i) : 0);
        }
        if (this.h > iB) {
            this.h = iB - 1;
        }
