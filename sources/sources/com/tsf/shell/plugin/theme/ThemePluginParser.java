...
public class ThemePluginParser extends ArrayAdapter<c> {
    int a;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (i < getCount() && (cVar = this.b.get(i)) != null) {
            TextView textView = (TextView) view.findViewById(ThemePluginManager.e.title);
            TextView textView2 = (TextView) view.findViewById(ThemePluginManager.e.count);
            ImageView imageView = (ImageView) view.findViewById(ThemePluginManager.e.image);
