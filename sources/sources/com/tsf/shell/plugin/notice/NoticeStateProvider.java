...
public class NoticeStateProvider {

    public interface a {
        void a(int i);
    }

    /* JADX WARN: Type inference failed for: r0v1, types: [com.tsf.shell.plugin.notice.NoticeStateProvider$1] */
    public static void a(final Context context, final a aVar, final boolean z) {
        if (c(context)) {
            new Thread() { // from class: com.tsf.shell.plugin.notice.NoticeStateProvider.1
    ...
    public static void c(Context context, a aVar, boolean z) {
        ...
        if (elementA != null) {
            ...
            if (!attribute.equals("")) {
                ...
                NoticeEvent.c("duration:" + iIntValue);
                a(context, iIntValue);
            }
            NodeList elementsByTagName = elementA.getElementsByTagName("update");
            if (elementsByTagName.getLength() > 0) {
                NoticeManager.a(context, elementsByTagName, aVar, z);
            }
            NodeList elementsByTagName2 = elementA.getElementsByTagName("recommend");
            if (elementsByTagName2.getLength() > 0) {
                com.tsf.shell.plugin.notice.NoticeDataProvider.a(context, elementsByTagName2);
            }
        }
    }
    ...
    private static Element a(Context context) {
        ...
        NoticeEvent.c("RequestUpdate:" + str);
        return NoticeConfig.a(str);
    }
    ...
    private static void a(Context context, int i) {
        NoticeEvent.c("saveDurationTime duration:" + i);
    ...
    private static boolean c(Context context) {
        ...
        NoticeEvent.c("now :" + jCurrentTimeMillis);
        NoticeEvent.b("prev :" + j);
        NoticeEvent.a("dura :" + j2);
        if (j2 == 0) {
            NoticeEvent.c("dura Error true");
            return true;
        }
        if (j == 0) {
            NoticeEvent.c("prev Error true");
            return true;
        }
        if (jCurrentTimeMillis < j) {
            NoticeEvent.c("now < prev Error true");
            return true;
        }
        if (jCurrentTimeMillis - j > j2) {
            NoticeEvent.c("(now - prev) > dura normal true");
            return true;
        }
        NoticeEvent.c("No error no need update");
        return false;
    }
}
