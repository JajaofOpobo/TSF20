...
import com.tsf.shell.plugin.crop.CropImageManager;
...
public class CropImageRenderer implements CropImageManager.a {
    ...
    public b b = new CropImageManager();
    public b c = new CropImageManager();
    private float u = 30.0f;
    private Matrix z = new Matrix();
    b e = new CropImageManager();
    b f = new CropImageManager();
    ...
    public d(Context context, g gVar) {
        ...
        CropImageConfig.a("mCornetRadius:" + this.A);
        this.r = new Paint();
    ...
    public void a(a aVar, float f, float f2) {
        ...
        if (aVar == CropImageParser.BOTTOM) {
            float fG = g(f2);
            if (this.t) {
            ...
            if (f <= (this.a.a + f3) - f5 || f >= f3 + this.a.a + f5) {
                if (f2 > (this.a.b + f4) - f5 && f2 < this.a.b + f4 + f5) {
                    if (f > this.a.a - f5 && f < this.a.a + f5) {
                        return CropImageParser.LEFT;
                    }
                    if (f > this.a.c - f5 && f < this.a.c + f5) {
                        return CropImageParser.RIGHT;
                    }
                }
            } else {
                if (f2 > this.a.b - f5 && f2 < this.a.b + f5) {
                    return CropImageParser.TOP;
                }
                if (f2 > this.a.d - f5 && f2 < this.a.d + f5) {
                    return CropImageParser.BOTTOM;
                }
            }
            return CropImageParser.CENTER;
        }
        return CropImageParser.NULL;
    }
