...
public class PluginBridgeB {
    ...
    static {
        a = !PluginBridgeB.class.desiredAssertionStatus();
    ...
    public static byte[] a(byte[] bArr, int i, int i2, byte[] bArr2) throws c {
        int i3;
        int iA;
        ...
        while (true) {
            ...
            if (b3 >= -5) {
                if (b3 < -1) {
                    ...
                    if (i5 == 0 || i5 == 1) {
                        throw new PluginBridgeException("invalid padding byte '=' at byte offset " + i4);
                    }
                    if ((i5 == 3 && i6 > 2) || (i5 == 4 && i6 > 1)) {
                        throw new PluginBridgeException("padding byte '=' falsely signals end of encoded value at offset " + i4);
                    }
                    if (b4 != 61 && b4 != 10) {
                        throw new PluginBridgeException("encoded value has invalid trailing byte");
                    }
                } else {
                    i3 = i5 + 1;
                    bArr4[i5] = b2;
                ...
                throw new PluginBridgeException("Bad Base64 input character at " + i4 + ": " + ((int) bArr[i4 + i]) + "(decimal)");
            }
        }
        if (i5 != 0) {
            if (i5 == 1) {
                throw new PluginBridgeException("single trailing character at offset " + (i2 - 1));
            }
            int i7 = i5 + 1;
            bArr4[i5] = 61;
