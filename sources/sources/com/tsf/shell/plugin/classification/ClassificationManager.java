...
public class ClassificationManager {
    ...
    /* JADX INFO: renamed from: com.tsf.shell.plugin.classification.ClassificationManager$d, reason: collision with other inner class name */
    ...
    public static AsyncTask a(Context context, ArrayList<String> arrayList, InterfaceC0151d interfaceC0151d) {
        return new ClassificationDatabase(context, arrayList, interfaceC0151d).execute(new Void[0]);
    }
        ...
        if (str != null && str.length() != 0) {
            try {
                try {
                    ...
                    writableDatabase = com.tsf.shell.plugin.classification.ClassificationDatabase.a(context).getWritableDatabase();
                    while (itKeys.hasNext()) {
                        ...
                        contentValues.put(com.tsf.shell.plugin.classification.ClassificationColumns.b, next);
                        contentValues.put(com.tsf.shell.plugin.classification.ClassificationColumns.a, Integer.valueOf(iA));
    ...
    */
    public static java.lang.String b(java.util.ArrayList<java.lang.String> r11) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.plugin.classification.ClassificationManager.b(java.util.ArrayList):java.lang.String");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static a c(Context context, ArrayList<String> arrayList) {
        b bVar;
        SQLiteDatabase readableDatabase = com.tsf.shell.plugin.classification.ClassificationDatabase.a(context).getReadableDatabase();
        a aVar = new ClassificationColumns(context);
        for (String str : arrayList) {
            try {
                Cursor cursorQuery = readableDatabase.query("application", null, com.tsf.shell.plugin.classification.ClassificationColumns.b + "=?", new String[]{str}, null, null, null);
                if (cursorQuery != null) {
                    int columnIndex = cursorQuery.getColumnIndex(com.tsf.shell.plugin.classification.ClassificationColumns.a);
                    if (cursorQuery.getCount() != 0) {
                        ...
                        if (aVar.a.containsKey(Integer.valueOf(iA))) {
                            ...
                            bVar = new ClassificationInfoColumns(a(context, iA), iA);
