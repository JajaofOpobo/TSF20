...
public final class Home extends ActivityGroup implements View.OnLongClickListener, com.tsf.shell.ShellCoreInterface, com.tsf.shell.manager.bind.ShellBindCallback {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (this.s) {
            ...
            a(new ShellLayoutEngine.b() { // from class: com.tsf.shell.Home.12
    ...
    public boolean onLongClick(View view) {
        ...
        final ShellLayoutEngine.a aVar = (ShellLayoutEngine.a) (!(view instanceof com.tsf.shell.e.CellLayout) ? (View) view.getParent().getParent() : view).getTag();
        if (aVar == null) {
            return true;
        }
        if (this.g.a()) {
