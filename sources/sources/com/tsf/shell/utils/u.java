...
public class u {
    ...
    private static String a(byte[] bArr) {
        ...
        for (int i = 0; i < bArrDigest.length; i++) {
            if (Integer.toHexString(bArrDigest[i] & Constants.UNKNOWN).length() == 1) {
                stringBuffer.append("0").append(Integer.toHexString(bArrDigest[i] & Constants.UNKNOWN));
            } else {
                stringBuffer.append(Integer.toHexString(bArrDigest[i] & Constants.UNKNOWN));
            }
        }
