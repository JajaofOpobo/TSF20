...
public class b {
    public static void a(final g gVar, final float f, final float f2, final a.AbstractC0146a abstractC0146a) {
        if (com.tsf.shell.manager.app.StateHub.F() == -1) {
            com.tsf.shell.manager.app.StateHub.a(com.tsf.shell.manager.app.StateHub.o(), (Runnable) null, new Runnable() { // from class: com.tsf.shell.manager.r.c.a.b.1
            ...
            ItemInfo itemInfoA = a(gVar, com.tsf.shell.manager.app.StateHub.F(), f, f2, f, f2, 1.0f, 1.0f, 0.0f, 0.0f);
            if (itemInfoA != null) {
