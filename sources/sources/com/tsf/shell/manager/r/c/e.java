...
public class e {
    ...
    private b b;
    private ArrayList<com.tsf.shell.f.i._c.g> c;
    private com.tsf.shell.f.i._c.g d;
    ...
    private void f() {
        ArrayList<com.tsf.shell.f.i._c.e> arrayList = new ArrayList<>();
        ArrayList<com.tsf.shell.f.i._c.e> arrayList2 = new ArrayList<>();
        com.tsf.shell.f.i._c.c cVar = new com.tsf.shell.f.i._c.c();
        this.d = cVar;
        cVar.e = true;
        cVar.b = com.tsf.shell.f.i._b.d.b.class.getName();
        ((com.tsf.shell.f.i._c.g) cVar).a = "";
        cVar.d = 1;
        cVar.c(b.i.widget_folder);
        arrayList.add(this.d);
        this.c.add(cVar);
        com.tsf.shell.f.i._c.g gVarA = f.a("com.tsf.shell.widget.alarm", null);
        gVarA.e = true;
        ...
        arrayList.add(gVarA);
        this.c.add(gVarA);
        com.tsf.shell.f.i._c.g gVarA2 = f.a("com.tsf.shell.widget.message", null);
        gVarA2.e = false;
        gVarA2.b = "";
        gVarA2.d = 5;
        ...
        this.c.add(gVarA2);
        com.tsf.shell.f.i._c.g gVarA3 = f.a("com.tsf.shell.widget.dotsclock", null);
        gVarA3.e = true;
        ...
        this.c.add(gVarA3);
        com.tsf.shell.f.i._c.g gVarA4 = f.a("com.tsf.shell.widget.cubeclock", null);
        gVarA4.e = true;
        ...
        this.c.add(gVarA4);
        com.tsf.shell.f.i._c.g gVarA5 = f.a("com.tsf.shell.widget.calendar", null);
        gVarA5.e = false;
        gVarA5.b = "";
        gVarA5.d = 5;
        ...
        this.c.add(gVarA5);
        com.tsf.shell.f.i._c.g gVarA6 = f.a("com.tsf.shell.widget.gallery", null);
        gVarA6.e = false;
        gVarA6.b = "";
        gVarA6.d = 5;
        ...
        this.c.add(gVarA6);
        com.tsf.shell.f.i._c.g gVarA7 = f.a("com.tsf.shell.widget.memo", null);
        gVarA7.e = false;
        gVarA7.b = "";
        gVarA7.d = 5;
        ...
        this.c.add(gVarA7);
        com.tsf.shell.f.i._c.g gVarA8 = f.a("com.tsf.shell.widget.weather", null);
        gVarA8.e = false;
        gVarA8.b = "";
        gVarA8.d = 5;
        ...
        this.c.add(gVarA8);
        com.tsf.shell.f.i._c.g gVarA9 = f.a("com.tsf.shell.widget.music", null);
        gVarA9.e = false;
        gVarA9.b = "";
        gVarA9.d = 5;
        ...
        this.c.add(gVarA9);
        com.tsf.shell.f.i._c.g gVarK = com.tsf.shell.f.i._b.a.b.k();
        gVarK.e = true;
        gVarK.b = com.tsf.shell.f.i._b.a.b.class.getName();
        ...
        this.c.add(gVarK);
        com.tsf.shell.f.i._c.d dVar = new com.tsf.shell.f.i._c.d();
        dVar.e = true;
        dVar.b = com.tsf.shell.f.i._b.c.a.class.getName();
        dVar.c = "com.tsf.shell.widget.floating";
        ((com.tsf.shell.f.i._c.g) dVar).a = "";
        dVar.d = 5;
        dVar.g = 1;
        dVar.c(b.i.widget_flotage);
        arrayList2.add(dVar);
        this.c.add(dVar);
        com.tsf.shell.f.i._c.g gVarA10 = f.a("com.tsf.shell.widget.adornment", null);
        gVarA10.e = false;
        gVarA10.b = "";
        gVarA10.d = 5;
    ...
    public void a(final ItemInfo itemInfo, final a.AbstractC0146a abstractC0146a) {
        ...
        com.tsf.shell.f.i._c.g gVarA = a(itemInfo.packagename);
        ...
        for (com.tsf.shell.manager.a.f fVar : arrayList) {
            try {
                ...
                if (!packageName.equals("com.tsf.shell.widget.alarm")) {
                    ...
                    String str = fVar.e;
                    com.tsf.shell.f.i._c.g gVarA = a(packageName);
                    if (gVarA == null) {
    ...
    public void c(final ArrayList<com.tsf.shell.manager.a.f> arrayList) {
        ...
        com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.manager.r.c.e.8
            ...
            public void run() {
                for (com.tsf.shell.manager.a.f fVar : arrayList) {
                    com.tsf.shell.f.i._c.g gVarA = e.this.a(fVar.b.getPackageName());
    ...
    public void a(final ArrayList<com.tsf.shell.manager.a.f> arrayList, boolean z) {
        com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.manager.r.c.e.9
            ...
            public void run() {
                ...
                while (it.hasNext()) {
                    com.tsf.shell.f.i._c.g gVarA = e.this.a(((com.tsf.shell.manager.a.f) it.next()).b.getPackageName());
                    if (gVarA != null) {
                        gVarA.b(false);
                        if (!gVarA.j) {
    ...
    public com.tsf.shell.f.i._c.g a(String str) {
        Iterator<com.tsf.shell.f.i._c.g> it = this.c.iterator();
        while (it.hasNext()) {
            com.tsf.shell.f.i._c.g next = it.next();
