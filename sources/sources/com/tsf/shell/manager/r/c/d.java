...
public class d implements b.a, e.a, h.a, n.a {
    ...
    public void b() {
        if (!this.f) {
            this.g = com.tsf.shell.manager._a.q.a(this.g, x.c(b.i.notic_line_picker_notic));
            this.f = true;
    ...
    public void c() {
        if (this.f) {
            com.tsf.shell.manager._a.q.b(this.g);
            this.f = false;
                ...
                if (arrayList3.size() > 0) {
                    ...
                    while (true) {
                        ...
                        if (it2.hasNext()) {
                            ...
                            final com.tsf.shell.f.i.b.d.b bVarA = com.tsf.shell.f.i.b.d.b.a(com.tsf.shell.manager._a.h.F(), (int) f3, (int) f4);
