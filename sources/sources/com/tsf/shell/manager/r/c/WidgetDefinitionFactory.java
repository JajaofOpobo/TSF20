...
public class WidgetDefinitionFactory {
    public static com.tsf.shell.f.i.c.g a(Context context, String str, String str2, String str3, com.tsf.shell.manager.app.LauncherAppInfo fVar) {
        com.tsf.shell.f.i.c.g gVarA = a(str2, fVar);
        b(gVarA, context, str, str2, str3, fVar);
        return gVarA;
    }

    private static void b(final com.tsf.shell.f.i.c.g gVar, Context context, String str, String str2, String str3, com.tsf.shell.manager.app.LauncherAppInfo fVar) {
        if (!gVar.e) {
            gVar.b = str3;
            gVar.a = str2;
            gVar.c = str2;
            ...
            com.censivn.C3DEngine.A.a().c(new Runnable() { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.1
    ...
    public static void a(com.tsf.shell.f.i.c.g gVar, Context context, String str, String str2, String str3, com.tsf.shell.manager.app.LauncherAppInfo fVar) {
        b(gVar, context, str, str2, str3, fVar);
    }

    public static com.tsf.shell.f.i.c.g a(String str, com.tsf.shell.manager.app.LauncherAppInfo fVar) {
        com.tsf.shell.f.i.c.g gVar;
        float f = 0.5f;
        float f2 = 0.45f;
        float f3 = 0.0f;
        if (str.equals("com.tsf.shell.widget.music")) {
            gVar = new com.tsf.shell.f.i.c.b(0.42f, f3, f3) { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.5
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.41f, f3, (-40.0f) * com.censivn.C3DEngine.b.b.A.c) { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.6
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.33f, f3, com.censivn.C3DEngine.b.b.A.c * (-15.0f)) { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.7
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.28f, f3, com.censivn.C3DEngine.b.b.A.c * (-15.0f)) { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.8
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.6f * com.censivn.C3DEngine.b.b.A.c, f3, f3) { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.9
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(f, f3, (-20.0f) * com.censivn.C3DEngine.b.b.A.c) { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.10
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(f, f3, (-10.0f) * com.censivn.C3DEngine.b.b.A.c) { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.11
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(f2, f3, f3) { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.12
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.55f, f3, (-50.0f) * com.censivn.C3DEngine.b.b.A.c) { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.2
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(f2, f3, f3) { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.3
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.g() { // from class: com.tsf.shell.manager.r.c.WidgetDefinitionFactory.4
