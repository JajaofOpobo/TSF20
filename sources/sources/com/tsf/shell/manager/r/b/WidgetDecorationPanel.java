...
public class WidgetDecorationPanel extends com.tsf.shell.f.e._g.a.MenuActionItem {
    private WidgetMenuPanel.C0095a a;
    private WidgetMenuPanel.C0095a b;
    private Runnable c;
    ...
    public WidgetDecorationPanel(final WidgetMenuPanel aVar, String str) {
        ...
        WidgetMenuPanel.C0095WidgetMenuPanel.C0096a c0096a = new WidgetMenuPanel.C0095WidgetMenuPanel.C0096a() { // from class: com.tsf.shell.manager.r.b.b.3
        ...
        WidgetMenuPanel.C0095a c0095a = new WidgetMenuPanel.C0095a(b.d.widget_menu_decoration_floating, x.c(b.i.text_floating), new WidgetMenuPanel.C0095WidgetMenuPanel.C0096a() { // from class: com.tsf.shell.manager.r.b.b.4
            @Override // com.tsf.shell.f.e._g.a.MenuActionHandler.C0095WidgetMenuPanel.C0096a
            public boolean a() {
        ...
        this.b = c0095a;
        WidgetMenuPanel.C0095a c0095a2 = new WidgetMenuPanel.C0095a(b.d.widget_menu_setting, x.c(b.i.text_animation), c0096a);
    ...
    public boolean a(com.tsf.shell.f.i.c.ItemLabelProvider eVar, float f, float f2) {
        com.tsf.shell.manager.r.c.a.WidgetPlacementHelper.a((g) eVar, f, f2, new WidgetMenuPanel.AbstractC0146a() { // from class: com.tsf.shell.manager.r.b.b.6
