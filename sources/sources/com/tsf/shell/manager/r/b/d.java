...
public class d extends com.tsf.shell.manager.r.b.C<com.tsf.shell.f.e._g.a.a> {
    ...
    public void b() {
        if (!this.h) {
            this.h = true;
            for (b.a aVar : com.tsf.shell.manager._a.d.a()) {
                C cVar = new C();
                cVar.c = aVar.a;
                this.f.add(cVar);
            }
    ...
    class B extends A {
        ...
        @Override // com.tsf.shell.manager.r.b.d.a
        public void b() {
            com.tsf.shell.manager._a.x.a.a(this.d, 0.0f, 0.0f, new a.C0130a() { // from class: com.tsf.shell.manager.r.b.d.b.1
        ...
        public boolean b(MotionEvent motionEvent, A aVar, final i iVar) {
            ...
            com.tsf.shell.manager._a.x.a.a(this.d, iVar.position().x, iVar.position().y);
            return true;
        }

        @Override // com.tsf.shell.manager.r.b.d.a
        public void a(A aVar) {
            com.tsf.shell.manager._a.x.a.a(this.d, 0.0f, d.this.b.getScreenFreeSpaceCenter());
        }
    ...
    class C extends A {
        ...
        public void a(A aVar) {
            ...
            com.tsf.shell.manager._a.h.n().a(bVarA);
            bVarA.ah();
