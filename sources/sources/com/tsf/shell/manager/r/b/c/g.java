...
public class g extends com.tsf.shell.f.e._g.a.b {
    ...
    public boolean a(com.tsf.shell.f.i._c.e eVar, float f, float f2) {
        if (eVar instanceof com.tsf.shell.f.i._c.g) {
            com.tsf.shell.manager.r.c.a.b.a((com.tsf.shell.f.i._c.g) eVar, f, f2, new a.AbstractC0146a() { // from class: com.tsf.shell.manager.r.b.c.g.4
                @Override // com.tsf.shell.manager.r.c.a.a.AbstractC0146a
                public void a(ItemInfo itemInfo) {
                }

                @Override // com.tsf.shell.manager.r.c.a.a.AbstractC0146a
                public void a(com.tsf.shell.f.i.B bVar, com.tsf.shell.f.i._c.g gVar) {
        ...
        if (!(eVar instanceof com.tsf.shell.f.i._c.f)) {
            return true;
        }
        float[] fArrA = x.a(f, f2);
        com.tsf.shell.manager.a.l.a.a(this.g, (com.tsf.shell.f.i._c.f) eVar, (int) fArrA[0], (int) fArrA[1]);
        return false;
    }
