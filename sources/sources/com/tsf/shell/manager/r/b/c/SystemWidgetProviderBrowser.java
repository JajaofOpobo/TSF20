...
public class SystemWidgetProviderBrowser extends com.tsf.shell.manager.r.b.b.SlidePanelAnimatorBase {
    ...
    private void i() {
        ...
        this.b.a(new com.censivn.C3DEngine.b.h.b.b() { // from class: com.tsf.shell.manager.r.b.c.SystemWidgetProviderBrowser.1
            ...
            public i a(int i, i iVar) {
                ...
                a aVar = (a) SystemWidgetProviderBrowser.this.h.get(i);
                com.tsf.shell.manager.r.b.a.AppListItemCell cVar2 = (com.tsf.shell.manager.r.b.a.AppListItemCell) iVar2;
    ...
    public void h() {
        if (!this.g) {
            this.g = true;
            com.censivn.C3DEngine.C3DEngine.a().d(new Runnable() { // from class: com.tsf.shell.manager.r.b.c.SystemWidgetProviderBrowser.3
                @Override // java.lang.Runnable
                public void run() {
                    for (AppWidgetProviderInfo appWidgetProviderInfo : SystemWidgetProviderBrowser.this.f.getInstalledProviders()) {
                        try {
                            SystemWidgetProviderBrowser.this.a(SystemWidgetProviderBrowser.this.e.getApplicationInfo(appWidgetProviderInfo.provider.getPackageName(), 0), appWidgetProviderInfo);
                        } catch (PackageManager.NameNotFoundException e) {
                        }
                    }
                    final Collator collator = Collator.getInstance(Locale.getDefault());
                    Collections.sort(SystemWidgetProviderBrowser.this.h, new Comparator<a>() { // from class: com.tsf.shell.manager.r.b.c.SystemWidgetProviderBrowser.3.1
                    ...
                    com.censivn.C3DEngine.C3DEngine.a().c(new Runnable() { // from class: com.tsf.shell.manager.r.b.c.SystemWidgetProviderBrowser.3.2
                        @Override // java.lang.Runnable
                        public void run() {
                            SystemWidgetProviderBrowser.this.g();
                            SystemWidgetProviderBrowser.this.i.b(true);
                        }
                    });
                }
            });
    ...
    /* JADX INFO: renamed from: com.tsf.shell.manager.r.b.c.SystemWidgetProviderBrowser$b, reason: collision with other inner class name */
    class C0145b {
    ...
    class a {
        ...
        public TextureElement a() {
            ...
            if (this.d.id == 0) {
                try {
                    resourcesForApplication = SystemWidgetProviderBrowser.this.e.getResourcesForApplication(this.e);
                } catch (PackageManager.NameNotFoundException e) {
                    resourcesForApplication = null;
                }
                if (resourcesForApplication != null && (i = this.e.icon) != 0) {
                    bitmapA = com.tsf.shell.manager.r.c.a.WidgetInstantiator(resourcesForApplication, i);
                }
                if (bitmapA == null) {
                    bitmapA = x.a(b.d.sym_def_app_icon);
                }
                Bitmap bitmapCreateScaledBitmap = Bitmap.createScaledBitmap(bitmapA, com.tsf.shell.manager.o.ButtonPresetManager.c.H, com.tsf.shell.manager.o.ButtonPresetManager.c.I, true);
                if (bitmapCreateScaledBitmap != bitmapA) {
                    bitmapA.recycle();
                }
                Bitmap bitmapA2 = com.tsf.shell.manager.o.ButtonPresetManager.c.a(this.a);
                Bitmap bitmapA3 = com.tsf.shell.manager.o.ButtonPresetManager.c.a();
                Canvas canvas = new Canvas(bitmapA3);
                canvas.drawColor(-1, PorterDuff.Mode.CLEAR);
                com.tsf.shell.manager.o.ButtonPresetManager.c.a(canvas, bitmapCreateScaledBitmap);
                if (bitmapA2 != null) {
                    com.tsf.shell.manager.o.ButtonPresetManager.c.b(canvas, bitmapA2, true);
                }
                com.censivn.C3DEngine.C3DEngine.g().a(this.d, bitmapA3);
            }
            return this.d;
        }
