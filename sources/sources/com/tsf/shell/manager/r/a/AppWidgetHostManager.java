...
public class AppWidgetHostManager implements com.censivn.C3DEngine.b.c.ActivityResultBridge.InterfaceC0025a {
    ...
    class C0143a extends ContentObserver {
        ...
        public void onChange(boolean z) {
            try {
                AppWidgetHostManager.this.e.startListening();
            } catch (Exception e) {
            }
        }
    }
    ...
    public void a(final AppWidgetManager appWidgetManager, final f fVar, final int i, final int i2) {
        com.censivn.C3DEngine.C3DEngine.a().a(new Runnable() { // from class: com.tsf.shell.manager.r.a.AppWidgetHostManager.2
            ...
            public void run() {
                ...
                AppWidgetHostManager.this.a(iA, i, i2);
            }
        });
    }
    ...
    public void b(int i, int i2, int i3) {
        ...
        if (appWidgetInfo != null) {
            ...
            com.tsf.shell.manager.r.BoundsHelper.c(iArr);
            int i4 = iArr[0];
    ...
    public void a(LauncherAppWidgetInfo launcherAppWidgetInfo) {
        ...
        if (com.censivn.C3DEngine.b.b.ScreenConstants.O) {
            ...
            if (com.tsf.shell.manager.r.BoundsHelper.c(iArr2)) {
