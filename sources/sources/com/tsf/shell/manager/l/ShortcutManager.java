...
public class ShortcutManager implements com.censivn.C3DEngine.b.c.a.InterfaceC0025a {
    ...
    public static class C0130a implements com.censivn.C3DEngine.b.c.a.InterfaceC0025a {
        ...
        public com.tsf.shell.manager.o.ButtonMetrics a() {
            return com.tsf.shell.manager.o.ButtonPresetManager.a;
        }
    }
            ...
            public void run() {
                com.censivn.C3DEngine.A.a().c(new Runnable() { // from class: com.tsf.shell.manager.l.ShortcutManager.1.1
                    ...
                    public void run() {
                        ...
                        if (iF == -1) {
                            iF = com.tsf.shell.manager.app.StateHub.q();
                        }
    ...
    private static com.tsf.shell.f.i.b.e.b b(ItemInfo itemInfo, com.tsf.shell.manager.o.ButtonMetrics aVar, boolean z) {
        ...
        switch (intExtra) {
            ...
            default:
                ...
                if (intExtra != 0 && (aVarB = com.tsf.shell.manager.action.ActionManager.b(intExtra)) != null && aVarB.d != null) {
    ...
    private static LauncherShortcutStandardInfo a(int i, int i2, int i3, float f, float f2, boolean z) {
        ...
        com.tsf.shell.manager.action.ActionManager.a(aVarB);
    ...
    public static void a() {
        ArrayList<com.tsf.shell.manager.app.LauncherAppInfo> arrayList = (ArrayList) com.tsf.shell.manager.bind.ShellBindContext.c().a.clone();
    ...
    public static void b() {
        ArrayList arrayList = (ArrayList) com.tsf.shell.manager.bind.ShellBindContext.c().a.clone();
