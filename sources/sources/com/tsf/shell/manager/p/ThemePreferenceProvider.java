...
public class ThemePreferenceProvider {
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: com.tsf.shell.manager.p.ThemePreferenceProvider$a$a, reason: collision with other inner class name */
    ...
    public a a(int i2, ArrayList<a> arrayList) {
        ...
        for (a aVar : arrayList) {
            if (aVar.a != i2) {
                if (!aVar.d.isEmpty() && (aVarA = a(i2, aVar.d)) != null) {
                    return aVarA;
                }
            } else {
                return aVar;
