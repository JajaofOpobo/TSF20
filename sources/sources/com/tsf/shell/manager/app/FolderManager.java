...
public class FolderManager implements AppListModel.a {
    private static final Object a = new Object();
    private DataCoordinator e;
    private a f;
    ...
    private void a(final ItemInfo itemInfo, int i, final Runnable runnable) {
        ...
        ShellModel.b.post(new Runnable() { // from class: com.tsf.shell.manager.app.FolderManager.2
            @Override // java.lang.Runnable
            public void run() {
                synchronized (d.a) {
                    ContentResolver contentResolver = com.censivn.C3DEngine.A.d().getContentResolver();
    ...
    public void d() {
        ...
        com.tsf.shell.manager.app.ServiceProvider.a().a().a();
        this.g.clear();
    }
