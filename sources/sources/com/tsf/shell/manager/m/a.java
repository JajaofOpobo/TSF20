...
public class a extends com.censivn.C3DEngine.b.b.A.c {
    ...
    public int c(float f) {
        float fB = b();
        float fC = c();
        int i = (int) (((f - fB) + (fC / 2.0f)) / (fC + com.tsf.shell.manager.o.b.a.U));
        if (i < 0) {
            i = 0;
        }
    ...
    /* JADX INFO: renamed from: com.tsf.shell.manager.m.a$a, reason: collision with other inner class name */
    class C0131a extends com.censivn.C3DEngine.b.d.a {
        ...
        public void c(MotionEvent motionEvent) {
            if (this.g != null) {
                ...
                this.g.setAnimationObjectState(true);
                com.tsf.shell.manager.app.j.a(this.g);
                this.d = true;
        ...
        public void d(MotionEvent motionEvent) {
            if (this.g != null) {
                ...
                if (!this.l) {
                    this.b.setAllFrom(this.g.position());
                    com.tsf.shell.manager.app.j.b(this.g);
