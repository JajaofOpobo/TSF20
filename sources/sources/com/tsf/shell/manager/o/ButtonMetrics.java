...
public class ButtonMetrics {
    ...
    private void a(int i, int i2, int i3, int i4, int i5, boolean z) {
        if (z) {
            this.y = com.censivn.C3DEngine.b.b.ScreenConstants.c * this.A;
            this.z = com.censivn.C3DEngine.b.b.ScreenConstants.c * this.B;
        } else {
            this.y = this.A;
            this.z = this.B;
        }
    ...
    public com.censivn.C3DEngine.b.f.sprite.TextureSpriteRenderable a(com.censivn.C3DEngine.b.f.sprite.TextureSpriteRenderable aVar) {
        ...
        bVarA2.i().y = this.aa;
        bVarA2.a(true);
        bVarA2.a(this.F - 1, this.G - 1, this.J + 2, this.K + 2);
        bVarA2.h();
        if (this.i == 0.0f) {
            this.a = aVar.a(0).a;
            this.b = aVar.a(0).b;
