...
public class c {
    ...
    public void a() {
        ...
        c();
        j jVarA = com.tsf.shell.manager._a.j.a(this.b);
        this.a.removeFromParent();
        this.a.a();
        this.a.alpha(255.0f);
        jVarA.addChild(this.a);
        com.tsf.shell.manager._a.j.a(new Runnable() { // from class: com.tsf.shell.manager.j.c.1
    ...
    public void b() {
        ...
        com.tsf.shell.manager._a.j.a(new Runnable() { // from class: com.tsf.shell.manager.j.c.2
            @Override // java.lang.Runnable
            public void run() {
                c.this.a.d();
