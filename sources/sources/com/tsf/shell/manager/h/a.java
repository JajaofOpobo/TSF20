...
public class a {
            ...
            switch (motionEvent.getAction()) {
                ...
                case 1:
                    if (this.f >= ((int) (C0128a.a - this.d))) {
                        ...
                        Animation.AnimationListener animationListener = new Animation.AnimationListener() { // from class: com.tsf.shell.manager.h.a.c.1
    ...
    /* JADX INFO: renamed from: com.tsf.shell.manager.h.a$a, reason: collision with other inner class name */
