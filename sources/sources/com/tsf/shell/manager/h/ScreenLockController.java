...
public class ScreenLockController {
    ...
    public void i() {
        if (this.f == null) {
            ...
            a(textView);
            checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.tsf.shell.manager.h.ScreenLockController.3
            ...
            switch (motionEvent.getAction()) {
                ...
                case 1:
                    if (this.f >= ((int) (C0128a.a - this.d))) {
                        ...
                        int i2 = (int) ((this.f / (C0128a.a - this.d)) * 500.0f);
    ...
    /* JADX INFO: renamed from: com.tsf.shell.manager.h.ScreenLockController$a, reason: collision with other inner class name */
    private static class C0128a extends View {
