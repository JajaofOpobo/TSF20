...
public class ConfigManager {
    ...
    public static void a() {
        if (K() < 110) {
            ...
            editorAC.remove("effect_desktop_border_state");
            editorAC.remove("effect_desktop_transition_random_state");
            editorAC.remove("effect_desktop_transition");
            editorAC.commit();
        }
        aH();
        aG();
    ...
    public static void a(int i2) {
        int iA = y.a(i2);
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("slinding_dock_button_transparency_precent", iA);
        editorAC.commit();
    }
    ...
    public static void a(float f2) {
        h = f2;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putFloat("slinding_dock_v_width", f2);
        editorAC.commit();
    }
    ...
    public static void b(float f2) {
        i = f2;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putFloat("slinding_dock_h_width", f2);
        editorAC.commit();
    }
    ...
    public static void a(float f2, float f3) {
        ...
        k = f3;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putFloat("slinding_dock_position_v_x", f2);
        editorAC.putFloat("slinding_dock_position_v_y", f3);
        editorAC.commit();
    }
    ...
    public static void b(float f2, float f3) {
        ...
        m = f3;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putFloat("slinding_dock_position_h_x", f2);
        editorAC.putFloat("slinding_dock_position_h_y", f3);
        editorAC.commit();
    }

    public static void a(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("slinding_dock_hidden", z2);
        editorAC.commit();
    }
    ...
    public static void b(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("side_menu_state", z2);
        editorAC.commit();
    }
    ...
    public static void b(int i2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("side_menu_direction", i2);
        editorAC.commit();
    }
    ...
    public static void c(float f2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putFloat("side_menu_toggle_vertical_position", f2);
        editorAC.commit();
    }
    ...
    public static void d(float f2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putFloat("side_menu_toggle_horizontal_position", f2);
        editorAC.commit();
    }
    ...
    public static void a(String str) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putString("video_version_name", str);
        editorAC.commit();
    }
    ...
    public static void c(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("effect_icon_click_random_state", z2);
        editorAC.commit();
    }
    ...
    public static void b(String str) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putString("effect_icon_click", str);
        editorAC.commit();
    }
    ...
    public static void c(int i2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("shake_animation_type", i2);
        editorAC.commit();
    }
    ...
    public static void c(String str) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putString("tips_configuration", str);
        editorAC.commit();
    }
    ...
    public static void a(Boolean bool) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("desktop_lock", bool.booleanValue());
        editorAC.commit();
    }

    public static void d(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("desktop_relock", z2);
        editorAC.commit();
    }
    ...
    public static void d(int i2) {
        ...
        n = iA;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("static_dock_vertical_width_margin_precent", iA);
        editorAC.commit();
    }
    ...
    public static void e(int i2) {
        ...
        o = iA;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("static_dock_horizontal_width_margin_precent", iA);
        editorAC.commit();
    }

    public static void e(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("static_dock_hidden", z2);
        editorAC.commit();
    }

    public static void f(int i2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("dock_mode", i2);
        editorAC.commit();
    }
    ...
    public static void c(float f2, float f3) {
        ...
        q = f3;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putFloat("smart_button_position_vertical_x", f2);
        editorAC.putFloat("smart_button_position_vertical_y", f3);
        editorAC.commit();
    }
    ...
    public static void d(float f2, float f3) {
        ...
        s = f3;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putFloat("smart_button_position_horizontal_x", f2);
        editorAC.putFloat("smart_button_position_horizontal_y", f3);
        editorAC.commit();
    }
    ...
    public static void f(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("effect_desktop_border_state", z2);
        editorAC.commit();
    }
    ...
    public static void g(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("effect_desktop_transition_random_state", z2);
        editorAC.commit();
    }
    ...
    public static void d(String str) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putString("effect_desktop_transition", str);
        editorAC.commit();
    }
    ...
    public static void h(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("effect_icon_menu_random_state", z2);
        editorAC.commit();
    }
    ...
    public static void e(String str) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putString("effect_icon_menu", str);
        editorAC.commit();
    }
    ...
    public static void f(String str) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putString("effect_mark", str);
        editorAC.commit();
    }
    ...
    public static void i(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("effect_drawer_inout_transition_random_state", z2);
        editorAC.commit();
    }
    ...
    public static void g(String str) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putString("effect_drawer_inout_transition", str);
        editorAC.commit();
    }
    ...
    public static void j(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("effect_drawer_transition_random_state", z2);
        editorAC.commit();
    }
    ...
    public static void h(String str) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putString("effect_drawer_transition", str);
        editorAC.commit();
    }

    public static void g(int i2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("launcher_shortcut_text_style", i2);
        editorAC.commit();
    }
    ...
    public static void e(float f2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putFloat("style_icon_scale", f2);
        editorAC.commit();
    }
    ...
    public static void b(Boolean bool) {
        d = bool.booleanValue();
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("screen_infinite_scroll", bool.booleanValue());
        editorAC.commit();
    }
    ...
    public static void i(int i2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("version", i2);
        editorAC.commit();
    }

    public static void k(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("GDPREnable", z2);
        editorAC.commit();
    }
    ...
    public static void c(Boolean bool) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("notification_bar_transparent_status", bool.booleanValue());
        editorAC.commit();
    }
    ...
    public static void d(Boolean bool) {
        u = bool.booleanValue();
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("notification_status", bool.booleanValue());
        editorAC.commit();
    }
    ...
    private static void aJ() {
        ...
        com.tsf.shell.manager.f.ScreenFadeController.b(aD().getInt("drawer_bg_alpha", com.tsf.shell.manager.f.ScreenFadeController.a));
    }

    public static void j(int i2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("drawer_bg_alpha", i2);
        editorAC.commit();
    }
    ...
    public static void a(int i2, int i3) {
        ...
        if (com.censivn.C3DEngine.b.b.ScreenConstants.O) {
            ...
            editorAC.putInt("drawer_columns_v", i3);
        } else {
            z = i2;
            A = i3;
            editorAC.putInt("drawer_rows_h", i2);
            editorAC.putInt("drawer_columns_h", i3);
        }
        editorAC.commit();
    }
    ...
    public static void l(boolean z2) {
        B = z2;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("drawer_autosize", z2);
        editorAC.commit();
    }
    ...
    public static void m(boolean z2) {
        v = z2;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("drawer_action_bar_state", z2);
        editorAC.commit();
    }
    ...
    public static void n(boolean z2) {
        w = z2;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("drawer_menu_bar_state", z2);
        editorAC.commit();
    }
    ...
    public static void k(int i2) {
        ...
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("wallpaper_blur_level", g);
        editorAC.commit();
    }
    ...
    public static void l(int i2) {
        ...
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("wallpaper_scroll_mode", f);
        editorAC.commit();
    }
    ...
    public static void m(int i2) {
        int iA = y.a(i2);
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("floating_button_transparency_precent", iA);
        editorAC.commit();
    }
    ...
    public static void o(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("floating_button_state", z2);
        editorAC.commit();
    }
    ...
    public static void p(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("vibration_feedback", z2);
        editorAC.commit();
        c = z2;
    }
    ...
    public static void q(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("desktop_indicator_static_dock", z2);
        editorAC.commit();
        a = z2;
    }
    ...
    public static void r(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("desktop_indicator_sliding_dock", z2);
        editorAC.commit();
        b = z2;
    }
    ...
    public static void i(String str) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putString("screenorder", str);
        editorAC.commit();
    }
    ...
    public static void j(String str) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putString("new_notif_point_config", str);
        editorAC.commit();
    }
    ...
    public static void k(String str) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putString("app_drawer_customize_title", str);
        editorAC.commit();
    }
    ...
    public static void q(int i2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("all_apps_direction", i2);
        editorAC.commit();
    }
    ...
    public static void t(boolean z2) {
        E = z2;
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("perference_folder_auto_close", z2);
        editorAC.commit();
    }
    ...
    public static void s(int i2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("natural_orientation", i2);
        editorAC.commit();
    }
    ...
    public static void a(int i2, Activity activity) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("setting_screen_orientation", i2);
        editorAC.commit();
        if (activity != null) {
            b(i2, activity);
        }
    ...
    public static void v(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("decoration_snow_state", z2);
        editorAC.commit();
    }
    ...
    public static void t(int i2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("smart_menu_content_type", i2);
        editorAC.commit();
    }
    ...
    public static void w(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("smart_menu_state", z2);
        editorAC.commit();
    }
    ...
    public static void x(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("contact_menu_recents_state", z2);
        editorAC.commit();
    }
    ...
    public static void u(int i2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("recent_apps_menu_display_count", i2);
        editorAC.commit();
    }
    ...
    public static void y(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("widgetanimation", z2);
        editorAC.commit();
    }
    ...
    public static void z(boolean z2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putBoolean("memory_pemanent", z2);
        editorAC.commit();
    }
    ...
    public static void v(int i2) {
        SharedPreferences.Editor editorAC = aC();
        editorAC.putInt("shortcut_menu_direction", i2);
        editorAC.commit();
    }
    ...
    public static void aE() {
        SharedPreferences.Editor editorEdit = aD().edit();
        editorEdit.clear();
        editorEdit.commit();
    }
}
