...
public class ShellWallpaperManager extends BroadcastReceiver {
    ...
    private float b(g gVar) {
        return (gVar.r() - 1) / (com.tsf.shell.manager.app.h.l() - 2);
    }

    private float c(g gVar) {
        return ((gVar.r() - 1) - gVar.g) / (com.tsf.shell.manager.app.h.l() - 2);
    }
    ...
    public void a(g gVar, boolean z, boolean z2) {
        ...
        if (gVar.r() > 0) {
            ...
            if (com.tsf.shell.manager.app.h.l() == 2) {
                fL = 0.5f;
            } else {
                fL = (iR - f) / (com.tsf.shell.manager.app.h.l() - 2);
            }
            if (z2) {
                a(fL);
            } else {
