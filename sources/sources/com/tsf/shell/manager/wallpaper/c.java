...
public class c extends com.tsf.shell.f.e._g.a.d {
    private j a;
    private l b;
    private h c;
    private int d;
    ...
    public c() {
        ...
        this.c.a(new h.a() { // from class: com.tsf.shell.manager.wallpaper.c.3
            ...
            public boolean a(int i) {
                c.this.d = i;
                com.tsf.shell.manager.app.f.b(i);
                return true;
            }
        });
    ...
    public void onShow() {
        ...
        a();
        this.c.f();
        this.d = com.tsf.shell.manager.app.f.j();
        this.c.k(this.d);
    }
    ...
    public void onHideComplete() {
        recycle();
        com.tsf.shell.manager.app.f.c(this.d);
    }
