...
public class WallpaperPreviewRenderer extends VObject3dContainer {
    private C0148a a;
    private b b;
    ...
    public class b extends VObject3dContainer {
        ...
        /* JADX INFO: renamed from: com.tsf.shell.manager.wallpaper.WallpaperPreviewRenderer$b$a, reason: collision with other inner class name */
        public class C0149a {
            float a;
            float b;
            VButtonItem g;
    ...
    /* JADX INFO: renamed from: com.tsf.shell.manager.wallpaper.WallpaperPreviewRenderer$a, reason: collision with other inner class name */
