...
public class WidgetPanelBase extends com.censivn.C3DEngine.b.f.BaseRenderable {
    ...
    public void a() {
        ...
        for (int i2 = 0; i2 < 60; i2 += 2) {
            ...
            WidgetEvent.a("index:" + i2 + "  next:" + i3);
            this.t.add(new WidgetDataProvider(bVarA2, this.j.a(i3)));
        }
        this.j.calAABB();
        ...
        bitmapB.recycle();
        this.m = new WidgetElementBase(12.0f, 230.0f);
        ...
        bitmapB2.recycle();
        this.n = new WidgetElementBase(16.0f, 170.0f);
        this.n.textures().addElement(this.A);
        this.n.moveAllPointsPX(0.0f, 65.0f, 0.0f);
        this.n.rotation().z = 30.0f;
        this.o = new WidgetCanvas(this.d, 60, "  ");
        this.k = new WidgetLabelElement(60.0f, 60.0f);
        this.k.position().y = 300.0f;
        this.k.textures().addElement(this.o.a);
        this.p = new WidgetCanvas(this.d, 50, "  ");
        this.l = new WidgetLabelElement(50.0f, 50.0f);
    ...
    private void f() {
        ...
        if (this.v != this.w) {
            ...
            this.I = this.F;
            this.v = this.w;
            WidgetEvent.a("Widget Cube Slient First");
            c(Color.argb(255, this.G, this.H, this.I));
        }
    }
    ...
    /* JADX INFO: renamed from: com.tsf.shell.widget.a.WidgetPanelBase$a, reason: collision with other inner class name */
