...
public class AlarmThemeProvider {
    ...
    public static void a(VObject3d[] vObject3dArr, int i, Bitmap bitmap, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < length; i5++) {
            new AlarmContainer(vObject3dArr[i5], i5, length, bitmap, i, i2, i3, i4);
        }
    }
    ...
    static class A extends VTweenParam {
        ...
        public void onComplete() {
            AlarmState.c("onComplete id : " + this.d + "   max:" + this.e);
            if (this.d == this.e - 1 && this.h != null) {
                AlarmTouchManager.a(this.j, this.h, 0, 0);
                this.h.recycle();
            }
