...
public class AlarmDataManager extends AlarmDataEntry {
    ...
    protected void h_() {
        this.a = new AlarmDataEntry.a[7];
        this.b = new AlarmDataEntry.a[2];
        this.c = new AlarmDataEntry.a[2];
    }
    ...
    public Bitmap e() {
        ...
        Bitmap bitmapCreateBitmap = Bitmap.createBitmap(770, 30, Bitmap.Config.ARGB_8888);
        ...
        while (i < 7) {
            ...
            float f3 = (((30 - r12) / 2.0f) + 0.0f) - fontMetrics.top;
            float f4 = f + 70.0f;
            String str = "";
            switch (i) {
                case 0:
            ...
            this.a[i] = new AlarmDataEntry.a((int) (f2 - 35.0f), (int) 0.0f, 70, 30);
            i++;
            f = f4;
        }
        ...
        while (i2 < 2) {
            ...
            float f7 = (((30 - r12) / 2.0f) + 0.0f) - fontMetrics.top;
            paint.setColor(com.tsf.shell.widget.alarm.d.a.e);
            canvas.drawText(amPmStrings[i2], f6, f7, paint);
            this.b[i2] = new AlarmDataEntry.a((int) (f6 - 35.0f), (int) 0.0f, 70, 30);
            i2++;
            f5 += 70.0f;
        }
        int i3 = 0;
        float f8 = 0.0f;
        while (i3 < 2) {
            float f9 = 630.0f + f8 + 35.0f;
            float f10 = (((30 - r12) / 2.0f) + 0.0f) - fontMetrics.top;
            paint.setColor(com.tsf.shell.widget.alarm.d.a.e);
            canvas.drawText(amPmStrings[i3], f9, f10, paint);
            this.c[i3] = new AlarmDataEntry.a((int) (f9 - 35.0f), (int) 0.0f, 70, 30);
            i3++;
            f8 += 70.0f;
        }
