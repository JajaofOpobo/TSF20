...
public class AlarmMeshRenderer extends VObject3dContainer {
    ...
    protected com.tsf.shell.widget.alarm.a.AlarmIntentReceiver[] e = new com.tsf.shell.widget.alarm.a.AlarmIntentReceiver[24];
    ...
    private void d() {
        ...
        for (int i = 0; i < this.e.length; i++) {
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver[] aVarArr = this.e;
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar = new com.tsf.shell.widget.alarm.a.AlarmIntentReceiver();
            aVarArr[i] = aVar;
            aVar.a = d;
        }
    ...
    public void a() {
        this.f = true;
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.widget.alarm.AlarmMeshRenderer.1
            float a;
    ...
    public void b() {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar = this.e[(i * 6) + 0];
            aVar.g = 0.0f;
            aVar.e = 0.0d;
            aVar.f = 0.0d;
            aVar.h = a(0.0f);
            ...
            aVar.a(dA);
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar2 = this.e[(i * 6) + 1];
            ...
            aVar2.i = b(0.0f);
            aVar2.a(dA);
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar3 = this.e[(i * 6) + 2];
            aVar3.g = 0.0f;
            aVar3.e = 0.0d;
            aVar3.f = 192.0f;
            aVar3.h = a(0.0f);
            aVar3.i = b(0.0f);
            aVar3.a(dA);
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar4 = this.e[(i * 6) + 3];
            aVar4.g = 0.0f;
            aVar4.e = 0.0d;
            aVar4.f = 0.0d;
            aVar4.h = a(0.0f);
            ...
            aVar4.a(dA - dA2);
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar5 = this.e[(i * 6) + 4];
            aVar5.g = 0.0f;
            aVar5.e = 192.0f;
            aVar5.f = 0.0d;
            ...
            aVar5.a(dA - dA2);
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar6 = this.e[(i * 6) + 5];
            aVar6.g = 0.0f;
            aVar6.e = 192.0f;
            aVar6.f = f;
        ...
        for (int i3 = 1; i3 < i2; i3++) {
            double dA4 = a(d2);
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar7 = this.e[(i3 * 6) + 0];
            aVar7.g = 0.0f;
            aVar7.e = 0.0d;
            aVar7.f = 0.0d;
            aVar7.h = a(0.0f);
            ...
            aVar7.a(dA4);
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar8 = this.e[(i3 * 6) + 1];
            aVar8.g = 0.0f;
            aVar8.e = 192.0f;
            aVar8.f = 192.0f;
            ...
            aVar8.i = b(0.0f);
            aVar8.a(dA4);
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar9 = this.e[(i3 * 6) + 2];
            aVar9.g = 0.0f;
            aVar9.e = 0.0d;
            aVar9.f = 192.0f;
            aVar9.h = a(0.0f);
            aVar9.i = b(0.0f);
            aVar9.a(dA4);
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar10 = this.e[(i3 * 6) + 3];
            aVar10.g = 0.0f;
            aVar10.e = 0.0d;
            aVar10.f = 0.0d;
            aVar10.h = a(0.0f);
            ...
            aVar10.a(dA4);
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar11 = this.e[(i3 * 6) + 4];
            aVar11.g = 0.0f;
            aVar11.e = 192.0f;
            aVar11.f = 0.0d;
            ...
            aVar11.a(dA4);
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar12 = this.e[(i3 * 6) + 5];
            aVar12.g = 0.0f;
            aVar12.e = 192.0f;
            aVar12.f = 192.0f;
        ...
        while (i2 < 4) {
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar13 = this.e[(i2 * 6) + 0];
            aVar13.g = 0.0d;
            aVar13.e = 0.0d;
            aVar13.f = 0.0d;
            aVar13.h = 0.0d;
            aVar13.i = 0.0d;
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar14 = this.e[(i2 * 6) + 1];
            aVar14.g = 0.0d;
            aVar14.e = 0.0d;
            aVar14.f = 0.0d;
            aVar14.h = 0.0d;
            aVar14.i = 0.0d;
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar15 = this.e[(i2 * 6) + 2];
            aVar15.g = 0.0d;
            aVar15.e = 0.0d;
            aVar15.f = 0.0d;
            aVar15.h = 0.0d;
            aVar15.i = 0.0d;
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar16 = this.e[(i2 * 6) + 3];
            aVar16.g = 0.0d;
            aVar16.e = 0.0d;
            aVar16.f = 0.0d;
            aVar16.h = 0.0d;
            aVar16.i = 0.0d;
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar17 = this.e[(i2 * 6) + 4];
            aVar17.g = 0.0d;
            aVar17.e = 0.0d;
            aVar17.f = 0.0d;
            aVar17.h = 0.0d;
            aVar17.i = 0.0d;
            com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar18 = this.e[(i2 * 6) + 5];
            aVar18.g = 0.0d;
            aVar18.e = 0.0d;
            aVar18.f = 0.0d;
            aVar18.h = 0.0d;
    ...
    private void a(com.tsf.shell.widget.alarm.a.AlarmIntentReceiver aVar) {
