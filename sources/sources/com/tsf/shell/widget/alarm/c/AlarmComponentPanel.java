...
public class AlarmComponentPanel extends VObject3dContainer {
    ...
    public static void a() {
        AlarmWidget.e.post(new Runnable() { // from class: com.tsf.shell.widget.alarm.c.AlarmComponentPanel.1
    ...
    public void a(int i) {
        ...
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.widget.alarm.c.AlarmComponentPanel.2
