...
import com.tsf.shell.widget.alarm.AlarmContainer;
...
public class AlarmPanel extends VObject3dContainer implements AlarmWidget.b, c.InterfaceC0180c {
    ...
    private f h;
    private com.tsf.shell.widget.alarm.b.AlarmDataFilter i;
    ...
    private void h() {
        this.a = new AlarmIndicator();
        addChild(this.a);
        this.o = new AlarmMeshRenderer();
        addChild(this.o);
        this.h = new AlarmRenderer(this, this.f);
        this.i = new com.tsf.shell.widget.alarm.b.AlarmDataFilter(this.f, this.c);
        this.i.a("--", "--", "--", "--");
        ...
        this.i.d.a(this.m);
        addChild(this.m);
        this.n = new AlarmSettingButton();
        addChild(this.n);
        this.p = new com.tsf.shell.widget.alarm.c.AlarmComponentListener();
        this.p.position().spX(-180.0f);
        this.p.position().spY(-150.0f);
        this.p.position().spZ(0.0f);
        this.p.a(com.tsf.shell.widget.alarm.c.AlarmComponentListener.a.h, com.tsf.shell.widget.alarm.c.AlarmComponentListener.a.g);
        this.p.a(new Runnable() { // from class: com.tsf.shell.widget.alarm.AlarmPanel.1
    ...
    public void c() {
        AlarmWidget.k.a(new c.a() { // from class: com.tsf.shell.widget.alarm.AlarmPanel.2
            ...
            public void a(com.tsf.shell.widget.alarm.service.IAlarmCallback bVar) {
                AlarmState.c("RequestUpdate RequestUpdate RequestUpdate");
                bVar.a(false);
            }
        });
    }
    ...
    public void a(int i, byte[] bArr) {
        AlarmWidget.l.m.b();
        com.tsf.shell.widget.alarm.d.AlarmConfigDefault cVar = (com.tsf.shell.widget.alarm.d.AlarmConfigDefault) com.tsf.shell.widget.alarm.d.AlarmConfigDefault.a(bArr);
        cVar.b();
        a(cVar);
    }

    public void a(final com.tsf.shell.widget.alarm.d.AlarmConfigDefault cVar) {
        this.e.post(new Runnable() { // from class: com.tsf.shell.widget.alarm.AlarmPanel.3
            @Override // java.lang.Runnable
            public void run() {
    ...
    class B extends VTweenParam {
        ...
        private com.tsf.shell.widget.alarm.b.AlarmDataEntry c;
    ...
    public void g() {
        AlarmThemeProvider.a(new VObject3d[]{this.k, this.j, this.l, this.m}, this.i.g().id, this.i.e(), 300, 150, 500);
        this.h.e();
        this.a.a();
        this.o.a();
    }
