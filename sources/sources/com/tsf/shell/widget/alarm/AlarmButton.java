...
public class AlarmButton extends VRectangle {
    ...
    public j() {
        ...
        this.i = 496.0f;
        if (a == null) {
            Bitmap bitmapA = AlarmTouchManager.a(AlarmWidget.h, "back_number");
            a = AlarmWidget.c.createTexture(bitmapA, true);
            bitmapA.recycle();
        }
        if (b == null) {
            Bitmap bitmapA2 = AlarmTouchManager.a(AlarmWidget.h, "back_number_minute");
    ...
    public static void a() {
        AlarmWidget.e.post(new Runnable() { // from class: com.tsf.shell.widget.alarm.AlarmButton.1
            @Override // java.lang.Runnable
            public void run() {
                if (j.a != null) {
                    Bitmap bitmapA = AlarmTouchManager.a(AlarmWidget.h, "back_number");
                    AlarmTouchManager.a(j.a.id, bitmapA, 0, 0);
                    bitmapA.recycle();
                }
                if (j.b != null) {
                    Bitmap bitmapA2 = AlarmTouchManager.a(AlarmWidget.h, "back_number_minute");
                    AlarmTouchManager.a(j.b.id, bitmapA2, 0, 0);
                    bitmapA2.recycle();
                }
            }
