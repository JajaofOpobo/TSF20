...
public interface IAlarmCallback extends IInterface {
    void a();

    void a(int i, boolean z, int i2, int i3, int i4, boolean z2, String str, String str2);

    void a(com.tsf.shell.widget.alarm.service.IAlarmService aVar);
    ...
    public static abstract class a extends Binder implements IAlarmCallback {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    a(IAlarmService.AbstractBinderC0177a.a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 2:
                    parcel.enforceInterface("com.tsf.shell.widget.alarm.service.AlarmInterface");
                    b(IAlarmService.AbstractBinderC0177a.a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 3:
                    parcel.enforceInterface("com.tsf.shell.widget.alarm.service.AlarmInterface");
        ...
        private static class C0179a implements IAlarmCallback {
            ...
            public void a(com.tsf.shell.widget.alarm.service.IAlarmService aVar) {
            ...
            @Override // com.tsf.shell.widget.alarm.service.IAlarmCallback
            public void b(com.tsf.shell.widget.alarm.service.IAlarmService aVar) {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.tsf.shell.widget.alarm.service.AlarmInterface");
