...
public class AlarmSettingButton extends VRectangle {
    ...
    public AlarmSettingButton() {
        ...
        position().spY(175.0f);
        position().spZ(80.0f);
        setMouseEventListener(new VMouseEventListener(this) { // from class: com.tsf.shell.widget.alarm.AlarmSettingButton.1
    ...
    private void a() {
        byte[] bArrA = com.tsf.shell.widget.alarm.d.AlarmConfigManager.a(AlarmWidget.h, -1);
    ...
    public void a(float f, float f2) {
        AlarmState.c("width:" + f + "    height:" + f2);
