...
import com.tsf.shell.widget.alarm.c.AlarmComponentProvider;

/* JADX INFO: loaded from: C:\Users\Jaja\AndroidStudioProjects\TSF20\resources-Prime\classes.dex */
public class AlarmContainer extends VObject3dContainer implements c.b {
    public static boolean a;
    private j A;
    private j B;
    private com.tsf.shell.widget.alarm.c.AlarmComponentListener C;
    private VRectangle D;
    private com.tsf.shell.widget.alarm.AlarmRoundRect E;
    private Cursor h;
    private int i;
    private int j;
    private String k;
    ...
    private e t;
    private e u;
    private com.tsf.shell.widget.alarm.c.AlarmComponentEvent v;
    private com.tsf.shell.widget.alarm.c.AlarmComponentProvider w;
    private com.tsf.shell.widget.alarm.c.AlarmComponentContainer x;
    private C y;
    ...
    private com.tsf.shell.widget.alarm.service.AlarmServiceBinder g = AlarmWidget.k;
    ...
    private void g() {
        AlarmState.c("============SetData=================" + this.i + ":" + this.j);
        this.t.a(this.i);
        this.u.a(this.j);
        this.v.a(this.l.b());
        this.w.a(A);
    ...
    private void h() {
        Bitmap bitmapA = AlarmTouchManager.a(this.f, "back_big_circle");
        this.o = this.c.createTexture(bitmapA, false);
        bitmapA.recycle();
        Bitmap bitmapA2 = AlarmTouchManager.a(this.f, "back_small_circle");
        this.p = this.c.createTexture(bitmapA2, false);
        bitmapA2.recycle();
        Bitmap bitmapA3 = AlarmTouchManager.a(this.f, "back_time_bar_bg");
        this.q = this.c.createTexture(bitmapA3, false);
        bitmapA3.recycle();
    }

    private void i() {
        this.E = new com.tsf.shell.widget.alarm.AlarmRoundRect();
        ...
        addChild(this.D);
        this.B = new AlarmButton();
        this.B.textures().addElement(AlarmButton.a);
        this.B.position().spZ(80.0f);
        this.B.position().spX(100.0f);
        this.B.position().spY(-2.0f);
        addChild(this.B);
        this.A = new AlarmButton();
        this.A.textures().addElement(AlarmButton.b);
        this.A.position().spZ(80.0f);
        this.A.position().spX(156.0f);
        this.A.position().spY(-2.0f);
        addChild(this.A);
        this.C = new com.tsf.shell.widget.alarm.c.AlarmComponentListener();
        this.C.position().spX(-180.0f);
        this.C.position().spY(-150.0f);
        this.C.position().spZ(0.0f);
        this.C.a(com.tsf.shell.widget.alarm.c.AlarmComponentListener.a.f, com.tsf.shell.widget.alarm.c.AlarmComponentListener.a.e);
        addChild(this.C);
        this.v = new com.tsf.shell.widget.alarm.c.AlarmComponentEvent(this);
        this.t = new AlarmDataProvider(this.z, this.B, 3, 1, 1);
        this.u = new AlarmDataProvider(this.E, this.A, -1, 5, 0);
        this.x = new com.tsf.shell.widget.alarm.c.AlarmComponentContainer();
        this.B.a(this.x);
        addChild(this.x);
        this.w = new com.tsf.shell.widget.alarm.c.AlarmComponentProvider();
        this.w.a(this);
        addChild(this.w);
        this.C.a(new Runnable() { // from class: com.tsf.shell.widget.alarm.a.1
            ...
            public void run() {
                new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.tsf.shell.widget.alarm.a.1.1
                    @Override // java.lang.Runnable
                    public void run() {
                        if (com.tsf.shell.ShellCallbackInterface.a.e.a(a.this.f)) {
    ...
    public void a() {
        this.h = com.tsf.shell.widget.alarm.AlarmContainerlarmUtils.c.b(this.f);
        if (this.h == null) {
            com.tsf.shell.widget.alarm.AlarmContainerlarmUtils.c.a(this.f);
            this.h.close();
            this.h = com.tsf.shell.widget.alarm.AlarmContainerlarmUtils.c.b(this.f);
        }
        AlarmState.b("mCursor Count():" + this.h.getCount());
        if (this.h.getCount() > 0) {
            Alarm alarmA = com.tsf.shell.widget.alarm.AlarmContainerlarmUtils.c.a(this.f, 1);
            a = alarmA.b;
            this.k = alarmA.h;
            this.i = alarmA.c;
            this.j = alarmA.d;
    ...
    @Override // com.tsf.shell.widget.alarm.c.AlarmComponentProvider.b
    ...
    /* JADX INFO: renamed from: com.tsf.shell.widget.alarm.AlarmContainer$a, reason: collision with other inner class name */
    ...
    public void f() {
        com.tsf.shell.widget.alarm.c.AlarmComponentPanel.a();
        this.w.a();
        AlarmButton.a();
        AlarmThemeProvider.a(new VObject3d[]{this.E}, this.o.id, AlarmTouchManager.a(this.f, "back_big_circle"), 250, 250, 50);
        AlarmThemeProvider.a(new VObject3d[]{this.z}, this.p.id, AlarmTouchManager.a(this.f, "back_small_circle"), 250, 250, 50);
        AlarmThemeProvider.a(new VObject3d[]{this.D}, this.q.id, AlarmTouchManager.a(this.f, "back_time_bar_bg"), 250, 250, 50);
        this.E.doubleSidedEnabled(d.a.a);
    }
}
