...
public class AlarmProviderContract implements BaseColumns {
    ...
    public static final Uri l = Uri.parse("content://com.tsf.shell.widget.alarm.AlarmStatenshell.setting.provider/settings");
}
