...
public class AlarmIndicator extends VRectangle {
    float[] a;
    float[] b;
    float[] c;
    float[] d;
    ...
    public AlarmIndicator() {
        ...
        this.c = new float[4];
        this.d = new float[4];
        Bitmap bitmapA = AlarmTouchManager.a(AlarmWidget.h, "front_circle_bg");
    ...
    public void a() {
        AlarmThemeProvider.a(new VObject3d[]{this}, this.f.id, AlarmTouchManager.a(AlarmWidget.h, "front_circle_bg"), 300, 250, 0);
        doubleSidedEnabled(d.a.a);
    }
}
