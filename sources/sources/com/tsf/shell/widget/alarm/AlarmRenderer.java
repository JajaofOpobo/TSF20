...
public class AlarmRenderer implements AlarmWidget.b {
    public static com.tsf.shell.widget.alarm.b.AlarmDataCursor a;
    ...
    private void f() {
        if (a == null) {
            a = new com.tsf.shell.widget.alarm.b.AlarmDataCursor(AlarmWidget.h, AlarmWidget.c);
        }
    }

    public void c() {
        this.n = new com.tsf.shell.widget.alarm.b.AlarmDataQuery(this.h, AlarmWidget.c);
    ...
    public void d() {
        ...
        new AlarmRoundRect(this, this.c, a.a[i / 10], 0);
        new AlarmRoundRect(this, this.d, a.a[i % 10], VEasing.Back.easeIn);
        new AlarmRoundRect(this, this.f, a.a[i2 / 10], VEasing.Linear.easeNone);
        new AlarmRoundRect(this, this.g, a.a[i2 % 10], 600);
    }
    ...
    private void g() {
        ...
        calendar.setTimeInMillis(System.currentTimeMillis());
        if (calendar.get(9) == 0) {
            new AlarmRoundRect(this, this.l, AlarmWidget.a.b[0], 0);
        } else {
            new AlarmRoundRect(this, this.l, AlarmWidget.a.b[1], 0);
        }
        this.l.updateUvsVBO();
    }
    ...
    private void h() {
        this.n.f();
        new AlarmRoundRect(this.i, this.n, this.n.a, 0, false);
        new AlarmRoundRect(this.j, this.n, this.n.b, 100, true);
    }

    public void b(boolean z) {
        AlarmState.c("refreshAlarmStat :" + z);
        this.o = z;
        if (z) {
            this.m.visible(true);
        } else {
    ...
    public void e() {
        AlarmThemeProvider.a(new VObject3d[]{this.l}, AlarmWidget.a.g().id, AlarmWidget.a.e(), 300, 150, 500);
        AlarmThemeProvider.a(new VObject3d[]{this.c, this.d, this.e, this.f, this.g, this.m}, a.g().id, a.b(), 300, 150, 50);
        AlarmThemeProvider.a(new VObject3d[]{this.i, this.j}, this.n.g().id, this.n.b(), 300, 150, 500);
    }
