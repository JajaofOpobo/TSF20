...
public class AlarmAlert extends Activity {
    ...
    private void b() {
        ...
        setContentView(a(layoutInflaterFrom));
    ...
    public void c() {
        ...
        c.a(this, this.a.a, jCurrentTimeMillis);
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (notificationManagerD != null) {
                notificationManagerD.createNotificationChannel(notificationChannel);
            }
        }
        builder.build();
        notificationManagerD.notify(this.a.a, builder.getNotification());
