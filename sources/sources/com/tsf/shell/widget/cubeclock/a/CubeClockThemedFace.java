...
public class CubeClockThemedFace extends VObject3dContainer {
    ...
    /* JADX INFO: renamed from: com.tsf.shell.widget.cubeclock.a.CubeClockThemedFace$b, reason: collision with other inner class name */
    ...
    private void b() {
        ...
        fArr[17] = 0.0f;
        for (int i = 0; i < 16; i++) {
            a aVar = new CubeClockDefaultFace(i);
            this.h.add(aVar);
            this.i.add(aVar);
            this.b.put(fArr);
