...
public class CubeClockMusicFace extends CubeClockConfigBase {
    private float c;
    private float d;
    private float e;
    private float f;
    ...
    @Override // com.tsf.shell.widget.cubeclock.CubeClockConfigBase
    public /* bridge */ /* synthetic */ TextureElement a() {
        return super.a();
    }

    public CubeClockMusicFace(c cVar) {
        super(cVar);
        this.e = 130.0f;
        this.f = 130.0f;
        this.g = 64.0f;
    ...
    private void b() {
        Bitmap bitmapA = CubeClockFaceConfig.a(this.b.a, CubeClockResources.a.cube_clock_week);
        this.c = 910.0f;
        this.d = 130.0f;
