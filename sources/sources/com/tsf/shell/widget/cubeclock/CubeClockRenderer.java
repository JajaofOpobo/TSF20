...
import com.tsf.shell.widget.cubeclock.CubeClockResources;
import java.text.SimpleDateFormat;
import java.util.Date;

/* JADX INFO: loaded from: C:\Users\Jaja\AndroidStudioProjects\TSF20\resources-Prime\classes.dex */
public class CubeClockRenderer extends VObject3dContainer {
    public int a;
    private f b;
    private f c;
    private f d;
    ...
    public k(c cVar) {
        ...
        scale().z = this.n.p;
        this.l = d();
        Bitmap bitmapA = CubeClockFaceConfig.a(this.n.a, CubeClockResources.a.cube_clock_shadow);
        TextureElement textureElementCreateTexture = this.n.b.createTexture(bitmapA, true);
        bitmapA.recycle();
        ...
        vRectangle.textures().addElement(textureElementCreateTexture);
        addChild(vRectangle);
        this.b = new CubeClockContainer(this.n);
        this.b.position().x = -204.0f;
        this.c = new CubeClockContainer(this.n);
        this.c.position().x = -68.0f;
        this.d = new CubeClockContainer(this.n);
        this.d.position().x = 68.0f;
        this.e = new CubeClockContainer(this.n);
        this.e.position().x = 204.0f;
        addChild(this.b);
        addChild(this.e);
        addChild(this.c);
        addChild(this.d);
        this.h = new CubeClockDateElement(this.n);
        this.f = new CubeClockSecondsElement(this.n);
        this.g = new CubeClockSecondsElement(this.n);
        this.i = new CubeClockSmallElement(this.n);
        this.j = new CubeClockBatteryElement(this.n);
    ...
    private boolean d() {
        ...
        if (TextUtils.isEmpty(string)) {
            CubeClockEmpty.a("System format is Empty");
            string = ((SimpleDateFormat) DateFormat.getMediumDateFormat(this.n.a.getApplicationContext())).toLocalizedPattern();
            CubeClockEmpty.a("Pattern String:" + string);
        } else {
            CubeClockEmpty.a("System format not Empty");
        }
        CubeClockEmpty.a("getSystemDateFormatMD :" + string);
