...
public class PreferenceElementRenderer extends PreferenceBaseFragment {
    ...
    public void g() {
        ...
        while (true) {
            ...
            if (i2 < 8) {
                ...
                com.tsf.shell.manager.app.PreferenceProvider.a.b(i2);
                i = i2 + 1;
            } else {
                this.a.v();
                this.a.f().i();
    ...
    private void n() {
        ...
        PreferenceFragmentBase.a aVar = new PreferenceFragmentBase.a();
        aVar.a = 0.0f;
        aVar.b = 0.0f;
        aVar.c = 0.0f;
        this.a.a(e(), aVar);
