...
public class PreferenceSettingG extends PreferenceSettingBase {
    ...
    public void f() {
        ...
        super.f();
        this.f.clear();
        this.f.add(com.tsf.shell.manager.app.v.StateAccessor.a(0));
        this.f.add(com.tsf.shell.manager.app.v.StateAccessor.a(2));
        this.f.add(com.tsf.shell.manager.app.v.StateAccessor.a(3));
        this.f.add(com.tsf.shell.manager.app.v.StateAccessor.a(12));
        this.f.add(com.tsf.shell.manager.app.v.StateAccessor.a(14));
        while (true) {
            int i2 = i;
            if (i2 < this.f.size()) {
                com.tsf.shell.f._d.b.a.DashItemContainer bVarE = this.f.get(i2).e();
                if (i2 == 0) {
                    bVarE.g();
                } else {
                    bVarE.h();
    ...
    public void g() {
        ...
        while (true) {
            int i2 = i;
            if (i2 < this.f.size()) {
                com.tsf.shell.f._d.b.a.DashItemD dVar = this.f.get(i2);
