...
public class e extends i {
    ...
    public void g() {
        ...
        if (this.f.e() != com.tsf.shell.manager.b.e.Q()) {
            if (this.f.e()) {
                com.tsf.shell.manager._a.h.t().g(true);
            } else {
                com.tsf.shell.manager._a.h.t().h(true);
            }
        }
        if (this.g.e() != com.tsf.shell.manager.b.e.R()) {
            if (this.g.e()) {
                com.tsf.shell.manager._a.h.t().b(true, true);
            } else {
                com.tsf.shell.manager._a.h.t().c(true, true);
            }
        }
        if (this.a) {
            if (com.tsf.shell.manager.b.e.W() != this.a) {
                ...
                if (com.tsf.shell.f.f.a.h.p != this.c.e() || com.tsf.shell.f.f.a.h.q != this.b.e()) {
                    com.tsf.shell.manager._a.h.t().aE();
                    return;
                }
                return;
            }
    ...
    private void j() {
        ...
        com.tsf.shell.manager._a.h.t().a(iE2, iE);
    }
}
