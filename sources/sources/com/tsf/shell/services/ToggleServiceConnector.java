...
import com.tsf.shell.utils.IntentResolver;
import java.util.ArrayList;
import java.util.List;

/* JADX INFO: loaded from: C:\Users\Jaja\AndroidStudioProjects\TSF20\resources-Prime\classes.dex */
public class ToggleServiceConnector implements ServiceConnection {
    ...
    public boolean a() {
        return com.tsf.shell.utils.PackageManagerHelper.a(a, 2);
    }

    public void b() {
        if (a(this.k, 2)) {
            Intent intentA = i.a(com.censivn.C3DEngine.C3DEngine.d(), new Intent(e()));
            if (intentA != null) {
    ...
    class b extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            com.tsf.shell.manager.app.FolderManager.c.a(intent.getAction(), intent.getExtras().getInt("status"));
        }
    }
