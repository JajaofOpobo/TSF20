...
public class ShellBitmapCache {
    public static void a(int i, int i2, int i3, final Runnable runnable, final Runnable runnable2, final Runnable runnable3) {
        ...
        builder.setTitle(i);
        builder.setPositiveButton(b.i.public_action_ok, new DialogInterface.OnClickListener() { // from class: com.tsf.shell.ShellBitmapCache.1
        ...
        builder.setNeutralButton(b.i.mn_feedback, new DialogInterface.OnClickListener() { // from class: com.tsf.shell.ShellBitmapCache.2
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i4) {
                n.a(Home.b());
                if (runnable3 != null) {
        ...
        builder.setNegativeButton(b.i.public_action_cancel, new DialogInterface.OnClickListener() { // from class: com.tsf.shell.ShellBitmapCache.3
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i4) {
                if (runnable2 != null) {
                    runnable2.run();
