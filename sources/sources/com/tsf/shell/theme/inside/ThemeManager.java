...
public class ThemeManager {
    ...
    public void setTheme(final String str) {
        ...
        if (str != null) {
            ...
            try {
                ThemeParser.ThemeInfo themeInfo = ThemeParser.getThemeInfo(contextCreatePackageContext);
                this.mBaseThemeConfig.packagename = themeInfo.packagename;
                this.mBaseThemeConfig.version = themeInfo.versionCode;
                mix.setTheme(ThemeElementType.PARSER_CONFIG_ALL, contextCreatePackageContext, true);
