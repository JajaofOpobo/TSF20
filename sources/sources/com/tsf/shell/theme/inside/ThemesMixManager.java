...
public class ThemesMixManager {
    ...
    public ThemesMixManager(ThemeManager themeManager) throws Throwable {
        ...
        if (f.d()) {
            f.b(false);
            for (ThemeMixElementManager themeMixElementManager : this.managerLists) {
        ...
        ThemeManager.getInstance().addListener(new ThemeManager.ThemeListener() { // from class: com.tsf.shell.theme.inside.ThemesMixManager.1
            ...
            public void onThemeUpdate(String str) throws Throwable {
                ...
                for (ThemeMixElementManager themeMixElementManager2 : ThemesMixManager.this.managerLists) {
                    if (themeMixElementManager2.themeUpdate(str)) {
                        ...
                        if (contextCreatePackageContext != null) {
                            ThemeElementCacher.cacheThemeImage(contextCreatePackageContext, themeMixElementManager2.getType());
                            ThemeElementCacher.cacheThemeXml(contextCreatePackageContext, themeMixElementManager2.getType());
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    Iterator it = ThemesMixManager.this.managerLists.iterator();
                    while (it.hasNext()) {
                        ((ThemeMixElementManager) it.next()).refresh();
                    }
                }
            }
        });
    ...
    public void resetTheme(int i, String str) throws Throwable {
        ...
        if (contextCreatePackageContext != null) {
            ThemeElementCacher.cacheThemeImage(contextCreatePackageContext, i);
            ThemeElementCacher.cacheThemeXml(contextCreatePackageContext, i);
        }
    }
    ...
    public void setTheme(int i, String str, boolean z) {
        ...
        if (contextCreatePackageContext != null) {
            setTheme(i, contextCreatePackageContext, z);
        }
    }
