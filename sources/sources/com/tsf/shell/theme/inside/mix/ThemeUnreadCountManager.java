...
public class ThemeUnreadCountManager extends ThemeMixElementManager {
    ...
    public static Bitmap createPreviewBitmap(Bitmap bitmap) {
        ...
        try {
            Bitmap bitmapCreateScaledBitmap = Bitmap.createScaledBitmap(bitmap, (int) (bitmap.getWidth() * com.censivn.C3DEngine.b.b.ScreenConstants.b), (int) (bitmap.getHeight() * com.censivn.C3DEngine.b.b.ScreenConstants.b), true);
            ...
            Bitmap bitmapE = ((float) width) + (com.censivn.C3DEngine.b.b.ScreenConstants.b * 28.0f) > ((float) bitmapCreateScaledBitmap.getWidth()) ? q.e(bitmapCreateScaledBitmap, bitmapCreateScaledBitmap.getWidth() / 2, width + ((int) (com.censivn.C3DEngine.b.b.ScreenConstants.b * 28.0f))) : bitmapCreateScaledBitmap;
