...
public class ThemeMixerUtils {
    public static TextureElement createIconTexture(a aVar, String str, int i) {
        ...
        return com.censivn.C3DEngine.C3DEngine.g().a(bitmapA, true);
    }
    ...
    private static Bitmap getThemeIconBitmap(String str) {
        ...
        try {
            Context contextCreatePackageContext = com.censivn.C3DEngine.C3DEngine.d().createPackageContext(str, 3);
