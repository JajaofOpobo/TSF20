...
import com.censivn.C3DEngine.b.b.ScreenConstants.a;
...
public class ThemeMixMenu extends com.tsf.shell.f.e._g.a.MenuActionItem {
    ...
    public ThemeMixMenu(ThemeSettingMenu themeSettingMenu) {
        ...
        this.mStyleContainer.setTitlePosition(com.censivn.C3DEngine.b.b.ScreenConstants.a(250.0f));
        initStyleContainer();
        this.mElementContainer = new a();
        this.mElementContainer.setTitle(b.i.text_theme_element);
        this.mElementContainer.setTitleSize(38);
        this.mElementContainer.setTitlePosition(com.censivn.C3DEngine.b.b.ScreenConstants.a(250.0f));
        ...
        while (true) {
            ...
            if (i2 < themeMixElementManagerLists.size()) {
                ...
                initIconDesigner();
                com.tsf.shell.manager.app.AppListManager.a(this, e.c);
                return;
            }
        }
    }
    ...
    private void resetLayout() {
        this.mScrollContainer.position().x = com.censivn.C3DEngine.b.b.ScreenConstants.z;
        this.mScrollContainer.setAABBPX(0.0f, (-com.censivn.C3DEngine.b.b.ScreenConstants.a(500.0f)) / 2.0f, 0.0f, com.censivn.C3DEngine.b.b.ScreenConstants.D, com.censivn.C3DEngine.b.b.ScreenConstants.a(500.0f) / 2.0f, 0.0f);
