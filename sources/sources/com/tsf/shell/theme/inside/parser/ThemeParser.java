...
public class ThemeParser extends DefaultHandler {
    ...
    public void parser(InputStreamCallback inputStreamCallback, int i) throws IOException {
        ...
        try {
            elementStream = inputStreamCallback.getElementStream();
            parserElement(elementStream, i, themeDescription);
            try {
                elementStream = inputStreamCallback.getFolderStream();
                parserFolder(elementStream, i, themeDescription);
    ...
    public void parser(String str, int i) throws IOException {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (nodeItem.getNodeType() == 1) {
                ...
                if (nodeName.equals("textPlane")) {
                    ...
                    int dimension = parseDimension(element2.getAttribute("width"), f);
                    textFormat.width = dimension;
                    themeFolderDescription.textWidth = dimension;
                    themeFolderDescription.textPlaneWidth = dimension;
                    ThemeFolderDescription.TextFormat textFormat2 = themeFolderDescription.nameTextFormat;
                    int dimension2 = parseDimension(element2.getAttribute("height"), f);
                    textFormat2.height = dimension2;
                    themeFolderDescription.textHeight = dimension2;
                    themeFolderDescription.textPlaneHeight = dimension2;
                    ...
                    int dimension3 = parseDimension(element2.getAttribute("width"), f);
                    textFormat3.width = dimension3;
                    themeFolderDescription.sizeTextWidth = dimension3;
                    themeFolderDescription.sizePlaneWidth = dimension3;
                    ThemeFolderDescription.TextFormat textFormat4 = themeFolderDescription.sizeTextFormat;
                    int dimension4 = parseDimension(element2.getAttribute("height"), f);
                    textFormat4.height = dimension4;
                    themeFolderDescription.sizeTextHeight = dimension4;
                    themeFolderDescription.sizePlaneHeight = dimension4;
    ...
    public static int parseDimension(String str, float f) {
        return (int) (j.a(str) * f * com.censivn.C3DEngine.b.b.ScreenConstants.f);
    }
