...
public class ShellThemeProvider {
    public static void a(final String str) {
        com.censivn.C3DEngine.C3DEngine.a().a(new Runnable() { // from class: com.tsf.shell.e.1
            @Override // java.lang.Runnable
            public void run() {
                Toast.makeText(com.censivn.C3DEngine.C3DEngine.d(), str, 0).show();
            }
        });
    }

    public static void a(int i) {
        a(com.censivn.C3DEngine.C3DEngine.d().getString(i));
    }
    ...
    public static void a(int i, int i2, int i3, Runnable runnable, Runnable runnable2) {
        a(com.censivn.C3DEngine.C3DEngine.d().getString(i), com.censivn.C3DEngine.C3DEngine.d().getString(i2), com.censivn.C3DEngine.C3DEngine.d().getString(i3), runnable, runnable2);
    }

    public static void a(String str, String str2, String str3, Runnable runnable, Runnable runnable2) {
        a(com.censivn.C3DEngine.C3DEngine.d(), str, str2, str3, runnable, runnable2);
    }
    ...
    public static void a(final Context context, final String str, final String str2, final String str3, final Runnable runnable, final Runnable runnable2) {
        ...
        if (com.censivn.C3DEngine.C3DEngine.a() == null) {
            runnable3.run();
        } else {
            com.censivn.C3DEngine.C3DEngine.a().a(runnable3);
        }
    }
    ...
    public static void a(Context context, final String str, final String str2, final String str3, final String str4, final String str5, final Runnable runnable, final Runnable runnable2) {
        com.censivn.C3DEngine.C3DEngine.a().a(new Runnable() { // from class: com.tsf.shell.e.3
            @Override // java.lang.Runnable
            public void run() {
