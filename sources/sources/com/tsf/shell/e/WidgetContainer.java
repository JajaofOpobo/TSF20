...
public class WidgetContainer extends FrameLayout {
    ...
    public void a(TSFAppWidgetHostView cVar) {
        removeView(this.a);
        this.a = cVar;
        addView(cVar);
    }
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            try {
                ...
                if (this.b != null) {
                    ...
                    ItemInfo itemInfoK = this.b.K();
                    str = (itemInfoK == null || !(itemInfoK instanceof LauncherAppWidgetInfo)) ? str2 : str2 + "   launcherinfo:    " + ((LauncherAppWidgetInfo) itemInfoK).providerName;
                }
                map.put("error", str);
                m.a("EVENT_ISSUSE_UPDATE_APP_WIDGET_SIZE", map);
            }
        }
    }
            ...
            synchronized (this.e) {
                if (this.f != null && this.f.get() != null) {
                    ...
                    if (bitmapCreateBitmap.getWidth() != getWidth() || bitmapCreateBitmap.getHeight() != getHeight()) {
                        ...
                        this.f.clear();
                        this.f = new SoftReference<>(bitmapCreateBitmap);
                    }
                } else {
