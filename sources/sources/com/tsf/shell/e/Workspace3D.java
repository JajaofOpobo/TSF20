...
public class Workspace3D extends ViewGroup {
    ...
    public Workspace3D(Context context) {
        super(context);
        this.a = true;
        this.d = 0;
        this.f = true;
    ...
    public void a(View view, CellLayout dVar, int i, int i2, int i3, int i4, boolean z) {
        ...
        if (dVar != null) {
            ...
            if (view instanceof b) {
                WidgetContainer bVar3 = (WidgetContainer) view;
                bVar3.a(i3, i4);
    ...
    public void a(WidgetContainer bVar) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        switch (action & 255) {
            case 0:
                ...
                com.censivn.C3DEngine.C3DEngine.a().c(new Runnable() { // from class: com.tsf.shell.e.Workspace3D.1
            ...
            case 2:
                ...
                int iAbs = (int) Math.abs(x2 - this.b);
                int iAbs2 = (int) Math.abs(y2 - this.c);
    ...
    public boolean a(MotionEvent motionEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            if (((CellLayout) getChildAt(i)).a(motionEvent)) {
                return true;
            }
        }
        return false;
