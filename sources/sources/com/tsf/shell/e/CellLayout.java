...
public class CellLayout extends ViewGroup {
    ...
    public CellLayout(Context context, g gVar) {
        ...
        a = (int) (com.censivn.C3DEngine.b.b.ScreenConstants.e * 3.0f);
        d = (int) (com.censivn.C3DEngine.b.b.ScreenConstants.e * 3.0f);
        b = 0;
        e = 0;
    ...
    public void a() {
        ...
        for (int i = 0; i < childCount; i++) {
            ((com.tsf.shell.e.WidgetContainer) getChildAt(i)).a();
        }
    }
    ...
    public boolean a(MotionEvent motionEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            WidgetContainer bVar = (WidgetContainer) ((com.tsf.shell.e.WidgetContainer) getChildAt(i)).getLayoutParams();
    ...
    public void b() {
        ...
        int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
            ((com.tsf.shell.e.WidgetContainer) getChildAt(i)).b();
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            WidgetContainer bVar = (WidgetContainer) childAt.getLayoutParams();
            int i6 = bVar.a;
            int i7 = bVar.b;
    ...
    public boolean a(int i, View view) {
        int i2;
        int childCount = getChildCount();
        int i3 = com.censivn.C3DEngine.b.b.ScreenConstants.D * com.censivn.C3DEngine.b.b.ScreenConstants.E;
        int i4 = 0;
        int i5 = 0;
        while (i4 < childCount) {
            View childAt = getChildAt(i4);
            if (!(childAt instanceof com.tsf.shell.e.WidgetContainer) || childAt == view) {
                i2 = i5;
            } else {
                WidgetContainer bVar = (WidgetContainer) childAt.getLayoutParams();
                i2 = (bVar.e * bVar.d) + i5;
    ...
    public void a(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ((WidgetContainer) layoutParams).c = true;
        super.addView(view, i, layoutParams);
    }

    public void a(View view) {
        super.addView(view, (WidgetContainer) view.getLayoutParams());
    }
        ...
        if (action == 0) {
            ...
            while (true) {
                ...
                if (childAt.getVisibility() == 0 || childAt.getAnimation() != null) {
                    ...
                    if (rect.contains(x, y) && (childAt instanceof com.tsf.shell.e.WidgetContainer)) {
                        WidgetContainer bVar = (WidgetContainer) childAt.getLayoutParams();
                        aVar.a = (com.tsf.shell.e.WidgetContainer) childAt;
                        aVar.b = bVar.a;
                        aVar.c = bVar.b;
                        aVar.d = bVar.d;
                        aVar.e = bVar.e;
    ...
    public static class WidgetContainer extends ViewGroup.MarginLayoutParams {
        public int a;
        public int b;
        boolean c;
        public int d;
    ...
    public static final class a implements ContextMenu.ContextMenuInfo {
        public com.tsf.shell.e.WidgetContainer a;
        public int b;
        public int c;
        public int d;
        public int e;
