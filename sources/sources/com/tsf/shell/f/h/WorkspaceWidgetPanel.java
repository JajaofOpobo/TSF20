...
public class WorkspaceWidgetPanel extends com.censivn.C3DEngine.b.h.e.b {
    ...
    public void a(ArrayList<ItemInfo> arrayList, String str) {
        ...
        while (it.hasNext()) {
            com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVarA = com.tsf.shell.manager.l.ShortcutManager.a(it.next(), com.tsf.shell.manager.o.ButtonPresetManager.b, true);
            a(bVarA);
            f(bVarA);
        }
        f(this.b);
