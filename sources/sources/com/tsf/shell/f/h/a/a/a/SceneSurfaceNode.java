...
public class SceneSurfaceNode extends j implements SceneInteractionHandler.InterfaceC0098a {
    ...
    public SceneSurfaceNode(com.tsf.shell.f.h.a.a.SceneElementRenderer dVar, j jVar) {
        ...
        addChild(this.j);
        this.h = new com.tsf.shell.f.e.ObjectPool<d>() { // from class: com.tsf.shell.f.h.a.a.a.SceneSurfaceNode.2
            @Override // com.tsf.shell.f.e.ObjectPool
            /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
            public d b() {
                return new SceneDecorNode();
            }
        };
    ...
    public com.tsf.shell.f.h.a.a.SceneNodeAnimator a() {
        return this.f;
    }
    ...
    public void b(boolean z) {
        ...
        this.i.clear();
        for (SceneInteractionHandler.c cVar : this.f.a().f) {
            d dVarC = this.h.c();
            dVarC.a(cVar);
            if (cVar == this.f.a().a()) {
                dVarC.e();
        ...
        for (SceneInteractionHandler.C0126a c0126a : this.f.a().g) {
            d dVarC2 = this.h.c();
            dVarC2.a(c0126a);
    ...
    public void a(com.tsf.shell.f.h.a.a.SceneNodeAnimator bVar) {
        this.f = bVar;
        bVar.b().alpha(0.0f);
        this.e.reset();
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.h.a.a.a.SceneSurfaceNode.5
    ...
    public boolean c() {
        ...
        a(this.f.c(), false);
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.h.a.a.a.SceneSurfaceNode.6
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
                c.this.f.a().e();
