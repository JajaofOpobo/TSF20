...
public class e implements com.censivn.C3DEngine.b.c.e.a {
    ...
    public void b() {
        ...
        if (!this.m) {
            this.e = com.tsf.shell.manager.app.h.h();
        } else {
        ...
        p();
        this.i.g();
        if (com.tsf.shell.manager.app.g.c() != 0) {
            b(false);
        }
    }
    ...
    public void d(int i) {
        if (this.j != null && !this.m) {
            com.tsf.shell.manager.app.k.c(this.j);
        }
        this.j = (A) this.i.getChildAt(i);
        if (this.g && !this.m) {
            com.tsf.shell.manager.app.k.b(this.j);
        }
    }
    ...
    public void k() {
        if (this.m || com.tsf.shell.manager.app.g.c() == 0) {
            if (this.o) {
                b(true);
            } else {
                c(true);
    ...
    public void b(boolean z) {
        if (this.o) {
            ...
            if (!this.m) {
                ...
                com.tsf.shell.manager.app.k.c(this.j);
                com.tsf.shell.manager.app.h.t().ar();
            }
        }
    }
        ...
        if (this.o && !this.g) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.c.b.e.6
                ...
                public void a() {
                    ...
                    if (!e.this.m) {
                        com.tsf.shell.manager.app.k.b(e.this.j);
                    }
                }
