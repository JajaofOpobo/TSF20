...
public class DrawerSettingsResult implements IDrawerSettingsCallback {
    private IDrawerSettingsCallback.C0084a a;
    private float b;
    private float c;
    private float d;
    private float e;
    ...
    @Override // com.tsf.shell.f.c.b.a.IDrawerSettingsCallback
    public void a(ArrayList<com.tsf.shell.f.c.b.DrawerSettingsData> arrayList, int i) {
        float fA = a(i);
        ...
        float f4 = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.c().folder.nameTextFormat.auto ? -this.k.Y : (-(com.tsf.shell.f.i.b.d.FolderShortcutItem.m.f + com.tsf.shell.f.i.b.d.FolderShortcutItem.m.h)) / 2.0f;
        float f5 = -this.k.Y;
        if (f3 == 0.93f) {
            float f6 = f / i;
            float f7 = f6 / 2.0f;
            ...
            for (int i2 = 0; i2 < i; i2++) {
                com.tsf.shell.f.c.b.DrawerSettingsData bVar = arrayList.get(i2);
                bVar.c = f8;
                bVar.a = f8;
                bVar.b = f5;
                bVar.d = f4;
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            ...
            for (int i6 = 0; i6 < i; i6++) {
                ...
                com.tsf.shell.f.c.b.DrawerSettingsData bVar2 = arrayList.get(i7);
    ...
    @Override // com.tsf.shell.f.c.b.a.IDrawerSettingsCallback
    public IDrawerSettingsCallback.b a(Number3d number3d, ArrayList<com.tsf.shell.f.c.b.DrawerSettingsData> arrayList, int i) {
        IDrawerSettingsCallback.b bVar = IDrawerSettingsCallback.b.c;
        float f = number3d.x;
        ...
        for (int i3 = 0; i3 < size; i3++) {
            com.tsf.shell.f.c.b.DrawerSettingsData bVar2 = arrayList.get(i3);
            if (i != i3 && f <= bVar2.a) {
                if (i3 > i) {
                    bVar.a = i3 - 1;
                    a(number3d, arrayList, bVar);
    ...
    private void a(Number3d number3d, ArrayList<com.tsf.shell.f.c.b.DrawerSettingsData> arrayList, IDrawerSettingsCallback.b bVar) {
        int size = arrayList.size();
        float f = number3d.x;
        bVar.b = 0;
        for (int i = 0; i < size; i++) {
            com.tsf.shell.f.c.b.DrawerSettingsData bVar2 = arrayList.get(i);
