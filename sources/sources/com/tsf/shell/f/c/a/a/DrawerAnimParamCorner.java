...
public class DrawerAnimParamCorner extends DrawerAnimParamRight {
    public DrawerAnimParamCorner() {
        this.c = 1;
    }
    ...
    public void a(j jVar, j jVar2) {
        ...
        jVar.position().x = (-160.0f) * com.censivn.C3DEngine.b.b.ScreenConstants.b;
    }

    @Override // com.tsf.shell.f.c.a.a.DrawerAnimParamRight, com.tsf.shell.f.c.a.a.DrawerAnimConfig
    ...
    public void a(com.censivn.C3DEngine.b.f.IRenderable iVar, float f, float f2, float f3) {
        iVar.setAABBPX(com.censivn.C3DEngine.b.b.ScreenConstants.b * (-83.0f), 0.0f + f, 0.0f, 2.1474836E9f, f3 - f2, 0.0f);
    }
    ...
    public void a(com.tsf.shell.f.c.a.DrawerState dVar, com.censivn.C3DEngine.b.f.IRenderable iVar, float f, boolean z) {
        if (!this.d) {
            dVar.a = 0.0f + ((-iVar.maxX()) * f) + com.tsf.shell.f.c.a.DrawerContentPanel.q;
        } else if (z) {
    ...
    @Override // com.tsf.shell.f.c.a.a.DrawerAnimParamBase, com.tsf.shell.f.c.a.a.DrawerAnimConfig
    public Number3d c() {
        Number3DrawerAnimParamLeft.TEMPNUMBER3D.y = iVar.position().y;
        Number3DrawerAnimParamLeft.TEMPNUMBER3D.x = com.censivn.C3DEngine.b.b.ScreenConstants.A + com.tsf.shell.f.c.a.DrawerContentPanel.b;
    ...
    public Number3d d() {
        Number3DrawerAnimParamLeft.TEMPNUMBER3D.y = iVar.position().y;
        Number3DrawerAnimParamLeft.TEMPNUMBER3D.x = com.censivn.C3DEngine.b.b.ScreenConstants.A - com.tsf.shell.f.c.a.DrawerContentPanel.a;
        return Number3DrawerAnimParamLeft.TEMPNUMBER3D;
    }
    ...
    public DrawerAnimConfig.C0080a a(com.censivn.C3DEngine.b.f.IRenderable iVar, float f, float f2, float f3, float f4) {
        ...
        c0080a.d = ((f4 / 2.0f) + 0.0f) - f2;
        c0080a.e = (f4 - f2) + 0.0f + (c0080a.b / 2.0f) + f3;
        return c0080a;
    }
