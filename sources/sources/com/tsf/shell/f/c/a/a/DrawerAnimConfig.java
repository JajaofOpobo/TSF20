...
public class DrawerAnimConfig {
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.c.a.a.DrawerAnimConfig$a, reason: collision with other inner class name */
    ...
    public int b(float f) {
        if (f <= com.tsf.shell.f.c.a.DrawerContentPanel.e) {
            return 0;
        }
        if (f > com.tsf.shell.f.c.a.DrawerContentPanel.f) {
            return -4;
        }
        return -3;
    }
