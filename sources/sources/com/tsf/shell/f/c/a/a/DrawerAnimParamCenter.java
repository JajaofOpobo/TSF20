...
public class DrawerAnimParamCenter extends DrawerAnimParamBase {
    public DrawerAnimParamCenter() {
        this.c = 0;
    }

    @Override // com.tsf.shell.f.c.a.a.DrawerAnimConfig
    public int b(float f, float f2) {
        return b(DrawerAnimParamRight);
    }
    ...
    public int a(ArrayList<com.tsf.shell.f.c.a.DrawerState> arrayList, ArrayList<com.censivn.C3DEngine.b.f.i> arrayList2, int i, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        if (iB == 0) {
            ...
            if (aVarA.a == -1 || aVarA.a == -2) {
                ...
                float f8 = (f4 * f7) / 2.0f;
                if (aVarA.b > 0.0f) {
                    fMaxY = (((-aVarA.d) - (aVarA.c / 2.0f)) - (iVar.minY() * f7)) + f8;
                } else {
                    fMaxY = (((-aVarA.d) + (aVarA.c / 2.0f)) - (iVar.maxY() * f7)) - f8;
                }
                dVar.b = ((fMaxY + aVarA.d) * fAbs) + (-aVarA.d);
                dVar.d = f7;
                dVar.f = dVar.b + (iVar.maxY() * f7) + f8;
                dVar.e = (dVar.b + (iVar.minY() * f7)) - f8;
                dVar.c = 0.0f;
                dVar.i = 255.0f;
                a(dVar, iVar, f7, true);
                dVar.h = false;
                    ...
                    if (i2 > 1) {
                        ...
                        while (true) {
                            ...
                            if (f11 - 0.4f < this.e && i3 > 0) {
                                float fMinY = ((this.e * f4) / 2.0f) + (dVar3.f - (iVar2.minY() * this.e)) + ((this.e * f4) / 2.0f) + (iVar2.maxY() * this.e);
                                com.tsf.shell.f.c.a.DrawerState dVar5 = arrayList.get(i3 - 1);
                                if (fMinY < dVar5.e) {
                                    a(dVar3, dVar4, iVar2, (dVar5.e - dVar3.f) / ((iVar2.maxY() - iVar2.minY()) + f4), f4);
                                    a(dVar4, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
                    ...
                    if (i2 < i - 2) {
                        ...
                        while (true) {
                            ...
                            if (f14 - 0.4f < this.e && i5 < i - 1) {
                                float fMaxY2 = (((dVar7.e - (iVar3.maxY() * this.e)) - ((this.e * f4) / 2.0f)) + (iVar3.minY() * this.e)) - ((this.e * f4) / 2.0f);
                                com.tsf.shell.f.c.a.DrawerState dVar8 = arrayList.get(i5 + 1);
                                if (fMaxY2 > dVar8.f) {
                                    b(dVar7, dVar6, iVar3, (dVar7.e - dVar8.f) / ((iVar3.maxY() - iVar3.minY()) + f4), f4);
                                    a(dVar6, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
    ...
    private void a(com.tsf.shell.f.c.a.DrawerState dVar, com.tsf.shell.f.c.a.DrawerState dVar2, com.censivn.C3DEngine.b.f.i iVar, float f, float f2) {
        ...
        dVar2.d = f;
        float f3 = (f2 * f) / 2.0f;
        dVar2.b = (dVar.f - (iVar.minY() * f)) + f3;
        dVar2.f = dVar2.b + (iVar.maxY() * f) + f3;
        dVar2.e = (dVar2.b + (iVar.minY() * f)) - f3;
        dVar2.c = 0.0f;
        a(dVar2, iVar, f, true);
        dVar2.h = false;
    }
    ...
    public void a(ArrayList<com.tsf.shell.f.c.a.DrawerState> arrayList, ArrayList<com.censivn.C3DEngine.b.f.i> arrayList2, int i, float f, float f2, float f3, float f4) {
        ...
        if (f7 == 1.0f) {
            float f10 = f5 - fA;
            int i2 = 0;
            float fMinY = (-f2) - (f10 / 2.0f);
            while (i2 < i) {
                com.censivn.C3DEngine.b.f.i iVar = arrayList2.get(i2);
                com.tsf.shell.f.c.a.DrawerState dVar = arrayList.get(i2);
                dVar.b = fMinY - iVar.maxY();
                dVar.f = dVar.b + iVar.maxY() + f9;
                dVar.e = (dVar.b + iVar.minY()) - f9;
                dVar.c = 0.0f;
                dVar.i = 255.0f;
        ...
        while (i3 < i) {
            ...
            dVar2.b = fMinY2 - (iVar2.maxY() * f7);
            dVar2.f = dVar2.b + (iVar2.maxY() * f7) + f9;
            dVar2.e = (dVar2.b + (iVar2.minY() * f7)) - f9;
            dVar2.c = 0.0f;
            dVar2.i = 255.0f;
            ...
            dVar2.h = false;
            i3++;
            fMinY2 = ((iVar2.minY() * f7) + dVar2.b) - f8;
        }
    }
    ...
    public boolean a(Number3d number3d, com.censivn.C3DEngine.b.f.i iVar, boolean z) {
        return number3d.y < iVar.position().y ? !z : z;
    }
    ...
    public DrawerAnimConfig.C0080a a(com.censivn.C3DEngine.b.f.i iVar, float f, float f2, float f3, float f4) {
        ...
        c0080a.d = ((f4 / 2.0f) - 180.0f) - f2;
        c0080a.e = ((f4 - f2) - 180.0f) + (c0080a.b / 2.0f) + f3;
        return c0080a;
    }
