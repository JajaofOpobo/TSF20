...
public class DrawerAnimParamRight extends DrawerAnimParamBase {
    ...
    public int a(ArrayList<com.tsf.shell.f.c.a.DrawerState> arrayList, ArrayList<com.censivn.C3DEngine.b.f.IRenderable> arrayList2, int i, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        if (iB == 0) {
            ...
            if (aVarA.a == -1 || aVarA.a == -2) {
                ...
                float f8 = (f4 * f7) / 2.0f;
                if (aVarA.b > 0.0f) {
                    fMinY = ((aVarA.d + (aVarA.c / 2.0f)) - (iVar.maxY() * f7)) - f8;
                } else {
                    fMinY = ((aVarA.d - (aVarA.c / 2.0f)) - (iVar.minY() * f7)) + f8;
                }
                dVar.b = ((fMinY - aVarA.d) * fAbs) + aVarA.d;
                dVar.d = f7;
                dVar.f = (dVar.b + (iVar.minY() * f7)) - f8;
                dVar.e = dVar.b + (iVar.maxY() * f7) + f8;
                dVar.c = 0.0f;
                dVar.i = 255.0f;
                a(dVar, iVar, f7, true);
                dVar.h = false;
                if (i2 > 0) {
                    com.tsf.shell.f.c.a.DrawerState dVar2 = arrayList.get(i2 - 1);
                    ...
                    if (i2 > 1) {
                        int i3 = i2 - 2;
                        float f10 = f9;
                        com.tsf.shell.f.c.a.DrawerState dVar3 = dVar2;
                        while (true) {
                            if (i3 <= -1) {
                                break;
                            }
                            ...
                            if (f11 - 0.4f < this.e && i3 > 0) {
                                float fMaxY = (((dVar3.f - (iVar2.maxY() * this.e)) - ((this.e * f4) / 2.0f)) + (iVar2.minY() * this.e)) - ((this.e * f4) / 2.0f);
                                com.tsf.shell.f.c.a.DrawerState dVar5 = arrayList.get(i3 - 1);
                                if (fMaxY > dVar5.e) {
                                    a(dVar3, dVar4, iVar2, (dVar3.f - dVar5.e) / ((iVar2.maxY() - iVar2.minY()) + f4), f4);
                                    a(dVar4, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
                ...
                if (i2 < i - 1) {
                    com.tsf.shell.f.c.a.DrawerState dVar6 = arrayList.get(i2 + 1);
                    ...
                    if (i2 < i - 2) {
                        ...
                        while (true) {
                            int i5 = i4;
                            float f13 = f12;
                            com.tsf.shell.f.c.a.DrawerState dVar7 = dVar6;
                            if (i5 >= i) {
                                break;
                            }
                            ...
                            if (f14 - 0.4f < this.e && i5 < i - 1) {
                                float fMinY2 = ((this.e * f4) / 2.0f) + (dVar7.e - (iVar3.minY() * this.e)) + ((this.e * f4) / 2.0f) + (iVar3.maxY() * this.e);
                                com.tsf.shell.f.c.a.DrawerState dVar8 = arrayList.get(i5 + 1);
                                if (fMinY2 < dVar8.f) {
                                    b(dVar7, dVar6, iVar3, (dVar8.f - dVar7.e) / ((iVar3.maxY() - iVar3.minY()) + f4), f4);
                                    a(dVar6, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
    ...
    private void a(com.tsf.shell.f.c.a.DrawerState dVar, float f, float f2, float f3, float f4) {
        float f5 = f4 - f2;
        if (dVar.f < f) {
            if (dVar.f < 0.0f) {
                dVar.i = 0.0f;
    ...
    private void a(com.tsf.shell.f.c.a.DrawerState dVar, com.tsf.shell.f.c.a.DrawerState dVar2, com.censivn.C3DEngine.b.f.IRenderable iVar, float f, float f2) {
        ...
        dVar2.d = f;
        float f3 = (f2 * f) / 2.0f;
        dVar2.b = (dVar.f - (iVar.maxY() * f)) - f3;
        dVar2.f = (dVar2.b + (iVar.minY() * f)) - f3;
        dVar2.e = f3 + dVar2.b + (iVar.maxY() * f);
        dVar2.c = 0.0f;
        a(dVar2, iVar, f, true);
        dVar2.h = false;
    }
    ...
    public void a(ArrayList<com.tsf.shell.f.c.a.DrawerState> arrayList, ArrayList<com.censivn.C3DEngine.b.f.IRenderable> arrayList2, int i, float f, float f2, float f3, float f4) {
        ...
        if (f7 == 1.0f) {
            ...
            while (i2 < i) {
                com.censivn.C3DEngine.b.f.IRenderable iVar = arrayList2.get(i2);
                com.tsf.shell.f.c.a.DrawerState dVar = arrayList.get(i2);
                dVar.b = fMaxY - iVar.minY();
                dVar.f = (dVar.b + iVar.minY()) - f9;
                dVar.e = dVar.b + iVar.maxY() + f9;
                dVar.c = 0.0f;
                dVar.i = 255.0f;
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            dVar2.b = f2 - (iVar2.minY() * f7);
            dVar2.f = (dVar2.b + (iVar2.minY() * f7)) - f9;
            dVar2.e = dVar2.b + (iVar2.maxY() * f7) + f9;
            dVar2.c = 0.0f;
            dVar2.i = 255.0f;
            ...
            dVar2.d = f7;
            dVar2.h = false;
            f2 = (iVar2.maxY() * f7) + dVar2.b + f8;
        }
    }

    @Override // com.tsf.shell.f.c.a.a.DrawerAnimConfig
    public int a(Number3d number3d, ArrayList<com.tsf.shell.f.c.a.DrawerState> arrayList, int i) {
        float f = number3d.y;
        com.tsf.shell.f.c.a.DrawerState dVar = arrayList.get(0);
        com.tsf.shell.f.c.a.DrawerState dVar2 = arrayList.get(i - 1);
        if (f < dVar.f) {
            return -1;
        }
        if (f < dVar.b) {
        ...
        int i2 = 1;
        com.tsf.shell.f.c.a.DrawerState dVar3 = dVar;
        while (i2 < i) {
            com.tsf.shell.f.c.a.DrawerState dVar4 = arrayList.get(i2);
    ...
    public void a(com.censivn.C3DEngine.b.f.IRenderable iVar, float f, float f2, float f3) {
        iVar.setAABBPX(-2.1474836E9f, 0.0f + f, 0.0f, com.censivn.C3DEngine.b.b.ScreenConstants.b * 83.0f, f3 - f2, 0.0f);
    }
    ...
    public DrawerAnimConfig.C0080a a(com.censivn.C3DEngine.b.f.IRenderable iVar, float f, float f2, float f3, float f4) {
        ...
        if (((-com.censivn.C3DEngine.b.b.ScreenConstants.C) - com.tsf.shell.f.c.a.DrawerContentPanel.a) + iVar.position().y > f) {
            fAsin = 180.0f;
        } else {
        ...
        c0080a.d = (0.0f - (f4 / 2.0f)) + f2;
        c0080a.e = ((0.0f - (f4 - f2)) - (c0080a.b / 2.0f)) - f3;
        return c0080a;
    }
