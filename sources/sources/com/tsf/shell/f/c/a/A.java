...
public class A extends com.censivn.C3DEngine.b.d.a {
    ...
    public A(i iVar, f fVar) {
        ...
        this.j = fVar;
        this.k = this.j.g();
        this.b = com.tsf.shell.manager._a.h;
    }
        ...
        switch (this.e) {
            case 0:
                if (x.b(motionEvent.getX(), motionEvent.getY(), motionEvent2.getX(), motionEvent2.getY()) > this.d) {
                    this.e = com.tsf.shell.manager._a.g.b.a((x.d(motionEvent.getX(), motionEvent.getY(), motionEvent2.getX(), motionEvent2.getY()) + 90.0f) * (-1.0f));
                    switch (this.e) {
                        case 1:
                            this.b.w();
