...
public class DrawerContentPanel implements DrawerEditPanel.a {
    ...
    public void a(j jVar, A aVar) {
        ...
        this.ag.l(1.0f);
        this.ag.m(1.0f);
        this.ah = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.c.a.DrawerContentPanel.1
        ...
        this.P.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this.P) { // from class: com.tsf.shell.f.c.a.DrawerContentPanel.10
            private float b;
            ...
            public void a(MotionEvent motionEvent, MotionEvent motionEvent2) {
                if (!f.this.af) {
                    ...
                    if (this.d) {
                        ...
                        if (fA < f.c * com.censivn.C3DEngine.b.b.A.b) {
                            fA = f.c * com.censivn.C3DEngine.b.b.A.b;
                        }
                        f.this.ac = fA;
                        f.this.z = false;
        ...
        this.K.a(255);
        this.L = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.c.a.DrawerContentPanel.11
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
        ...
        this.N.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this.N) { // from class: com.tsf.shell.f.c.a.DrawerContentPanel.13
            boolean a = true;
            boolean b = true;
            i d;
    ...
    private void c(boolean z) {
        float fAbs = Math.abs(this.u - com.censivn.C3DEngine.b.b.A.z);
        float fAbs2 = Math.abs(com.censivn.C3DEngine.b.b.A.A - this.u);
        float fAbs3 = Math.abs(this.v - com.censivn.C3DEngine.b.b.A.C);
        if (!z || this.n == null) {
    ...
    public void v() {
        if (this.ad) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.c.a.DrawerContentPanel.5
                @Override // com.censivn.C3DEngine.b.g.d
    ...
    public void a(final Runnable runnable, boolean z) {
        if (!this.ad) {
            ...
            if (z) {
                com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.c.a.DrawerContentPanel.6
                    @Override // com.censivn.C3DEngine.b.g.d
    ...
    public void b(boolean z) {
        if (!this.al) {
            ...
            if (z) {
                if (this.an == null) {
                    this.an = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.c.a.DrawerContentPanel.7
                        @Override // com.censivn.C3DEngine.b.g.d
                        public void a() {
    ...
    public void z() {
        if (this.al && this.Z) {
            ...
            if (this.am == null) {
                this.am = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.c.a.DrawerContentPanel.8
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a() {
    ...
    public void a(int i2, int i3, int i4, int i5) {
        ...
        float f3;
        boolean z = false;
        if (((this.n instanceof com.tsf.shell.f.c.a.a.DrawerAnimParamLeft) && com.censivn.C3DEngine.b.b.A.O) || ((this.n instanceof com.tsf.shell.f.c.a.a.DrawerAnimParamBase) && !com.censivn.C3DEngine.b.b.A.O)) {
            z = true;
        }
        Number3d number3dF = com.censivn.C3DEngine.b.b.A.O ? com.tsf.shell.manager.b.ConfigManager.f() : com.tsf.shell.manager.b.ConfigManager.g();
        ...
        if (fC != 0.0f) {
            if (fC < c * com.censivn.C3DEngine.b.b.A.b) {
                fC = c * com.censivn.C3DEngine.b.b.A.b;
            }
            float fA = this.n.a(this.u, this.v);
            if (fC > fA) {
                fC = fA;
