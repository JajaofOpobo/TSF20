...
public class f implements e.a {
    ...
    public static String b() {
        Cursor cursorQuery = com.censivn.C3DEngine.A.d().getContentResolver().query(g.h.a, null, null, null, null);
        String string = "";
    ...
    public f(boolean z) {
        ...
        this.af = false;
        this.Y = z;
        if (!z && com.tsf.shell.manager.app.g.c() != 1) {
            z2 = false;
        }
        this.Z = z2;
        if (!z) {
    ...
    public void a(j jVar, A aVar) {
        ...
        com.tsf.shell.manager.app.h.c().a(new o.a() { // from class: com.tsf.shell.f.c.a.f.14
            ...
            @Override // com.tsf.shell.f.f.o.a
            public void b() {
                if (!f.this.af && !f.this.ad && com.tsf.shell.manager.app.h.n().t() != -1) {
                    f.this.x();
                }
            }
        });
    ...
    public void j() {
        ...
        if (c0080aA != null) {
            ...
            com.tsf.shell.manager.app.j.a(this.E);
        }
    }
    ...
    private void c(boolean z) {
        ...
        } else if (this.n instanceof com.tsf.shell.f.c.a.a.d) {
            this.v = com.censivn.C3DEngine.b.b.A.C + a;
            F();
        } else {
            if (fAbs > fAbs2) {
