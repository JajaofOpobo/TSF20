...
public class PageItemTouchHandler extends com.censivn.C3DEngine.b.d.a {
    public static n a;
    public float b;
    public float d;
    boolean e;
    ...
    public PageItemTouchHandler(com.tsf.shell.f.i.PageItem bVar) {
        super(bVar);
        this.l = false;
        this.m = false;
        this.n = false;
    ...
    */
    public void d(android.view.MotionEvent r7) {
        ...
        Lc6:
            ...
            goto La3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.f.i.a.PageItemTouchHandler.d(android.view.MotionEvent):void");
    }

    public void b() {
        if (com.tsf.shell.manager.app.StateHub.d.b()) {
            a(com.tsf.shell.manager.app.StateHub.d.PageItemTouchHandler(), true);
        } else {
            PageItemTouchHandler();
        }
    }
    ...
    public void a(float[] fArr, boolean z) {
        ...
        if (fArr[0] != this.g.position().x || fArr[1] != this.g.position().y) {
            ...
            dVar.h(fArr[1]);
            if (this.g.Y()) {
                WidgetMatchResizeController.a(fArr[0] - this.g.position().x, fArr[1] - this.g.position().y);
            }
        }
        if (z) {
            dVar.e(0.0f);
    ...
    public void a(MotionEvent motionEvent, MotionEvent motionEvent2) {
        ...
        if (this.l) {
            if (this.g.D()) {
                com.tsf.shell.f.e.AlignmentOverlay.a((int) (this.b + (motionEvent2.getX() - motionEvent.getX())), (int) (this.d - (motionEvent2.getY() - motionEvent.getY())));
            } else if (this.n) {
    ...
    */
    public void e(android.view.MotionEvent r6) {
        ...
        L5a:
            ...
            goto L2c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.f.i.a.PageItemTouchHandler.e(android.view.MotionEvent):void");
    }
