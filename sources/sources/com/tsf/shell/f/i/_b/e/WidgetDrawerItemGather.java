...
public class WidgetDrawerItemGather extends WidgetDrawerItemAction {
    private static k a;
    ...
    public WidgetDrawerItemGather(LauncherShortcut3DInfo launcherShortcut3DInfo, com.tsf.shell.manager.o.ButtonMetrics aVar, boolean z, int i) {
        ...
        if (a == null) {
            ...
            WidgetDrawerItemBase.position().y = aE().Y;
            WidgetDrawerItemBase.rotation().z = p;
            WidgetDrawerItemBase.textures().addElement(WidgetDrawerShortcutItemBase);
        }
        q.add(this);
    }

    @Override // com.tsf.shell.f.i._b.e.WidgetDrawerItemAction
    ...
    public com.tsf.shell.f.i._a.WidgetItemTouchHandler aH() {
        return new WidgetDrawerItemBase(this);
    }
    ...
    public static void h(float f) {
        if (f != p) {
            p = f;
            if (a != null) {
                r.e(WidgetDrawerItemEditAction);
                r.a(com.censivn.C3DEngine.b.g.a.e);
                com.censivn.C3DEngine.b.g.TweenUtils.a(WidgetDrawerItemBase);
    ...
    @Override // com.tsf.shell.f.i._b.e.WidgetDrawerItemAction, com.tsf.shell.f.i._b.e.WidgetDrawerShortcutItemBase, com.tsf.shell.f.i.ShortcutItem, com.tsf.shell.f.i.PageItem
    public void g() {
        if (q.contains(this)) {
            q.remove(this);
        }
