...
public class WidgetItemPositioner implements ItemStubHelper.a {
    public static i N;
    public static i O;
    ...
    private static com.censivn.C3DEngine.b.f._a.AltTextureSpriteRenderable Z;
    ...
    public WidgetItemPositioner() {
        com.tsf.shell.manager.app.ObserverManager.a(this);
        this.X = new com.tsf.shell.preference.a.a.PreferenceItemF() { // from class: com.tsf.shell.f.i._b.d.WidgetItemPositioner.1
    ...
    private void m() {
        this.T = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.i._b.d.WidgetItemPositioner.2
    ...
    private void n() {
        N = new ScrollingIndicator(1.0f, com.censivn.C3DEngine.b.b.ScreenConstants.b * 11.0f, true, c());
        N.visible(false);
        N.alpha(0.0f);
        O = new ScrollingIndicator(1.0f, com.censivn.C3DEngine.b.b.ScreenConstants.b * 11.0f, false, c());
        O.visible(false);
        O.alpha(0.0f);
    }
    ...
    public void k() {
        ...
        if (this.E == null) {
            ...
            this.W = new WidgetItemBackground();
            this.W.a(this.F);
            ...
            this.I = new WidgetItemIndicator(com.censivn.C3DEngine.b.b.ScreenConstants.b * 12.0f, this.n);
            ...
            this.J.setMouseEventListener(new com.censivn.C3DEngine.b.d.MouseEventListener(this.J) { // from class: com.tsf.shell.f.i._b.d.WidgetItemPositioner.3
    ...
    private void b(boolean z) {
        ...
        Z = new com.censivn.C3DEngine.b.f._a.AltTextureSpriteRenderable(i2 + c().folder.sampleCount, 0, 0);
        Z.useVBO(false);
        if (c().folder.backPlaneEnable) {
            com.censivn.C3DEngine.b.f._a.AltSpriteItemData bVarA = Z.a(0);
        ...
        if (c().folder.frontPlaneEnable) {
            com.censivn.C3DEngine.b.f._a.AltSpriteItemData bVarA2 = Z.a(ScrollingIndicator);
        ...
        if (c().folder.sizePlaneEnable) {
            com.censivn.C3DEngine.b.f._a.AltSpriteItemData bVarA3 = Z.a(ScrollingIndicator);
        ...
        for (int i3 = 0; i3 < c().folder.sampleCount; i3++) {
            ...
            com.censivn.C3DEngine.b.f._a.AltSpriteItemData bVarA4 = Z.a(ScrollingIndicator);
            bVarA4.b(WidgetItemBackground);
            bVarA4.d(f2);
        ...
        Z.maxX();
        Z.maxY();
        com.censivn.C3DEngine.b.f._a.AltSpriteItemData bVarA5 = Z.a(ScrollingIndicator);
    ...
    private void o() {
        ...
        int[] iArrA = x.a(i4 - ((int) (80.0f * com.censivn.C3DEngine.b.b.ScreenConstants.b)), i6 - ((int) (fA + (180.0f * com.censivn.C3DEngine.b.b.ScreenConstants.b))), i, i2, 0, 0);
        this.a = iArrA[0];
        this.b = iArrA[1];
    ...
    private void p() {
        this.M = new com.censivn.C3DEngine.b.d.MouseEventListener(this.H) { // from class: com.tsf.shell.f.i._b.d.WidgetItemPositioner.4
            @Override // com.censivn.C3DEngine.b.d.MouseEventListener
    ...
    public void a(final b bVar) {
        com.censivn.C3DEngine.C3DEngine.a().a(new Runnable() { // from class: com.tsf.shell.f.i._b.d.WidgetItemPositioner.5
            ...
            public void run() {
                ...
                builder.setNegativeButton(contextD.getString(WorkspaceShortcutItem.i.public_action_cancel), new DialogInterface.OnClickListener() { // from class: com.tsf.shell.f.i._b.d.WidgetItemPositioner.5.2
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i) {
                    }
                });
    ...
    public void a(boolean z) {
        this.W.c();
        if (z) {
            com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.i._b.d.WidgetItemPositioner.6
                @Override // com.censivn.C3DEngine.b.g.TweenParams
                public void a() {
