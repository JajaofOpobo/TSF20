...
public class k {
    ...
    private com.censivn.C3DEngine.b.f.j f = new com.censivn.C3DEngine.b.f.j() { // from class: com.tsf.shell.f.i._b.d.k.1
        @Override // com.censivn.C3DEngine.b.f.i
        public void onDrawEnd() {
            k.this.i();
        }
    };
    private com.tsf.shell.f.b.a q = new com.tsf.shell.f.b.a() { // from class: com.tsf.shell.f.i._b.d.k.2
    ...
    public void g() {
        ...
        com.censivn.C3DEngine.b.f.j jVarA = com.tsf.shell.manager.a.j.a(this.q);
    ...
    public void a(final boolean z) {
        ...
        this.c.a(new Runnable() { // from class: com.tsf.shell.f.i._b.d.k.3
            ...
            public void run() {
                com.tsf.shell.manager.a.j.b(new Runnable() { // from class: com.tsf.shell.f.i._b.d.k.3.1
                    @Override // java.lang.Runnable
                    public void run() {
                        if (!k.this.s) {
    ...
    public void a(MotionEvent motionEvent, final MotionEvent motionEvent2) {
        if (this.p) {
            this.a = false;
            this.p = false;
            com.censivn.C3DEngine.a.a().b(new Runnable() { // from class: com.tsf.shell.f.i._b.d.k.4
                @Override // java.lang.Runnable
                public void run() {
                    k.this.g();
                    k.this.n = false;
