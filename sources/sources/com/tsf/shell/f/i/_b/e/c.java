...
public class c extends d {
    ...
    public c(LauncherShortcut3DInfo launcherShortcut3DInfo, com.tsf.shell.manager.o.ButtonMetrics aVar, boolean z, int i) {
        ...
        if (a == null) {
            a = new k(i2, i2, false) { // from class: com.tsf.shell.f.i._b.e.c.1
    ...
    @Override // com.tsf.shell.f.i._b.e.d
    ...
    public com.censivn.C3DEngine.b.f._a.a aF() {
        com.censivn.C3DEngine.b.f._a.a aVar = new com.censivn.C3DEngine.b.f._a.a(2, 0, aE().V, aE().W) { // from class: com.tsf.shell.f.i._b.e.c.3
