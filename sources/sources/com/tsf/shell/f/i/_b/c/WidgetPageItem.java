    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i2 == -1) {
            if (i == this.s) {
                ...
                floatingItem.a();
                this.b = floatingItem;
                com.censivn.C3DEngine.A.a().a(new RenderRunnable(i3, i4) { // from class: com.tsf.shell.f.i._b.c.WidgetPageItem.1
        ...
        com.censivn.C3DEngine.A.a().a(new RenderRunnable(i3, i4) { // from class: com.tsf.shell.f.i._b.c.WidgetPageItem.2
            @Override // com.censivn.C3DEngine.api.message.RenderRunnable, java.lang.Runnable
            public void run() {
                com.tsf.shell.manager.app.WidgetManager.a(a.this);
            }
