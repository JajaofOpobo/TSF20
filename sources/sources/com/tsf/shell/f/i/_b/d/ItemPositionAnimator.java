...
public class ItemPositionAnimator {
    ...
    private com.censivn.C3DEngine.b.f.j f = new com.censivn.C3DEngine.b.f.j() { // from class: com.tsf.shell.f.i._b.d.ItemPositionAnimator.1
    ...
    public void a(MotionEvent motionEvent, final MotionEvent motionEvent2) {
        if (this.p) {
            this.a = false;
            this.p = false;
            com.censivn.C3DEngine.A.a().b(new Runnable() { // from class: com.tsf.shell.f.i._b.d.ItemPositionAnimator.4
                @Override // java.lang.Runnable
                public void run() {
                    k.this.g();
                    k.this.n = false;
