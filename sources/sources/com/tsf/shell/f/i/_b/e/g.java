...
public class g extends a {
    ...
    public g(LauncherShortcutAppInfo launcherShortcutAppInfo, com.tsf.shell.manager.o.ButtonMetrics aVar, com.tsf.shell.manager.app.LauncherAppInfo fVar, boolean z) {
        ...
        if (z) {
            ...
            com.censivn.C3DEngine.A.a().c(new Runnable() { // from class: com.tsf.shell.f.i._b.e.g.1
    ...
    @Override // com.tsf.shell.f.i._b.e.b, com.tsf.shell.f.i.ShortcutItem, com.censivn.C3DEngine.b.f.j
    ...
    public void aX() {
        if (!this.b) {
            this.b = true;
            com.tsf.shell.manager.app.v.StateAccessor.a((b) this);
        }
    }
