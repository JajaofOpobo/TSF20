...
public class a extends com.censivn.C3DEngine.b.d.a {
    ...
    public void c(MotionEvent motionEvent) {
        ...
        if (this.a.aV() == b.a) {
            ...
            if (com.tsf.shell.manager.app.A.a() && bVar.aC()) {
                ...
                if (this.a.aC()) {
                    if (!bVar.as()) {
                        com.tsf.shell.manager.app.h.t().a((com.tsf.shell.f.i.B) bVar, false, l[0], l[1]);
                        return;
                    }
                    return;
                }
                com.tsf.shell.manager.app.p.a(bVar, l[0], l[1], true, 0);
            }
        }
    }
