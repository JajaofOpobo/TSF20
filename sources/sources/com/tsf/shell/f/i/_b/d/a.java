...
public class a extends com.censivn.C3DEngine.b.d.a {
    ...
    public boolean a() {
        ...
        if (this.f) {
            ((com.tsf.shell.f.i._b.e.b) this.c).ah();
            this.b.c(null);
    ...
    public void c(MotionEvent motionEvent) {
        ...
        if (this.a.aV() == WorkspaceShortcutItem.a) {
            com.tsf.shell.f.i._b.e.b bVar = (com.tsf.shell.f.i._b.e.b) this.c;
            if (com.tsf.shell.manager.app.FeatureConfig.a() && bVar.aC()) {
                ...
                if (bVar.A().e()) {
                    ...
                    for (int i = 0; i < size; i++) {
                        com.tsf.shell.f.i._b.e.b bVar2 = (com.tsf.shell.f.i._b.e.b) arrayListI.get(ScrollingIndicator);
                        if (bVar2 != bVar) {
                            bVar2.g(1.0f);
                ...
                this.a.aF().a((com.tsf.shell.f.i._b.e.b) this.c);
    ...
    */
    public void d(android.view.MotionEvent r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.f.i._b.d.a.d(android.view.MotionEvent):void");
    }
    ...
    public void a(MotionEvent motionEvent, MotionEvent motionEvent2) {
        ...
        if (this.f) {
            ...
            if (this.q == null) {
                this.q = new Runnable() { // from class: com.tsf.shell.f.i._b.d.a.2
                    ...
                    public void run() {
                        ...
                        if (!a.this.d) {
                            ...
                            if (iB == -2) {
                                a.this.d = true;
                                a.this.a.aF().c(false);
                                a.this.a.a((com.tsf.shell.f.i._b.e.b) a.this.c);
                                return;
                            }
                            if (a.this.m != iB) {
                                switch (iB) {
    ...
    public void e(MotionEvent motionEvent) {
        if (this.c.parent() instanceof g) {
            ...
            ((com.tsf.shell.f.i._b.e.b) this.c).a(Number3d.TEMPNUMBER3D2, Number3d.TEMPNUMBER3D3);
        }
    }
    ...
    public void a(MotionEvent motionEvent) {
        ...
        ((com.tsf.shell.f.i._b.e.b) this.c).l();
    }
