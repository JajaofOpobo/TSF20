...
public class WidgetTouchHandler extends com.censivn.C3DEngine.b.d.MouseEventListener {
    ...
    public WidgetTouchHandler(com.censivn.C3DEngine.b.f.IRenderable iVar, b bVar) {
        ...
        this.e = new com.tsf.shell.manager.d.HitTargetManager.C0127a() { // from class: com.tsf.shell.f.i._b.d.WidgetTouchHandler.1
            ...
            public boolean a(com.tsf.shell.f.e.SelectionFrameLayoutItem fVar) {
                return fVar instanceof WidgetItemState.b;
            }
        };
    }
    ...
    public boolean a() {
        ...
        if (this.f) {
            ((com.tsf.shell.f.i._b.e.WidgetDrawerShortcutItemBase) this.c).ah();
            this.b.c(null);
    ...
    public void c(MotionEvent motionEvent) {
        ...
        if (this.a.aV() == WorkspaceShortcutItem.a) {
            com.tsf.shell.f.i._b.e.WidgetDrawerShortcutItemBase bVar = (com.tsf.shell.f.i._b.e.WidgetDrawerShortcutItemBase) this.c;
            if (com.tsf.shell.manager.app.FeatureConfig.a() && bVar.aC()) {
                this.m = this.a.aF().a(this.c);
                this.a.aO();
                this.a.aF().c(true);
                if (bVar.A().e()) {
                    ArrayList<com.tsf.shell.f.i.ShortcutItem> arrayListI = bVar.A().i();
                    bVar.rotation().z = 0.0f;
                    int size = arrayListI.size();
                    for (int i = 0; i < size; i++) {
                        com.tsf.shell.f.i._b.e.WidgetDrawerShortcutItemBase bVar2 = (com.tsf.shell.f.i._b.e.WidgetDrawerShortcutItemBase) arrayListI.get(ScrollingIndicator);
                        if (bVar2 != bVar) {
                            bVar2.g(1.0f);
                ...
                this.a.aF().a((com.tsf.shell.f.i._b.e.WidgetDrawerShortcutItemBase) this.c);
                ...
                if (this.a.aC()) {
                    if (!bVar.as()) {
                        com.tsf.shell.manager.app.StateHub.t().a((com.tsf.shell.f.i.PageItem) bVar, false, l[0], l[1]);
                        return;
                    }
                    return;
                }
                com.tsf.shell.manager.app.WidgetAnimator.a(bVar, l[0], l[1], true, 0);
            }
        }
    }
    ...
    */
    public void d(android.view.MotionEvent r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.f.i._b.d.WidgetTouchHandler.d(android.view.MotionEvent):void");
    }
        ...
        if (this.f) {
            if (!this.k) {
                if (x.b(motionEvent.getX(), motionEvent.getY(), motionEvent2.getX(), motionEvent2.getY()) > 15.0f) {
                    this.k = true;
                    if (this.c instanceof com.tsf.shell.f.i.PageItem) {
                        ((com.tsf.shell.f.i.PageItem) this.c).ab();
                        return;
                    }
                    return;
                }
            ...
            if (this.q == null) {
                this.q = new Runnable() { // from class: com.tsf.shell.f.i._b.d.WidgetTouchHandler.2
                    ...
                    public void run() {
                        ...
                        if (!a.this.d) {
                            ...
                            if (iB == -2) {
                                a.this.d = true;
                                a.this.a.aF().c(false);
                                a.this.a.a((com.tsf.shell.f.i._b.e.WidgetDrawerShortcutItemBase) a.this.c);
                                return;
                            }
                            if (a.this.m != iB) {
                                switch (iB) {
                                    case -4:
                                        a.this.a.aF();
                                        WidgetItemGrid.a(false);
                                        a.this.a.aF();
                                        WidgetItemGrid.b(true);
                                        return;
                                    case -3:
                                        a.this.a.aF();
                                        WidgetItemGrid.a(true);
                                        a.this.a.aF();
                                        WidgetItemGrid.b(false);
                                        return;
                                    case -2:
                                    default:
                                        a.this.a.aF();
            ...
            if (!this.p) {
                this.p = true;
                com.censivn.C3DEngine.C3DEngine.a().b(this.q);
            }
        }
    }
    ...
    public void e(MotionEvent motionEvent) {
        if (this.c.parent() instanceof g) {
            g gVar = (WidgetItemGrid) this.c.parent();
            Number3d.TEMPNUMBER3D2.reset();
            ...
            ((com.tsf.shell.f.i._b.e.WidgetDrawerShortcutItemBase) this.c).a(Number3d.TEMPNUMBER3D2, Number3d.TEMPNUMBER3D3);
        }
    }
    ...
    public void a(MotionEvent motionEvent) {
        ...
        ((com.tsf.shell.f.i._b.e.WidgetDrawerShortcutItemBase) this.c).l();
    }
