...
public class b extends com.tsf.shell.f.i.C implements com.tsf.shell.f.e._a.a, com.tsf.shell.f.e._h.a, m, com.tsf.shell.f.i._a.InterfaceC0113a {
        ...
        if (!this.z && !this.ab && !l.d()) {
            ...
            Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.i._b.d.b.4
                ...
                public void run() {
                    ...
                    com.tsf.shell.manager.a.j.a(new Runnable() { // from class: com.tsf.shell.f.i._b.d.b.4.1
                        @Override // java.lang.Runnable
                        public void run() {
