...
import com.tsf.shell.f.i._b.d.g;
...
public class b extends com.tsf.shell.f.i.C implements com.tsf.shell.f.e._a.a, m, com.tsf.shell.f.i._a.InterfaceC0113a {
    ...
    public static c n;
    boolean A;
    private com.tsf.shell.f.i._b.e.b H;
    private int I;
    private e J;
    private int K;
    private Number3d L;
    private Number3d M;
    private com.tsf.shell.f.i._b.e.b N;
    ...
    private boolean Y;
    private boolean Z;
    private com.tsf.shell.f.i._b.e.b aa;
    private boolean ab;
    private Number3d ac;
    private ArrayList<com.tsf.shell.f.i._b.e.b> ad;
    private boolean ae;
    private boolean af;
    private boolean ag;
    protected g o;
    ...
    public static b a(int i, int i2, int i3) {
        ...
        com.tsf.shell.manager._a.i.d(bVar);
        return bVar;
    }
    ...
    public b az() {
        ...
        for (com.censivn.C3DEngine.b.f.i iVar : this.o.children()) {
            if (iVar instanceof com.tsf.shell.f.i._b.e.g) {
                LauncherShortcutAppInfo launcherShortcutAppInfoBb = ((com.tsf.shell.f.i._b.e.g) iVar).bb();
    ...
    public void a(com.tsf.shell.f.i._b.e.b bVar, final com.tsf.shell.f.i._b.e.b bVar2, com.censivn.C3DEngine.b.f.i iVar) {
        if (this.H == null) {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._b.d.b.1
    ...
    public void a(com.censivn.C3DEngine.b.f.i iVar, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._b.d.b.12
            @Override // com.censivn.C3DEngine.b.g.d
    ...
    public void a(com.tsf.shell.f.i._b.e.b bVar, com.tsf.shell.f.i._b.e.b bVar2, boolean z) {
        ...
        com.tsf.shell.f.i._b.e.b bVar3 = (com.tsf.shell.f.i._b.e.b) this.o.getChildAt(0);
    ...
    public b(ItemInfo itemInfo) {
        ...
        this.O = new com.censivn.C3DEngine.b.d.a(this.p) { // from class: com.tsf.shell.f.i._b.d.b.15
        ...
        this.P = new com.censivn.C3DEngine.b.d.a(this.p) { // from class: com.tsf.shell.f.i._b.d.b.16
            @Override // com.censivn.C3DEngine.b.d.a
            public void a(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
        ...
        this.Q = new com.censivn.C3DEngine.b.d.a(this.p) { // from class: com.tsf.shell.f.i._b.d.b.17
            @Override // com.censivn.C3DEngine.b.d.a
            public void a(MotionEvent motionEvent) {
                w.b();
                if (b.this.K == b.b) {
        ...
        this.W = new com.tsf.shell.f.i.A(this, this) { // from class: com.tsf.shell.f.i._b.d.b.18
            ...
            */
            public boolean a(com.tsf.shell.f.i._b.e.b r5) {
                /*
                    r4 = this;
                    r3 = 1
                    r2 = 0
                    com.tsf.shell.f.i._b.d.b r0 = com.tsf.shell.f.i._b.d.b.this
                    int r0 = r0.aU()
                    r1 = 2
                    if (r0 != r1) goto L30
                    com.tsf.shell.f.i._b.d.b r0 = com.tsf.shell.f.i._b.d.b.this
                    com.tsf.shell.f.i._b.d.k r0 = com.tsf.shell.f.i._b.d.b.d(r0)
                    r0.e()
                    com.tsf.shell.f.i._b.d.b r0 = com.tsf.shell.f.i._b.d.b.this
                    com.tsf.shell.f.i._b.d.k r0 = com.tsf.shell.f.i._b.d.b.d(r0)
                    boolean r0 = r0.c()
                ...
                L30:
                    ...
                    goto L2f
                */
                throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.f.i._b.d.b.AnonymousClass18.a(com.tsf.shell.f.i._b.e.b):boolean");
            }
            ...
            public void c(com.tsf.shell.f.i.B bVar) {
                super.c(bVar);
                if (b.this.K == b.a) {
                    b.this.b((com.tsf.shell.f.i._b.e.b) bVar);
                    return;
                }
                int iA = b.this.o.a(bVar);
                b.this.o.removeChild(bVar);
                b.this.a((com.tsf.shell.f.i._b.e.b) bVar, false);
                if (iA < b.l.K) {
                    b.this.aB();
                    b.m.a(b.this);
                    b.m.c(b.this);
        ...
        this.S = new com.tsf.shell.f.b.a() { // from class: com.tsf.shell.f.i._b.d.b.19
    ...
    public void b(int i) {
        Collections.sort(this.o.children(), com.tsf.shell.manager._a.w.b().a(i).b());
        this.o.k();
        this.o.o();
        aJ();
    }
    ...
    public void aB() {
        ...
        for (int i = 0; i < iAW; i++) {
            com.tsf.shell.f.i._b.e.b bVar = (com.tsf.shell.f.i._b.e.b) this.o.children().get((aW() - i) - 1);
            a(bVar, l.L.get(i));
            bVar.visible(true);
            bVar.alpha(255.0f);
        }
    ...
    private void a(ItemInfo itemInfo, boolean z) {
        com.tsf.shell.f.i._b.e.b bVarA = (com.tsf.shell.f.i._b.e.b) itemInfo.getWidget();
        if (bVarA == null) {
    ...
    public ComponentName[] aI() {
        ...
        for (int i = 0; i < size; i++) {
            componentNameArr[i] = ((com.tsf.shell.f.i._b.e.g) this.o.children().get(i)).bd().b;
        }
    ...
    public void aJ() {
        if (!this.af) {
            ...
            String str = "";
            for (int i = 0; i < size; i++) {
                str = str + ((com.tsf.shell.f.i._b.e.b) this.o.children().get(i)).K().id + ",";
            }
            if (this.ae) {
                launcherFolder3DInfo.config = str;
                com.tsf.shell.manager._a.w.c().a(launcherFolder3DInfo, 16);
            } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void c(com.tsf.shell.f.i._b.e.b bVar) {
        if (this.ae) {
            if (!this.af) {
                if (K().id == -1) {
                    com.tsf.shell.manager._a.w.c().a(K(), 0);
                }
                bVar.K().container = K().id;
                com.tsf.shell.manager._a.w.c().a(bVar.K(), 132);
            }
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void a(com.tsf.shell.f.i._b.e.b bVar, boolean z) {
    ...
    public void a(final String str) {
        ...
        if (str != "") {
            if (this.ae) {
                ...
                com.tsf.shell.manager._a.w.c().a(launcherFolder3DInfo, 1);
            } else {
    ...
    public void aR() {
        ...
        if (K().container != -1 || (K() instanceof LauncherDrawerFolder3DInfo)) {
            ...
            if (aC()) {
                this.ag = com.tsf.shell.manager._a.b.a();
                com.tsf.shell.manager._a.b.b(Home.b());
            }
        }
        this.T = com.tsf.shell.manager._a.j.a(this.S);
    ...
    public void m(final boolean z) {
        if (!this.z && !this.ab && !l.d()) {
            ...
            this.W.g();
            l.a(z);
            Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.i._b.d.b.4
                @Override // java.lang.Runnable
                public void run() {
                    com.censivn.C3DEngine.b.g.d dVar;
                    j jVar = b.l;
                    ...
                    if (b.this.aa != null) {
                        if (b.this.aa.parent() instanceof com.tsf.shell.f.c.b.A) {
                            com.tsf.shell.f.c.b.b bVarA = com.tsf.shell.manager._a.g.a.a(b.this.aa);
                            b.this.L.x = bVarA.a;
                            b.this.L.y = bVarA.b;
                            b.this.M.z = bVarA.e;
                        } else {
                    ...
                    com.tsf.shell.manager._a.j.a(new Runnable() { // from class: com.tsf.shell.f.i._b.d.b.4.1
                        @Override // java.lang.Runnable
                        public void run() {
                            ...
                            if (b.this.aa != null) {
                                ...
                                com.tsf.shell.manager._a.h.n().a(b.this);
                            }
                            if (b.this.N != null) {
    ...
    protected void a(com.tsf.shell.f.i._b.e.b bVar) {
        if (this.ae) {
            com.tsf.shell.manager._a.w.d().c();
        }
        this.o.n();
        this.N = bVar;
    ...
    public void aY() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            com.tsf.shell.f.i._b.e.b bVar = (com.tsf.shell.f.i._b.e.b) this.o.children().get((size - i2) - 1);
            if (i2 < i) {
    ...
    public void a(boolean z, final Runnable runnable, boolean z2) {
        ...
        if (iAW > 0) {
            ...
            com.tsf.shell.f.i._b.e.b bVar = null;
            int i8 = iAW - 1;
            while (i8 > -1) {
                final com.tsf.shell.f.i._b.e.b bVar2 = (com.tsf.shell.f.i._b.e.b) this.o.children().get((iAW - i8) - 1);
                ...
                if (i8 < i7) {
                    ...
                    bVar2.alpha(255.0f);
                    dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._b.d.b.5
                        @Override // com.censivn.C3DEngine.b.g.d
                        public void a(float f) {
                            if (bVar2.aJ() != 0.0f) {
                                bVar2.g(1.0f - f);
                    ...
                    if (bVar2.visible()) {
                        dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._b.d.b.6
                            @Override // com.censivn.C3DEngine.b.g.d
                            public void a() {
                                bVar2.visible(false);
                            }
                ...
                if (dVar != null) {
                    ...
                    if (i8 == 0) {
                        if (i3 == 0) {
                            ...
                            runnable2 = new Runnable() { // from class: com.tsf.shell.f.i._b.d.b.8
                                @Override // java.lang.Runnable
                                public void run() {
                                    b.this.a(runnable);
                                }
    ...
    public void bj() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            com.tsf.shell.f.i._b.e.b bVar = (com.tsf.shell.f.i._b.e.b) this.o.children().get((i - 1) - i2);
        ...
        while (true) {
            final int i4 = i3;
            if (i4 > i - 1) {
                final com.tsf.shell.f.i._b.e.b bVar2 = (com.tsf.shell.f.i._b.e.b) this.o.children().get(i4);
                bVar2.alpha(255.0f);
                Number3d number3dD = d((iAW - i4) - 1);
                com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._b.d.b.9
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a(float f) {
                        bVar2.visible(true);
                        bVar2.g(f);
    ...
    public void c(ArrayList<com.tsf.shell.f.i._b.e.b> arrayList) {
        a(arrayList, false);
    }

    public void a(ArrayList<com.tsf.shell.f.i._b.e.b> arrayList, boolean z) {
        this.ad = arrayList;
        p(z);
    }
    ...
    public void p(boolean z) {
        ...
        if (this.ad != null) {
            ...
            for (int i = 0; i < size; i++) {
                final com.tsf.shell.f.i._b.e.b bVar = this.ad.get(i);
                bVar.clearDefaultColor();
                bVar.position().setAllFrom(globalToLocal(bVar.position()));
                bVar.removeFromParent();
                this.o.addChild(bVar);
                if (i == size - 1) {
                    dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._b.d.b.10
                        @Override // com.censivn.C3DEngine.b.g.d
                        public void a() {
                            Iterator it = b.this.ad.iterator();
                            while (it.hasNext()) {
                                b.this.c((com.tsf.shell.f.i._b.e.b) it.next());
                            }
                            b.this.n(true);
                            b.this.a(false, (Runnable) null, true);
                            b.this.aJ();
                    ...
                    dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._b.d.b.11
                        @Override // com.censivn.C3DEngine.b.g.d
                        public void a(float f) {
                            bVar.g(1.0f - f);
                        }
    ...
    @Override // com.tsf.shell.f.e._a.a
    public void e() {
        this.z = true;
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._b.d.b.13
            @Override // com.censivn.C3DEngine.b.g.d
            public void a(float f) {
    ...
    @Override // com.tsf.shell.f.e._a.a
    public void i() {
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._b.d.b.14
            @Override // com.censivn.C3DEngine.b.g.d
            public void a(float f) {
                float fAlpha = b.this.p.alpha();
                if (b.this.q != null) {
    ...
    @Override // com.tsf.shell.f.e._a.a
    public void a(com.censivn.C3DEngine.b.f.i iVar, com.tsf.shell.f.i._b.e.g gVar) {
        com.tsf.shell.f.i._b.e.g gVarBa = gVar.ba();
        ...
        aVarA.c = 0.0f;
        aVarA.e = 1.0f;
        c((com.tsf.shell.f.i._b.e.b) gVarBa);
    ...
    public void a(com.tsf.shell.f.e.F fVar) {
        super.a(fVar);
        if (fVar instanceof com.tsf.shell.f.i._b.e.b) {
    ...
    public boolean b(com.tsf.shell.f.e.F fVar) {
        return fVar instanceof com.tsf.shell.f.i._b.e.b;
    }
    ...
    public void e(com.tsf.shell.f.e.F fVar) {
        super.c(fVar);
        this.J.b((com.censivn.C3DEngine.b.f.i) fVar);
        com.tsf.shell.f.i._b.e.b bVar = (com.tsf.shell.f.i._b.e.b) fVar;
        ...
        if (bVar.as()) {
            ...
            for (int i = 0; i < size; i++) {
                arrayList.add((com.tsf.shell.f.i._b.e.b) arrayListAw.get((size - i) - 1));
            }
        }
        arrayList.add(bVar);
        bi();
