...
public class b extends com.tsf.shell.f.i.C implements com.tsf.shell.f.e._a.a, m, com.tsf.shell.f.i._a.InterfaceC0113a {
    ...
    public void b(int i) {
        Collections.sort(this.o.children(), com.tsf.shell.manager.app.ServiceProvider.b().a(i).b());
        this.o.k();
        this.o.o();
        aJ();
    }
                ...
                public void run() {
                    ...
                    if (b.this.aa != null) {
                        if (b.this.aa.parent() instanceof com.tsf.shell.f.c.b.A) {
                            com.tsf.shell.f.c.b.b bVarA = com.tsf.shell.manager.app.WidgetPanelController.a.a(b.this.aa);
                            b.this.L.x = bVarA.a;
                            b.this.L.y = bVarA.b;
                            b.this.M.z = bVarA.e;
                        } else {
                    ...
                    com.tsf.shell.manager.app.TaskScheduler.a(new Runnable() { // from class: com.tsf.shell.f.i._b.d.b.4.1
                        @Override // java.lang.Runnable
                        public void run() {
