...
public class j extends b {
    ...
    public j(com.tsf.shell.manager.action.toggle.B bVar) {
        ...
        this.b = new k(this.n.H, this.n.I, false) { // from class: com.tsf.shell.f.i._b.e.j.1
    ...
    @Override // com.tsf.shell.f.i._b.e.b, com.censivn.C3DEngine.b.f.i
    public void onDrawStart() {
        if (this.r != this.q) {
            this.r = this.q;
            switch (this.q) {
                case 0:
                    ...
                    this.b.textures().addElement(com.tsf.shell.manager.app.d.c.b());
                    break;
                case 1:
                    this.b.textures().clear();
                    this.b.textures().addElement(com.tsf.shell.manager.app.d.c.c());
