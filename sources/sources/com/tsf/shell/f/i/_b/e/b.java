...
public abstract class b extends com.tsf.shell.f.i.C implements m {
    ...
    public com.tsf.shell.f.i._a.c aH() {
        return new com.tsf.shell.f.i._a.d(this);
    }
    ...
    public void b(Number3d number3d, Number3d number3d2) {
        if (this.b) {
            this.s = com.tsf.shell.manager._a.v.b.a(this, number3d, number3d2);
        }
    }

    public void aP() {
        if (this.b) {
            this.s = com.tsf.shell.manager._a.v.b.a(this);
        }
    }

    public void b(com.tsf.shell.f._d.a.A aVar) {
        if (this.b) {
            com.tsf.shell.manager._a.v.b.a(this, aVar);
        }
    }
    ...
    public void b(com.censivn.C3DEngine.b.f.i iVar) {
        if (this.u != null) {
            this.u.a.a(iVar, new Runnable() { // from class: com.tsf.shell.f.i._b.e.b.1
