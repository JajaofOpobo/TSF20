...
public class TextureElementC extends VObject3dContainer {
    ...
    public TextureElementC(int i) {
        ...
        for (int i3 = 0; i3 < (this.s + 2) * 2; i3++) {
            this.j.a(new DeferredItemGroup());
        }
    ...
    public synchronized void e() {
        ...
        position().setAll(0.0f, 47.0f * PendingItemGroup.j, 0.0f);
        alpha(255);
        this.p.position(0);
        this.l.position(0);
        this.o.position(0);
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.i.c.a.a.TextureElementC$c, reason: collision with other inner class name */
    private class C0117c {
        ...
        public void a(double d) {
            double dCos = Math.cos(PendingItemGroup);
            double dSin = Math.sin(PendingItemGroup);
