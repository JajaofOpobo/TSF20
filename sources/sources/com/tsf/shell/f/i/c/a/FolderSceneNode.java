...
public class FolderSceneNode extends AsyncTextureNode {
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredItemGroup.d.widget_preview_adornment_texture_default, this.c);
            a(DeferredItemGroup.d.widget_preview_adornment_texture_thumbtack_hd, this.d);
            c(z);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredItemGroup.d.widget_preview_adornment_texture_default) {
            this.a = textureElement;
        } else if (i == DeferredItemGroup.d.widget_preview_adornment_texture_thumbtack_hd) {
