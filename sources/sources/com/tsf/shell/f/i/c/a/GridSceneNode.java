...
public class GridSceneNode extends AsyncTextureNode {
    ...
    public void k() {
        final VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.GridSceneNode.1
            boolean a = false;

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                if (f > 0.5f && !this.a) {
                    ItemGroupBase.this.b(false);
                }
            }

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                ItemGroupBase.this.r.visible(true);
                ItemGroupBase.this.n.visible(false);
                ItemGroupBase.this.l();
            }
        };
        vTweenParam.setRotationX(0.0f);
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.GridSceneNode.2
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                VTween.to(ItemGroupBase.this.o, 500, vTweenParam);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void l() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.GridSceneNode.3
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                ItemGroupBase.this.e();
                ItemGroupBase.this.a();
            }
        ...
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.GridSceneNode.4
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                ItemGroupBase.this.v.setAngle((float) (((double) f) * 0.5d));
                ItemGroupBase.this.w.apply();
                ItemGroupBase.this.t.updatePointsVBO();
                ItemGroupBase.this.e();
            }

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                ItemGroupBase.this.o();
            }
        };
    ...
    private void m() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.GridSceneNode.5
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                ItemGroupBase.this.r.visible(false);
                ItemGroupBase.this.n.visible(true);
                ItemGroupBase.this.e();
                ItemGroupBase.this.n();
            }
        ...
        VTween.to(this.t, 800, vTweenParam);
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.GridSceneNode.6
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                ItemGroupBase.this.v.setAngle((float) (((double) f) * 0.5d));
                ItemGroupBase.this.w.apply();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void n() {
        final VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.GridSceneNode.7
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.GridSceneNode.7.1
                    @Override // com.censivn.C3DEngine.api.tween.VTweenParam
                    public void onComplete() {
                        ItemGroupBase.this.k();
                    }
                };
                vTweenParam2.setTimeout(1000);
                VTween.to(ItemGroupBase.this, 1, vTweenParam2);
            }
        };
        vTweenParam.setSPY(130.0f);
        vTweenParam.setEase(300);
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.GridSceneNode.8
            boolean a = false;

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                if (f > 0.5f && !this.a) {
                    ItemGroupBase.this.b(true);
                }
            }

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                VTween.to(ItemGroupBase.this.q, 1500, vTweenParam);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void o() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.GridSceneNode.9
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
            }
            ...
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                ItemGroupBase.this.v.setAngle((1.0f - f) * 0.5f);
                ItemGroupBase.this.w.apply();
                ItemGroupBase.this.t.updatePointsVBO();
                ItemGroupBase.this.e();
            }
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredItemGroup.d.widget_preview_message_back_inside, this.p);
            a(DeferredItemGroup.d.widget_preview_message_content, this.q);
            a(DeferredItemGroup.d.widget_preview_message_back_no_flap, this.u);
            a(DeferredItemGroup.d.widget_preview_message_back_flag_back, this.o);
            a(DeferredItemGroup.d.widget_preview_message_back, this.t);
            a(DeferredItemGroup.d.widget_preview_message_front, this.s);
            c(z);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredItemGroup.d.widget_preview_message_back_inside) {
            this.f = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_message_content) {
            this.d = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_message_back_no_flap) {
            this.c = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_message_back_flag_back) {
            this.e = textureElement;
        } else if (i == DeferredItemGroup.d.widget_preview_message_back) {
            this.b = textureElement;
        } else if (i == DeferredItemGroup.d.widget_preview_message_front) {
