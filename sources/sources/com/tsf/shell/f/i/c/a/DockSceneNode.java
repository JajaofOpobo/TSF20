...
public class DockSceneNode extends AsyncTextureNode {
    ...
    public void h() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.b.1
            ...
            public void onComplete() {
                DeferredItemGroup.this.a();
            }

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                if (f > 0.5f && !this.b) {
                    DeferredItemGroup.this.b(false);
                    this.b = true;
                }
            }
        };
        ...
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.b.2
            ...
            public void onComplete() {
                VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.b.2.1
                    @Override // com.censivn.C3DEngine.api.tween.VTweenParam
                    public void onComplete() {
                        DeferredItemGroup.this.h();
                    }
                };
                vTweenParam2.setTimeout(1000);
                VTween.to(DeferredItemGroup.this, 1, vTweenParam2);
            }
    ...
    private void j() {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            item.position().spY((float) (Math.cos(Math.toRadians(AppPreviewLabel)) * 215.0d));
            item.position().spX(-((float) (Math.sin(Math.toRadians(AppPreviewLabel)) * 215.0d)));
            item.rotation().z = f;
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredItemGroup.d.widget_preview_alarm_frontbg, this.h);
            a(DeferredItemGroup.d.widget_preview_alarm_front_content, this.m);
            a(DeferredItemGroup.d.widget_preview_alarm_back_bg, this.t);
            a(DeferredItemGroup.d.widget_preview_alarm_small_circle, this.s);
            a(DeferredItemGroup.d.widget_preview_alarm_toggle, this.r);
            a(DeferredItemGroup.d.widget_preview_alarm_week, this.q);
            c(z);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredItemGroup.d.widget_preview_alarm_frontbg) {
            this.a = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_alarm_front_content) {
            this.b = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_alarm_back_bg) {
            this.c = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_alarm_small_circle) {
            this.d = textureElement;
        } else if (i == DeferredItemGroup.d.widget_preview_alarm_toggle) {
            this.e = textureElement;
        } else if (i == DeferredItemGroup.d.widget_preview_alarm_week) {
