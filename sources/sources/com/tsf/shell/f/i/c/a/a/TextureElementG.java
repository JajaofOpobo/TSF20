...
import com.tsf.b;
import com.tsf.shell.f.i.c.a.NodeConstants;
...
public class TextureElementG {
    public static Bitmap a(Context context, Date date) {
        Bitmap bitmapB = l.b(context, DeferredItemGroup.d.widget_preview_calendar_content);
        ...
        com.tsf.shell.f.i.c.a.NodeConfig.a("mFirstDay:" + firstDayOfWeek);
        if (firstDayOfWeek == 1) {
