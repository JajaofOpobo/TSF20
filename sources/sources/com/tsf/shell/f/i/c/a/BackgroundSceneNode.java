...
public class BackgroundSceneNode extends AsyncTextureNode {
    ...
    public void i() {
        ...
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.BackgroundSceneNode.2
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredItemGroup.d.widget_preview_music_p1, this.x.get(0));
            a(DeferredItemGroup.d.widget_preview_music_p2, this.x.get(1));
            a(DeferredItemGroup.d.widget_preview_music_p3, this.x.get(2));
            a(DeferredItemGroup.d.widget_preview_music_p4, this.x.get(3));
            a(DeferredItemGroup.d.widget_preview_music_p5, this.x.get(4));
            a(DeferredItemGroup.d.widget_preview_music_title, this.w);
            a(DeferredItemGroup.d.widget_preview_music_control, this.n, this.o, this.p, this.q, this.r, this.v);
            c(z);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredItemGroup.d.widget_preview_music_p1) {
            this.b = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_music_p2) {
            this.c = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_music_p3) {
            this.d = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_music_p4) {
            this.e = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_music_p5) {
            this.f = textureElement;
        } else if (i == DeferredItemGroup.d.widget_preview_music_title) {
            this.g = textureElement;
        } else if (i == DeferredItemGroup.d.widget_preview_music_control) {
