...
public class SceneRendererA extends BaseRenderable {
    ...
    private int e;
    private int f;
    private com.censivn.C3DEngine.b.f.sprite.TextureSpriteRenderable g;
    private d h;
    private d i;
    private int p;
    private com.censivn.C3DEngine.b.f.sprite.TextureSpriteRenderable v;
    ...
    public void a() {
        ...
        this.g = new com.censivn.C3DEngine.b.f.sprite.TextureSpriteRenderable(30, 40, 40, 40, null, false);
        this.g.textures().addElement(this.t);
        for (int i = 0; i < 30; i++) {
            com.censivn.C3DEngine.b.f.sprite.SpriteItemData bVarA = this.g.a(i);
        ...
        while (true) {
            ...
            com.censivn.C3DEngine.b.f.sprite.SpriteItemData bVarA2 = this.g.a(i3);
            int i4 = i3 + 3;
            if (i4 >= 30) {
                i4 %= 30;
            }
            this.m.add(new ItemStubHelper(bVarA2, this.g.a(i4)));
            i2 = i3 + 2;
        }
        this.g.calAABB();
        this.p = (int) a(this.g.a(0), this.g.a(3));
        int size = this.m.size();
        this.v = new com.censivn.C3DEngine.b.f.sprite.TextureSpriteRenderable(size, 1, this.p, 4, null, true);
        this.v.textures().addElement(this.q);
        for (int i5 = 0; i5 < size; i5++) {
            e eVar = this.m.get(i5);
            com.censivn.C3DEngine.b.f.sprite.SpriteItemData bVarA3 = this.v.a(i5);
            bVarA3.a(0.0f);
            bVarA3.b(0, 0, this.p, 4);
            eVar.a(bVarA3);
        }
        this.h = new PendingItemGroup(20.0f, 230.0f);
        this.h.textures().addElement(this.r);
        this.h.moveAllPointsPX(0.0f, 95.0f, 0.0f);
        this.i = new PendingItemGroup(24.0f, 170.0f);
    ...
    private void f() {
        ...
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.i.c.a.c.SceneRendererA.1
        ...
        com.censivn.C3DEngine.b.g.TweenParams dVar2 = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.i.c.a.c.SceneRendererA.2
            @Override // com.censivn.C3DEngine.b.g.TweenParams
