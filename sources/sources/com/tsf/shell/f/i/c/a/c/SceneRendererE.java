...
public class SceneRendererE {
    ...
    private float e;
    private float f;
    private com.censivn.C3DEngine.b.f.sprite.SpriteItemData g;
    private com.censivn.C3DEngine.b.f.sprite.SpriteItemData h;
    private com.censivn.C3DEngine.b.f.sprite.SpriteItemData i;
    private long j = -1;

    public SceneRendererE(com.censivn.C3DEngine.b.f.sprite.SpriteItemData bVar, com.censivn.C3DEngine.b.f.sprite.SpriteItemData bVar2) {
        this.a = 0.0f;
        this.b = 0.0f;
        this.c = 0.0f;
        this.d = 0.0f;
    ...
    public void a(com.censivn.C3DEngine.b.f.sprite.SpriteItemData bVar) {
        this.i = bVar;
        this.i.i().x = this.a;
        this.i.i().y = this.b;
    ...
    public void a(long j) {
        if (j >= this.j && this.j != -1) {
            ...
            if (Math.abs(AppPreviewLabel) < 0.01f) {
                float f2 = this.c;
                this.e = f2;
                this.d = f2;
                this.j = -1L;
