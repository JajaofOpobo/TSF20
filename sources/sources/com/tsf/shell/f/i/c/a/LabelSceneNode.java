...
public class LabelSceneNode extends j {
    ...
    private void i() {
        ...
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.LabelSceneNode.1
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                VTweenParam vTweenParam3 = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.LabelSceneNode.1.1
                    @Override // com.censivn.C3DEngine.api.tween.VTweenParam
                    public void onComplete() {
                        AppPreviewLabel.this.j();
                    }
                };
                vTweenParam3.setTimeout(1000);
                VTween.killTween(AppPreviewLabel.this.g);
                VTween.to(AppPreviewLabel.this.g, 1, vTweenParam3);
            }

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                AppPreviewLabel.this.e();
            }
        };
        vTweenParam2.setEase(VEasing.Back.easeOut);
        vTweenParam2.setRotationY(180.0f);
        VTween.to(this.c, 900, vTweenParam2);
        VTweenParam vTweenParam3 = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.LabelSceneNode.2
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                AppPreviewLabel.this.e.setAngle((float) (((double) f) * 0.5d));
                AppPreviewLabel.this.f.apply();
                AppPreviewLabel.this.c.updatePointsVBO();
            }

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                AppPreviewLabel.this.k();
            }
        };
    ...
    public void j() {
        ...
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.LabelSceneNode.3
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                AppPreviewLabel.this.d.visible(false);
                AppPreviewLabel.this.a();
            }
        ...
        VTweenParam vTweenParam3 = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.LabelSceneNode.4
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                AppPreviewLabel.this.e.setAngle((float) (((double) f) * 0.5d));
                AppPreviewLabel.this.f.apply();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void k() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i.c.a.LabelSceneNode.5
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                AppPreviewLabel.this.e.setAngle((float) (((double) (1.0f - f)) * 0.5d));
                AppPreviewLabel.this.f.apply();
                AppPreviewLabel.this.c.updatePointsVBO();
            }
        };
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredItemGroup.d.widget_preview_memo_bg_logo, this.c);
            a(DeferredItemGroup.d.widget_preview_memo_bg, this.d);
            c(z);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredItemGroup.d.widget_preview_memo_bg_logo) {
            this.a = textureElement;
        } else if (i == DeferredItemGroup.d.widget_preview_memo_bg) {
