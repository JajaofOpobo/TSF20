...
public class TextureElementB extends j {
    ...
    public TextureElementB(VTextureManager vTextureManager, Context context) {
        ...
        com.tsf.shell.f.i.c.a.a.TextureElementA.b = VInformation.Scale();
        com.tsf.shell.f.i.c.a.a.TextureElementA.d = vTextureManager;
        a = this;
        this.b = new VObject3dContainer();
        this.c = new PendingItemGroup(this.b);
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredItemGroup.d.widget_preview_calendar_main_bg, this.c.d);
            a(DeferredItemGroup.d.widget_preview_calendar_point, this.c.c.a);
            a(DeferredItemGroup.d.widget_preview_calendar_photo1, this.c.c.b);
            a(DeferredItemGroup.d.widget_preview_calendar_photo2, this.c.c.c);
            a(DeferredItemGroup.d.widget_preview_calendar_photo3, this.c.c.d);
    ...
    class a extends j.a {
        ...
        public void a(Bitmap bitmap) {
            DeferredItemGroup.this.a(bitmap);
            DeferredItemGroup.this.a(this);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredItemGroup.d.widget_preview_calendar_main_bg) {
            this.d = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_calendar_point) {
            this.e = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_calendar_photo1) {
            this.f = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_calendar_photo2) {
            this.g = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_calendar_photo3) {
            this.h = textureElement;
            return;
        }
        if (i == DeferredItemGroup.d.widget_preview_calendar_line) {
            this.m = textureElement;
        } else if (i == DeferredItemGroup.d.widget_preview_calendar_refresh) {
            this.n = textureElement;
        } else if (i == DeferredItemGroup.d.widget_preview_calendar_detil_bar) {
