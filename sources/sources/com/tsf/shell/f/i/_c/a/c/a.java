...
public class a extends j {
    ...
    private int e;
    private int f;
    private com.censivn.C3DEngine.b.f._a.a g;
    private d h;
    private d i;
    private int p;
    private com.censivn.C3DEngine.b.f._a.a v;
    ...
    public void a() {
        ...
        this.g = new com.censivn.C3DEngine.b.f._a.a(30, 40, 40, 40, null, false);
        this.g.textures().addElement(this.t);
        for (int i = 0; i < 30; i++) {
            com.censivn.C3DEngine.b.f._a.b bVarA = this.g.a(i);
        ...
        while (true) {
            ...
            com.censivn.C3DEngine.b.f._a.b bVarA2 = this.g.a(i3);
            int i4 = i3 + 3;
            if (i4 >= 30) {
                i4 %= 30;
            }
        ...
        this.v = new com.censivn.C3DEngine.b.f._a.a(size, 1, this.p, 4, null, true);
        this.v.textures().addElement(this.q);
        for (int i5 = 0; i5 < size; i5++) {
            e eVar = this.m.get(i5);
            com.censivn.C3DEngine.b.f._a.b bVarA3 = this.v.a(i5);
            bVarA3.a(0.0f);
    ...
    private void f() {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._c.a.c.a.1
        ...
        com.censivn.C3DEngine.b.g.d dVar2 = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._c.a.c.a.2
            @Override // com.censivn.C3DEngine.b.g.d
