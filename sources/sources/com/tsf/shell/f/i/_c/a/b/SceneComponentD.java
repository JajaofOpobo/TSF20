...
public class SceneComponentD extends VObject3dContainer {
    ...
    public void onDrawStart() {
        ...
        this.a.position().z += f;
        if (Math.abs(WidgetPreviewLabel) < 0.02f) {
            this.a.position().z = this.c;
            if (this.g != null && this.f != (iB = b(this.e))) {
                this.f = iB;
                this.g.c(iB);
            }
        }
    ...
    private void b() {
        if (this.g != null) {
            int iA = a(this.a.rotation().x);
            this.a.a(a(iA), this.g.a(b(iA)));
            int iA2 = a(this.a.rotation().x + 90.0f);
            this.a.a(a(iA2), this.g.a(b(iA2)));
            int iA3 = a(this.a.rotation().x - 90.0f);
            this.a.a(a(iA3), this.g.a(b(iA3)));
        }
    }
