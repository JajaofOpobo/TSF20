...
public class SceneComponentH extends VObject3dContainer {
    public int a;
    private d b;
    private d c;
    private d d;
    ...
    public SceneComponentH(float f) {
        ...
        this.n.alpha(100);
        addChild(this.n);
        this.b = new PendingWidgetGroup();
        this.b.position().x = -204.0f;
        this.c = new PendingWidgetGroup();
        this.c.position().x = -68.0f;
        this.d = new PendingWidgetGroup();
        this.d.position().x = 68.0f;
        this.e = new PendingWidgetGroup();
        this.e.position().x = 204.0f;
        addChild(this.b);
        addChild(this.e);
        addChild(this.c);
        addChild(this.d);
        this.h = new WidgetGroupBase();
        this.f = new i();
        this.g = new i();
        this.i = new WidgetPreviewLabel();
        this.j = new p();
        this.k = new j();
        this.m = new n();
        this.e.a(this.m);
