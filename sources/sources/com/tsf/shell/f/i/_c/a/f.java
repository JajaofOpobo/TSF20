...
public class f extends j {
    ...
    private void i() {
        ...
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.f.1
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                VTweenParam vTweenParam3 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.f.1.1
                    @Override // com.censivn.C3DEngine.api.tween.VTweenParam
                    public void onComplete() {
                        f.this.j();
                    }
        ...
        VTweenParam vTweenParam3 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.f.2
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
    ...
    public void j() {
        ...
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.f.3
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
        ...
        VTweenParam vTweenParam3 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.f.4
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                f.this.e.setAngle((float) (((double) f) * 0.5d));
                f.this.f.apply();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void k() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.f.5
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
