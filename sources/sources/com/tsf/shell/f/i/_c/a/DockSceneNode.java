...
public class DockSceneNode extends j {
    ...
    public void h() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.b.1
            private boolean b = false;

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                DeferredWidgetGroup.this.a();
            }

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                if (f > 0.5f && !this.b) {
                    DeferredWidgetGroup.this.b(false);
                    this.b = true;
                }
            }
        };
    ...
    private void i() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.b.2
            private boolean b = false;

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.b.2.1
                    @Override // com.censivn.C3DEngine.api.tween.VTweenParam
                    public void onComplete() {
                        DeferredWidgetGroup.this.h();
                    }
                };
                vTweenParam2.setTimeout(1000);
                VTween.to(DeferredWidgetGroup.this, 1, vTweenParam2);
            }
    ...
    private void j() {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            item.position().spY((float) (Math.cos(Math.toRadians(WidgetPreviewLabel)) * 215.0d));
            item.position().spX(-((float) (Math.sin(Math.toRadians(WidgetPreviewLabel)) * 215.0d)));
            item.rotation().z = f;
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredWidgetGroup.d.widget_preview_alarm_frontbg, this.h);
            a(DeferredWidgetGroup.d.widget_preview_alarm_front_content, this.m);
            a(DeferredWidgetGroup.d.widget_preview_alarm_back_bg, this.t);
            a(DeferredWidgetGroup.d.widget_preview_alarm_small_circle, this.s);
            a(DeferredWidgetGroup.d.widget_preview_alarm_toggle, this.r);
            a(DeferredWidgetGroup.d.widget_preview_alarm_week, this.q);
            c(z);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredWidgetGroup.d.widget_preview_alarm_frontbg) {
            this.a = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_alarm_front_content) {
            this.b = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_alarm_back_bg) {
            this.c = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_alarm_small_circle) {
            this.d = textureElement;
        } else if (i == DeferredWidgetGroup.d.widget_preview_alarm_toggle) {
            this.e = textureElement;
        } else if (i == DeferredWidgetGroup.d.widget_preview_alarm_week) {
