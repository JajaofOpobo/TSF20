...
public class TextureElementH extends VObject3dContainer {
    ...
    private void c() {
        this.a = new WidgetPreviewLabel(this.g * 64.0f, this.g * 64.0f, 0.0f);
        this.b = new WidgetPreviewLabel(this.g * 256.0f, this.g * 192.0f, 10.0f);
        this.b.moveAllPointsPX(this.f * 0.0f, this.f * (-40.0f), 0.0f);
        this.c = new WidgetPreviewLabel(this.g * 256.0f, this.g * 192.0f, 25.0f);
        this.c.moveAllPointsPX((-10.0f) * this.f, this.f * (-40.0f), 0.0f);
        this.d = new WidgetPreviewLabel(this.g * 256.0f, this.g * 192.0f, -5.0f);
