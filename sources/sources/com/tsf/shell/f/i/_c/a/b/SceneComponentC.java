...
public class SceneComponentC extends com.tsf.shell.f.i._c.a.FolderSceneNodesyncTextureNode {
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredWidgetGroup.d.widget_preview_cubeclock_shadow, new VObject3d[0]);
            this.k.add(new a(WidgetPreviewLabel));
            this.k.add(new a(WidgetGroupBase));
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredWidgetGroup.d.widget_preview_cubeclock_shadow) {
    ...
    class a extends j.a {
        ...
        public void a(Bitmap bitmap) {
            this.h.a(bitmap);
            FolderWidgetGroup.this.a(this);
        }
    }

    @Override // com.tsf.shell.f.i._c.a.FolderSceneNodesyncTextureNode
    public void f() {
        com.tsf.shell.f.i._c.a.NodeConfig.a("-----------onTaskMissionFinish");
    ...
    public void d() {
        if (this.l) {
            this.l = false;
            PendingWidgetGroup.deleteTexture(this.m);
            WidgetPreviewLabel.b();
            WidgetGroupBase.b();
            ItemStubHelper.b();
            h.b();
            this.o.a();
