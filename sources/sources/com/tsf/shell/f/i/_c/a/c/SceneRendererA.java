...
public class SceneRendererA extends BaseRenderable {
    ...
    private int e;
    private int f;
    private com.censivn.C3DEngine.b.f._a.AltTextureSpriteRenderable g;
    private d h;
    private d i;
    private int p;
    private com.censivn.C3DEngine.b.f._a.AltTextureSpriteRenderable v;
    ...
    public void a() {
        ...
        this.g = new com.censivn.C3DEngine.b.f._a.AltTextureSpriteRenderable(30, 40, 40, 40, null, false);
        this.g.textures().addElement(this.t);
        for (int i = 0; i < 30; i++) {
            com.censivn.C3DEngine.b.f._a.AltSpriteItemData bVarA = this.g.a(i);
            this.n[i] = new DeferredWidgetGroup(bVarA, 250.0f, ((-12.0f) * i) + 90.0f);
            bVarA.b(0, 0, 1, 1);
            bVarA.h();
        }
        int i2 = 0;
        while (true) {
            ...
            com.censivn.C3DEngine.b.f._a.AltSpriteItemData bVarA2 = this.g.a(i3);
            int i4 = i3 + 3;
            if (i4 >= 30) {
                i4 %= 30;
            }
        ...
        this.v = new com.censivn.C3DEngine.b.f._a.AltTextureSpriteRenderable(size, 1, this.p, 4, null, true);
        this.v.textures().addElement(this.q);
        for (int i5 = 0; i5 < size; i5++) {
            e eVar = this.m.get(i5);
            com.censivn.C3DEngine.b.f._a.AltSpriteItemData bVarA3 = this.v.a(i5);
            bVarA3.a(0.0f);
            bVarA3.b(0, 0, this.p, 4);
            eVar.a(bVarA3);
        }
        this.h = new PendingWidgetGroup(20.0f, 230.0f);
        this.h.textures().addElement(this.r);
        this.h.moveAllPointsPX(0.0f, 95.0f, 0.0f);
        this.i = new PendingWidgetGroup(24.0f, 170.0f);
    ...
    private float a(com.censivn.C3DEngine.b.f._a.AltSpriteItemData bVar, com.censivn.C3DEngine.b.f._a.AltSpriteItemData bVar2) {
