...
public class BackgroundSceneNode extends j {
    ...
    public void h() {
        ItemStubHelper.a("scaleAndMovePreview");
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.BackgroundSceneNode.1
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void i() {
        ItemStubHelper.a("restoreScaleAndMove");
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.BackgroundSceneNode.2
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.BackgroundSceneNode.2.1
                    @Override // com.censivn.C3DEngine.api.tween.VTweenParam
                    public void onComplete() {
                        h.this.h();
                    }
    ...
    private void j() {
        ...
        VTween.to(this.A, 500, vTweenParam);
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.BackgroundSceneNode.3
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
    ...
    public void k() {
        ...
        this.y.visible(true);
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.BackgroundSceneNode.4
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                h.this.a();
            }
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredWidgetGroup.d.widget_preview_music_p1, this.x.get(0));
            a(DeferredWidgetGroup.d.widget_preview_music_p2, this.x.get(1));
            a(DeferredWidgetGroup.d.widget_preview_music_p3, this.x.get(2));
            a(DeferredWidgetGroup.d.widget_preview_music_p4, this.x.get(3));
            a(DeferredWidgetGroup.d.widget_preview_music_p5, this.x.get(4));
            a(DeferredWidgetGroup.d.widget_preview_music_title, this.w);
            a(DeferredWidgetGroup.d.widget_preview_music_control, this.n, this.o, this.p, this.q, this.r, this.v);
            c(z);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredWidgetGroup.d.widget_preview_music_p1) {
            this.b = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_music_p2) {
            this.c = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_music_p3) {
            this.d = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_music_p4) {
            this.e = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_music_p5) {
            this.f = textureElement;
        } else if (i == DeferredWidgetGroup.d.widget_preview_music_title) {
            this.g = textureElement;
        } else if (i == DeferredWidgetGroup.d.widget_preview_music_control) {
