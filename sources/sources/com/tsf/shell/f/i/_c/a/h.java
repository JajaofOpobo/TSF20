...
public class h extends j {
    ...
    public void h() {
        ...
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.h.1
    ...
    public void i() {
        ...
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.h.2
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.h.2.1
                    @Override // com.censivn.C3DEngine.api.tween.VTweenParam
                    public void onComplete() {
                        h.this.h();
                    }
    ...
    private void j() {
        ...
        VTween.to(this.A, 500, vTweenParam);
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.h.3
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
    ...
    public void k() {
        ...
        this.y.visible(true);
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.h.4
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                h.this.a();
            }
