...
import com.tsf.b;
import com.tsf.shell.f.i._c.a.NodeConstants;
import java.text.DateFormatSymbols;
import java.util.Date;
import java.util.GregorianCalendar;

/* JADX INFO: loaded from: C:\Users\Jaja\AndroidStudioProjects\TSF20\resources-Prime\classes.dex */
public class TextureElementG {
    public static Bitmap a(Context context, Date date) {
        Bitmap bitmapB = l.b(context, DeferredWidgetGroup.d.widget_preview_calendar_content);
        ...
        com.tsf.shell.f.i._c.a.NodeConfig.a("mFirstDay:" + firstDayOfWeek);
        if (firstDayOfWeek == 1) {
