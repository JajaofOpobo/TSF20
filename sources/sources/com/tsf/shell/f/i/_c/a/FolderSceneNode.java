...
public class FolderSceneNode extends j {
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.i._c.a.a$a, reason: collision with other inner class name */
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredWidgetGroup.d.widget_preview_adornment_texture_default, this.c);
            a(DeferredWidgetGroup.d.widget_preview_adornment_texture_thumbtack_hd, this.d);
            c(z);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredWidgetGroup.d.widget_preview_adornment_texture_default) {
            this.a = textureElement;
        } else if (i == DeferredWidgetGroup.d.widget_preview_adornment_texture_thumbtack_hd) {
