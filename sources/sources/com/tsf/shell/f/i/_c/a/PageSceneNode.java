...
public class PageSceneNode extends j {
    ...
    private void e() {
        Collections.sort(this.a, new Comparator<VRectangle>() { // from class: com.tsf.shell.f.i._c.a.PageSceneNode.1
            @Override // java.util.Comparator
            /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
            public int compare(VRectangle vRectangle, VRectangle vRectangle2) {
                return (int) (PendingWidgetGroup.this.a(vRectangle2.rotation().y) - PendingWidgetGroup.this.a(vRectangle.rotation().y));
            }
        });
    ...
    @Override // com.tsf.shell.f.i._c.a.FolderSceneNodesyncTextureNode
    public void a() {
    }
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredWidgetGroup.d.widget_preview_gallery_item0, this.a.get(0));
            a(DeferredWidgetGroup.d.widget_preview_gallery_item1, this.a.get(1));
            a(DeferredWidgetGroup.d.widget_preview_gallery_item2, this.a.get(2));
            a(DeferredWidgetGroup.d.widget_preview_gallery_item3, this.a.get(3));
            a(DeferredWidgetGroup.d.widget_preview_gallery_item4, this.a.get(4));
            a(DeferredWidgetGroup.d.widget_preview_gallery_item5, this.a.get(5));
            a(DeferredWidgetGroup.d.widget_preview_gallery_item6, this.a.get(6));
            a(DeferredWidgetGroup.d.widget_preview_gallery_item7, this.a.get(7));
            c(z);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredWidgetGroup.d.widget_preview_gallery_item0) {
            this.d[0] = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_gallery_item1) {
            this.d[1] = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_gallery_item2) {
            this.d[2] = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_gallery_item3) {
            this.d[3] = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_gallery_item4) {
            this.d[4] = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_gallery_item5) {
            this.d[5] = textureElement;
        } else if (i == DeferredWidgetGroup.d.widget_preview_gallery_item6) {
            this.d[6] = textureElement;
        } else if (i == DeferredWidgetGroup.d.widget_preview_gallery_item7) {
