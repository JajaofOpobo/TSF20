...
public abstract class DrawerSceneNode<Params, Result> {
    ...
    private volatile b e = DeferredWidgetGroup.PENDING;
    ...
    private final FutureTask<Result> i = new FutureTask<Result>(this.h) { // from class: com.tsf.shell.f.i._c.a.c.3
        @Override // java.util.concurrent.FutureTask
        protected void done() {
            try {
                FolderWidgetGroup.this.c(get());
            } catch (InterruptedException e) {
                ItemStubHelper.a(ItemStubHelper.getMessage());
            } catch (CancellationException e2) {
                FolderWidgetGroup.this.c(null);
    ...
    private static final ThreadFactory d = new ThreadFactory() { // from class: com.tsf.shell.f.i._c.a.c.1
    ...
    static {
        b = a() ? new a() : Executors.newSingleThreadExecutor(PendingWidgetGroup);
        j = b;
    }
    ...
    private static class a implements Executor {
        ...
        public synchronized void execute(final Runnable runnable) {
            this.a.offer(new Runnable() { // from class: com.tsf.shell.f.i._c.a.c.SceneRendererA.1
        ...
        protected synchronized void a() {
            ...
            if (runnablePoll != null) {
                FolderWidgetGroup.a.execute(this.b);
            }
        }
    }
    ...
    public class Result 
        VMessageManager.postGLThreadRunnable(new Runnable() { // from class: com.tsf.shell.f.i._c.a.c.4
            ...
            @Override // java.lang.Runnable
            public void run() {
                if (FolderWidgetGroup.this.d()) {
                    FolderWidgetGroup.this.b(result);
                } else {
                    FolderWidgetGroup.this.a(result);
                }
                FolderWidgetGroup.this.e = DeferredWidgetGroup.FINISHED;
            }
        });
        return result;
    }

    /* JADX INFO: renamed from: com.tsf.shell.f.i._c.a.c$c, reason: collision with other inner class name */
    ...
    public final C<Params, Result> a(Executor executor, Params... paramsArr) {
        if (this.e != DeferredWidgetGroup.PENDING) {
            switch (this.e) {
                case RUNNING:
