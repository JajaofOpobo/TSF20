...
public class CompositeSceneNode extends j implements k {
    ...
    private void a(final VButtonItem vButtonItem, float f, final float f2, final int i) {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.CompositeSceneNode.1
            boolean a = false;
            ...
            public void onProgress(float f3) {
                if (f3 > 0.8f && !this.a) {
                    this.a = true;
                    VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.CompositeSceneNode.1.1
                        @Override // com.censivn.C3DEngine.api.tween.VTweenParam
        ...
        vTweenParam.setRotationZ(WidgetPreviewLabel);
        VTween.killTween(vButtonItem);
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(DeferredWidgetGroup.d.widget_preview_weather_ico1, this.g);
            a(DeferredWidgetGroup.d.widget_preview_weather_ico2, this.h);
            a(DeferredWidgetGroup.d.widget_preview_weather_ico3, this.m);
            a(DeferredWidgetGroup.d.widget_preview_weather_main, this.f);
            a(DeferredWidgetGroup.d.widget_preview_weather_building, this.n);
            c(z);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == DeferredWidgetGroup.d.widget_preview_weather_ico1) {
            this.b = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_weather_ico2) {
            this.c = textureElement;
            return;
        }
        if (i == DeferredWidgetGroup.d.widget_preview_weather_ico3) {
            this.d = textureElement;
        } else if (i == DeferredWidgetGroup.d.widget_preview_weather_main) {
            this.a = textureElement;
        } else if (i == DeferredWidgetGroup.d.widget_preview_weather_building) {
    ...
    public class a extends VRectangle {
        ...
        public void onDrawEnd() {
            if (Math.abs(this.a) > 0.001f && !com.tsf.shell.f.i._c.a.a.TextureElementH.e) {
                invalidate();
            }
        }
