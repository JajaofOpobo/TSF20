...
public class m extends j implements k {
    ...
    private void a(final VButtonItem vButtonItem, float f, final float f2, final int i) {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.m.1
            boolean a = false;
            ...
            public void onProgress(float f3) {
                if (f3 > 0.8f && !this.a) {
                    this.a = true;
                    VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.m.1.1
                        @Override // com.censivn.C3DEngine.api.tween.VTweenParam
    ...
    public void a(int i, TextureElement textureElement) {
        ...
        if (i == b.d.widget_preview_weather_ico2) {
            this.c = textureElement;
            return;
        }
        if (i == b.d.widget_preview_weather_ico3) {
    ...
    public class a extends VRectangle {
        ...
        public void onDrawEnd() {
            if (Math.abs(this.a) > 0.001f && !com.tsf.shell.f.i._c.a.a.h.e) {
                invalidate();
            }
        }
