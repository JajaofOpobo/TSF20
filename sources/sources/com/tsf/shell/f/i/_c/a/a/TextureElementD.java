...
public class TextureElementD extends VObject3dContainer {
    ...
    private void a(float f, float f2) {
        ...
        float fWidth;
        if (f2 > 0.0f) {
            if (Math.abs(WidgetPreviewLabel) > f2) {
                if (f > 0.0f) {
                    this.x = this.m.right;
                } else {
                    this.x = this.m.left;
                ...
                this.y = this.m.top;
                com.tsf.shell.f.i._c.a.NodeConfig.a("IS THIS FLITER?");
            }
        } else if (Math.abs(WidgetPreviewLabel) > (-f2)) {
            if (f > 0.0f) {
                this.x = this.m.right;
            } else {
                this.x = this.m.left;
        ...
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.a.TextureElementD.1
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                PendingWidgetGroup.this.c.b();
                DeferredWidgetGroup.a.a();
            }
        };
        if (Math.abs(WidgetPreviewLabel) > Math.abs(f2)) {
            if (f > 0.0f) {
                fWidth = this.m.width();
            } else {
                fWidth = -this.m.width();
    ...
    public d(VObject3dContainer vObject3dContainer) {
        j = com.tsf.shell.f.i._c.a.a.TextureElementA.a / 1.8f;
        this.t = j / com.tsf.shell.f.i._c.a.a.TextureElementA.b;
        n = 545.0f * j;
        o = 350.0f * j;
        this.m.top = o / 2.0f;
        ...
        this.m.left = (-n) / 2.0f;
        this.m.right = n / 2.0f;
        this.a = new FolderWidgetGroup(15);
        ...
        this.g = new VObject3dContainer() { // from class: com.tsf.shell.f.i._c.a.a.TextureElementD.2
            @Override // com.censivn.C3DEngine.api.core.VObject3d
            public void onDrawStart() {
                PendingWidgetGroup.this.a.d();
            }
        };
        this.f = new VObject3dContainer() { // from class: com.tsf.shell.f.i._c.a.a.TextureElementD.3
            @Override // com.censivn.C3DEngine.api.core.VObject3d
            public void onDrawStart() {
                if (!PendingWidgetGroup.this.u) {
                    if (Math.abs(PendingWidgetGroup.this.x - PendingWidgetGroup.this.l.a.x) >= 1.0f || Math.abs(PendingWidgetGroup.this.y - PendingWidgetGroup.this.l.a.y) >= 1.0f || PendingWidgetGroup.this.v) {
                        float f2 = (PendingWidgetGroup.this.y - PendingWidgetGroup.this.l.a.y) * PendingWidgetGroup.this.s;
                        PendingWidgetGroup.this.l.a.set(((PendingWidgetGroup.this.x - PendingWidgetGroup.this.l.a.x) * PendingWidgetGroup.this.s) + PendingWidgetGroup.this.l.a.x, f2 + PendingWidgetGroup.this.l.a.y);
                        PendingWidgetGroup.this.a(PendingWidgetGroup.this.l);
                    } else {
                        PendingWidgetGroup.this.a.c();
                        PendingWidgetGroup.this.a.visible(false);
                        PendingWidgetGroup.this.u = true;
                        if (!PendingWidgetGroup.this.w) {
                            com.tsf.shell.f.i._c.a.NodeConfig.a("FINISH AND CHANGE TEXTURE");
                            PendingWidgetGroup.this.w = true;
                        }
                    }
                }
                PendingWidgetGroup.this.a.c();
        ...
        PositionNumber3d positionNumber3dPosition2 = this.g.position();
        float f2 = 47.0f * j;
    ...
    public void a(a aVar) {
        double dWidth = ((double) (this.m.width() / 2.0f)) * ((double) Math.max(1.0f - aVar.b, 0.0f));
        this.q.set(aVar.a);
        this.p.x = this.q.x - this.r.x;
        this.p.y = this.q.y - this.r.y;
        a(this.q, this.p, dWidth);
    }
    ...
    private void a(PointF pointF, PointF pointF2, double d) {
        ...
        double dSqrt = Math.sqrt((pointF2.x * pointF2.x) + (pointF2.y * pointF2.y));
        if (dSqrt != 0.0d) {
            pointF2.x = (float) (((double) pointF2.x) / dSqrt);
            pointF2.y = (float) (((double) pointF2.y) / dSqrt);
