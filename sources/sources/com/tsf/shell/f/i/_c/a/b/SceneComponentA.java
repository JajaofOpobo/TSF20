...
public class SceneComponentA extends VObject3dContainer {
    ...
    private void a() {
        ...
        b(-13421773);
        this.b.put(this.i);
        float[] fArrC = FolderWidgetGroup.h.c();
        this.c.put(fArrC);
        this.c.put(fArrC);
        this.c.put(fArrC);
        this.c.put(fArrC);
    ...
    public void drawElement() {
        ...
        if (visible() && FolderWidgetGroup.h.a != null) {
            if (zColorFillEnable) {
            ...
            GLES20.glBindTexture(3553, FolderWidgetGroup.h.a.id);
