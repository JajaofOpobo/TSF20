...
public class g extends j {
    ...
    public void k() {
        final VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.g.1
            boolean a = false;
        ...
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.g.2
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void l() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.g.3
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                g.this.e();
                g.this.a();
        ...
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.g.4
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                g.this.v.setAngle((float) (((double) f) * 0.5d));
                g.this.w.apply();
    ...
    private void m() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.g.5
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
        ...
        VTween.to(this.t, 800, vTweenParam);
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.g.6
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                g.this.v.setAngle((float) (((double) f) * 0.5d));
                g.this.w.apply();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void n() {
        final VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.g.7
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.g.7.1
                    @Override // com.censivn.C3DEngine.api.tween.VTweenParam
                    public void onComplete() {
                        g.this.k();
                    }
        ...
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.g.8
            boolean a = false;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void o() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.g.9
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
            }
    ...
    @Override // com.tsf.shell.f.i._c.a.k
    ...
    @Override // com.tsf.shell.f.i._c.a.j, com.tsf.shell.f.i._c.a.i
    public void a(int i, TextureElement textureElement) {
        if (i == b.d.widget_preview_message_back_inside) {
            this.f = textureElement;
            return;
        }
        if (i == b.d.widget_preview_message_content) {
            this.d = textureElement;
            return;
        }
        if (i == b.d.widget_preview_message_back_no_flap) {
            this.c = textureElement;
            return;
        }
        if (i == b.d.widget_preview_message_back_flag_back) {
    ...
    @Override // com.tsf.shell.f.i._c.a.j, com.tsf.shell.f.i._c.a.k
    public void d() {
        if (this.l) {
            this.l = false;
