...
public class c extends g {
    ...
    @Override // com.tsf.shell.f.i._c.g
    public void c() {
        this.s = true;
    }
    ...
    public void e() {
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._c.c.1
    ...
    @Override // com.tsf.shell.f.i._c.g, com.tsf.shell.f.i._c.e
    public void f() {
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i._c.c.2
            @Override // com.censivn.C3DEngine.b.g.d
            public void a(float f) {
                float fAlpha = c.this.m.a.alpha();
                c.this.m.a.alpha(fAlpha);
    ...
    private void q() {
        ...
        this.v = new Runnable() { // from class: com.tsf.shell.f.i._c.c.3
            ...
            public void run() {
                ...
                c.this.l.e(bVar3);
                c.this.v = new Runnable() { // from class: com.tsf.shell.f.i._c.c.3.1
                    @Override // java.lang.Runnable
                    public void run() {
                        c.this.v = null;
