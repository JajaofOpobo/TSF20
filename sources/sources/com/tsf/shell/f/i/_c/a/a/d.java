...
public class d extends VObject3dContainer {
    ...
    private void a(float f, float f2) {
        ...
        if (f2 > 0.0f) {
            if (Math.abs(f) > f2) {
                ...
                this.y = this.m.top;
                com.tsf.shell.f.i._c.a.e.a("IS THIS FLITER?");
            }
        ...
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.f.i._c.a.a.d.1
    ...
    public d(VObject3dContainer vObject3dContainer) {
        j = com.tsf.shell.f.i._c.a.a.a.a / 1.8f;
        this.t = j / com.tsf.shell.f.i._c.a.a.a.b;
        n = 545.0f * j;
        o = 350.0f * j;
        this.m.top = o / 2.0f;
        ...
        this.g = new VObject3dContainer() { // from class: com.tsf.shell.f.i._c.a.a.d.2
            @Override // com.censivn.C3DEngine.api.core.VObject3d
            public void onDrawStart() {
                d.this.a.d();
            }
        };
        this.f = new VObject3dContainer() { // from class: com.tsf.shell.f.i._c.a.a.d.3
            @Override // com.censivn.C3DEngine.api.core.VObject3d
            public void onDrawStart() {
                if (!d.this.u) {
                    if (Math.abs(d.this.x - d.this.l.a.x) >= 1.0f || Math.abs(d.this.y - d.this.l.a.y) >= 1.0f || d.this.v) {
                        ...
                        d.this.u = true;
                        if (!d.this.w) {
                            com.tsf.shell.f.i._c.a.e.a("FINISH AND CHANGE TEXTURE");
                            d.this.w = true;
                        }
                    }
                }
