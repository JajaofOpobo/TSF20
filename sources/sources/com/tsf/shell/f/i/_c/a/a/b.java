...
import com.tsf.b;
import com.tsf.shell.f.i._c.a.j;
...
public class b extends j {
    ...
    public b(VTextureManager vTextureManager, Context context) {
        ...
        com.tsf.shell.f.i._c.a.a.a.c = context;
        com.tsf.shell.f.i._c.a.a.a.a = VInformation.engineDensity();
        com.tsf.shell.f.i._c.a.a.a.b = VInformation.Scale();
        com.tsf.shell.f.i._c.a.a.a.d = vTextureManager;
        a = this;
    ...
    class a extends j.a {
        ...
        @Override // com.tsf.shell.f.i._c.a.j.a, com.tsf.shell.f.i._c.a.c
    ...
    public void a(int i, TextureElement textureElement) {
        ...
        if (i == b.d.widget_preview_calendar_point) {
            this.e = textureElement;
            return;
        }
        if (i == b.d.widget_preview_calendar_photo1) {
            this.f = textureElement;
            return;
        }
        if (i == b.d.widget_preview_calendar_photo2) {
            this.g = textureElement;
            return;
        }
        if (i == b.d.widget_preview_calendar_photo3) {
            this.h = textureElement;
            return;
        }
        if (i == b.d.widget_preview_calendar_line) {
