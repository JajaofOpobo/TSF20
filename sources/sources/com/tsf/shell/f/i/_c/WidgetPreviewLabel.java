...
public class WidgetPreviewLabel extends WidgetLabelProvider {
    public k b;
    ...
    public Bitmap c() {
        ...
        if (bitmapA == null) {
            bitmapA = x.a(DeferredWidgetGroup.d.sym_def_app_icon);
        }
        return q.c(bitmapA, i, i2);
    }

    @Override // com.tsf.shell.f.i._c.WidgetLabelProvider
