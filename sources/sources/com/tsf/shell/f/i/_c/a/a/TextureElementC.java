...
public class TextureElementC extends VObject3dContainer {
    ...
    private final e x = new ItemStubHelper();
    ...
    public c(int i) {
        ...
        for (int i3 = 0; i3 < (this.s + 2) * 2; i3++) {
            this.j.a(new DeferredWidgetGroup());
        }
    ...
    public synchronized void a(PointF pointF, PointF pointF2, double d) {
        ...
        for (int i6 = 0; i6 < this.d.b(); i6++) {
            ...
            this.m.put(DeferredWidgetGroup);
            this.q += 2;
        }
        this.u = 0;
    ...
    public synchronized void e() {
        ...
        position().setAll(0.0f, 47.0f * PendingWidgetGroup.j, 0.0f);
        alpha(255);
        this.p.position(0);
        this.l.position(0);
        this.o.position(0);
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.i._c.a.a.TextureElementC$c, reason: collision with other inner class name */
    private class C0117c {
        ...
        public void a(double d) {
            double dCos = Math.cos(PendingWidgetGroup);
            double dSin = Math.sin(PendingWidgetGroup);
