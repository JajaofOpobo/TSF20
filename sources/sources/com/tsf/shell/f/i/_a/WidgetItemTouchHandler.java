    ...
    public void c(MotionEvent motionEvent) {
        ...
        if (com.tsf.shell.manager.app.FeatureConfig.a()) {
            if (bVar == null || !bVar.O()) {
                ...
                if (motionEvent != null && (this.c instanceof com.tsf.shell.f.e.SelectionFrameLayoutItem) && !this.g.D()) {
                    com.tsf.shell.f.e.SelectionFrameLayoutItem fVar = (com.tsf.shell.f.e.SelectionFrameLayoutItem) this.c;
                    if (fVar.o()) {
                        com.tsf.shell.f.e.SelectionFrameLayoutItem fVarA = fVar.a((int) f, (int) f2);
                        if (fVarA != null) {
                            fVar.f(fVarA);
                        } else {
                            fVar.p();
                ...
                if (!bVar.D()) {
                    ...
                    if (bVar == null || bVar.K() == null || bVar.K().title == null || !bVar.K().title.equals(x.c(WidgetDragHandler.i.panda))) {
    ...
    */
    public void d(android.view.MotionEvent r7) {
        ...
        L26:
            ...
            r6.m = r3
            r6.b()
            com.tsf.shell.f.f.PageTouchHandler r0 = com.tsf.shell.f.i._a.WidgetItemTouchHandler.a
            r0.x()
        L3e:
            r6.b(r3)
            com.tsf.shell.f.e._e.SelectionState r0 = com.tsf.shell.manager.app.WidgetAnimator
            r0.c()
            com.tsf.shell.f.f.PageTouchHandler r0 = com.tsf.shell.manager.app.StateHub
            com.tsf.shell.f.e._e.SelectionIndicator r0 = r0.b()
            r0.c()
        ...
        L55:
            ...
            boolean r4 = r6.n
            if (r4 != 0) goto L76
            com.tsf.shell.f.e.SelectionFrameLayoutItem r4 = r1.n()
            if (r4 == 0) goto Lc6
        L76:
            boolean r4 = r1.o()
            if (r4 == 0) goto Lc6
            ...
            r4 = r4[r2]
            int r4 = (int) r4
            com.tsf.shell.f.e.SelectionFrameLayoutItem r4 = r1.a(r5, r4)
            boolean r5 = r1.h(r4)
            if (r5 == 0) goto Lbc
        ...
        Lc6:
            ...
            goto La3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.f.i._a.WidgetItemTouchHandler.d(android.view.MotionEvent):void");
    }
    ...
    public void a(float[] fArr, boolean z) {
        ...
        if (fArr == null) {
            fArr = com.tsf.shell.manager.r.a.AppWidgetHostManager(this.g, this.g.position().x, this.g.position().y);
        }
    ...
    public void a(MotionEvent motionEvent, MotionEvent motionEvent2) {
        ...
        if (this.l) {
            if (this.g.D()) {
                com.tsf.shell.f.e._a.DropTarget((int) (this.b + (motionEvent2.getX() - motionEvent.getX())), (int) (this.d - (motionEvent2.getY() - motionEvent.getY())));
            } else if (this.n) {
            ...
            if (this.m) {
                WidgetWallpaperHandler.a(motionEvent2.getX(), motionEvent2.getY(), this.h, this.i);
                return;
            } else {
                if (this.n && (this.c instanceof com.tsf.shell.f.e.SelectionFrameLayoutItem)) {
                    this.q.a((com.tsf.shell.f.e.SelectionFrameLayoutItem) this.c, motionEvent2);
                    return;
                }
                return;
            }
    ...
    */
    public void e(android.view.MotionEvent r6) {
        /*
            ...
            com.tsf.shell.f.i.MultiSelectController r3 = r0.A()
            if (r3 == 0) goto L5a
            com.tsf.shell.f.i.MultiSelectController r0 = r0.A()
            boolean r0 = r0.e()
        L2c:
            if (r0 != 0) goto L58
