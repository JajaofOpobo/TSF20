...
public class ItemShell extends PageItem {
    ...
    public ItemShell(LauncherAppWidgetInfo launcherAppWidgetInfo, String str) {
    ...
    public void m_() {
        ...
        if (!this.a) {
            ...
            com.censivn.C3DEngine.b.g.d dVar2 = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.i.b.b.ItemShell.3
