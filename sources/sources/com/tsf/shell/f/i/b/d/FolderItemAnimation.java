...
public class FolderItemAnimation {
    ...
    private void c() {
        ...
        this.g = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.i.b.d.FolderItemAnimation.1
            @Override // com.censivn.C3DEngine.b.g.TweenParams
            public void a() {
                ItemStubHelper.this.i.ba();
                if (ItemStubHelper.this.i.x) {
                    com.tsf.shell.f.i.b.d.FolderShortcutItem.m.e(ItemStubHelper.this.i);
                }
            }
        };
        this.g.l(1.0f);
    ...
    public void b() {
        ...
        com.censivn.C3DEngine.b.g.TweenParams dVar3 = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.i.b.d.FolderItemAnimation.2
            @Override // com.censivn.C3DEngine.b.g.TweenParams
            public void a() {
                ItemStubHelper.this.i.ba();
            }
    ...
    public void a(com.censivn.C3DEngine.b.f.IRenderable iVar) {
        ...
        this.i.aZ();
        com.tsf.shell.f.i.b.d.FolderShortcutItem.m.d(this.i);
        com.censivn.C3DEngine.b.g.TweenUtils.a(this.i.q);
