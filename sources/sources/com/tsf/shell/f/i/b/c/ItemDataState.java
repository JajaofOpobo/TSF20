...
public class ItemDataState {
    ...
    private TextureElement c(com.tsf.shell.f.i.b.c.ItemDataConfig aVar) throws Throwable {
        ...
        bitmapA.recycle();
        a aVar2 = new ItemDataConfig(textureElementA, aVar.b.a + ":" + aVar.b.b);
        aVar2.b(aVar);
        this.a.add(aVar2);
    ...
    public void b(com.tsf.shell.f.i.b.c.ItemDataConfig aVar) {
        for (a aVar2 : this.a) {
    ...
    class a {
        ...
        public void a(com.tsf.shell.f.i.b.c.ItemDataConfig aVar) {
            this.b.remove(aVar);
        }
