...
public abstract class DrawerShortcutItemBase extends com.tsf.shell.f.i.ShortcutItem implements m {
    ...
    public void alpha(float f) {
        this.k.alpha(DrawerItemEditAction);
    }
    ...
    public static a aU() {
        a aVar = new DrawerItemBase();
        aVar.a = new com.tsf.shell.f.i.b.d.FolderShortcutItem(new LauncherDrawerFolder3DInfo(true));
        aVar.b = new DrawerItemButton();
        w++;
        return aVar;
    }
