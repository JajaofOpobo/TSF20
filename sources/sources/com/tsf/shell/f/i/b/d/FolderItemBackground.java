...
public class FolderItemBackground extends com.tsf.shell.f.e.d.a.DropIndicatorConfig {
    public f() {
        ...
        arrayList.add(new FolderItemState.C0092c(com.tsf.b.i.text_rename, com.tsf.b.d.widget_folder_rename) {
            @Override
            public void a() {
                if (com.tsf.shell.f.i.b.d.FolderShortcutItem.k != null) {
                    w.b();
        ...
        FolderItemState.C0092c c0092c = new FolderItemState.C0092c(com.tsf.b.i.text_sort, com.tsf.b.d.widget_folder_sort);
        c0092c.a(l());
        arrayList.add(c0092c);
        a(arrayList);
    }

    private ArrayList<FolderItemState.C0092c> l() {
        ArrayList<FolderItemState.C0092c> arrayList = new ArrayList<>();
        arrayList.add(new FolderItemState.C0092c(com.tsf.b.i.text_sort_alphabetical, com.tsf.b.d.widget_folder_sort_name) {
            @Override
            public void a() {
                if (com.tsf.shell.f.i.b.d.FolderShortcutItem.k != null) {
                    w.b();
        ...
        arrayList.add(new FolderItemState.C0092c(com.tsf.b.i.text_sort_latest_installed, com.tsf.b.d.widget_folder_sort_time_earliest) {
            @Override
            public void a() {
                if (com.tsf.shell.f.i.b.d.FolderShortcutItem.k != null) {
                    w.b();
        ...
        arrayList.add(new FolderItemState.C0092c(com.tsf.b.i.text_sort_earliest_installed, com.tsf.b.d.widget_folder_sort_time_latest) {
            @Override
            public void a() {
                if (com.tsf.shell.f.i.b.d.FolderShortcutItem.k != null) {
                    w.b();
        ...
        arrayList.add(new FolderItemState.C0092c(com.tsf.b.i.text_sort_most_used, com.tsf.b.d.widget_folder_sort_frequency) {
            @Override
            public void a() {
                if (com.tsf.shell.f.i.b.d.FolderShortcutItem.k != null) {
                    w.b();
