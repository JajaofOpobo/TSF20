...
public class ItemDataConfig extends com.tsf.shell.f.i.PageItem implements com.censivn.C3DEngine.b.c.a.InterfaceC0025a {
    ...
    public ItemDataConfig(ItemInfo itemInfo) {
        super(itemInfo);
        this.l = false;
        this.m = false;
        this.n = false;
        ...
        e(false);
        if (f == null) {
            f = new com.tsf.shell.f.i.b.c.ItemDataState();
        }
        ac();
        this.o = position().y;
    ...
    class C0114a extends k {
        public ItemDataConfig(float f, float f2, boolean z) {
            super(f, f2, false);
        }
    }
    ...
    class b extends k {
        ...
        public ItemDataConfig(int i, int i2, int i3, int i4, int i5, int i6) {
