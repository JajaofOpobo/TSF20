...
public class j implements e.a {
    ...
    private void b(boolean z) {
        ...
        if (c().folder.frontPlaneEnable) {
            com.censivn.C3DEngine.b.f.a.b bVarA2 = Z.a(i);
        ...
        if (c().folder.sizePlaneEnable) {
            com.censivn.C3DEngine.b.f.a.b bVarA3 = Z.a(i);
        ...
        for (int i3 = 0; i3 < c().folder.sampleCount; i3++) {
            ...
            com.censivn.C3DEngine.b.f.a.b bVarA4 = Z.a(i);
            bVarA4.b(f);
            bVarA4.d(f2);
        ...
        Z.maxX();
        Z.maxY();
        com.censivn.C3DEngine.b.f.a.b bVarA5 = Z.a(i);
