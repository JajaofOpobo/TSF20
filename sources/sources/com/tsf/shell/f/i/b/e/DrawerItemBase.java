...
public abstract class DrawerItemBase extends DrawerShortcutItemBase {
    ...
    public void q() {
        ...
        if (this instanceof g) {
            g gVar = (DrawerItemVisual) this;
            if (gVar.bd() != null) {
                launcherShortcut3DInfo.onUpdateName(gVar.bd().e, false);
            }
        }
        final com.tsf.shell.f.i.b.e.DrawerItemBase self = this;
        Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.i.b.e.DrawerItemBase.1
            @Override // java.lang.Runnable
            public void run() {
                com.censivn.C3DEngine.C3DEngine.a().c(new Runnable() { // from class: com.tsf.shell.f.i.b.e.DrawerItemBase.1.1
                    @Override // java.lang.Runnable
                    public void run() {
                        self.k();
                    }
    ...
    */
    public void a(android.graphics.Bitmap r5, java.lang.String r6) {
        /*
            ...
            r2 = 1
            boolean r1 = r4 instanceof com.tsf.shell.f.i.b.e.DrawerItemVisual
            if (r1 == 0) goto L2d
            r1 = r4
            com.tsf.shell.f.i.b.e.DrawerItemVisual r1 = (com.tsf.shell.f.i.b.e.DrawerItemVisual) r1
            com.tsf.shell.manager.app.LauncherAppInfo r3 = r1.bd()
            if (r3 == 0) goto L2d
            com.tsf.shell.manager.app.LauncherAppInfo r1 = r1.bd()
        ...
        L21:
            ...
            com.tsf.shell.f.i.b.e.DrawerItemBase$2 r1 = new com.tsf.shell.f.i.b.e.DrawerItemBase$2
            r1.<init>()
        ...
        L2d:
            ...
            goto L21
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.f.i.b.e.DrawerItemBase.a(android.graphics.Bitmap, java.lang.String):void");
    }
    ...
    */
    public void a(java.lang.String r5) {
        ...
        L31:
            ...
            goto L21
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.f.i.b.e.DrawerItemBase.a(java.lang.String):void");
    }
}
