...
public class ItemContainer extends j {
    private i d;
    private j e;
    private j f;
    private boolean h;
    ...
    private void i() {
        float f = 150.0f;
        this.f = new j() { // from class: com.tsf.shell.f.i.b.a.ItemContainer.1
        ...
        this.e = new j() { // from class: com.tsf.shell.f.i.b.a.ItemContainer.2
            @Override // com.censivn.C3DEngine.b.f.i
            public void onDrawStart() {
        ...
        k kVar = new k(f, f) { // from class: com.tsf.shell.f.i.b.a.ItemContainer.3
            @Override // com.censivn.C3DEngine.b.f.i
            public void onDrawStart() {
                if (!a.this.a) {
                    rotation().z += 25.0f;
        ...
        addChild(this.f);
        this.f.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this.f) { // from class: com.tsf.shell.f.i.b.a.ItemContainer.4
