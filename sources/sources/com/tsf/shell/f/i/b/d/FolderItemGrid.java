...
public class FolderItemGrid extends com.tsf.shell.f.e.f.EditModeNode {
    ...
    public void b() {
        ...
        if (com.tsf.shell.f.i.b.d.FolderItemPositioner.N.d()) {
            this.p -= i;
            i += 0.5f;
            if (this.p < com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x) {
                this.p = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x;
            }
            this.k = false;
    ...
    public void h() {
        this.e = false;
        float f = this.o - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x;
        int iNumChildren = numChildren();
        for (int i2 = 0; i2 < iNumChildren; i2++) {
            com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar = (com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) getChildAt(i2);
            if (!bVar.o) {
                bVar.position().y += f;
            }
        }
    ...
    private void p() {
        float f = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.c().folder.childContainerY;
        this.p = f;
        this.o = f;
    }

    private void w() {
        if (numChildren() == 0 || numChildren() <= com.tsf.shell.f.i.b.d.FolderShortcutItem.l.c) {
            this.n = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x;
        } else {
            this.n = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x + (((((numChildren() - 1) / com.tsf.shell.f.i.b.d.FolderShortcutItem.l.a) - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.b) + 1) * com.tsf.shell.f.i.b.d.FolderShortcutItem.l.j);
        }
        this.k = false;
        setAnimationObjectState(true);
        invalidate();
    ...
    public int j() {
        float f = (this.p - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x) % com.tsf.shell.f.i.b.d.FolderShortcutItem.l.j;
        float fAbs = Math.abs(FolderItemBackground) / com.tsf.shell.f.i.b.d.FolderShortcutItem.l.j;
        float f2 = this.p - f;
        if (fAbs > 0.5d) {
            if (f > 0.0f) {
                f2 += com.tsf.shell.f.i.b.d.FolderShortcutItem.l.j;
            } else {
                f2 -= com.tsf.shell.f.i.b.d.FolderShortcutItem.l.j;
            }
        }
        return (int) ((f2 - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x) / com.tsf.shell.f.i.b.d.FolderShortcutItem.l.j);
    }
    ...
    public void k() {
        ...
        if (fAbs > 0.5d) {
            if (f > 0.0f) {
                this.p += com.tsf.shell.f.i.b.d.FolderShortcutItem.l.j;
            } else {
                this.p -= com.tsf.shell.f.i.b.d.FolderShortcutItem.l.j;
            }
        }
    ...
    public float l() {
        return this.p - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x;
    }

    public float m() {
        return this.o - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x;
    }
    ...
    public void a(com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar) {
        ...
        this.f.l(bVar.aI());
        int iIndexOf = children().indexOf(bVar);
        if (iIndexOf != -1) {
            children().set(iIndexOf, this.f);
        }
    }

    public int b(com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar) {
        bVar.l(this.f.aI());
        int iIndexOf = children().indexOf(this.f);
        if (iIndexOf != -1) {
            bVar.parent(this);
    ...
    public boolean a(com.censivn.C3DEngine.b.f.i iVar, int i2, int i3) {
        ...
        com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar = (com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) getChildAt((iNumChildren - i3) - 1);
        if (!bVar.visible() || bVar.o) {
            return false;
        }
        children().remove(this.f);
        children().add((iNumChildren - i3) - 1, this.f);
        if (i2 > i3) {
            i4 = i2;
            i5 = i3;
        } else {
    ...
    public void dispatchDraw() {
        if (this.e) {
            if (visible()) {
                ...
                this.e = z;
                MatrixStack.glColor(alpha(), getDefaultColor());
                for (int i3 = 0; i3 < iNumChildren; i3++) {
                    com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar2 = (com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) getChildAt(i3);
                    if (bVar2.o && bVar2.aI()) {
    ...
    private void a(com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar, a aVar, int i2, float f, float f2) {
        float f3 = f2 / com.tsf.shell.f.i.b.d.FolderShortcutItem.l.j;
        if (!bVar.o) {
            bVar.mouseEnabled(false);
            bVar.o = true;
            bVar.position().y += f;
            ArrayList<ThemeFolderDescription.SystemFolderChild> arrayList = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.c().folder.sampleList;
            int size = i2 > arrayList.size() + (-1) ? arrayList.size() - 1 : i2;
            aVar.f = ((com.tsf.shell.f.i.b.d.FolderShortcutItem.l.a - i2) - 1) * (0.5f / (com.tsf.shell.f.i.b.d.FolderShortcutItem.l.a - 1));
            ...
            aVar.k = number3d2.z;
            aVar.l = number3d3.x;
            float f4 = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.l + (com.tsf.shell.f.i.b.d.FolderShortcutItem.l.i * i2);
            aVar.a = f4;
            aVar.m = f4;
            float f5 = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.w;
            aVar.b = f5;
            aVar.n = f5;
            aVar.c = 0.0f;
            aVar.o = 0.0f;
    ...
    private void a(com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar, a aVar, int i2, float f) {
        if (bVar.o) {
    ...
    public void onDrawStart() {
        ...
        if (this.e) {
            if (!this.k || !this.l) {
                ...
                float f2 = (com.tsf.shell.f.i.b.d.FolderShortcutItem.l.r - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.o) - (((this.o - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x) / (this.n - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x)) * com.tsf.shell.f.i.b.d.FolderShortcutItem.l.t);
                com.tsf.shell.f.i.b.d.FolderShortcutItem.l.I.position().y = f2;
                if (com.tsf.shell.f.i.b.d.FolderShortcutItem.l.o + f2 > com.tsf.shell.f.i.b.d.FolderShortcutItem.l.r) {
                    float f3 = (f2 + com.tsf.shell.f.i.b.d.FolderShortcutItem.l.o) - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.r;
                    if (f3 < com.tsf.shell.f.i.b.d.FolderShortcutItem.l.o) {
                        com.tsf.shell.f.i.b.d.FolderShortcutItem.l.I.c(com.tsf.shell.f.i.b.d.FolderShortcutItem.l.o - f3);
                        com.tsf.shell.f.i.b.d.FolderShortcutItem.l.I.d(com.tsf.shell.f.i.b.d.FolderShortcutItem.l.o);
                    } else {
                        com.tsf.shell.f.i.b.d.FolderShortcutItem.l.I.c(0.0f);
                        float f4 = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.n - f3;
                        if (f4 < com.tsf.shell.f.i.b.d.FolderShortcutItem.l.p) {
                            f4 = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.p;
                        }
                        com.tsf.shell.f.i.b.d.FolderShortcutItem.l.I.d(f4);
                        com.tsf.shell.f.i.b.d.FolderShortcutItem.l.I.position().y = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.r;
                    }
                } else if (f2 - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.o < com.tsf.shell.f.i.b.d.FolderShortcutItem.l.s) {
                    float f5 = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.s - (f2 - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.o);
                    if (f5 < com.tsf.shell.f.i.b.d.FolderShortcutItem.l.o) {
                        com.tsf.shell.f.i.b.d.FolderShortcutItem.l.I.d(com.tsf.shell.f.i.b.d.FolderShortcutItem.l.o - f5);
                        com.tsf.shell.f.i.b.d.FolderShortcutItem.l.I.c(com.tsf.shell.f.i.b.d.FolderShortcutItem.l.o);
                    } else {
                        com.tsf.shell.f.i.b.d.FolderShortcutItem.l.I.d(0.0f);
                        float f6 = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.n - f5;
                        if (f6 < com.tsf.shell.f.i.b.d.FolderShortcutItem.l.p) {
                            f6 = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.p;
                        }
                        com.tsf.shell.f.i.b.d.FolderShortcutItem.l.I.c(f6);
                        com.tsf.shell.f.i.b.d.FolderShortcutItem.l.I.position().y = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.s;
                    }
                }
                com.tsf.shell.f.i.b.d.FolderShortcutItem.l.h();
                if (this.l) {
                    if (this.p < com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x) {
                        this.p += (com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x - this.p) * 0.1f;
                        if (Math.abs(this.p - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x) < 0.2f) {
                            this.p = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x;
                        }
                        ...
                        this.k = true;
                        j = 0.0f;
                        com.tsf.shell.f.i.b.d.FolderShortcutItem.l.i();
                    }
                }
                float f7 = this.o - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.x;
                int size = children().size();
                int i2 = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.a;
                for (int i3 = 0; i3 < size; i3++) {
                    com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar = (com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) children().get((size - 1) - i3);
                    a aVar = this.b.get((size - 1) - i3);
                    if (aVar.h + bVar.maxY() + f7 > com.tsf.shell.f.i.b.d.FolderShortcutItem.l.u) {
                        float fMaxY = ((aVar.h + bVar.maxY()) + f7) - com.tsf.shell.f.i.b.d.FolderShortcutItem.l.u;
                        if (fMaxY >= bVar.maxY()) {
                            aVar.d = 0.0f;
                        } else {
                            aVar.d = (bVar.maxY() - fMaxY) / bVar.maxY();
                        }
                        bVar.scale().x = aVar.d;
                        bVar.scale().y = aVar.d;
                    ...
                    } else if (aVar.h + f7 < com.tsf.shell.f.i.b.d.FolderShortcutItem.l.v) {
                        if (aVar.r) {
                            a(bVar, aVar, i3 % i2, f7);
                            bVar.visible(true);
                            aVar.d = 1.0f;
                            ...
                            a(bVar, aVar, i3 % i2, f7, com.tsf.shell.f.i.b.d.FolderShortcutItem.l.v - (aVar.h + f7));
                        }
                    } else {
                        aVar.r = false;
                        a(bVar, aVar, i3 % i2, f7);
            ...
            if (!this.d) {
                ...
                for (int i4 = 0; i4 < children().size(); i4++) {
                    com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar2 = (com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) children().get(i4);
                    ...
                    if (!aVar2.q) {
                        ...
                        Number3d number3dScale = bVar2.scale();
                        Number3d number3dScale2 = bVar2.scale();
                        float f10 = number3dScale2.y + ((aVar2.d - bVar2.scale().x) * 0.15f);
                        number3dScale2.y = f10;
                        number3dScale.x = f10;
                        float fAJ = bVar2.aJ();
                        bVar2.g(fAJ + ((aVar2.e - fAJ) * 0.15f));
                        float fAlpha = bVar2.alpha();
                        bVar2.alpha(fAlpha + ((aVar2.s - fAlpha) * 0.15f));
                        if (Math.abs(bVar2.aJ() - aVar2.e) < 0.2f && Math.abs(bVar2.alpha() - aVar2.s) < 0.2f && Math.abs(bVar2.position().x - f8) < 0.2f && Math.abs(bVar2.position().y - f9) < 0.2f && Math.abs(bVar2.scale().x - aVar2.d) < 0.01f && Math.abs(bVar2.rotation().z - aVar2.c) < 0.2f) {
                            ...
                            Number3d number3dScale3 = bVar2.scale();
                            Number3d number3dScale4 = bVar2.scale();
                            float f11 = aVar2.d;
                            number3dScale4.y = f11;
                            number3dScale3.x = f11;
                            aVar2.q = true;
                            aVar2.r = false;
                            bVar2.alpha(aVar2.s);
                            bVar2.g(aVar2.e);
    ...
    private void a(a aVar, com.censivn.C3DEngine.b.f.i iVar, int i2) {
        ...
        if (i2 > (iJ * com.tsf.shell.f.i.b.d.FolderShortcutItem.l.a) + (i3 - 1) && bVar.aI()) {
            int i4 = i2 - i3;
            ...
            aVar.f = ((com.tsf.shell.f.i.b.d.FolderShortcutItem.l.a - (i2 % com.tsf.shell.f.i.b.d.FolderShortcutItem.l.a)) - 1) * (0.5f / (com.tsf.shell.f.i.b.d.FolderShortcutItem.l.a - 1));
            aVar.m = aVar.g;
            aVar.n = com.tsf.shell.f.i.b.d.FolderShortcutItem.l.w;
            aVar.o = 0.0f;
            aVar.p = 1.0f;
    ...
    private void x() {
        if (this.e) {
            com.tsf.shell.f.i.b.d.FolderShortcutItem.l.a(numChildren());
        }
    }
