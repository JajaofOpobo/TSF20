...
public class FolderItemPositioner implements ItemStubHelper.a {
    ...
    private void b(boolean z) {
        ...
        Z.useVBO(false);
        if (c().folder.backPlaneEnable) {
            com.censivn.C3DEngine.b.f.a.b bVarA = Z.a(0);
        ...
        if (c().folder.frontPlaneEnable) {
            com.censivn.C3DEngine.b.f.a.b bVarA2 = Z.a(FolderItemDotIndicator);
        ...
        if (c().folder.sizePlaneEnable) {
            com.censivn.C3DEngine.b.f.a.b bVarA3 = Z.a(FolderItemDotIndicator);
        ...
        for (int i3 = 0; i3 < c().folder.sampleCount; i3++) {
            ...
            com.censivn.C3DEngine.b.f.a.b bVarA4 = Z.a(FolderItemDotIndicator);
        ...
        Z.maxX();
        Z.maxY();
        com.censivn.C3DEngine.b.f.a.b bVarA5 = Z.a(FolderItemDotIndicator);
    ...
    public void a(final com.tsf.shell.f.i.b.d.FolderShortcutItem bVar) {
        com.censivn.C3DEngine.A.a().a(new Runnable() { // from class: com.tsf.shell.f.i.b.d.FolderItemPositioner.5
