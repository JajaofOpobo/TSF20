...
public class a extends d {
    ...
    public void a(ArrayList<Integer> arrayList, float f, float f2) {
        ...
        int iAcos2;
        int iAcos3;
        ArrayList<com.tsf.shell.f.e.f.a.c> arrayListC = com.tsf.shell.manager.app.v.e.d().c();
    ...
    public void a() {
        ArrayList<com.tsf.shell.f.e.f.a.c> arrayListC = com.tsf.shell.manager.app.v.e.d().c();
        int iNumChildren = com.tsf.shell.manager.app.v.e.d().d().numChildren();
    ...
    private void a(final com.tsf.shell.f.e.f.a.c cVar, int i, boolean z, float f, float f2, float f3, int i2, com.censivn.C3DEngine.b.g.b bVar) {
        ...
        cVar.d.scale().x = 0.0f;
        cVar.d.scale().y = 0.0f;
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f._d.c.a.a.1
