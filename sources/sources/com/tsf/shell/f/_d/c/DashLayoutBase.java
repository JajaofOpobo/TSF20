...
import com.tsf.shell.f._d.c.a.DashLayoutB;
import com.tsf.shell.f._d.c.a.DashLayoutContainer;
import com.tsf.shell.f._d.c.a.DashLayoutE;
...
public class DashLayoutBase extends DashLayoutPool<d> {
    ...
    public DashLayoutBase() {
        ...
        arrayList.add(new com.tsf.shell.f._d.c.a.DashLayoutA(10, true, true));
        arrayList.add(new com.tsf.shell.f._d.c.a.DashLayoutA(11, false, true));
