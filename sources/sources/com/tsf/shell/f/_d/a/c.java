...
public class c {
    ...
    public void a() {
        ...
        this.a.add(new com.tsf.shell.f._d.a.a.b(70, false));
        this.a.add(new h(0, false));
        this.a.add(new g(10, false));
        this.a.add(new d(40, true));
        this.a.add(new com.tsf.shell.f._d.a.a.a(30, true));
        this.a.add(new com.tsf.shell.f._d.a.a.c(20, true));
        this.a.add(new f(60, true));
        this.h = new com.tsf.shell.f._d.a.a.e(100, false);
        if (!this.g) {
            this.a.add(this.h);
        }
