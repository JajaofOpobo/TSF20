...
public class DashButtonH extends com.tsf.shell.f._d.a.DashElementBase {
    ...
    public void a(final i iVar, Number3d number3d, Number3d number3d2, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f._d.a._a.DashButtonH.1
            @Override // com.censivn.C3DEngine.b.g.TweenParams
            public void a() {
                com.censivn.C3DEngine.b.g.TweenParams dVar2 = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f._d.a._a.DashButtonH.1.1
                    @Override // com.censivn.C3DEngine.b.g.TweenParams
                    public void a() {
                        if (runnable != null) {
                            runnable.run();
