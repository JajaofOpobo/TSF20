...
public class DashButtonA extends com.tsf.shell.f._d.a.DashElementBase {
    ...
    public void a(final com.censivn.C3DEngine.b.f.sprite.TextureSpriteRenderable aVar, final Runnable runnable) {
        ...
        final float f15;
        final float f16;
        final boolean zAK = ((com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) aVar.parent()).aK();
        ...
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f._d.a.a.DashButtonA.1
        ...
        dVar.a((com.censivn.C3DEngine.b.g.TweenCallback) new a.e.C0036a());
    ...
    public void a(final com.censivn.C3DEngine.b.f.sprite.TextureSpriteRenderable aVar, final Runnable runnable, final boolean z) {
        ...
        final float fPxX8 = aVar.points().pxX(com.tsf.shell.manager.o.ButtonPresetManager.a.h);
        final float fPxY8 = aVar.points().pxY(com.tsf.shell.manager.o.ButtonPresetManager.a.h);
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f._d.a.a.DashButtonA.2
            @Override // com.censivn.C3DEngine.b.g.TweenParams
            public void a() {
                if (runnable != null) {
                    runnable.run();
    ...
    public void a(com.censivn.C3DEngine.b.f.sprite.TextureSpriteRenderable aVar) {
        com.censivn.C3DEngine.b.g.TweenUtils.a(aVar);
        ...
        if (!((com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) aVar.parent()).aK()) {
    ...
    private void b(final GridRenderable kVar, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f._d.a.a.DashButtonA.3
            @Override // com.censivn.C3DEngine.b.g.TweenParams
            public void a() {
    ...
    public void c(final GridRenderable kVar, final Runnable runnable) {
        ...
        final float fPxY3 = kVar.points().pxY(2);
        final float fPxY4 = kVar.points().pxY(3);
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f._d.a.a.DashButtonA.4
            @Override // com.censivn.C3DEngine.b.g.TweenParams
            public void a() {
                if (runnable != null) {
                    runnable.run();
