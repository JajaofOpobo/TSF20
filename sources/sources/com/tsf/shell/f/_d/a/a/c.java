...
public class c extends com.tsf.shell.f._d.a.A {
    ...
    public void a(i iVar, Number3d number3d, Number3d number3d2, Runnable runnable) {
        if (iVar.textures().size() != 0 && iVar.textures().get(0).textureElement != null) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f._d.a.a.c.1
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
                    c.this.a.textures().removeAll();
                    com.tsf.shell.manager.app.j.b(c.this.a);
                }
            };
    ...
    public void a(k kVar, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f._d.a.a.c.2
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
