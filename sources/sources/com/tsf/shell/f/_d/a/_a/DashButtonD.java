...
public class DashButtonD extends com.tsf.shell.f._d.a.DashElementBase {
    ...
    public void a(final com.censivn.C3DEngine.b.f._a.AltTextureSpriteRenderable aVar, final Runnable runnable) {
        ...
        float f5 = com.tsf.shell.manager.o.ButtonPresetManager.a.T * 0.7f;
        if (aVar.rotation().z != 0.0f) {
            ...
            f = com.tsf.shell.manager.o.ButtonPresetManager.a.s * f();
            f2 = -f5;
            f3 = com.tsf.shell.manager.o.ButtonPresetManager.a.t * f();
            f4 = f5;
        }
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f._d.a._a.DashButtonD.1
        ...
        dVar.a((com.censivn.C3DEngine.b.g.EasingInterpolator) new DashButtonA.e.C0036a());
    ...
    public void a(final com.censivn.C3DEngine.b.f._a.AltTextureSpriteRenderable aVar, final Runnable runnable, final boolean z) {
        ...
        final float fPxX2 = aVar.points().pxX(com.tsf.shell.manager.o.ButtonPresetManager.a.d);
        final float fPxY2 = aVar.points().pxY(com.tsf.shell.manager.o.ButtonPresetManager.a.d);
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f._d.a._a.DashButtonD.2
            @Override // com.censivn.C3DEngine.b.g.TweenParams
            public void a() {
                if (runnable != null) {
                    runnable.run();
        ...
        dVar.a((com.censivn.C3DEngine.b.g.EasingInterpolator) new DashButtonA.c.C0034a());
        com.censivn.C3DEngine.b.g.TweenUtils.a(aVar);
        com.censivn.C3DEngine.b.g.TweenUtils.a(aVar, 1000, dVar);
    }

    public void a(com.censivn.C3DEngine.b.f._a.AltTextureSpriteRenderable aVar, boolean z) {
        com.censivn.C3DEngine.b.g.TweenUtils.a(aVar);
    ...
    private void b(final GridRenderable kVar, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f._d.a._a.DashButtonD.3
            @Override // com.censivn.C3DEngine.b.g.TweenParams
            public void a() {
    ...
    public void c(final GridRenderable kVar, final Runnable runnable) {
        ...
        final float fPxY = kVar.points().pxY(2);
        final float fPxY2 = kVar.points().pxY(3);
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f._d.a._a.DashButtonD.4
            @Override // com.censivn.C3DEngine.b.g.TweenParams
            public void a() {
                if (runnable != null) {
                    runnable.run();
