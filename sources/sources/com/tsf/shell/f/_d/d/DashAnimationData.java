...
public class DashAnimationData {
    public static Body a(World world, float f, float f2, float f3, float f4, float f5, float f6, boolean z) {
        ...
        Body bodyCreateBody = world.createBody(bodyDef);
        bodyCreateBody.createFixture(fixtureDef);
        if (z) {
            bodyCreateBody.setType(BodyDef.BodyType.StaticBody);
        } else {
            bodyCreateBody.setType(BodyDef.BodyType.DynamicBody);
        }
        return bodyCreateBody;
    }
}
