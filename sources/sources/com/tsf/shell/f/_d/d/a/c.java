...
public class c implements a {
    private int a;
    private com.tsf.shell.f._d.d.c b;
    private com.tsf.shell.f._d.d.c c;
    private Joint d;
    private j e;
    private g f;
    ...
    private void e() {
        this.e = new j();
        this.b = new com.tsf.shell.f._d.d.c(com.tsf.shell.manager.app.v.c.b, 320.0f, 96.0f, 1, 1, true);
        this.b.a.setTransform(0.0f, 0.0f, 0.0f);
        this.c = new com.tsf.shell.f._d.d.c(com.tsf.shell.manager.app.v.c.b, 128.0f, 64.0f, 1, 1, 100, 40, false);
        ...
        revoluteJointDef.localAnchorA.x = (-133.0f) / com.tsf.shell.f._d.d.b.a;
        ...
        this.d = com.tsf.shell.manager.app.v.c.b.b.createJoint(revoluteJointDef);
    }
    ...
    public void b() {
        c();
        com.tsf.shell.manager.app.v.c.g();
    }
