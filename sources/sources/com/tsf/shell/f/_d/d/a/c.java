...
public class c implements a {
    ...
    private void e() {
        this.e = new j();
        this.b = new com.tsf.shell.f._d.d.c(com.tsf.shell.manager.app.v.ObjectHelper.b, 320.0f, 96.0f, 1, 1, true);
        this.b.a.setTransform(0.0f, 0.0f, 0.0f);
        this.c = new com.tsf.shell.f._d.d.c(com.tsf.shell.manager.app.v.ObjectHelper.b, 128.0f, 64.0f, 1, 1, 100, 40, false);
