...
public class A extends h {
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f._d.e.A$a, reason: collision with other inner class name */
    ...
    public A(InterfaceC0090a interfaceC0090a) {
        ...
        while (true) {
            int i4 = i;
            if (i4 < a.size()) {
                com.censivn.C3DEngine.b.f.a.b bVarA = aVar.a(i4);
                bVarA.e(1, 1);
