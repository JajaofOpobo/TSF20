...
public class a extends b {
    ...
    public void a(final com.censivn.C3DEngine.b.f.a.a aVar, Runnable runnable) {
        d dVar = new d() { // from class: com.tsf.shell.f._d.e.a.a.1
    ...
    @Override // com.tsf.shell.f._d.e.a.b, com.tsf.shell.f._d.e.a.InterfaceC0090a
    public void b(final com.censivn.C3DEngine.b.f.a.a aVar, Runnable runnable) {
        d dVar = new d() { // from class: com.tsf.shell.f._d.e.a.a.2
            @Override // com.censivn.C3DEngine.b.g.d
            public void a(float f) {
                aVar.rotation().x = (1.0f - (Math.abs(f - 0.5f) * 2.0f)) * (-30.0f);
            }
    ...
    public void a(g gVar, float f, ArrayList<i> arrayList, Runnable runnable) {
        this.a = gVar;
        com.tsf.shell.manager._a.e.a(gVar.a((b) this, (i) com.tsf.shell.manager._a.e.a(), true).b, f, runnable);
    }
    ...
    public void c() {
        com.tsf.shell.manager._a.e.a().a(this.a.a(true, true).b);
        com.tsf.shell.manager._a.e.a().a(1.0f);
    }

    @Override // com.tsf.shell.f._d.e.a.b
    public void a(final g gVar, ArrayList<i> arrayList, final Runnable runnable, boolean z) {
        if (z) {
            com.tsf.shell.manager._a.e.a(500, new Runnable() { // from class: com.tsf.shell.f._d.e.a.a.3
            ...
            gVar.h();
            com.tsf.shell.manager._a.e.a(0, runnable);
            this.a = null;
        }
    }
