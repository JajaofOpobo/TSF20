...
public class a implements b {
    ...
    @Override // com.tsf.shell.f.f.d._a.b
    public void a() {
    ...
    public void a(final g gVar, com.censivn.C3DEngine.b.g._b.a aVar) {
        ...
        c.a(aVar, 500, new d() { // from class: com.tsf.shell.f.f.d._a.a.1
    ...
    public void b(final g gVar, com.censivn.C3DEngine.b.g._b.a aVar) {
        final float f = gVar.rotation().y;
        d dVar = new d() { // from class: com.tsf.shell.f.f.d._a.a.2
            @Override // com.censivn.C3DEngine.b.g.d
            public void a(float f2) {
    ...
    public void a(int i, ArrayList<g> arrayList, g gVar, boolean z) {
        ...
        for (int i3 = z ? 1 : 0; i3 < i; i3++) {
            ...
            if (gVar2 != gVar) {
                ...
                dVar = new d() { // from class: com.tsf.shell.f.f.d._a.a.3
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a() {
                        a.this.d.b();
                    }
        ...
        if (z) {
            ...
            d dVar2 = new d() { // from class: com.tsf.shell.f.f.d._a.a.4
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
                    g gVar3 = (g) d();
    ...
    public void a(ArrayList<g> arrayList, g gVar, boolean z) {
        ...
        for (int i = z ? 1 : 0; i < size; i++) {
            ...
            if (gVar2 != gVar) {
                d dVar = new d() { // from class: com.tsf.shell.f.f.d._a.a.5
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a() {
                        g gVar3 = (g) d();
                        gVar3.position().y = 0.0f;
        ...
        d dVar2 = new d() { // from class: com.tsf.shell.f.f.d._a.a.6
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
                a.this.d.c();
            }
