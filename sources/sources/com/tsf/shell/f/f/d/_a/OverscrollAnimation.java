package com.tsf.shell.f.f.d._a;
...
public class OverscrollAnimation implements OverscrollHandler {
    public int a;
    public int b;
    private n c;
    ...
    @Override // com.tsf.shell.f.f.d._a.OverscrollHandler
    public void a() {
        if (this.e.position().x != this.i) {
            c.a(this.e);
            PositionNumber3d positionNumber3dPosition = this.e.position();
            positionNumber3dPosition.x = (float) (((double) positionNumber3dPosition.x) + (((double) (this.i - this.e.position().x)) * 0.1d));
    ...
    public void a(final g gVar, com.censivn.C3DEngine.b.g._b.ITweenTarget aVar) {
        ...
        c.a(aVar, 500, new d() { // from class: com.tsf.shell.f.f.d._a.OverscrollAnimation.1
    ...
    public void b(final g gVar, com.censivn.C3DEngine.b.g._b.ITweenTarget aVar) {
        final float f = gVar.rotation().y;
        d dVar = new d() { // from class: com.tsf.shell.f.f.d._a.OverscrollAnimation.2
            @Override // com.censivn.C3DEngine.b.g.TweenParams
            public void a(float f2) {
    ...
    public void a(int i, ArrayList<g> arrayList, g gVar, boolean z) {
        ...
        for (int i3 = z ? 1 : 0; i3 < i; i3++) {
            ...
            if (gVar2 != gVar) {
                ...
                dVar = new d() { // from class: com.tsf.shell.f.f.d._a.OverscrollAnimation.3
                    @Override // com.censivn.C3DEngine.b.g.TweenParams
                    public void a() {
                        a.this.d.b();
                    }
        ...
        if (z) {
            ...
            d dVar2 = new d() { // from class: com.tsf.shell.f.f.d._a.OverscrollAnimation.4
                @Override // com.censivn.C3DEngine.b.g.TweenParams
                public void a() {
                    g gVar3 = (g) d();
    ...
    public void a(ArrayList<g> arrayList, g gVar, boolean z) {
        ...
        for (int i = z ? 1 : 0; i < size; i++) {
            ...
            if (gVar2 != gVar) {
                d dVar = new d() { // from class: com.tsf.shell.f.f.d._a.OverscrollAnimation.5
                    @Override // com.censivn.C3DEngine.b.g.TweenParams
                    public void a() {
                        g gVar3 = (g) d();
                        gVar3.position().y = 0.0f;
        ...
        d dVar2 = new d() { // from class: com.tsf.shell.f.f.d._a.OverscrollAnimation.6
            @Override // com.censivn.C3DEngine.b.g.TweenParams
            public void a() {
                a.this.d.c();
            }
    ...
    @Override // com.tsf.shell.f.f.d._a.OverscrollHandler
    public void a(com.tsf.shell.f.f.d.ScrollStateAggregator aVar) {
        this.d = aVar;
    }
