...
public class CubeInsideTransition extends ItemPageTransition {
    ...
    public void b(com.tsf.shell.f.f.WorkspacePage gVar, float f) {
        ...
        if (f < 0.0f) {
            float f2 = f * 90.0f;
            float fCos = (float) (Math.cos(Math.toRadians(f2)) * ((double) (com.censivn.C3DEngine.b.b.ScreenConstants.D * 0.5f)));
            this.a.position().x = (float) (Math.sin(Math.toRadians(f2)) * ((double) (com.censivn.C3DEngine.b.b.ScreenConstants.D * 0.5f)));
            this.a.position().z = (-fCos) + (com.censivn.C3DEngine.b.b.ScreenConstants.D * 0.5f);
            this.a.rotation().y = -f2;
        } else {
            float f3 = f * 90.0f;
            float fCos2 = (float) (Math.cos(Math.toRadians(f3)) * ((double) (com.censivn.C3DEngine.b.b.ScreenConstants.D * 0.5f)));
            this.a.position().x = (float) (Math.sin(Math.toRadians(f3)) * ((double) (com.censivn.C3DEngine.b.b.ScreenConstants.D * 0.5f)));
            this.a.position().z = (-fCos2) + (com.censivn.C3DEngine.b.b.ScreenConstants.D * 0.5f);
