...
public class i extends com.tsf.shell.f.f.l {
    ...
    public void b(com.tsf.shell.f.f.g gVar, float f) {
        boolean zI = com.tsf.shell.manager.app.f.i();
        ...
        if (f >= 0.0f) {
            if (gVar.g == 0.0f) {
                ...
                this.a.textures().addElement(aVarA.b);
                this.b.textures().clear();
                this.b.textures().addElement(aVarA.b);
                this.b.dispatchDraw();
                this.a.dispatchDraw();
    ...
    private void p() {
        float fAbs = 1.0f - (Math.abs(Math.abs(this.c.rotation().y) - 90.0f) / 90.0f);
        float f = 1.0f - (0.5f * fAbs);
        this.c.vertices().colors().set(0, f, f, f, 1.0f);
        this.c.vertices().colors().set(2, f, f, f, 1.0f);
        float f2 = 1.0f - (0.8f * fAbs);
