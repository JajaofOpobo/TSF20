...
public class FolderTransitionA extends FolderPageTransitionBase {
    private boolean b;
    private boolean c;

    public FolderTransitionA(int i, boolean z, boolean z2, boolean z3) {
        super(i, z3);
        this.b = z;
        this.c = z2;
    }
    ...
    public void a(com.censivn.C3DEngine.b.f.a.TextureSpriteRenderable aVar, Runnable runnable) {
        ...
        while (i < aVar.a()) {
            ...
            com.censivn.C3DEngine.b.g.TweenUtils.a(bVarA, 700, dVar2);
            i++;
            dVar = dVar2;
        }
        if (dVar != null) {
