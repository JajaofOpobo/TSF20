...
public class PageAnimationState {
    ...
    */
    public static com.tsf.shell.f.f.PageAnimationState.a c(java.lang.Object r4) {
        /*
            r1 = 0
            java.util.ArrayList<com.tsf.shell.f.f.PageAnimationState$a> r0 = com.tsf.shell.f.f.PageAnimationState.d
            java.util.Iterator r2 = r0.iterator()
        L7:
            boolean r0 = r2.hasNext()
            if (r0 == 0) goto L18
            java.lang.Object r0 = r2.next()
            com.tsf.shell.f.f.PageAnimationState$A r0 = (com.tsf.shell.f.f.PageAnimationState.a) r0
        ...
        L47:
            ...
            goto L38
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.f.f.PageAnimationState.c(java.lang.Object):com.tsf.shell.f.f.PageAnimationState$a");
    }
