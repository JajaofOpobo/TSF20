...
public class c extends i {
    private b g;
    private com.tsf.shell.f.f.a._c.a h;
    private a i;
    ...
    public static class a extends com.censivn.C3DEngine.b.f.j {
        ...
        public void g() {
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._c.c.a.1
    ...
    public c(final com.tsf.shell.f.f.a.h hVar, com.tsf.shell.f.f.a.f fVar) {
        ...
        this.h = new com.tsf.shell.f.f.a._c.a(this, fVar, hVar);
    ...
    public void a(com.censivn.C3DEngine.b.f.j jVar, com.tsf.shell.f.i.B bVar, int i, float f, float f2) {
        ...
        if (bVar2 != null) {
            ...
            if (fB > f3 || (bVar instanceof com.tsf.shell.f.i._b.d.b) || ((bVar2 instanceof com.tsf.shell.f.i._b.e.b) && !com.tsf.shell.f.i._b.e.b.aR() && bVar2 != this.j)) {
                q();
                r();
                ...
                bVar2 = null;
            } else if (((bVar2 instanceof com.tsf.shell.f.i._b.e.b) || (bVar2 instanceof com.tsf.shell.f.i._b.d.b)) && this.j != bVar2) {
                q();
                if (bVar instanceof com.tsf.shell.f.i._b.e.b) {
                    if (bVar2 instanceof com.tsf.shell.f.i._b.e.b) {
                        com.tsf.shell.f.i._b.e.g gVar = (com.tsf.shell.f.i._b.e.g) bVar2;
                        if (gVar.aC() && !gVar.t()) {
                            gVar.a((com.censivn.C3DEngine.b.f.i) bVar);
                        } else {
                            bVar2 = null;
                        }
                    } else if (bVar2 instanceof com.tsf.shell.f.i._b.d.b) {
                        bVar.f(bVar2);
                    }
                }
            }
    ...
    private void a(com.tsf.shell.f.i.B bVar, com.tsf.shell.f.i.B bVar2) {
        if (bVar2 != this.j) {
            if (this.j instanceof com.tsf.shell.f.i._b.e.b) {
                ((com.tsf.shell.f.i._b.e.b) this.j).b((com.censivn.C3DEngine.b.f.i) bVar);
            } else if (this.j instanceof com.tsf.shell.f.i._b.d.b) {
                bVar.p();
            }
            this.j = bVar2;
        }
    ...
    public void d(com.tsf.shell.f.i.C cVar, MotionEvent motionEvent) {
        ...
        if (z) {
            ...
            if (this.j != null && (cVar instanceof com.tsf.shell.f.i._b.e.b)) {
                jVar.removeChild(this.m);
                if (this.j instanceof com.tsf.shell.f.i._b.e.b) {
                    com.tsf.shell.f.i._b.e.g gVar = (com.tsf.shell.f.i._b.e.g) this.j;
                    com.tsf.shell.f.i._b.d.b bVarA = gVar.a((com.tsf.shell.f.i._b.e.b) cVar, true);
                    r();
                    this.a.a(bVarA, gVar);
    ...
    public void b(com.tsf.shell.f.i.C cVar) {
        ...
        if (cVar instanceof com.tsf.shell.f.i._b.d.b) {
            com.tsf.shell.f.i._b.d.b bVar = (com.tsf.shell.f.i._b.d.b) cVar;
            if (bVar.L()) {
                r();
                ArrayList arrayList2 = new ArrayList();
                Iterator<com.censivn.C3DEngine.b.f.i> it = bVar.aX().children().iterator();
                while (it.hasNext()) {
                    arrayList2.add((com.tsf.shell.f.i._b.e.g) it.next());
                }
                int size = arrayList2.size();
                for (int i = 0; i < size; i++) {
                    com.tsf.shell.f.i._b.e.g gVar = (com.tsf.shell.f.i._b.e.g) arrayList2.get((size - i) - 1);
                    ((com.tsf.shell.f.i._b.d.a) gVar.getMouseEventListener()).a();
                    Number3d.TEMPNUMBER3D.reset();
    ...
    public void a(final com.tsf.shell.f.i.C cVar, MotionEvent motionEvent, final MotionEvent motionEvent2) {
        ...
        if (this.o) {
            ...
            if (!this.y) {
                this.y = true;
                com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.f.f.a._c.c.2
                    ...
                    public void run() {
                        ...
                        if (c.this.o) {
                            ...
                            if (cVar.n() != null && !(cVar.n() instanceof com.tsf.shell.f.i._b.d.b)) {
                                cVar.p();
                            }
                            c.this.z.x = fArrB[0];
                            c.this.z.y = fArrB[1];
