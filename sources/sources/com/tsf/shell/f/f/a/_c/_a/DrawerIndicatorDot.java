...
public class DrawerIndicatorDot extends j {
    ...
    public DrawerIndicatorDot(CircleDotNode.a aVar) {
        this.j = aVar;
    ...
    public j a(TextureElement textureElement) {
        com.censivn.C3DEngine.b.f._a.a aVarA = com.tsf.shell.f.f.a._c.DrawerLabelConfig.a();
        aVarA.a(true);
    ...
    public void b(int i) {
        e();
        if (this.c.id == 0) {
            com.tsf.shell.f.f.a._c.DrawerLabelConfig.a(this.c, this.g, this.f);
        }
        this.d.visible(true);
        d dVar = new d();
        dVar.l(1.0f);
        ...
        d dVar2 = new d() { // from class: com.tsf.shell.f.f.a._c._a.DrawerIndicatorDot.2
    ...
    public void i() {
        d dVar = new d() { // from class: com.tsf.shell.f.f.a._c._a.DrawerIndicatorDot.3
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
