package com.tsf.shell.f.f.a._d.a;
...
public class f extends c {
    public f(int i) {
        ...
        this.a = i;
        this.b = new Comparator<com.tsf.shell.f.i.B>() { // from class: com.tsf.shell.f.f.a._d.a.f.1
            ...
            public final int compare(com.tsf.shell.f.i.B bVar, com.tsf.shell.f.i.B bVar2) {
                ...
                if (!(bVar2 instanceof com.tsf.shell.f.i._b.d.b) && bVar.s() <= bVar2.s()) {
                    return bVar.s() < bVar2.s() ? -1 : 0;
                }
                return 1;
            }
        };
        this.c = new Comparator<i>() { // from class: com.tsf.shell.f.f.a._d.a.f.2
            @Override // java.util.Comparator
            /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
