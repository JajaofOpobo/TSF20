...
public class b extends j {
    ...
    public b(com.tsf.shell.f.f.a.c.k.a aVar) {
        ...
        this.e.alpha(200.0f);
        this.d = a(this.c);
        this.d.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this.d) { // from class: com.tsf.shell.f.f.a.c._a.b.1
    ...
    public void b(int i) {
        ...
        d dVar2 = new d() { // from class: com.tsf.shell.f.f.a.c._a.b.2
    ...
    public void i() {
        d dVar = new d() { // from class: com.tsf.shell.f.f.a.c._a.b.3
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
