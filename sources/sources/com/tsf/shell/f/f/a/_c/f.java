...
public class f extends i {
    ...
    public f(com.tsf.shell.f.f.a.h hVar, com.tsf.shell.f.f.a.f fVar) {
        ...
        this.g = new com.censivn.C3DEngine.b.h.e.b(com.censivn.C3DEngine.b.b.A.D, this.i, com.tsf.shell.manager.o.b.a.U * f, 30.0f * com.censivn.C3DEngine.b.b.A.c * f, 10.0f * com.censivn.C3DEngine.b.b.A.c * f, f) { // from class: com.tsf.shell.f.f.a._c.f.1
            @Override // com.censivn.C3DEngine.b.h.e.b
            public void a(int i) {
                if (i > 0) {
                    com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._c.f.1.1
            ...
            public void b(com.censivn.C3DEngine.b.f.i iVar) {
                ...
                if (cVar != null && cVar.K() != null) {
                    ...
                    com.tsf.shell.manager.app.w.c().a(launcherShortcutAppInfo, 64);
                }
            }
        };
        addChild(this.g);
    ...
    public void e(com.tsf.shell.f.i.C cVar, MotionEvent motionEvent) {
        if ((cVar.parent() instanceof com.tsf.shell.f.f.a.A) && (cVar instanceof com.tsf.shell.f.i._b.e.b)) {
            ...
            if (cVar.K() != null) {
                ...
                com.tsf.shell.manager.app.w.c().a(launcherShortcutAppInfo, 68);
                return;
            }
            return;
        }
