...
@TargetApi(9)
public class DrawerSectionManager {
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.f.a._a.b$b, reason: collision with other inner class name */
    public static class C0102b extends ArrayList<c> {
        public void a(a aVar) {
            ...
            c cVar2 = new DrawerItemContainer(string);
            cVar2.b().add(aVar);
            add(cVar2);
        }
    }
    ...
    public static char a(char c2) {
        if (160 != c2) {
            ...
            for (int length = DrawerVisualFrame.length - 1; length >= 0; length--) {
                if (e[length] <= iC) {
                    return a[length];
                }
            }
    ...
    public static char a(String str) {
        if (str != null && str.length() > 0) {
            ...
            if (!d(upperCase)) {
                if (DrawerItemAnimationManager.contains(Character.valueOf(cB))) {
                    return cB;
                }
    ...
    public static ArrayList<c> a(ArrayList<a> arrayList) {
        ...
        Collections.sort(c0102b, new Comparator<c>() { // from class: com.tsf.shell.f.f.a._a.b.1
    ...
    public static c a(String str, a aVar) {
        c cVar = new DrawerItemContainer(str);
        cVar.b().add(aVar);
        return cVar;
    }

    public static int a(ArrayList<com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData> arrayList, com.tsf.shell.f.f.a._a.a.DrawerWidgetLayoutStrategy bVar) {
        final Collator collator = Collator.getInstance(Locale.getDefault());
        arrayList.add(bVar);
        Collections.sort(arrayList, new Comparator<com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData>() { // from class: com.tsf.shell.f.f.a._a.b.2
            @Override // java.util.Comparator
            /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
            public int compare(com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData cVar, com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData cVar2) {
                if ((cVar instanceof com.tsf.shell.f.f.a._a.a.DrawerWidgetLayoutStrategy) && (cVar2 instanceof com.tsf.shell.f.f.a._a.a.DrawerWidgetLayoutStrategy)) {
                    return collator.compare(((com.tsf.shell.f.f.a._a.a.DrawerWidgetLayoutStrategy) cVar).g(), ((com.tsf.shell.f.f.a._a.a.DrawerWidgetLayoutStrategy) cVar2).g());
                }
