...
public class FolderWidgetTouchHandler extends FolderContentList.a {
    ...
    private void h() {
        ...
        this.a = new com.censivn.C3DEngine.b.h.e.DockRendererB(com.censivn.C3DEngine.b.b.A.D, this.k, com.tsf.shell.manager.o.ButtonPresetManager.a.U * f, 30.0f * com.censivn.C3DEngine.b.b.A.c * f, com.censivn.C3DEngine.b.b.A.c * 10.0f * f, f) { // from class: com.tsf.shell.f.f.a.c.FolderWidgetTouchHandler.2
        ...
        e eVar = new FolderLabelElement(com.tsf.b.d.drawer_layout_folder, i, x.c(com.tsf.b.i.pop_menu_create_folder)) { // from class: com.tsf.shell.f.f.a.c.FolderWidgetTouchHandler.3
            ...
            public void a() {
                ...
                if (iNumChildren > 0) {
                    ...
                    for (com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar2 : arrayList) {
                        bVar2.alpha(255.0f);
                        bVar2.visible(true);
                        bVar2.al();
                        bVar2.an();
    ...
    public void a(int i) {
        ...
        while (true) {
            ...
            if (i3 < this.a.l().numChildren()) {
                com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar = (com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) this.a.l().getChildAt(i3);
                bVar.ak();
                bVar.am();
                i2 = i3 + 1;
            } else {
        ...
        if (iNumChildren > 0) {
            ...
            for (com.censivn.C3DEngine.b.f.IRenderable iVar : arrayList) {
                if (iVar instanceof com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) {
                    ...
                    com.tsf.shell.f.f.a.PageContainerBase aVarE = this.c.e(iB);
    ...
    private boolean k() {
        ...
        for (int i = 0; i < iNumChildren; i++) {
            if (((com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) this.a.l().getChildAt(FolderPageItemBase)).ao()) {
                return true;
            }
        }
        return false;
    ...
    public void a(com.tsf.shell.f.i.ShortcutItem cVar, MotionEvent motionEvent) {
        ...
        if (cVar.parent() == this.a.l() && (cVar instanceof com.tsf.shell.f.i.b.e.DrawerShortcutItemBase)) {
            com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar = (com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) cVar;
            if (!bVar.ao()) {
                bVar.ak();
                bVar.am();
            } else {
        ...
        if ((cVar.parent() instanceof com.tsf.shell.f.f.a.PageContainerBase) && (cVar instanceof com.tsf.shell.f.i.b.d.FolderShortcutItem)) {
    ...
    public void b(com.tsf.shell.f.i.ShortcutItem cVar, MotionEvent motionEvent) {
        ...
        if (jVar == this.a.l()) {
            if (this.e == 0) {
                ...
                while (it2.hasNext()) {
                    arrayList.add((com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) it2.next());
                }
            }
