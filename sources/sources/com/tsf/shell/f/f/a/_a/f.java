...
public class f {
    ...
    private j c = new j() { // from class: com.tsf.shell.f.f.a._a.f.1
    };
    private ArrayList<com.tsf.shell.f.f.a._a.a.c> i = new ArrayList<>();
    ...
    public f(c cVar) {
        this.b = cVar;
        this.h.alpha(0.0f);
        this.d = new j() { // from class: com.tsf.shell.f.f.a._a.f.2
            ...
            public void onDrawStart() {
                ...
                for (int i = 0; i < iNumChildren; i++) {
                    ...
                    if (childAt.getAnimationObjectState()) {
                        ...
                        if (!f.this.g) {
                            com.tsf.shell.f.f.a._a.a.c cVar2 = (com.tsf.shell.f.f.a._a.a.c) childAt.getTag();
                            number3d.x = cVar2.t();
                            number3d.y = cVar2.s();
                            aVar.d = 1.0f;
                        }
                        ...
                        if (Math.abs(childAt.position().x - number3d.x) < 0.2f && Math.abs(childAt.position().y - number3d.y) < 0.2f && Math.abs(childAt.scale().x - aVar.d) < 0.01f) {
                            ...
                            if (!f.this.g) {
                                f.this.i.add((com.tsf.shell.f.f.a._a.a.c) childAt.getTag());
                            }
                        }
                    }
                }
            ...
            public void onDrawEnd() {
                ...
                while (it.hasNext()) {
                    ((com.tsf.shell.f.f.a._a.a.c) it.next()).n();
                }
                f.this.i.clear();
            }
    ...
    private void h() {
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._a.f.4
    ...
    public void j() {
        if (this.g && this.k != this.j) {
            ...
            this.k = this.j;
            if (this.k != -1) {
                com.tsf.shell.f.f.a._a.a.c cVar = arrayListH.get(this.k);
                if (this.k == 0) {
                    this.b.d();
                } else {
                    this.b.b(cVar);
    ...
    public void f() {
        ...
        for (com.tsf.shell.f.f.a._a.a.c cVar : this.b.h()) {
            cVar.l().setAnimationObjectState(true);
            cVar.p();
        }
    }
