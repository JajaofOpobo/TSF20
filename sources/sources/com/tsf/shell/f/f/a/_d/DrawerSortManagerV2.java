...
import com.tsf.shell.f.f.a._d._a.DrawerNameSortV2;
import com.tsf.shell.f.f.a._d._a.DrawerSortBaseV2;
import com.tsf.shell.f.f.a._d._a.DrawerIndexSortV2;
import com.tsf.shell.f.f.a._d._a.DrawerLatestSortV2;
...
public class DrawerSortManagerV2 {
    private e b;
    private c d;
    private d e;
    ...
    public A(e eVar) {
        ...
        this.c.add(new f(1));
        this.c.add(new com.tsf.shell.f.f.a._d._a.DrawerAlphabeticalSortV2(3));
        this.e = new d(0);
