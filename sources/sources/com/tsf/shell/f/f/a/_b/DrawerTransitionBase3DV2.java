...
public abstract class DrawerTransitionBase3DV2 extends DrawerTransitionBaseV2 {
    ...
    public DrawerTransitionBase3DV2(int i, int i2, boolean z) {
        ...
        this.l = true;
        this.i = new Number3d();
        this.j = new DrawerBottleTransitionV2();
    ...
    public void a(com.tsf.shell.f.f.a.PageContainerBase aVar, int i) {
        aVar.b(DrawerScaleTransitionV2);
    }

    private void b(com.tsf.shell.f.f.a.PageContainerBase aVar, int i) {
        aVar.c(DrawerScaleTransitionV2);
    }

    private void a(com.tsf.shell.f.f.a.PageContainerBase aVar, boolean z) {
        aVar.b(z);
    }

    private int i(com.tsf.shell.f.f.a.PageContainerBase aVar) {
        return aVar.r();
    }

    private int j(com.tsf.shell.f.f.a.PageContainerBase aVar) {
        return aVar.s();
    }

    private boolean k(com.tsf.shell.f.f.a.PageContainerBase aVar) {
        return aVar.t();
    }
    ...
    public b a(int i) {
        b bVar;
        if (i < this.g.size()) {
            bVar = this.g.get(DrawerScaleTransitionV2);
        } else {
            bVar = new DrawerCylinderTransitionV2();
            this.g.add(bVar);
        }
        bVar.a();
        return bVar;
    ...
    public void a(com.tsf.shell.f.f.a.PageContainerBase aVar) {
        ...
        for (int i = 0; i < iNumChildren; i++) {
            com.tsf.shell.f.i.PageItem bVar = (com.tsf.shell.f.i.PageItem) aVar.getChildAt(DrawerScaleTransitionV2);
            Number3d number3d = this.h.get(DrawerScaleTransitionV2);
    ...
    public void a(com.tsf.shell.f.f.a.PageContainerBase aVar, float f) {
        float f2;
        float f3;
        float fAbs = Math.abs(DrawerRotationYTransitionV2);
        int iNumChildren = aVar.numChildren();
        ...
        while (it.hasNext()) {
            ...
            if (jVar2.visible()) {
                ...
                while (true) {
                    int i = size;
                    if (i > -1) {
                        this.k.add(arrayListChildren.get(DrawerScaleTransitionV2));
                        size = i - 1;
                    }
                }
            }
    ...
    public void g(com.tsf.shell.f.f.a.PageContainerBase aVar) {
        if (i(aVar) != c) {
            int iNumChildren = aVar.numChildren();
            for (int i = 0; i < iNumChildren; i++) {
                com.censivn.C3DEngine.b.g.TweenUtils.b((com.censivn.C3DEngine.b.f.BaseRenderable) aVar.getChildAt(DrawerScaleTransitionV2));
            }
    ...
    public void h(com.tsf.shell.f.f.a.PageContainerBase aVar) {
        if (i(aVar) != c) {
            int iNumChildren = aVar.numChildren();
            for (int i = 0; i < iNumChildren; i++) {
                com.censivn.C3DEngine.b.g.TweenUtils.c((com.censivn.C3DEngine.b.f.BaseRenderable) aVar.getChildAt(DrawerScaleTransitionV2));
            }
            com.censivn.C3DEngine.b.g.TweenUtils.c(aVar);
        }
    }

    private void b(final com.tsf.shell.f.f.a.PageContainerBase aVar, boolean z) {
        b bVar;
        b bVar2;
        this.l = false;
        a(aVar, false);
        ...
        if ((aVar.getChildAt(0).rotation().x != this.g.get(0).e || aVar.getChildAt(0).rotation().y != this.g.get(0).d || aVar.getChildAt(0).rotation().z != this.g.get(0).f || i(aVar) == b) && i(aVar) != a) {
            if (z) {
                ...
                b(aVar, a);
                for (int i = 0; i < iNumChildren; i++) {
                    com.censivn.C3DEngine.b.f.BaseRenderable jVar = (com.censivn.C3DEngine.b.f.BaseRenderable) aVar.getChildAt(DrawerScaleTransitionV2);
                    if (i >= this.e) {
                        bVar2 = this.g.get(this.e - 1);
                    } else {
                        bVar2 = this.g.get(DrawerScaleTransitionV2);
                    }
                    b bVar3 = bVar2;
                ...
                com.censivn.C3DEngine.b.g.TweenParams dVar2 = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.f.a._b.DrawerTransitionBase3DV2.1
            ...
            com.censivn.C3DEngine.b.g.TweenParams dVar3 = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.f.a._b.DrawerTransitionBase3DV2.2
                @Override // com.censivn.C3DEngine.b.g.TweenParams
                public void a() {
                    m.this.a(aVar, m.c);
                }
    ...
    private void l(com.tsf.shell.f.f.a.PageContainerBase aVar) {
        b bVar;
        this.l = false;
        a(aVar, c);
        b(aVar, a);
    ...
    private void m(com.tsf.shell.f.f.a.PageContainerBase aVar) {
        Number3d number3d;
        this.l = true;
        a(aVar, c);
        b(aVar, b);
        ...
        if (iNumChildren != 0) {
            for (int i = 0; i < iNumChildren; i++) {
                ...
                if (i >= this.e) {
                    ...
                    number3d = this.h.get(DrawerScaleTransitionV2);
                }
    ...
    private void n(final com.tsf.shell.f.f.a.PageContainerBase aVar) {
        Number3d number3d;
        a(aVar, false);
        int iNumChildren = aVar.numChildren();
        if ((aVar.getChildAt(0).rotation().x != 0.0f || aVar.getChildAt(0).rotation().y != 0.0f || aVar.getChildAt(0).rotation().z != 0.0f || i(aVar) == a) && i(aVar) != b) {
            ...
            com.censivn.C3DEngine.b.g.TweenParams dVar2 = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.f.a._b.DrawerTransitionBase3DV2.3
                @Override // com.censivn.C3DEngine.b.g.TweenParams
                public void a() {
                    m.this.a(aVar, m.c);
                    m.this.l = true;
