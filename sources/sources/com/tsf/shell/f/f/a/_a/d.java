...
import com.tsf.b;
import com.tsf.shell.manager._a.g;
...
public class d extends com.tsf.shell.f.f.a._a.a.a {
    private g.b a;
    private com.tsf.shell.f.e.D<com.tsf.shell.f.i._b.e.e> b;
    ...
    public d(c cVar) {
        ...
        this.a = new g.b() { // from class: com.tsf.shell.f.f.a._a.d.2
            @Override // com.tsf.shell.manager._a.g.b
            public void a(ArrayList<com.tsf.shell.f.i._b.e.g> arrayList) {
                d.this.g();
            }
        };
        com.tsf.shell.manager._a.w.a().a().a(this.a);
        ...
        i().addChild(this.e);
        this.e.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this.e) { // from class: com.tsf.shell.f.f.a._a.d.4
    ...
    public void e() {
        super.e();
        com.tsf.shell.f.f.a._a.b.b.a(this.e, this.f - c.a, this.f);
    }

    @Override // com.tsf.shell.f.f.a._a.a.c, com.censivn.C3DEngine.b.b.c
    public void c(int i) {
        super.c(i);
        this.e.position().x = r();
        if (q() == c.b) {
    ...
    @Override // com.tsf.shell.f.f.a._a.a.a, com.tsf.shell.f.f.a._a.a.c
    public void f() {
        super.f();
        if (this.d.id != 0) {
    ...
    public void g() {
        v();
        int iK = k() * 3;
        for (com.tsf.shell.f.i._b.e.g gVar : com.tsf.shell.manager._a.w.a().a().a(iK <= 12 ? iK : 12)) {
