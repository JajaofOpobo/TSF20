...
public class FolderIndicatorDot extends BaseRenderable {
    ...
    private float h;
    private float i;
    private com.tsf.shell.f.f.a.c.FolderSettingsPage.a j;
    private e.a m;
    ...
    public FolderIndicatorDot(com.tsf.shell.f.f.a.c.FolderSettingsPage.a aVar) {
        ...
        this.e.alpha(200.0f);
        this.d = a(this.c);
        this.d.setMouseEventListener(new com.censivn.C3DEngine.b.d.MouseEventListener(this.d) { // from class: com.tsf.shell.f.f.a.c._a.FolderIndicatorDot.1
    ...
    public void b(int i) {
        e();
        if (this.c.id == 0) {
            com.tsf.shell.f.f.a.c.FolderLabelConfig.a(this.c, this.g, this.f);
        }
        this.d.visible(true);
        d dVar = new d();
        dVar.l(1.0f);
