...
public class DrawerItemAnimationManager {
    public static final float a = com.censivn.C3DEngine.b.b.ScreenConstants.a(150.0f);
    private c b;
    ...
    public DrawerItemAnimationManager(c cVar) {
        ...
        this.d = new BaseRenderable() { // from class: com.tsf.shell.f.f.a._a.DrawerItemAnimationManager.2
            ...
            public void onDrawStart() {
                ...
                for (int i = 0; i < iNumChildren; i++) {
                    ...
                    if (childAt.getAnimationObjectState()) {
                        ...
                        if (!f.this.g) {
                            com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData cVar2 = (com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData) childAt.getTag();
                            number3d.x = cVar2.t();
                            number3d.y = cVar2.s();
                            aVar.d = 1.0f;
                        }
                        ...
                        if (Math.abs(childAt.position().x - number3d.x) < 0.2f && Math.abs(childAt.position().y - number3d.y) < 0.2f && Math.abs(childAt.scale().x - aVar.d) < 0.01f) {
                            ...
                            if (!f.this.g) {
                                f.this.i.add((com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData) childAt.getTag());
                            }
                        }
                    }
                }
            ...
            public void onDrawEnd() {
                ...
                while (it.hasNext()) {
                    ((com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData) it.next()).n();
                }
                f.this.i.clear();
            }
        ...
        this.f = new com.tsf.shell.f.e.ObjectPool<a>() { // from class: com.tsf.shell.f.f.a._a.DrawerItemAnimationManager.3
    ...
    private void g() {
        if (this.b.b() == DrawerItemContainer.b) {
    ...
    public void a() {
        this.h.b(com.censivn.C3DEngine.b.b.ScreenConstants.G);
        this.h.a(com.censivn.C3DEngine.b.b.ScreenConstants.F);
    }

    public void a(MotionEvent motionEvent) {
        a(0.0f - (motionEvent.getY() - com.censivn.C3DEngine.b.b.ScreenConstants.I));
    }
    ...
    public void j() {
        if (this.g && this.k != this.j) {
            ArrayList<com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData> arrayListH = this.b.h();
            if (this.k != -1) {
            ...
            this.k = this.j;
            if (this.k != -1) {
                com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData cVar = arrayListH.get(this.k);
                if (this.k == 0) {
                    this.b.d();
                } else {
                    this.b.b(cVar);
    ...
    public float d() {
        ...
        return (float) (Math.cos((3.141592653589793d - (((double) (size - 1)) * (Math.asin((fA / 2.0f) / r2) * 2.0d))) / 2.0d) * ((double) (com.censivn.C3DEngine.b.b.ScreenConstants.B * 2)));
    }
    ...
    public void e() {
        ...
        float fA = com.censivn.C3DEngine.b.b.ScreenConstants.a(50.0f);
        float f = com.censivn.C3DEngine.b.b.ScreenConstants.B * 2;
        double dAsin = Math.asin((fA / 2.0f) / f) * 2.0d;
        double d = (3.141592653589793d - (((double) (size - 1)) * dAsin)) / 2.0d;
        float fSin = ((float) (Math.sin(DrawerDragEffectController) * ((double) f))) - com.censivn.C3DEngine.b.b.ScreenConstants.a(50.0f);
        this.l = 0.0f;
        this.m = 0.0f;
        double d2 = d;
        for (int i = 0; i < size; i++) {
            com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData cVar = arrayListH.get(i);
            i iVarM = cVar.m();
            a aVarC = this.f.c();
            aVarC.b.x = (((float) (Math.sin(d2) * ((double) f))) - fSin) + com.censivn.C3DEngine.b.b.ScreenConstants.z;
            if (iB == DrawerItemContainer.c) {
                aVarC.b.x = -aVarC.b.x;
            }
    ...
    public void f() {
        ...
        for (com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData cVar : this.b.h()) {
            cVar.l().setAnimationObjectState(true);
            cVar.p();
        }
    }
