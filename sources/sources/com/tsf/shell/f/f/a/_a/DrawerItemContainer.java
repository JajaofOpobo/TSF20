...
public class DrawerItemContainer {
    ...
    public com.tsf.shell.f.f.a._a.a.DrawerWidgetLayoutStrategy a(String str) {
    ...
    public DrawerItemContainer() {
        ...
        this.k = new DrawerItemAnimationManager(this);
        ...
        this.h = new com.tsf.shell.f.e.ObjectPool<com.tsf.shell.f.f.a._a.a.DrawerWidgetLayoutStrategy>() { // from class: com.tsf.shell.f.f.a._a.DrawerItemContainer.7
            ...
            public com.tsf.shell.f.f.a._a.a.DrawerWidgetLayoutStrategy b() {
                return new com.tsf.shell.f.f.a._a.a.DrawerWidgetLayoutStrategy(c.this);
            }
        };
    }

    public void a(com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData cVar) {
        c(cVar);
    }
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.f.a._a.DrawerItemContainer$8, reason: invalid class name */
        ...
        if (this.e.parent() == null && com.tsf.shell.manager.app.ServiceProvider.a().b()) {
            ...
            Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.f.a._a.DrawerItemContainer.10
                ...
                public void run() {
                    ...
                    while (it.hasNext()) {
                        com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData cVarA = c.this.a(it.next());
    ...
    private void c(com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData cVar) {
        ...
        if (!(cVar instanceof d)) {
            this.h.a((com.tsf.shell.f.f.a._a.a.DrawerWidgetLayoutStrategy) cVar);
        }
    }
    ...
    public ArrayList<com.tsf.shell.f.f.a._a.a.DrawerItemLayoutData> h() {
        return this.i;
    }
