...
public class DrawerContentList extends DrawerPageItemBase {
    ...
    public static class a extends com.censivn.C3DEngine.b.f.j {
        ...
        public void g() {
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._c.DrawerContentList.a.1
    ...
    public c(final com.tsf.shell.f.f.a.FolderPage hVar, com.tsf.shell.f.f.a.PageGridRenderer fVar) {
