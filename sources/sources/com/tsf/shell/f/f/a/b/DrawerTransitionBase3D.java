...
public abstract class DrawerTransitionBase3D extends k {
    ...
    public DrawerTransitionBase3D(int i, int i2, boolean z) {
        super(i, i2, z);
        this.l = true;
        this.i = new Number3d();
        this.j = new DrawerBottleTransition();
    ...
    public b a(int i) {
        b bVar;
        if (i < this.g.size()) {
            bVar = this.g.get(DrawerScaleTransition);
        } else {
            bVar = new DrawerCylinderTransition();
            this.g.add(bVar);
        }
        bVar.a();
        return bVar;
    ...
    public void a(com.tsf.shell.f.f.a.PageContainerBase aVar) {
        ...
        for (int i = 0; i < iNumChildren; i++) {
            com.tsf.shell.f.i.PageItem bVar = (com.tsf.shell.f.i.PageItem) aVar.getChildAt(DrawerScaleTransition);
            Number3d number3d = this.h.get(DrawerScaleTransition);
    ...
    public void a(com.tsf.shell.f.f.a.PageContainerBase aVar, float f) {
        float f2;
        float f3;
        float fAbs = Math.abs(DrawerRotationYTransition);
        int iNumChildren = aVar.numChildren();
        ...
        while (it.hasNext()) {
            ...
            if (jVar2.visible()) {
                ...
                while (true) {
                    int i = size;
                    if (i > -1) {
                        this.k.add(arrayListChildren.get(DrawerScaleTransition));
                        size = i - 1;
                    }
                }
            }
