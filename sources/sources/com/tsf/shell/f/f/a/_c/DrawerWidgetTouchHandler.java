...
import com.tsf.shell.f.f.a._c.DrawerContentList;
...
public class DrawerWidgetTouchHandler extends DrawerContentList.a {
    ...
    private void h() {
        ...
        e eVar = new DrawerLabelElement(com.tsf.b.d.drawer_layout_folder, i, x.c(com.tsf.b.i.pop_menu_create_folder)) { // from class: com.tsf.shell.f.f.a._c.DrawerWidgetTouchHandler.3
            @Override // com.tsf.shell.f.f.a._c.DrawerLabelElement
            public void a() {
        ...
        this.f = eVar;
        this.d.add(eVar);
        e eVar2 = new DrawerLabelElement(com.tsf.b.d.drawer_layout_reset, i, x.c(com.tsf.b.i.text_reset)) { // from class: com.tsf.shell.f.f.a._c.DrawerWidgetTouchHandler.4
            @Override // com.tsf.shell.f.f.a._c.DrawerLabelElement
            public void a() {
                b.this.i();
            }
    ...
    public void b(int i) {
        j();
        if (i > 0) {
            com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.f.a._c.DrawerWidgetTouchHandler.5
    ...
    private boolean k() {
        ...
        for (int i = 0; i < iNumChildren; i++) {
            if (((com.tsf.shell.f.i._b.e.WidgetDrawerShortcutItemBase) this.a.l().getChildAt(DrawerPageItemBase)).ao()) {
                return true;
            }
        }
        return false;
    ...
    public void a(com.tsf.shell.f.i.ShortcutItem cVar, MotionEvent motionEvent) {
        ...
        if ((cVar.parent() instanceof com.tsf.shell.f.f.a.PageContainerBase) && (cVar instanceof com.tsf.shell.f.i._b.d.WorkspaceShortcutItem)) {
