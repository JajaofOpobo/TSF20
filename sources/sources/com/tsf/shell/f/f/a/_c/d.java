...
public class d extends i {
    ...
    private com.tsf.shell.f.f.a._b.l h;
    ...
    private void c() {
        ...
        this.g.a(new com.censivn.C3DEngine.b.h.b.b() { // from class: com.tsf.shell.f.f.a._c.d.1
            ...
            public com.censivn.C3DEngine.b.f.i a(int i, com.censivn.C3DEngine.b.f.i iVar) {
                ...
                com.tsf.shell.f.f.a._b.k kVarA = d.this.h.a(i);
        ...
        this.g.a(new com.censivn.C3DEngine.b.h.b.f() { // from class: com.tsf.shell.f.f.a._c.d.2
            @Override // com.censivn.C3DEngine.b.h.b.f
            public void a(com.censivn.C3DEngine.b.f.i iVar, int i, MotionEvent motionEvent) {
                w.b();
                if (!com.tsf.shell.manager.app.h.t().an().c()) {
                    d.this.a.d(i);
                    w.b();
                }
                d.this.g.d();
        ...
        arrayList.add(new com.tsf.shell.f.e._g.a.a.C0095a(b.d.effect_setting_desktop_menu_random, x.c(b.i.text_random), new com.tsf.shell.f.e._g.a.a.C0095a.C0096a() { // from class: com.tsf.shell.f.f.a._c.d.3
