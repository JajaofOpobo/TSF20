...
public class DrawerTriangularTransitionV2 extends DrawerTransitionBaseV2 {
    private int a;
    private int b;
    private int c;
    ...
    public DrawerTriangularTransitionV2(int i, boolean z) {
        super(i, DrawerCylinderTransitionV2.d.drawer_transition_effect_round, z);
    }
    ...
    public void a(int i, int i2, int i3, int i4, ArrayList<Number3d> arrayList) {
        ...
        if (i > i2) {
            i5 = (int) ((i2 / 2) - (68.0f * com.censivn.C3DEngine.b.b.ScreenConstants.a));
        } else {
            i5 = (int) ((i / 2) - (68.0f * com.censivn.C3DEngine.b.b.ScreenConstants.a));
        }
        for (int i6 = 1; i6 < this.b + 1; i6++) {
            ArrayList<a> arrayList2 = new ArrayList<>();
            double d = 6.283185307179586d / ((double) i6);
            float f = 360 / i6;
            int i7 = this.c - 1;
            for (int i8 = 0; i8 < i6; i8++) {
                a aVar = new DrawerBottleTransitionV2();
                aVar.a = (float) (Math.sin(((double) i7) * d) * ((double) i5));
                aVar.b = (float) (Math.cos(((double) i7) * d) * ((double) i5));
                aVar.c = 180.0f - (i7 * f);
                arrayList2.add(aVar);
                i7--;
                if (i7 == -1) {
    ...
    public void a(com.tsf.shell.f.f.a.PageContainerBase aVar, float f) {
        ...
        if (Math.abs(DrawerRotationYTransitionV2) > 0.5d) {
            aVar.rotation().z = (-(f - 0.5f)) * 2.0f * 180.0f;
        } else {
            aVar.rotation().z = 0.0f;
        }
        float fAbs = Math.abs(f * 2.0f);
        float f2 = fAbs > 1.0f ? 1.0f : fAbs;
        if (iNumChildren != 0) {
            ArrayList<a> arrayList = this.d.get(iNumChildren - 1);
            for (int i = 0; i < iNumChildren; i++) {
                com.censivn.C3DEngine.b.f.IRenderable childAt = aVar.getChildAt(DrawerScaleTransitionV2);
                if (i >= this.b) {
                    aVar2 = arrayList.get(this.b - 1);
                    number3d = this.e.get(this.b - 1);
                } else {
                    aVar2 = arrayList.get(DrawerScaleTransitionV2);
                    number3d = this.e.get(DrawerScaleTransitionV2);
                }
