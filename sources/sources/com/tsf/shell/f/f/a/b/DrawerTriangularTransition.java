...
public class DrawerTriangularTransition extends DrawerTransitionBase {
    private int a;
    private int b;
    private int c;
    ...
    public void a(int i, int i2, int i3, int i4, ArrayList<Number3d> arrayList) {
        ...
        for (int i6 = 1; i6 < this.b + 1; i6++) {
            ...
            for (int i8 = 0; i8 < i6; i8++) {
                a aVar = new DrawerBottleTransition();
    ...
    public void a(com.tsf.shell.f.f.a.PageContainerBase aVar, float f) {
        ...
        if (Math.abs(DrawerRotationYTransition) > 0.5d) {
        ...
        if (iNumChildren != 0) {
            ...
            for (int i = 0; i < iNumChildren; i++) {
                ...
                if (i >= this.b) {
                    ...
                    aVar2 = arrayList.get(DrawerScaleTransition);
                    number3d = this.e.get(DrawerScaleTransition);
                }
