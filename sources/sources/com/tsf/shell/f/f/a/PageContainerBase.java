...
public class PageContainerBase extends PageContainerView {
    ...
    public void a() {
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                i next = it.next();
                if (next instanceof com.tsf.shell.f.i.PageItem) {
    ...
    public void a(i iVar, int i, boolean z) {
        ...
        if (iNumChildren == h.m) {
            ...
            if (this.g && com.tsf.shell.manager.app.StateHub.n().t() == -1 && !com.tsf.shell.manager.app.StateHub.t().aq()) {
    ...
    public com.tsf.shell.f.i.PageItem c() {
