...
public class c {
    ...
    class a implements com.tsf.shell.manager._a.c.a {
        a() {
        }
    ...
    public void a() {
        this.q = this.q == b ? c : b;
        Iterator<com.tsf.shell.f.f.a._a.a.c> it = this.i.iterator();
        while (it.hasNext()) {
    ...
    public com.tsf.shell.f.f.a._a.a.b a(String str) {
        for (com.tsf.shell.f.f.a._a.a.c cVar : this.i) {
            if (cVar instanceof com.tsf.shell.f.f.a._a.a.b) {
                com.tsf.shell.f.f.a._a.a.b bVar = (com.tsf.shell.f.f.a._a.a.b) cVar;
    ...
    public c() {
        ...
        this.n = new a() { // from class: com.tsf.shell.f.f.a._a.c.1
            @Override // com.tsf.shell.f.f.a._a.c.a, com.tsf.shell.manager._a.c.a
            public void a(g gVar, boolean z) {
        ...
        this.l = new e(this);
        this.m = new d(this);
        this.e = new j() { // from class: com.tsf.shell.f.f.a._a.c.3
        ...
        this.j = new n();
        com.censivn.C3DEngine.b.d.a aVar = new com.censivn.C3DEngine.b.d.a(this.j) { // from class: com.tsf.shell.f.f.a._a.c.6
    ...
    public void a(com.tsf.shell.f.f.a._a.a.c cVar) {
        c(cVar);
    }
    ...
    public void b(com.tsf.shell.f.f.a._a.a.c cVar) {
    ...
    public void j() {
        ...
        this.p.alpha(0.0f);
        com.tsf.shell.manager._a.j.a(this.p);
        this.p.a(new AnonymousClass8(fA, fD), 0);
    }

    /* JADX INFO: renamed from: com.tsf.shell.f.f.a._a.c$8, reason: invalid class name */
        ...
        public void run() {
            c.this.p.a(com.censivn.C3DEngine.b.b.A.z + com.censivn.C3DEngine.b.b.A.a(50.0f), this.b, 600, new Runnable() { // from class: com.tsf.shell.f.f.a._a.c.8.1
                ...
                public void run() {
                    ...
                    final float f = fC - fB;
                    c.this.p.a(-20.0f, new Runnable() { // from class: com.tsf.shell.f.f.a._a.c.8.1.1
                        @Override // java.lang.Runnable
                        public void run() {
                            c.this.a(fB, fC, f);
                        }
    ...
    class AnonymousClass9 extends com.censivn.C3DEngine.b.g.d {
        ...
        public void a() {
            com.censivn.C3DEngine.b.g.c.a(new com.censivn.C3DEngine.b.g._b.b(), 1500, new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._a.c.9.1
                ...
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
                    c.this.p.b(new Runnable() { // from class: com.tsf.shell.f.f.a._a.c.9.1.1
                        @Override // java.lang.Runnable
                        public void run() {
                            c.this.l();
    ...
    public void f() {
        if (this.e.parent() == null && com.tsf.shell.manager._a.w.a().b()) {
            this.o = com.tsf.shell.manager.p.c.b(14);
            if (this.o) {
                this.e.mouseEnabled(false);
            }
            com.tsf.shell.manager._a.w.a().a(this.n);
            this.e.alpha(255.0f);
            final j jVarA = com.tsf.shell.manager._a.j.a(this.g);
            boolean zAM = com.tsf.shell.manager._a.h.t().aM();
            Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.f.a._a.c.10
                @Override // java.lang.Runnable
                public void run() {
                    com.tsf.shell.manager._a.h.t().aN();
                    ArrayList<g> arrayListD = com.tsf.shell.manager._a.w.a().d();
                    ...
                    ArrayList<com.tsf.shell.f.f.a._a.B.c> arrayListA = b.a((ArrayList<b.a>) arrayList);
                    c.this.f.addChild(c.this.m);
                    c.this.i.add(c.this.m);
                    c.this.m.a(c.this.q, false);
                    c.this.m.e();
                    Iterator<com.tsf.shell.f.f.a._a.B.c> it = arrayListA.iterator();
                    while (it.hasNext()) {
                        com.tsf.shell.f.f.a._a.a.c cVarA = c.this.a(it.next());
                    ...
                    com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._a.c.10.1
                        @Override // com.censivn.C3DEngine.b.g.d
                        public void a() {
            ...
            if (zAM) {
                ...
                com.tsf.shell.manager._a.j.a(runnable);
            }
        }
    }

    private void c(com.tsf.shell.f.f.a._a.a.c cVar) {
        this.i.remove(cVar);
        cVar.f();
        cVar.removeFromParent();
        if (!(cVar instanceof d)) {
            this.h.a((com.tsf.shell.f.f.a._a.a.b) cVar);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public com.tsf.shell.f.f.a._a.a.c a(com.tsf.shell.f.f.a._a.B.c cVar) {
        com.tsf.shell.f.f.a._a.a.b bVarC = this.h.c();
        bVarC.a(cVar);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public com.tsf.shell.f.f.a._a.a.c b(com.tsf.shell.f.f.a._a.B.c cVar) {
        com.tsf.shell.f.f.a._a.a.b bVarC = this.h.c();
        bVarC.a(cVar);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public com.tsf.shell.f.f.a._a.a.b a(g gVar) {
        for (com.tsf.shell.f.f.a._a.a.c cVar : this.i) {
            if (cVar instanceof com.tsf.shell.f.f.a._a.a.b) {
                com.tsf.shell.f.f.a._a.a.b bVar = (com.tsf.shell.f.f.a._a.a.b) cVar;
                if (bVar.c(gVar)) {
        ...
        com.tsf.shell.manager._a.j.a(new Runnable() { // from class: com.tsf.shell.f.f.a._a.c.2
            ...
            public void run() {
                ...
                for (com.tsf.shell.f.f.a._a.a.c cVar : c.this.i) {
                    ...
                    cVar.removeFromParent();
                    if (!(cVar instanceof d)) {
                        c.this.h.a((com.tsf.shell.f.f.a._a.a.b) cVar);
                    }
    ...
    public ArrayList<com.tsf.shell.f.f.a._a.a.c> h() {
        return this.i;
    }
