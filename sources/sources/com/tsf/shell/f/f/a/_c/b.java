...
public class b extends c.a {
    ...
    private void h() {
        ...
        e eVar = new e(b.d.drawer_layout_folder, i, x.c(b.i.pop_menu_create_folder)) { // from class: com.tsf.shell.f.f.a._c.b.3
        ...
        this.f = eVar;
        this.d.add(eVar);
        e eVar2 = new e(b.d.drawer_layout_reset, i, x.c(b.i.text_reset)) { // from class: com.tsf.shell.f.f.a._c.b.4
            @Override // com.tsf.shell.f.f.a._c.e
            public void a() {
                b.this.i();
            }
    ...
    public void b(int i) {
        j();
        if (i > 0) {
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._c.b.5
