...
import com.tsf.shell.manager._a.e;
...
public class A {
    ...
    public void d() {
        Collections.sort(com.tsf.shell.manager._a.h.t().ao().a(), e());
    }
    ...
    public void b(int i) {
        ...
        if (!com.tsf.shell.manager._a.h.t().ao().a().isEmpty()) {
            this.a = true;
            d();
            ...
            Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.f.a.d.a.1
                ...
                public void run() {
                    com.tsf.shell.manager._a.h.t().ay();
                    a.this.a = false;
                    if (a.this.f != -1) {
            ...
            com.tsf.shell.manager._a.h.t().b(runnable);
        }
    }
}
