...
public class FolderAppMenu extends FolderPageItemBase {
    private com.censivn.C3DEngine.b.h.b.h g;
    private com.tsf.shell.f.f.a.b.DrawerTransitionManager h;
    private com.tsf.shell.f.e._g.MenuContainer i;
    private ArrayList<com.tsf.shell.f.e._g.a.MenuActionHandler.C0095a> j;

    public FolderAppMenu(com.tsf.shell.f.f.a.FolderPage hVar, com.tsf.shell.f.f.a.PageGridRenderer fVar) {
        super(hVar, fVar, FolderWidgetTouchHandler.d.drawer_effect, x.c(FolderWidgetTouchHandler.i.text_effect));
        this.h = hVar.aC();
        c();
    }
    ...
    private void c() {
        ...
        this.g.a(new com.censivn.C3DEngine.b.h.b.b() { // from class: com.tsf.shell.f.f.a.c.FolderAppMenu.1
        ...
        this.g.a(new com.censivn.C3DEngine.b.h.b.f() { // from class: com.tsf.shell.f.f.a.c.FolderAppMenu.2
