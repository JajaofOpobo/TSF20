...
public class FolderSettingsPage extends FolderPageItemBase {
    ...
    public FolderSettingsPage(com.tsf.shell.f.f.a.FolderPage hVar, com.tsf.shell.f.f.a.PageGridRenderer fVar) {
        ...
        this.i = com.censivn.C3DEngine.b.b.ScreenConstants.b(12.0f) + com.tsf.shell.f.f.a.c._a.FolderIndicatorDot.a;
        ...
        if (aVarA.a()) {
            ...
            l = new com.tsf.shell.f.e.CircleDotNode();
            FolderSpringPhysics.position().y = com.censivn.C3DEngine.b.b.ScreenConstants.a(54.0f);
            FolderSpringPhysics.position().x = com.censivn.C3DEngine.b.b.ScreenConstants.a(70.0f);
    ...
    public void b(boolean z) {
        ...
        while (i < iNumChildren) {
            ...
            if (i < 3) {
                ...
                com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.f.a.c.FolderSettingsPage.7
                    @Override // com.censivn.C3DEngine.b.g.TweenParams
                    public void a() {
                    }
                };
    ...
    public void a() {
        ...
        for (int i = 0; i < this.g.size(); i++) {
            ...
            if (i < 3) {
                ...
                com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.f.a.c.FolderSettingsPage.9
                    @Override // com.censivn.C3DEngine.b.g.TweenParams
                    public void a() {
                        bVar.visible(false);
                    }
