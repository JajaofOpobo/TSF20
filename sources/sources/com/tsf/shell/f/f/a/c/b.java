...
public class b extends c.a {
    ...
    private void h() {
        ...
        this.a = new com.censivn.C3DEngine.b.h.e.b(com.censivn.C3DEngine.b.b.A.D, this.k, com.tsf.shell.manager.o.ButtonPresetManager.a.U * f, 30.0f * com.censivn.C3DEngine.b.b.A.c * f, com.censivn.C3DEngine.b.b.A.c * 10.0f * f, f) { // from class: com.tsf.shell.f.f.a.c.b.2
    ...
    private boolean k() {
        ...
        for (int i = 0; i < iNumChildren; i++) {
            if (((com.tsf.shell.f.i.b.e.DrawerShortcutItemBase) this.a.l().getChildAt(i)).ao()) {
                return true;
            }
        }
        return false;
    ...
    public void a(com.tsf.shell.f.i.ShortcutItem cVar, MotionEvent motionEvent) {
        ...
        if ((cVar.parent() instanceof com.tsf.shell.f.f.a.A) && (cVar instanceof com.tsf.shell.f.i.b.d.FolderShortcutItem)) {
