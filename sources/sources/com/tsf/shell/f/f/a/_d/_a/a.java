...
public class a extends c {
    ...
    public a(int i) {
        ...
        this.b = new Comparator<com.tsf.shell.f.i.PageItem>() { // from class: com.tsf.shell.f.f.a._d._a.a.1
        ...
        this.c = new Comparator<i>() { // from class: com.tsf.shell.f.f.a._d._a.a.2
            @Override // java.util.Comparator
            /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
