...
public class c extends com.censivn.C3DEngine.b.b.c {
    private com.tsf.shell.f.f.a._a.c a;
    private com.tsf.shell.f.f.a._a.b.b b;
    private float f;
    private float g;
    private float h;
    private int k;
    ...
    private j c = new j();
    private com.tsf.shell.f.f.a._a.A d = new com.tsf.shell.f.f.a._a.A();

    public c(com.tsf.shell.f.f.a._a.c cVar) {
        this.a = cVar;
    ...
    public com.tsf.shell.f.f.a._a.c h() {
        return this.a;
    }
    ...
    public void a(com.tsf.shell.f.f.a._a.b.b bVar) {
        this.b = bVar;
        PositionNumber3d positionNumber3dPosition = bVar.position();
        float f = (((-com.tsf.shell.f.f.a._a.b.b.a) / 2) - this.i) - this.e;
        this.f = f;
    ...
    public void e() {
        ...
        this.b.d();
        this.d.alpha(0.0f);
        this.d.position().y = (-this.e) - com.tsf.shell.f.f.a._a.c.a;
        d dVar = new d();
        dVar.a(255);
        dVar.h(-this.e);
    ...
    public float r() {
        float fA = a();
        if (this.k == com.tsf.shell.f.f.a._a.c.b) {
            return ((-fA) / 2.0f) + (com.tsf.shell.f.f.a._a.b.b.a / 2);
        }
        return (fA / 2.0f) - (com.tsf.shell.f.f.a._a.b.b.a / 2);
    }
    ...
    private float v() {
        float fA = a();
        if (this.k == com.tsf.shell.f.f.a._a.c.b) {
            return ((-fA) / 2.0f) + com.tsf.shell.f.f.a._a.b.b.a + this.j;
        }
    ...
    public void c(int i) {
        this.b.position().x = r();
        this.d.position().x = v();
        this.d.onMeasure((int) ((i - com.tsf.shell.f.f.a._a.b.b.a) - this.j), 0);
    ...
    public float u() {
        ...
        localToGlobal(Number3d.TEMPNUMBER3D);
        this.n = Number3d.TEMPNUMBER3D.y;
        float f = Number3d.TEMPNUMBER3D.y + this.f + (com.tsf.shell.f.f.a._a.b.b.a / 2);
