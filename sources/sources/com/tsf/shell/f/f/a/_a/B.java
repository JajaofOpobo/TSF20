...
public class B {
    ...
    public static int a(ArrayList<com.tsf.shell.f.f.a._a.a.c> arrayList, com.tsf.shell.f.f.a._a.a.b bVar) {
        final Collator collator = Collator.getInstance(Locale.getDefault());
        arrayList.add(bVar);
        Collections.sort(arrayList, new Comparator<com.tsf.shell.f.f.a._a.a.c>() { // from class: com.tsf.shell.f.f.a._a.b.2
            @Override // java.util.Comparator
            /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
            public int compare(com.tsf.shell.f.f.a._a.a.c cVar, com.tsf.shell.f.f.a._a.a.c cVar2) {
                if ((cVar instanceof com.tsf.shell.f.f.a._a.a.b) && (cVar2 instanceof com.tsf.shell.f.f.a._a.a.b)) {
                    return collator.compare(((com.tsf.shell.f.f.a._a.a.b) cVar).g(), ((com.tsf.shell.f.f.a._a.a.b) cVar2).g());
                }
