...
public class i extends com.censivn.C3DEngine.b.f.j {
    ...
    protected int c;
    protected String d;
    protected com.censivn.C3DEngine.b.f._a.a e;
    protected C0133a f;
    ...
    public com.censivn.C3DEngine.b.f._a.a e() {
        if (this.e == null) {
            this.e = j.a();
            this.e.textures().addElement(this.g);
            com.censivn.C3DEngine.b.d.a aVar = new com.censivn.C3DEngine.b.d.a(this.e) { // from class: com.tsf.shell.f.f.a._c.i.1
    ...
    public void f() {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._c.i.2
    ...
    public void g() {
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._c.i.3
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
    ...
    public void c(boolean z) {
        this.i = false;
        if (a(z)) {
            this.f = com.tsf.shell.manager._a.q.a(this.f, this.d);
        }
        b(z);
    ...
    public void i() {
        this.i = false;
        com.tsf.shell.manager._a.q.b(this.f);
        a();
