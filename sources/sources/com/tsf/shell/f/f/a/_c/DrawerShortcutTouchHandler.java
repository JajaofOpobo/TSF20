...
public class DrawerShortcutTouchHandler extends DrawerContentList.a {
    ...
    private void e() {
        ...
        this.d = new DrawerCountdownBadge() { // from class: com.tsf.shell.f.f.a._c._a.2
            @Override // com.tsf.shell.f.f.a._c.DrawerCountdownBadge
            public void b() {
                if (a.this.c.c() != null) {
                    a.this.a(a.this.c.c());
                }
            ...
            @Override // com.tsf.shell.f.f.a._c.DrawerSelectionFrame, com.tsf.shell.f.e.SelectionFrameLayoutItem
    ...
    public void a(com.tsf.shell.f.i.ShortcutItem cVar) {
        ...
        this.c.b(cVar2);
        this.f = (com.tsf.shell.f.i._a.WidgetItemTouchHandler) this.e.getMouseEventListener();
        this.e.ah();
        this.f.c(null);
        this.c.a(this.e);
