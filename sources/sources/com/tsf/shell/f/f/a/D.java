...
public class D {
    ...
    public void b() {
        ArrayList<com.tsf.shell.f.i.b.e.g> arrayListD = com.tsf.shell.manager.app.w.a().d();
        ...
        com.tsf.shell.manager.app.w.d().b();
        for (B bVar : this.a) {
            if (bVar.b != null) {
                ...
                if (!arrayList2.isEmpty()) {
                    com.tsf.shell.manager.app.h.t().a(bVar.c, arrayList2, false);
                }
            } else {
                ...
                while (true) {
                    if (it.hasNext()) {
                        ...
                        if (next.bd().b.equals(bVar.a)) {
                            com.tsf.shell.manager.app.w.d().a(next);
        ...
        while (it2.hasNext()) {
            com.tsf.shell.manager.app.w.d().a(it2.next());
        }
        com.tsf.shell.manager.app.h.t().aD();
    }

    public AsyncTask a(A aVar) {
        ArrayList arrayList = new ArrayList();
        for (com.tsf.shell.f.i.b.e.g gVar : com.tsf.shell.manager.app.w.a().d()) {
            if (!((LauncherShortcutAppInfo) gVar.K()).isHide) {
    ...
    public void c() {
        ...
        while (it.hasNext()) {
            com.tsf.shell.manager.app.w.d().a((com.tsf.shell.f.i.b.e.g) it.next());
        }
        com.tsf.shell.manager.app.h.t().aD();
        com.tsf.shell.manager.app.h.t().ao().c();
        com.tsf.shell.manager.app.h.t().ao().d();
    }
    ...
    public void a(d.a aVar) {
        ...
        for (d.b bVar : aVar.b) {
            ...
            if (!arrayList2.isEmpty()) {
                com.tsf.shell.manager.app.h.t().a(bVar.a, arrayList2, true);
            }
        }
        ...
        if (!arrayList3.isEmpty()) {
            com.tsf.shell.manager.app.h.t().a(x.c(b.i.text_system), arrayList3, true);
        }
        Iterator<com.tsf.shell.f.i.b.e.g> it3 = arrayList.iterator();
        while (it3.hasNext()) {
            com.tsf.shell.manager.app.w.d().a(it3.next());
        }
        com.tsf.shell.manager.app.h.t().aD();
        com.tsf.shell.manager.app.h.t().ao().c();
        com.tsf.shell.manager.app.h.t().ao().d();
