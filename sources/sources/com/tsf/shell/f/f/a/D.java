...
public class D {
    ...
    public void b() {
        ArrayList<com.tsf.shell.f.i.b.e.g> arrayListD = com.tsf.shell.manager.app.ServiceProvider.a().d();
    ...
    public AsyncTask a(A aVar) {
        ...
        for (com.tsf.shell.f.i.b.e.g gVar : com.tsf.shell.manager.app.ServiceProvider.a().d()) {
            if (!((LauncherShortcutAppInfo) gVar.K()).isHide) {
    ...
    public void c() {
        ...
        while (it.hasNext()) {
            com.tsf.shell.manager.app.ServiceProvider.d().a((com.tsf.shell.f.i.b.e.g) it.next());
        }
        com.tsf.shell.manager.app.StateHub.t().aD();
