...
public class k extends i {
    ...
    private ArrayList<com.tsf.shell.f.f.a._c.a.b> g;
    private com.censivn.C3DEngine.b.f.j h;
    private float i;
    private float j;
    private com.tsf.shell.f.f.a._c.a.a k;
    ...
    public k(com.tsf.shell.f.f.a.h hVar, com.tsf.shell.f.f.a.f fVar) {
        ...
        com.tsf.shell.f.f.a._c.a.a aVar = new com.tsf.shell.f.f.a._c.a.a(new a(b.d.drawer_classification, x.c(b.i.text_classify)));
        this.k = aVar;
        this.k.a(com.tsf.shell.manager.p.e.j);
        this.g.add(aVar);
        this.g.add(new com.tsf.shell.f.f.a._c.a.b(new a(b.d.drawer_preferences, x.c(b.i.text_preferences)) { // from class: com.tsf.shell.f.f.a._c.k.1
            @Override // com.tsf.shell.f.f.a._c.k.a
            public void a() {
                com.tsf.shell.manager.a.B.d().d();
            }
        }));
        this.g.add(new com.tsf.shell.f.f.a._c.a.b(new a(b.d.drawer_clean, x.c(b.i.text_clean)) { // from class: com.tsf.shell.f.f.a._c.k.2
            @Override // com.tsf.shell.f.f.a._c.k.a
            public void a() {
                com.tsf.shell.e.a(b.i.mn_next_version_release);
            }
        }));
        this.g.add(new com.tsf.shell.f.f.a._c.a.b(new a(b.d.drawer_more_manager, x.c(b.i.menu_manage_apps)) { // from class: com.tsf.shell.f.f.a._c.k.3
            @Override // com.tsf.shell.f.f.a._c.k.a
            public void a() {
                Home.b().m();
            }
        }));
        this.g.add(new com.tsf.shell.f.f.a._c.a.b(new a(b.d.drawer_more_reset, x.c(b.i.text_reset)) { // from class: com.tsf.shell.f.f.a._c.k.4
            @Override // com.tsf.shell.f.f.a._c.k.a
            public void a() {
        ...
        this.i = com.censivn.C3DEngine.b.b.a.b(12.0f) + com.tsf.shell.f.f.a._c.a.b.a;
        this.j = ((-this.i) * 2.0f) / 2.0f;
        float f = this.j;
        for (int i = 0; i < this.g.size(); i++) {
            com.tsf.shell.f.f.a._c.a.b bVar = this.g.get(i);
            bVar.position().x = f;
            if (i > 2) {
                bVar.visible(false);
                bVar.alpha(0.0f);
    ...
    public void n() {
        super.n();
        com.tsf.shell.f.f.a._c.a.b.j();
    }

    @Override // com.tsf.shell.f.f.a._c.i
    public void p() {
        com.tsf.shell.f.f.a._c.a.b.k();
    }
    ...
    public void b(boolean z) {
        ...
        while (i < iNumChildren) {
            ...
            bVar.b((i * 20) + 250);
            if (i < 3) {
                com.censivn.C3DEngine.b.g.c.a.a aVar = new com.censivn.C3DEngine.b.g.c.a.a(bVar, (i / 3) + 2, fA) { // from class: com.tsf.shell.f.f.a._c.k.6
                ...
                com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._c.k.7
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a() {
                    }
                };
    ...
    public void a() {
        ...
        for (int i = 0; i < this.g.size(); i++) {
            Number3d.TEMPNUMBER3D.reset();
            final com.tsf.shell.f.f.a._c.a.b bVar = this.g.get(i);
            bVar.i();
            ...
            float fA = com.censivn.C3DEngine.b.b.a.a(200.0f);
            if (i < 3) {
                com.censivn.C3DEngine.b.g.c.a.a aVar = new com.censivn.C3DEngine.b.g.c.a.a(bVar, (i / 3) + 2, fA) { // from class: com.tsf.shell.f.f.a._c.k.8
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a() {
                    }
                };
                ...
                com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._c.k.9
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a() {
                        bVar.visible(false);
                    }
