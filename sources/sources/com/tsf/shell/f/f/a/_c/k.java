...
public class k extends i {
    ...
    private float i;
    private float j;
    private com.tsf.shell.f.f.a._c._a.a k;
    ...
    public k(com.tsf.shell.f.f.a.h hVar, com.tsf.shell.f.f.a.f fVar) {
        ...
        this.g.add(new com.tsf.shell.f.f.a._c._a.b(new a(b.d.drawer_more_manager, x.c(b.i.menu_manage_apps)) { // from class: com.tsf.shell.f.f.a._c.k.3
            @Override // com.tsf.shell.f.f.a._c.k.a
            public void a() {
                Home.b().m();
            }
        ...
        this.g.add(new com.tsf.shell.f.f.a._c._a.b(new a(b.d.drawer_more_reset, x.c(b.i.text_reset)) { // from class: com.tsf.shell.f.f.a._c.k.4
            @Override // com.tsf.shell.f.f.a._c.k.a
            public void a() {
                com.tsf.shell.manager._a.h.t().am().c();
            }
        }));
        this.h = new com.censivn.C3DEngine.b.f.j();
        this.h.position().y = com.censivn.C3DEngine.b.b.A.a(20.0f);
        this.i = com.censivn.C3DEngine.b.b.A.b(12.0f) + com.tsf.shell.f.f.a._c._a.b.a;
        this.j = ((-this.i) * 2.0f) / 2.0f;
        float f = this.j;
        for (int i = 0; i < this.g.size(); i++) {
            com.tsf.shell.f.f.a._c._a.b bVar = this.g.get(i);
            bVar.position().x = f;
            if (i > 2) {
                bVar.visible(false);
                bVar.alpha(0.0f);
        ...
        e().addChild(this.h);
        e.a aVarA = com.tsf.shell.manager._a.a.a(com.tsf.shell.manager.p.e.i);
        if (aVarA.a()) {
    ...
    public void n() {
        super.n();
        com.tsf.shell.f.f.a._c._a.b.j();
    }

    @Override // com.tsf.shell.f.f.a._c.i
    public void p() {
        com.tsf.shell.f.f.a._c._a.b.k();
    }
    ...
    public void b(boolean z) {
        ...
        while (i < iNumChildren) {
            ...
            bVar.b((i * 20) + 250);
            if (i < 3) {
                com.censivn.C3DEngine.b.g._c.a.a aVar = new com.censivn.C3DEngine.b.g._c.a.a(bVar, (i / 3) + 2, fA) { // from class: com.tsf.shell.f.f.a._c.k.6
    ...
    public void a() {
        ...
        for (int i = 0; i < this.g.size(); i++) {
            Number3d.TEMPNUMBER3D.reset();
            final com.tsf.shell.f.f.a._c._a.b bVar = this.g.get(i);
            bVar.i();
            ...
            float fA = com.censivn.C3DEngine.b.b.A.a(200.0f);
            if (i < 3) {
                com.censivn.C3DEngine.b.g._c.a.a aVar = new com.censivn.C3DEngine.b.g._c.a.a(bVar, (i / 3) + 2, fA) { // from class: com.tsf.shell.f.f.a._c.k.8
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a() {
                    }
                };
