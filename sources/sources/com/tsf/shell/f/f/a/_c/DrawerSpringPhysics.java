...
public class DrawerSpringPhysics {
    ...
    public void c() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            a aVar = this.d.get(DrawerPageItemBase);
            aVar.a(Double.valueOf(DrawerAppMenu), 1.0f);
    ...
    public class a {
        ...
        public void a(Double d, float f) {
            double dSin = Math.sin(DrawerAppMenu.doubleValue());
            Double.valueOf(DrawerAppMenu.doubleValue() + 0.03490658503988659d);
