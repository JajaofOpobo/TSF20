...
public abstract class m extends k {
    ...
    private void b(final com.tsf.shell.f.f.a.A aVar, boolean z) {
        ...
        if ((aVar.getChildAt(0).rotation().x != this.g.get(0).e || aVar.getChildAt(0).rotation().y != this.g.get(0).d || aVar.getChildAt(0).rotation().z != this.g.get(0).f || i(aVar) == b) && i(aVar) != a) {
            if (z) {
                ...
                com.censivn.C3DEngine.b.g.d dVar2 = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._b.m.1
            ...
            com.censivn.C3DEngine.b.g.d dVar3 = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._b.m.2
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
                    m.this.a(aVar, m.c);
                }
    ...
    private void n(final com.tsf.shell.f.f.a.A aVar) {
        ...
        if ((aVar.getChildAt(0).rotation().x != 0.0f || aVar.getChildAt(0).rotation().y != 0.0f || aVar.getChildAt(0).rotation().z != 0.0f || i(aVar) == a) && i(aVar) != b) {
            ...
            com.censivn.C3DEngine.b.g.d dVar2 = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a._b.m.3
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
                    m.this.a(aVar, m.c);
                    m.this.l = true;
