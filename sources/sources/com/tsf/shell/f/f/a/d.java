...
public class D {
    ...
    public void a() {
        ...
        for (com.tsf.shell.f.i.B bVar : com.tsf.shell.manager.a.w.d().a()) {
            ...
            if (bVar instanceof com.tsf.shell.f.i._b.d.b) {
                ...
                bVar2.b = ((com.tsf.shell.f.i._b.d.b) bVar).aI();
            } else {
                bVar2.a = ((com.tsf.shell.f.i._b.e.g) bVar).bd().b;
            }
            this.a.add(bVar2);
        }
    }
    ...
    public void b() {
        ArrayList<com.tsf.shell.f.i._b.e.g> arrayListD = com.tsf.shell.manager.a.w.a().d();
        ...
        for (com.tsf.shell.f.i._b.e.g gVar : arrayListD) {
            ...
            if (gVar.K().container != -1) {
                if (gVar.getMouseEventListener() != null && (gVar.getMouseEventListener() instanceof com.tsf.shell.f.i._b.d.a)) {
        ...
        for (b bVar : this.a) {
            if (bVar.b != null) {
                ArrayList<com.tsf.shell.f.i._b.e.b> arrayList2 = new ArrayList<>();
                ...
                Iterator<com.tsf.shell.f.i._b.e.g> it = arrayList.iterator();
                while (true) {
                    if (it.hasNext()) {
                        com.tsf.shell.f.i._b.e.g next = it.next();
        ...
        Iterator<com.tsf.shell.f.i._b.e.g> it2 = arrayList.iterator();
        while (it2.hasNext()) {
    ...
    public AsyncTask a(a aVar) {
        ...
        for (com.tsf.shell.f.i._b.e.g gVar : com.tsf.shell.manager.a.w.a().d()) {
            if (!((LauncherShortcutAppInfo) gVar.K()).isHide) {
    ...
    public void c() {
        ...
        while (it.hasNext()) {
            com.tsf.shell.manager.a.w.d().a((com.tsf.shell.f.i._b.e.g) it.next());
        }
        com.tsf.shell.manager.a.h.t().aD();
    ...
    public void a(d.a aVar) {
        ...
        ArrayList<com.tsf.shell.f.i._b.e.b> arrayList3 = new ArrayList<>();
        for (com.tsf.shell.f.i._b.e.g gVar2 : arrayList) {
            if (gVar2.bd().c()) {
                arrayList3.add(gVar2);
            }
        }
        Iterator<com.tsf.shell.f.i._b.e.b> it2 = arrayList3.iterator();
        while (it2.hasNext()) {
        ...
        Iterator<com.tsf.shell.f.i._b.e.g> it3 = arrayList.iterator();
        while (it3.hasNext()) {
    ...
    private void a(String str, ArrayList<com.tsf.shell.f.i._b.e.g> arrayList, ArrayList<com.tsf.shell.f.i._b.e.b> arrayList2) {
        for (com.tsf.shell.f.i._b.e.g gVar : arrayList) {
            if (gVar.bd().b.getPackageName().equals(str)) {
                arrayList2.add(gVar);
            }
        }
        Iterator<com.tsf.shell.f.i._b.e.b> it = arrayList2.iterator();
        while (it.hasNext()) {
            arrayList.remove(it.next());
        }
    }

    private void a(ComponentName componentName, ArrayList<com.tsf.shell.f.i._b.e.g> arrayList, ArrayList<com.tsf.shell.f.i._b.e.b> arrayList2) {
        for (com.tsf.shell.f.i._b.e.g gVar : arrayList) {
