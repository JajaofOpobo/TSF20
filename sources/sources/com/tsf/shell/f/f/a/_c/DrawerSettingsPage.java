...
public class DrawerSettingsPage extends DrawerPageItemBase {
    ...
    public void b(boolean z) {
        ...
        while (i < iNumChildren) {
            ...
            bVar.b((i * 20) + 250);
            if (i < 3) {
                com.censivn.C3DEngine.b.g._c.orbit.OrbitTween aVar = new com.censivn.C3DEngine.b.g._c.orbit.OrbitTween(bVar, (i / 3) + 2, fA) { // from class: com.tsf.shell.f.f.a._c.DrawerSettingsPage.6
    ...
    public void a() {
        ...
        for (int i = 0; i < this.g.size(); i++) {
            ...
            float fA = com.censivn.C3DEngine.b.b.ScreenConstants.a(200.0f);
            if (i < 3) {
                com.censivn.C3DEngine.b.g._c.orbit.OrbitTween aVar = new com.censivn.C3DEngine.b.g._c.orbit.OrbitTween(bVar, (i / 3) + 2, fA) { // from class: com.tsf.shell.f.f.a._c.DrawerSettingsPage.8
                    @Override // com.censivn.C3DEngine.b.g.TweenParams
                    public void a() {
                    }
                };
