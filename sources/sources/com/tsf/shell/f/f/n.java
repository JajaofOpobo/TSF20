...
public class n implements b.a, com.censivn.C3DEngine.b.c.e.a {
    ...
    private com.tsf.shell.f.e.e.a H = new com.tsf.shell.f.e.e.a() { // from class: com.tsf.shell.f.f.n.1
        ...
        public void a(int i, Object obj) {
            c();
            com.tsf.shell.manager._a.h.b((com.tsf.shell.f.i.B) obj);
        }

        @Override // com.tsf.shell.f.e.e.a
        public float a() {
            return com.tsf.shell.manager._a.g.a.j() ? com.censivn.C3DEngine.b.b.A.g + (com.censivn.C3DEngine.b.b.A.h * 2) : com.censivn.C3DEngine.b.b.A.h * 2;
        }
    };
    private o G = new o();
    ...
    public boolean B() {
        return this.t == 2 && com.tsf.shell.manager._a.c.c();
    }
    ...
    public void b(float f, float f2, float f3, float f4) {
        if (this.t != 4 && this.t != 2) {
            com.tsf.shell.manager._a.f.a(f / com.censivn.C3DEngine.b.b.A.D);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void ak() {
        com.tsf.shell.manager._a.v.c.f();
        this.e = false;
    }
    ...
    public void D() {
        ...
        if (this.t != 3 && this.t != 1) {
            ...
            this.v.b();
            this.G.a();
            com.tsf.shell.manager._a.c.a(this.I);
            this.i.setAnimationObjectState(true);
            if (this.t == 2) {
                this.m.V();
                this.q = this.m;
    ...
    private void an() {
        if (this.t != 4 && this.t != 2) {
            ...
            com.tsf.shell.manager._a.c.a(this.I, true);
            this.v.a(this.m);
            this.G.b();
            this.G.a(this.m);
    ...
    public void ao() {
        ...
        if (this.J != null) {
            ...
            cVar.a(false);
            if (!cVar.a() && (gVarN = com.tsf.shell.manager._a.h.n()) != null) {
                this.J.removeFromParent();
                gVarN.a(this.J);
            }
            this.J.o_();
    ...
    public boolean E() {
        return com.tsf.shell.manager._a.h.F() == -1;
    }
    ...
    public void L() {
        if (com.tsf.shell.manager._a.A.a() && this.s != 1) {
            w();
            am();
            N();
            this.w.g();
    ...
    public void R() {
        com.censivn.C3DEngine.A.a().c(new Runnable() { // from class: com.tsf.shell.f.f.n.7
            @Override // java.lang.Runnable
            public void run() {
                if (com.tsf.shell.manager._a.A.a()) {
                    com.censivn.C3DEngine.a.d.d().i();
                    if (!n.this.E.a() && com.tsf.shell.manager._a.h.B() && com.tsf.shell.manager._a.h.F() != -1) {
                        n.this.E.b();
    ...
    public class C implements com.censivn.C3DEngine.b.c.b.a {
            ...
            this.A = new com.censivn.C3DEngine.b.f.j() { // from class: com.tsf.shell.f.f.n.c.1
                ...
                public void onDrawEnd() {
                    if (!c.this.w && !c.this.z) {
                        ...
                        float fAbs = c.this.y ? 255.0f : Math.abs((position().z - c.this.o) / (c.this.p - c.this.o)) * 255.0f;
                        int i = 0;
                        while (true) {
                            int i2 = i;
                            if (i2 >= n.this.n) {
                        ...
                        if (c.this.I == null) {
                            ...
                            if (Math.abs(c.this.q - rotation().y) > 0.1f || Math.abs(c.this.r - rotation().x) > 0.1f) {
                                ...
                                if (f < 0.5d) {
                                    c.this.s = (fAbs2 * (c.this.p - c.this.v)) + c.this.v;
                                } else {
                                    c.this.s = (fAbs2 * (c.this.p - c.this.o)) + c.this.o;
                                }
                                if (f > 0.9d) {
                                    c.this.x += 0.008f;
                                }
        ...
        public void k() {
            ...
            com.tsf.shell.manager._a.c.a(n.this.I, true);
            com.tsf.shell.manager._a.c.b(n.this.I);
            com.censivn.C3DEngine.b.c.b.b(this);
            a(false);
            n.this.al();
        }
        ...
        public void c(float f) {
            ...
            this.o = -this.n;
            this.p = -((int) (this.n * 3.5f));
            this.C = 6.283185307179586d / ((double) n.this.n);
            this.D = 360.0f / n.this.n;
            if (this.w) {
                n.this.ak();
                com.tsf.shell.manager._a.c.a(n.this.I);
                com.tsf.shell.manager._a.c.c(n.this.I);
                this.w = false;
                for (int i = 0; i < n.this.n; i++) {
                    g gVar = (g) n.this.k.get(i);
                    if (gVar != n.this.m) {
        ...
        public void c() {
            ...
            if (this.c != null && !this.c.a()) {
                com.tsf.shell.manager._a.v.c.b.a(true);
                com.tsf.shell.manager._a.v.c.b.a(n.this.m);
            } else {
                com.tsf.shell.manager._a.v.c.b.a(false);
            }
            if (!this.k) {
                if (this.L != null) {
                    if (this.g < 0.0f) {
        ...
        public void a(l lVar) {
            if (this.i) {
                if (lVar == null) {
                    lVar = com.tsf.shell.manager._a.v.a.C0126a.h();
                }
                this.c = lVar;
                this.c.d();
                com.tsf.shell.manager._a.v.a.C0126a.a2(this.c);
                this.h = false;
                this.i = false;
                this.f = n.this.m.g;
        ...
        public void d(MotionEvent motionEvent) {
            if (this.m) {
                ...
                if (!this.h && this.L == null && !this.k) {
                    g gVarN = n();
                    if (gVarN != null && gVarN != n.this.m) {
                        n.this.a(gVarN, false, true);
                        return;
                    }
                    return;
                }
        ...
        private void a(boolean z) {
            ...
            n.this.ae();
            n.this.g();
            com.tsf.shell.manager._a.v.a.C0126a();
            h.a(false);
            com.tsf.shell.manager._a.n.j();
        }
            ...
            if (com.censivn.C3DEngine.a.e.l()) {
                if (n.this.t().aJ() && this.k) {
                    ...
                    if (gVarN.t() == -1) {
                        ...
                        a(gVarK, i, null, false, com.tsf.shell.manager._a.v.a.b.h());
                        com.tsf.shell.manager._a.c.a(n.this.I, false);
                        return;
                    }
                    a(n.this.t(), i, null, true, com.tsf.shell.manager._a.v.a.b.h());
                    com.tsf.shell.manager._a.c.a(n.this.I);
                    return;
                }
                return;
    ...
    public void a(g gVar, boolean z, String str) {
        com.tsf.shell.manager._a.f.a(gVar, z, true);
    }
    ...
    public class b {
        ...
        private com.tsf.shell.f.e.e.b F = com.tsf.shell.manager._a.p.d();
            ...
            this.c = new com.censivn.C3DEngine.b.f.j() { // from class: com.tsf.shell.f.f.n.b.1
                ...
                public void onDrawStart() {
                    if (!b.this.r) {
                        ...
                        } else if (rotation().y > b.this.g && b.this.t > b.this.g) {
            ...
            if (this.e && !this.r && !this.G) {
                ...
                while (true) {
                    ...
                    if (i2 < n.this.n) {
                        ...
                        n.this.i.globalToLocal(number3dLocalToGlobal);
            ...
            com.censivn.C3DEngine.A.a().b(new Runnable() { // from class: com.tsf.shell.f.f.n.b.5
                ...
                public void run() {
                    ...
                    if (gVar.t() != -1 && !gVar.q() && n.this.n > 2) {
                        ...
                        if (b.this.F.calTouchCollision(fArrA2[0], fArrA2[1])) {
                            b.this.d(gVar);
                        } else {
                            b.this.e(gVar);
                        }
        ...
        private void a(float f, float f2, g gVar, boolean z) {
            ...
            if (hittingTarget != null) {
                if (hittingTarget == null) {
                    ...
                    gVarO = (g) n.this.k.get(((int) (((this.g - f3) / (this.g - this.f)) * (this.c.numChildren() - 1))) + 1);
                } else {
                    gVarO = (g) hittingTarget.parent();
                }
                if (gVarO.t() == -1 && gVar == (gVarO = n.this.o())) {
                    gVar.a(1);
                    return;
                }
                int iR = gVarO.r();
                int size = iR == -1 ? n.this.k.size() - 1 : iR;
                int iR2 = gVar.r();
                if (iR2 == -1) {
