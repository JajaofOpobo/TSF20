package com.tsf.shell.f.e._c.a;
...
public class SnapshotState extends VObject3dContainer {
    private b a;
    private b b;
    private c c;
    ...
    public SnapshotState(Context context, float f, float f2, float f3, int i) {
        a(f, f2, f3, i);
        SnapshotState();
    }
    ...
    private void d() {
        ...
        this.c = new SnapshotActionContext();
        e eVarA = this.c.a(this.d, this.e, this.f, this.k);
        this.a = new SnapshotFrameRect(128.0f, eVarA);
        this.m.addChild(this.a);
        this.b = new SnapshotFrameRect(128.0f, eVarA);
    ...
    private TextureElement f() {
        Bitmap bitmapCreateBitmap = Bitmap.createBitmap((int) (this.e * 2.0f), (int) (this.e * 2.0f), Bitmap.Config.ARGB_8888);
    ...
    public void c(float f) {
        ...
        float fD = d(f);
        this.b.b((fD * this.g) + (-this.h));
        float fE = e(f);
        this.a.b((fE * this.g) + (-this.h));
