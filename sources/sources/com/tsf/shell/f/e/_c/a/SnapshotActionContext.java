...
public class SnapshotActionContext extends VObject3dContainer {
    private a a;
    private a b;
    ...
    public e a(float f, float f2, float f3, int i) {
        ...
        this.f = f3;
        this.g = i;
        e eVar = new SnapshotData(f + f2, 0.0f, f2);
        float f4 = ((((-f3) * f3) - (f * f)) - ((2.0f * f) * f2)) / ((f3 - f2) * 2.0f);
        float f5 = f4 + f3;
        e eVar2 = new SnapshotData(0.0f, f5, f4);
        float fA = eVar.a(eVar2) * 2.0f;
        float fB = eVar.b(eVar2) * 2.0f;
        this.a = new SnapshotButtonRect(fA, fB);
        this.b = new SnapshotButtonRect(fA, fB);
        a(f4, f5, fA, fB);
        return eVar2;
    }
    ...
    private void a(float f, float f2, float f3, float f4) {
        ...
        this.j = f3;
        this.k = f4;
        Bitmap bitmapCreateBitmap = Bitmap.createBitmap((int) f3, (int) f4, Bitmap.Config.ARGB_8888);
