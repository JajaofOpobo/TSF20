...
public class SnapshotItem extends BaseRenderable {
    ...
    private float[] n;
    private float o;
    private com.tsf.shell.f.e._c.PageSnapshotRenderer x;
    private int h = 10;
    ...
    public SnapshotItem(com.tsf.shell.f.e._c.PageSnapshotRenderer aVar) {
        this.x = aVar;
    ...
    public void a(final float f, final float f2, final float f3, final Runnable runnable) {
        final Runnable runnable2 = new Runnable() { // from class: com.tsf.shell.f.e._c.SnapshotItem.8
    ...
    public void b(final float f, final float f2, final float f3, final Runnable runnable) {
        final Runnable runnable2 = new Runnable() { // from class: com.tsf.shell.f.e._c.SnapshotItem.11
            @Override // java.lang.Runnable
            public void run() {
                b.this.b(0.0f, 0.0f, f3, f3, 1.0f);
                b.this.x.position().x = f;
