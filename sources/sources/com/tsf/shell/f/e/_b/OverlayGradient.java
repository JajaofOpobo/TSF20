...
public class OverlayGradient extends j {
    ...
    public void dispatchDraw() {
        if (this.c == 1.0f || this.c == 0.0f) {
            ...
            setCustomShader(OverlayProperty.b);
        }
        super.dispatchDraw();
    }
    ...
    public void drawElement() {
        ...
        if (this.a != -1 && this.b != -1) {
            OverlayProperty.b.a(this.c);
            OverlayProperty.b.a(255, 255 - this.d, 255 - this.d, 255 - this.d);
            OverlayProperty.b.glMVPMatrix();
            OverlayProperty.b.glVertexPointer(3, 5126, false, 0, this.e);
            OverlayProperty.b.glTexCoordPointer(2, 5126, false, 0, this.f);
            GLES20.glActiveTexture(33984);
