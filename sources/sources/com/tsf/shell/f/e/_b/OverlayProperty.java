...
public class OverlayProperty {
    ...
    public static void a(int i2, int i3, d dVar, int i4, int i5) {
        ...
        if (a == null) {
            a = new OverlayBackground();
        }
        OverlayBackground.a(i2);
        OverlayBackground.a(dVar);
        OverlayBackground.a(i4, i5);
        OverlayBackground.a();
    }
