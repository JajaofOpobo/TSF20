...
public class OverlayBackground extends BaseRenderable {
    ...
    private c a = new OverlayGradient();
    ...
    private void a(TextureElement textureElement, int i, float f, int i2, float f2, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.e._b.OverlayBackground.1
    ...
    public void a(int i, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.e._b.OverlayBackground.2
            @Override // com.censivn.C3DEngine.b.g.TweenParams
    ...
    private void a(TextureElement textureElement, int i, float f) {
        ...
        if (this.d != textureElement.height || this.e != textureElement.width || i != this.f || this.g != f) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ...
                this.j.add(com.tsf.shell.manager.app.TextureCache.a(i3, i4));
                this.h.add(OverlayProperty.a(i3, i4));
                this.i.add(OverlayProperty.a(i3, i4));
            }
        }
        System.currentTimeMillis();
        for (int i5 = 0; i5 < i; i5++) {
            if (i5 == 0) {
                OverlayProperty.a(com.censivn.C3DEngine.C3DEngine.d(), this.k, this.h.get(i5), this.i.get(i5), this.j.get(i5));
            } else {
                OverlayProperty.a(com.censivn.C3DEngine.C3DEngine.d(), this.h.get(i5 - 1), this.h.get(i5), this.i.get(i5), this.j.get(i5));
            }
        }
        System.currentTimeMillis();
    }
    ...
    private void c() {
        ...
        while (this.j.size() > 0) {
            com.tsf.shell.manager.app.TextureCache.a(this.j.remove(0));
        }
    }
}
