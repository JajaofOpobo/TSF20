...
public class OverlayBackground extends BaseRenderable {
    ...
    private void a(TextureElement textureElement, int i, float f, int i2, float f2, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._b.OverlayBackground.1
    ...
    public void a(int i, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._b.OverlayBackground.2
            @Override // com.censivn.C3DEngine.b.g.d
