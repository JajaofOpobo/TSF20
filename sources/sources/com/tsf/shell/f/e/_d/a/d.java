...
public class d {
    ...
    private a a = new a() { // from class: com.tsf.shell.f.e._d.a.d.1
        @Override // com.tsf.shell.f.e._d.a.a
        public void a() {
            if (d.this.b) {
                d.this.e();
            } else {
    ...
    public void e() {
        if (this.b && this.c.b()) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._d.a.d.2
    ...
    public void j() {
        if (!this.b) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._d.a.d.3
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
                    d.this.g();
                }
