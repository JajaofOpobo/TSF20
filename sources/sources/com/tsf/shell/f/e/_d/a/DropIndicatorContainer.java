...
public class DropIndicatorContainer extends BaseRenderable {
    ...
    public DropIndicatorContainer() {
        addChild(this.a);
        setMouseEventListener(new com.censivn.C3DEngine.b.d.MouseEventListener(this) { // from class: com.tsf.shell.f.e._d.a.DropIndicatorContainer.1
    ...
    public void d() {
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.e._d.a.DropIndicatorContainer.2
