...
public class c extends j {
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.e._d.a.c$c, reason: collision with other inner class name */
    ...
    public void a(ArrayList<C0092c> arrayList, b bVar) {
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                com.censivn.C3DEngine.b.d.a aVar2 = new com.censivn.C3DEngine.b.d.a(aVar) { // from class: com.tsf.shell.f.e._d.a.c.1
    ...
    public boolean b() {
        ...
        for (int i = 0; i < this.b.numChildren(); i++) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._d.a.c.2
            ...
            if (i == this.b.numChildren() - 1) {
                dVar.a(new Runnable() { // from class: com.tsf.shell.f.e._d.a.c.3
    ...
    public void a(a aVar) {
        for (int i = 0; i < this.b.numChildren(); i++) {
            ...
            if (aVar2 != aVar) {
                com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._d.a.c.4
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a() {
                    }
                };
    ...
    private void e() {
        for (int i = 0; i < this.b.numChildren(); i++) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._d.a.c.5
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
                }
            };
    ...
    public float c() {
        if (this.a == 0.0f) {
            ...
            while (true) {
                ...
                float fA = ((a) this.b.getChildAt(i2)).a();
                if (fA > this.a) {
                    this.a = fA;
                }
                i = i2 + 1;
