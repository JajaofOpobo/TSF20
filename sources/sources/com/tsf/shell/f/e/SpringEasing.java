...
public class SpringEasing {
    public static final float a = com.censivn.C3DEngine.b.b.ScreenConstants.a(300.0f);
    ...
    public static float a(float f, float f2, float f3, float f4) {
        ...
        if (f > f2) {
            float f5 = (f - f2) / com.censivn.C3DEngine.b.b.ScreenConstants.D;
            return (float) ((Math.sin((((double) (f5 <= 1.0f ? f5 : 1.0f)) * 3.141592653589793d) / 2.0d) * ((double) f4)) + ((double) f2));
        }
        if (f < f3) {
            float f6 = (f3 - f) / com.censivn.C3DEngine.b.b.ScreenConstants.D;
