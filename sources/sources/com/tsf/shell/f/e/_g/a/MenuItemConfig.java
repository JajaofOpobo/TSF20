...
public class MenuItemConfig extends MenuItemBase {
    private a mTitleContainer = new MenuActionHandler() { // from class: com.tsf.shell.f.e._g.a.MenuItemConfig.1
        @Override // com.tsf.shell.f.e._g.a.MenuItemConfig.a
        public void a() {
