...
public abstract class d {
    ...
    public void show() {
        if (mCurrentMenu == null || mCurrentMenu == this) {
            ...
            if (!this.isShow) {
                ...
                com.tsf.shell.manager.app.b.a(this.mSceneEventListener);
                showAnimation(0);
                this.mClassMenu.a();
                resetSize();
                return;
    ...
    public void hide() {
        if (this.isShow) {
            if (this.mMenuItems.contains(this.mCurrentMenuItem)) {
                ...
                com.tsf.shell.manager.app.b.b(this.mSceneEventListener);
                hideAnimation();
                return;
            }
    ...
    private void showAnimation(int i) {
        if (!com.tsf.shell.manager.b.e.ai()) {
            enableBlurMode(com.tsf.shell.manager.app.e.a(this));
        }
        onShow();
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._g.d.1
        ...
        com.tsf.shell.manager.app.j.a(this.mContainer);
    }
    ...
    private void hideAnimation() {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._g.d.2
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
                com.tsf.shell.manager.app.j.b(d.this.mContainer);
                ...
                com.tsf.shell.manager.app.e.b(d.this);
    ...
    public com.tsf.shell.f.e._g.A getClassMenu() {
    ...
    public void templeteHide() {
        if (this.isShow) {
            ...
            com.censivn.C3DEngine.b.g.c.a(this.mMenuContainer);
            com.censivn.C3DEngine.b.g.c.a(this.mMenuContainer, 450, dVar);
            com.censivn.C3DEngine.b.g.d dVar2 = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._g.d.4
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
    ...
    public void templeteShow() {
        if (this.isShow) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._g.d.5
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
                    d.this.mContainer.mouseEnabled(true);
                }
    ...
    public void showOption(i iVar) {
        ...
        if (!this.mExtraMenuContainer.containsChild(iVar)) {
            ...
            if (this.mOffsetMenuHeight != menuHeight) {
                ...
                com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._g.d.6
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a(float f2) {
