...
public class a extends c {
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.e._g.a.a$a, reason: collision with other inner class name */
    public static class C0095a extends k {
        ...
        /* JADX INFO: renamed from: com.tsf.shell.f.e._g.a.a$a$a, reason: collision with other inner class name */
        ...
        public C0095a(int i, String str, C0096a c0096a) {
            ...
            setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this) { // from class: com.tsf.shell.f.e._g.a.a.a.1
    ...
    public static Bitmap createCustomIco(String str, Bitmap bitmap) {
        ...
        bitmap.recycle();
        canvas.drawBitmap(bitmapB, r2 + i, (i - bitmapB.getHeight()) / 2.0f, paint);
        bitmapB.recycle();
