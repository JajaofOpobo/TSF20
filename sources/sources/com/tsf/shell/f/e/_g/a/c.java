...
public abstract class c {
    ...
    public void hide(boolean z) {
        ...
        if (z) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._g.a.c.1
    ...
    public void show(boolean z) {
        ...
        if (z) {
            this.isAnimation = true;
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._g.a.c.2
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
                    c.this.isAnimation = false;
