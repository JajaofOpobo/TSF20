...
public class MeshRenderer extends j {
    ...
    private float[] n;
    private float o;
    private com.tsf.shell.f.e.c.AnimationNode x;
    private int h = 10;
    ...
    private void d() {
        ...
        d dVar = new d() { // from class: com.tsf.shell.f.e.c.MeshRenderer.7
    ...
    public void a(final float f, final float f2, final float f3, final Runnable runnable) {
        ...
        d dVar2 = new d() { // from class: com.tsf.shell.f.e.c.MeshRenderer.10
            @Override // com.censivn.C3DEngine.b.g.d
            public void a(float f7) {
            }
    ...
    public void b(final float f, final float f2, final float f3, final Runnable runnable) {
        ...
        final d dVar5 = new d() { // from class: com.tsf.shell.f.e.c.MeshRenderer.2
            @Override // com.censivn.C3DEngine.b.g.d
            public void a(float f7) {
            }
        ...
        final d dVar6 = new d() { // from class: com.tsf.shell.f.e.c.MeshRenderer.3
            @Override // com.censivn.C3DEngine.b.g.d
            public void a(float f7) {
            }
