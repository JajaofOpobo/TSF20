...
public class IconEditorConfig implements com.censivn.C3DEngine.b.c.ActivityResultBridge.InterfaceC0025a {
    private static b a;
    private a b;
    private int c;
    private int d;
    ...
    public IconEditorConfig() {
        String[] strArr = {com.censivn.C3DEngine.C3DEngine.d().getString(com.tsf.b.i.icon_picker_main_item_0), com.censivn.C3DEngine.C3DEngine.d().getString(com.tsf.b.i.icon_picker_main_item_1), com.censivn.C3DEngine.C3DEngine.d().getString(com.tsf.b.i.icon_picker_main_item_2), com.censivn.C3DEngine.C3DEngine.d().getString(com.tsf.b.i.icon_picker_main_item_3)};
    }

    public static void a(final a aVar, final com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar, final int i, final int i2) {
        com.censivn.C3DEngine.C3DEngine.a().a(new Runnable() { // from class: com.tsf.shell.f.e.h.IconEditorConfig.1
    ...
    public void b(a aVar, com.tsf.shell.f.i.b.e.DrawerShortcutItemBase bVar, int i, int i2) {
        this.b = aVar;
        this.d = i;
        this.e = i2;
        LauncherShortcut3DInfo launcherShortcut3DInfo = (LauncherShortcut3DInfo) bVar.K();
        Intent intent = new Intent();
        intent.setClass(com.censivn.C3DEngine.C3DEngine.d(), AppIconEditorActivity.class);
