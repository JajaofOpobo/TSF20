...
public class PhotoPicker implements com.censivn.C3DEngine.b.c.a.InterfaceC0025a {
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.e.h.PhotoPicker$a, reason: collision with other inner class name */
    ...
    public void onActivityResult(int i, int i2, final Intent intent) {
        if (i2 == -1) {
            if (i == this.c) {
                com.censivn.C3DEngine.C3DEngine.a().c(new Runnable() { // from class: com.tsf.shell.f.e.h.PhotoPicker.1
