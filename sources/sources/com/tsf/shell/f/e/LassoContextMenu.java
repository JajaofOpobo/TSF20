...
public class LassoContextMenu implements KeyboardHandler.a {
    ...
    private static com.censivn.C3DEngine.b.f.IRenderable D;
    private static com.censivn.C3DEngine.b.f.IRenderable E;
    private static com.censivn.C3DEngine.b.f.IRenderable F;
    private static TextureElement A;
    private static TextureElement B;
    private com.censivn.C3DEngine.b.f.BaseRenderable p;
    private a q;
    ...
    public LassoContextMenu(com.censivn.C3DEngine.b.f.BaseRenderable jVar, a aVar) {
        this.p = jVar;
        this.q = aVar;
    }
    ...
    public void e() {
        if (f == null) {
            ThemeManager.mix.lasso.addElementListener(new DynamicThemeRunnable() { // from class: com.tsf.shell.f.e.LassoContextMenu.2
        ...
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.e.LassoContextMenu.3
            ...
            public void a(float f2) {
                ...
                com.tsf.shell.f.e.LassoContextMenu.f.alpha((int) (255.0f * f2));
            }
        };
        dVar.a(255);
        dVar.a((com.censivn.C3DEngine.b.g.TweenCallback) new com.censivn.C3DEngine.b.g.EasingFunctions.C0030a.C());
            ...
            public void onKillFocus() {
                if (com.tsf.shell.f.e.LassoContextMenu.k != null) {
                    com.censivn.C3DEngine.C3DEngine.a().c(new Runnable() { // from class: com.tsf.shell.f.e.LassoContextMenu.4.1
                        ...
                        public void run() {
                            if (com.tsf.shell.f.e.LassoContextMenu.k != null) {
                                com.tsf.shell.f.e.LassoContextMenu.k.a(-1, true);
                            }
                        }
                    });
                }
        ...
        j = new com.censivn.C3DEngine.b.d.MouseEventListener(ObjectPool) { // from class: com.tsf.shell.f.e.LassoContextMenu.5
            ...
            public void f(MotionEvent motionEvent) {
                if (com.tsf.shell.f.e.LassoContextMenu.i != -1 && com.tsf.shell.f.e.LassoContextMenu.i != 5) {
                    w.b();
                    com.tsf.shell.f.e.LassoContextMenu.c(com.tsf.shell.f.e.LassoContextMenu.i, false);
                    com.tsf.shell.f.e.LassoContextMenu.k.a(com.tsf.shell.f.e.LassoContextMenu.i, false);
                    int unused = com.tsf.shell.f.e.LassoContextMenu.i = -1;
                }
            }
            ...
            public void a(MotionEvent motionEvent, MotionEvent motionEvent2) {
                ...
                if (!com.tsf.shell.f.e.LassoContextMenu.m) {
                    iB = com.tsf.shell.f.e.LassoContextMenu.b(motionEvent2);
                } else {
                    float[] fArrB = x.b(motionEvent2.getX(), motionEvent2.getY());
                    if (x.b(com.tsf.shell.f.e.LassoContextMenu.n, com.tsf.shell.f.e.LassoContextMenu.o, fArrB[0], fArrB[1]) > 50.0f) {
                        boolean unused = com.tsf.shell.f.e.LassoContextMenu.m = false;
                    }
                }
