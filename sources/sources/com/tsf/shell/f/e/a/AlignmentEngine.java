...
public class AlignmentEngine {
    ...
    private static d g;
    private static a i;
    private static ArrayList<com.tsf.shell.f.i.b.e.DrawerItemVisual> j;
    private static ArrayList<LauncherAppInfo> k;
    private static AlignmentBackHandler.a l;
    ...
    private static void h() {
        if (!d) {
            ...
            g = new AlignmentResizeHandler();
            b = new BaseRenderable() { // from class: com.tsf.shell.f.e.a.AlignmentEngine.1
                @Override // com.censivn.C3DEngine.b.f.IRenderable
                public void onKillFocus() {
                    c.b();
                }
            };
            l = new AlignmentBackHandler.a() { // from class: com.tsf.shell.f.e.a.AlignmentEngine.2
            ...
            e = new g(com.censivn.C3DEngine.b.b.A.z, com.censivn.C3DEngine.b.b.A.A, com.censivn.C3DEngine.b.b.A.b * (-80.0f), com.censivn.C3DEngine.b.b.A.b * 80.0f, com.tsf.shell.manager.o.ButtonPresetManager.a.T) { // from class: com.tsf.shell.f.e.a.AlignmentEngine.3
                ...
                public i a(int i2, i iVar) {
                    ...
                    iVarB.textures().addElement(((com.tsf.shell.f.i.b.e.DrawerItemVisual) c.j.get(i2)).aZ());
                    return iVarB;
                }
    ...
    public static void a() {
        j.clear();
        ArrayList<com.tsf.shell.f.i.b.e.DrawerItemVisual> arrayListD = com.tsf.shell.manager.app.ServiceProvider.a().a.d();
        if (k != null) {
        ...
        Iterator<com.tsf.shell.f.i.b.e.DrawerItemVisual> it = arrayListD.iterator();
        while (it.hasNext()) {
            j.add(it.next());
        }
    }
    ...
    private static void i() {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e.a.AlignmentEngine.5
        ...
        dVar.a(255);
        dVar.h(AlignmentListener);
        com.censivn.C3DEngine.b.g.c.a(AlignmentBackHandler);
    ...
    protected static void c() {
        ...
        i.i();
        AlignmentBackHandler.mouseEnabled(false);
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e.a.AlignmentEngine.6
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
