...
public class ItemAnimationController {
    ...
    public void a() {
        ...
        this.n = new j() { // from class: com.tsf.shell.f.e.e.ItemAnimationController.1
        ...
        a aVar = new ItemNode(com.censivn.C3DEngine.b.b.A.c * 120.0f, com.censivn.C3DEngine.b.b.A.c * 120.0f, z) { // from class: com.tsf.shell.f.e.e.ItemAnimationController.2
        ...
        b bVar = new ItemContainerNode(com.censivn.C3DEngine.b.b.A.c * 120.0f, com.censivn.C3DEngine.b.b.A.c * 120.0f, z) { // from class: com.tsf.shell.f.e.e.ItemAnimationController.3
            @Override // com.tsf.shell.f.e.e.ItemRowItem, com.tsf.shell.f.e.SelectionFrameLayoutItem
            public void a(com.tsf.shell.f.e.SelectionFrameLayoutItem fVar) {
                w.a(3);
                c.this.m.b = fVar;
        ...
        b bVar2 = new ItemContainerNode(com.censivn.C3DEngine.b.b.A.c * 120.0f, com.censivn.C3DEngine.b.b.A.c * 120.0f, z) { // from class: com.tsf.shell.f.e.e.ItemAnimationController.4
            @Override // com.tsf.shell.f.e.e.ItemRowItem, com.tsf.shell.f.e.SelectionFrameLayoutItem
            public void a(com.tsf.shell.f.e.SelectionFrameLayoutItem fVar) {
        ...
        a aVar2 = new ItemNode(com.censivn.C3DEngine.b.b.A.c * 120.0f, com.censivn.C3DEngine.b.b.A.c * 120.0f, z) { // from class: com.tsf.shell.f.e.e.ItemAnimationController.5
            @Override // com.tsf.shell.f.e.e.ItemRowItem, com.tsf.shell.f.e.SelectionFrameLayoutItem
            public boolean a() {
                return super.a();
            }
        ...
        b bVar3 = new ItemContainerNode(com.censivn.C3DEngine.b.b.A.c * 120.0f, com.censivn.C3DEngine.b.b.A.c * 120.0f, z) { // from class: com.tsf.shell.f.e.e.ItemAnimationController.6
            @Override // com.tsf.shell.f.e.e.ItemRowItem, com.tsf.shell.f.e.SelectionFrameLayoutItem
            public boolean a() {
                return super.a();
            }
            ...
            public boolean b(final com.tsf.shell.f.e.SelectionFrameLayoutItem fVar) {
                com.censivn.C3DEngine.A.a().a(new Runnable() { // from class: com.tsf.shell.f.e.e.ItemAnimationController.6.1
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        b bVar4 = new ItemContainerNode(com.censivn.C3DEngine.b.b.A.c * 120.0f, com.censivn.C3DEngine.b.b.A.c * 120.0f, z) { // from class: com.tsf.shell.f.e.e.ItemAnimationController.7
            @Override // com.tsf.shell.f.e.e.ItemRowItem, com.tsf.shell.f.e.SelectionFrameLayoutItem
            public void a(com.tsf.shell.f.e.SelectionFrameLayoutItem fVar) {
            }
    ...
    public void c() {
        if (Thread.currentThread().getId() != com.censivn.C3DEngine.a.e.f) {
            com.censivn.C3DEngine.A.a().c(new Runnable() { // from class: com.tsf.shell.f.e.e.ItemAnimationController.9
                @Override // java.lang.Runnable
                public void run() {
                    c.this.c();
                }
    ...
    public static class a extends ItemContainerNode {
        ...
        public a(float f, float f2, boolean z) {
            super(f, f2, z);
            this.a = new k(com.censivn.C3DEngine.b.b.A.a(64.0f), com.censivn.C3DEngine.b.b.A.a(14.0f), false) { // from class: com.tsf.shell.f.e.e.ItemAnimationController.a.1
                @Override // com.censivn.C3DEngine.b.f.i
                public void onDrawStart() {
                    if (ItemNode.d.id == 0) {
                        com.censivn.C3DEngine.A.g().a(ItemNode.d, ItemContainerNode.d.editer_icon_delete_cap);
                    }
                }
            };
