...
public class c {
    ...
    public void a() {
        ...
        a aVar = new a(com.censivn.C3DEngine.b.b.A.c * 120.0f, com.censivn.C3DEngine.b.b.A.c * 120.0f, z) { // from class: com.tsf.shell.f.e.e.c.2
            ...
            public void a(com.tsf.shell.f.e.F fVar) {
                super.a(fVar);
                w.a(3);
                com.tsf.shell.manager._a.q.a(-52736);
            }
            ...
            public void e(com.tsf.shell.f.e.F fVar) {
                ...
                for (com.tsf.shell.f.i.B bVar2 : arrayList) {
                    ...
                    com.tsf.shell.manager._a.j.a(bVar2);
                }
                if (arrayList.size() > 1) {
        ...
        b bVar = new b(com.censivn.C3DEngine.b.b.A.c * 120.0f, com.censivn.C3DEngine.b.b.A.c * 120.0f, z) { // from class: com.tsf.shell.f.e.e.c.3
            ...
            public void a(com.tsf.shell.f.e.F fVar) {
                ...
                com.tsf.shell.manager._a.q.a(-16728065);
            }
        ...
        b bVar2 = new b(com.censivn.C3DEngine.b.b.A.c * 120.0f, com.censivn.C3DEngine.b.b.A.c * 120.0f, z) { // from class: com.tsf.shell.f.e.e.c.4
            @Override // com.tsf.shell.f.e.e.e, com.tsf.shell.f.e.F
            public void a(com.tsf.shell.f.e.F fVar) {
                if (!com.tsf.shell.manager._a.h.n().c()) {
                    com.tsf.shell.manager._a.h.n().d();
                    c.this.c();
                    com.tsf.shell.manager._a.h.d.a((com.tsf.shell.f.i.B) fVar);
                    w.a(3);
                }
            }
        ...
        a aVar2 = new a(com.censivn.C3DEngine.b.b.A.c * 120.0f, com.censivn.C3DEngine.b.b.A.c * 120.0f, z) { // from class: com.tsf.shell.f.e.e.c.5
            ...
            public boolean b(com.tsf.shell.f.e.F fVar) {
                ...
                com.tsf.shell.manager._a.q.a();
                return com.tsf.shell.manager._a.h.t().d(bVar3);
            }
        ...
        this.m = new f() { // from class: com.tsf.shell.f.e.e.c.8
            ...
            public void a(com.tsf.shell.f.e.F fVar) {
                com.tsf.shell.manager._a.h.b((com.tsf.shell.f.i.B) fVar);
            }
        };
    }
    ...
    public void a(com.tsf.shell.f.i.B bVar, float f, float f2, boolean z, int... iArr) {
        ...
        if (bVar.S()) {
            ...
            this.o = f;
            this.p = f2;
            this.s = com.tsf.shell.manager._a.q.a(this.s);
            this.r = true;
            ...
            ArrayList<com.tsf.shell.f.e.e.b> arrayList = new ArrayList();
            for (int i = 0; i < length; i++) {
                ...
                if (bVar2 == null) {
                    ...
                    bVar2.a();
                    bVar2.a((i * f3) + f4, com.censivn.C3DEngine.b.b.A.I - (com.tsf.shell.manager._a.q.b() / 2.0f), true);
                    arrayList.add(bVar2);
                }
            }
            ...
            for (com.tsf.shell.f.e.e.b bVar4 : arrayList) {
                bVar4.b();
    ...
    public void c() {
        if (Thread.currentThread().getId() != com.censivn.C3DEngine.a.e.f) {
            ...
            com.tsf.shell.manager._a.q.b(this.s);
            this.r = false;
            Iterator<i> it = this.n.children().iterator();
            while (it.hasNext()) {
