...
public class EditModeController implements com.censivn.C3DEngine.b.c.KeyboardHandler.a, e.a, com.tsf.shell.f.e.h.IconEditorConfig.a, com.tsf.shell.f.e.f.EditModeNode.a {
    ...
    private com.tsf.shell.f.e.f.EditModeNode g;
    private com.tsf.shell.f.i.b.e.DrawerItemBase j;
    private c m;
    private boolean n;
    private i o;
    private d q;
    ...
    private BaseRenderable d = new BaseRenderable() { // from class: com.tsf.shell.f.e.f.EditModeController.1
    ...
    public EditModeController() {
        ...
        for (int i2 = 0; i2 < 9; i2++) {
            this.b.add(new EditModeConfig(i2));
        }
        if (a == null) {
            a = new HashMap<>();
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.e.f.EditModeController$2, reason: invalid class name */
    ...
    public void a(int i) {
        switch (i) {
            case 0:
                ...
                break;
            case 1:
                if (this.f instanceof com.tsf.shell.f.i.b.e.DrawerItemBase) {
                    com.tsf.shell.manager.app.FeatureConfig.c();
                    a((com.tsf.shell.f.i.b.e.DrawerItemBase) this.f);
                }
                break;
            case 2:
                com.tsf.shell.manager.app.FeatureConfig.c();
                EditModeNode.a(this.f);
                break;
            case 3:
                this.f.aq();
                break;
    ...
    public void a(final int i, boolean z) {
        if (this.h && !this.i) {
            Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.e.f.EditModeController.4
                @Override // java.lang.Runnable
                public void run() {
                    int size = a.p.size();
                    for (int i2 = 0; i2 < size; i2++) {
        ...
        public static void c(final com.tsf.shell.f.i.PageItem bVar) {
            ...
            builder.setPositiveButton(contextD.getString(EditModeNode.i.public_action_ok), new DialogInterface.OnClickListener() { // from class: com.tsf.shell.f.e.f.EditModeController.b.2
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    if (bVar instanceof com.tsf.shell.f.i.b.e.DrawerItemBase) {
                        ((com.tsf.shell.f.i.b.e.DrawerItemBase) bVar).a(string);
                    } else if (bVar instanceof com.tsf.shell.f.i.b.d.FolderShortcutItem) {
                        ((com.tsf.shell.f.i.b.d.FolderShortcutItem) bVar).a(string);
                    }
                }
            });
            builder.setNegativeButton(contextD.getString(EditModeNode.i.public_action_cancel), new DialogInterface.OnClickListener() { // from class: com.tsf.shell.f.e.f.EditModeController.b.3
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i) {
                }
            });
    ...
    @Override // com.tsf.shell.f.e.h.IconEditorConfig.a
    ...
    public void a(com.tsf.shell.f.i.b.e.DrawerItemBase aVar) {
        this.j = aVar;
        int[] iArrAG = aVar.aG();
        com.tsf.shell.f.e.h.IconEditorConfig.a(this, aVar, iArrAG[0], iArrAG[1]);
    }
