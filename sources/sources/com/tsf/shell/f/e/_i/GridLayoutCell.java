...
public class GridLayoutCell extends j {
    ...
    public GridLayoutCell() {
        ...
        Collections.sort(this.e, new Comparator<a>() { // from class: com.tsf.shell.f.e._i.GridLayoutCell.1
    ...
    public void onDrawChildStart() {
        ...
        while (it.hasNext()) {
            a aVar = (GridLayoutStrategy) it.next();
