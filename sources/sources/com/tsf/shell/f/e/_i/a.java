...
public class a extends j {
    ...
    public void b(int i) {
        f();
        VMessageManager.postGLThreadRunnable(new Runnable() { // from class: com.tsf.shell.f.e._i.a.2
            @Override // java.lang.Runnable
            public void run() {
                a.this.b.textures().removeAll();
                a.this.b.textures().addElement(a.c);
                a.this.b.scale().setAll(0.0f, 0.0f, 1.0f);
                com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._i.a.2.1
