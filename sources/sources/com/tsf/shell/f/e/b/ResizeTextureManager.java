...
public class ResizeTextureManager {
    public static a a;
    public static f b;
    private static d h;
    private static d i;
    ...
    public static void a() {
        ...
        if (h == null) {
            ...
            h = new ResizeConstants(str6, str7);
        }
        if (i == null) {
            try {
            ...
            i = new ResizeConstants(str3, str4);
        }
        if (b == null) {
            try {
    ...
    public static void a(int i2, int i3, d dVar, int i4, int i5) {
        ...
        if (a == null) {
            a = new ResizeButtonNode();
        }
        ResizeButtonNode.a(i2);
        ResizeButtonNode.a(dVar);
        ResizeButtonNode.a(i4, i5);
        ResizeButtonNode.a();
    }
