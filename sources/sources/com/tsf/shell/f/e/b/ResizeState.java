...
public class ResizeState extends BaseRenderable {
    ...
    public ResizeState() {
        ...
        this.f = byteBufferAllocateDirect2.asFloatBuffer();
        this.f.position(0);
    ...
    public void dispatchDraw() {
        if (this.c == 1.0f || this.c == 0.0f) {
            ...
            setCustomShader(ResizeTextureManager.b);
        }
        super.dispatchDraw();
    }
    ...
    public void drawElement() {
        ...
        if (this.a != -1 && this.b != -1) {
            ResizeTextureManager.b.a(this.c);
            ResizeTextureManager.b.a(255, 255 - this.d, 255 - this.d, 255 - this.d);
            ResizeTextureManager.b.glMVPMatrix();
            ResizeTextureManager.b.glVertexPointer(3, 5126, false, 0, this.e);
            ResizeTextureManager.b.glTexCoordPointer(2, 5126, false, 0, this.f);
            GLES20.glActiveTexture(33984);
