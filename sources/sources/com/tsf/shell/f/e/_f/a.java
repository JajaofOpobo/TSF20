...
public class a implements com.censivn.C3DEngine.b.c.b.a, e.a, com.tsf.shell.f.e._h.b.a, com.tsf.shell.f.e._f.b.a {
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.e._f.a$2, reason: invalid class name */
    class AnonymousClass2 extends com.censivn.C3DEngine.b.d.a {
        ...
        public void a(MotionEvent motionEvent, MotionEvent motionEvent2) {
            if (!this.a) {
                ...
                this.a = true;
                com.censivn.C3DEngine.A.a().c(new Runnable() { // from class: com.tsf.shell.f.e._f.a.2.1
    ...
    public void f() {
        ...
        com.tsf.shell.manager.app.j.b(this.d);
    }
    ...
    public void a(com.tsf.shell.f.i.C cVar, i iVar, ArrayList<Integer> arrayList, ArrayList<Integer> arrayList2) {
        if (!this.h) {
            ...
            if (this.g != null) {
                ...
                this.f = cVar;
                this.h = true;
                com.tsf.shell.manager.app.j.a(this.d, 0);
                ...
                com.tsf.shell.manager.app.v.e.h().a(p, f, fQ);
                this.d.setFocus();
            }
        }
    }
    ...
    private void g() {
        if (this.o != null) {
            this.n = true;
            com.tsf.shell.manager.app.e.a(i().b, (Runnable) null);
            this.o.visible(false);
            this.o.mouseEnabled(false);
            return;
        }
        this.n = false;
        com.tsf.shell.manager.app.e.a(this.k);
    }
    ...
    public void a(final com.tsf.shell.f.i.C cVar) {
        if (!this.r && this.q != null) {
            this.r = true;
            this.q.a();
            com.censivn.C3DEngine.A.a().b(new Runnable() { // from class: com.tsf.shell.f.e._f.a.3
                @Override // java.lang.Runnable
                public void run() {
                    a.this.r = false;
                    ...
                    a.this.q = null;
                    if (cVar != null && a.this.q != com.tsf.shell.manager.app.v.e.h()) {
                        a.this.b(cVar);
                    }
                }
            }, this.q.a(p.size()));
    ...
    public void b(com.tsf.shell.f.i.C cVar) {
        ...
        this.q = com.tsf.shell.manager.app.v.e.h();
        this.q.a(p, f, fA);
    }

    private void a(int i, Runnable runnable, boolean z) {
        if (this.n) {
            com.tsf.shell.manager.app.e.a(i, runnable, z);
        } else {
            com.tsf.shell.manager.app.e.b(i, runnable, z);
        }
    }
    ...
    private j.a i() {
        ...
        aVarC.a = this;
        com.tsf.shell.manager.app.t.b(com.tsf.shell.f.f.j.c(), aVarC.b);
        com.tsf.shell.manager.app.e.dispatchDraw();
        this.o.dispatchDraw();
    ...
    public void a(final int i, boolean z) {
        if (this.h && !this.i) {
            Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.e._f.a.4
                @Override // java.lang.Runnable
                public void run() {
                    int size = a.p.size();
                    for (int i2 = 0; i2 < size; i2++) {
                    ...
                    if (!a.this.n) {
                        com.tsf.shell.manager.app.c.b(a.this);
                    }
                    a.this.h();
                    a.this.a(i);
                    a.this.h = false;
                    ...
                    com.tsf.shell.manager.app.b.b(a.this);
                    com.tsf.shell.manager.app.v.e.f();
                    a.this.f = null;
                }
            };
            this.i = true;
            if (z) {
                ...
                this.f.alpha(0.0f);
                a(com.tsf.shell.manager.app.v.e.h().a(p.size()), runnable, z);
                this.f.alpha(fAlpha);
                this.f.visible(true);
                com.tsf.shell.manager.app.v.e.h().a();
                return;
            }
            a(com.tsf.shell.manager.app.v.e.h().a(p.size()), runnable, z);
            com.tsf.shell.manager.app.v.e.h().a();
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.e._f.a$a, reason: collision with other inner class name */
    ...
    static class b {
        ...
        public static void c(final com.tsf.shell.f.i.B bVar) {
            ...
            builder.setPositiveButton(contextD.getString(b.i.public_action_ok), new DialogInterface.OnClickListener() { // from class: com.tsf.shell.f.e._f.a.b.2
            ...
            builder.setNegativeButton(contextD.getString(b.i.public_action_cancel), new DialogInterface.OnClickListener() { // from class: com.tsf.shell.f.e._f.a.b.3
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i) {
                }
            });
    ...
    public class c extends com.censivn.C3DEngine.b.f.j {
        ...
        public void a() {
            ...
            com.tsf.shell.manager.app.v.e.h().a(this);
        }
        ...
        public void a(boolean z) {
            ...
            if (z) {
                com.tsf.shell.manager.app.v.e.h().b(this);
            }
        }
    ...
    @Override // com.tsf.shell.f.e._h.b.a
    ...
    public void a(com.tsf.shell.f.i._b.e.a aVar) {
        this.j = aVar;
        int[] iArrAG = aVar.aG();
        com.tsf.shell.f.e._h.b.a(this, aVar, iArrAG[0], iArrAG[1]);
    }
