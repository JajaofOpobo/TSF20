...
public class a implements com.censivn.C3DEngine.b.c.b.a, e.a, com.tsf.shell.f.e._h.b.a, com.tsf.shell.f.e._f.b.a {
    ...
    public void f() {
        ...
        com.tsf.shell.manager._a.j.b(this.d);
    }
    ...
    public void a(com.tsf.shell.f.i.C cVar, i iVar, ArrayList<Integer> arrayList, ArrayList<Integer> arrayList2) {
        if (!this.h) {
            ...
            if (this.g != null) {
                ...
                this.f = cVar;
                this.h = true;
                com.tsf.shell.manager._a.j.a(this.d, 0);
                ...
                com.tsf.shell.manager._a.v.e.h().a(p, f, fQ);
                this.d.setFocus();
            }
        }
    }
    ...
    private void g() {
        if (this.o != null) {
            this.n = true;
            com.tsf.shell.manager._a.e.a(i().b, (Runnable) null);
            this.o.visible(false);
            this.o.mouseEnabled(false);
            return;
        }
        this.n = false;
        com.tsf.shell.manager._a.e.a(this.k);
    }
        ...
        if (!this.r && this.q != null) {
            ...
            com.censivn.C3DEngine.A.a().b(new Runnable() { // from class: com.tsf.shell.f.e._f.a.3
                ...
                public void run() {
                    ...
                    a.this.q = null;
                    if (cVar != null && a.this.q != com.tsf.shell.manager._a.v.e.h()) {
                        a.this.b(cVar);
                    }
                }
            }, this.q.a(p.size()));
    ...
    public void b(com.tsf.shell.f.i.C cVar) {
        ...
        this.q = com.tsf.shell.manager._a.v.e.h();
        this.q.a(p, f, fA);
    }

    private void a(int i, Runnable runnable, boolean z) {
        if (this.n) {
            com.tsf.shell.manager._a.e.a(i, runnable, z);
        } else {
            com.tsf.shell.manager._a.e.b(i, runnable, z);
        }
    }
    ...
    private j.a i() {
        ...
        com.tsf.shell.manager._a.e.dispatchDraw();
        this.o.dispatchDraw();
        ...
        if (this.h && !this.i) {
            Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.e._f.a.4
                ...
                public void run() {
                    ...
                    if (!a.this.n) {
                        com.tsf.shell.manager._a.c.b(a.this);
                    }
                    a.this.h();
                    a.this.a(i);
                    a.this.h = false;
                    ...
                    com.tsf.shell.manager._a.b.b(a.this);
                    com.tsf.shell.manager._a.v.e.f();
                    a.this.f = null;
                }
            };
            this.i = true;
            if (z) {
                ...
                this.f.alpha(0.0f);
                a(com.tsf.shell.manager._a.v.e.h().a(p.size()), runnable, z);
                this.f.alpha(fAlpha);
                this.f.visible(true);
                com.tsf.shell.manager._a.v.e.h().a();
                return;
            }
            a(com.tsf.shell.manager._a.v.e.h().a(p.size()), runnable, z);
            com.tsf.shell.manager._a.v.e.h().a();
    ...
    public class c extends com.censivn.C3DEngine.b.f.j {
        ...
        public void a() {
            ...
            com.tsf.shell.manager._a.v.e.h().a(this);
        }
        ...
        public void a(boolean z) {
            ...
            if (z) {
                com.tsf.shell.manager._a.v.e.h().b(this);
            }
        }
