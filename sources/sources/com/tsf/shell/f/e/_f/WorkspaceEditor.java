...
public class WorkspaceEditor implements com.censivn.C3DEngine.b.c.b.a, e.a, com.tsf.shell.f.e._h.IconEditorHelper.a, com.tsf.shell.f.e._f.EditTarget.a {
    ...
    public WorkspaceEditor() {
        ...
        if (a == null) {
            a = new HashMap<>();
            a.put(0, new C0094a(ThemeShellDescription.ICON_MENU_DETAIL_ON, ThemeShellDescription.ICON_MENU_DETAIL_OFF, 0, x.c(EditTarget.i.text_detail)));
            a.put(1, new C0094a(ThemeShellDescription.ICON_MENU_EDIT_ON, ThemeShellDescription.ICON_MENU_EDIT_OFF, 1, x.c(EditTarget.i.text_edit)));
            a.put(2, new C0094a(ThemeShellDescription.ICON_MENU_EDIT_ON, ThemeShellDescription.ICON_MENU_EDIT_OFF, 2, x.c(EditTarget.i.text_rename)));
            a.put(4, new C0094a(ThemeShellDescription.ICON_MENU_DELETE_ON, ThemeShellDescription.ICON_MENU_DELETE_OFF, 4, x.c(EditTarget.i.text_delete)));
            a.put(3, new C0094a(ThemeShellDescription.ICON_MENU_MUTIL_CHOICE_ON, ThemeShellDescription.ICON_MENU_MUTIL_CHOICE_OFF, 3, x.c(EditTarget.i.text_multi_choice)));
            a.put(5, new C0094a(ThemeShellDescription.ICON_MENU_UNINSTALL_ON, ThemeShellDescription.ICON_MENU_UNINSTALL_OFF, 5, x.c(EditTarget.i.text_uninstall)));
            a.put(6, new C0094a(ThemeShellDescription.ICON_MENU_RESET_ON, ThemeShellDescription.ICON_MENU_RESET_OFF, 6, x.c(EditTarget.i.text_rotate)));
            a.put(7, new C0094a(ThemeShellDescription.ICON_MENU_ALIGN_ON, ThemeShellDescription.ICON_MENU_ALIGN_OFF, 7, x.c(EditTarget.i.text_snaplines)));
        }
        while (true) {
            int i3 = i;
            if (i3 < 9) {
    ...
    public void f() {
        ...
        com.tsf.shell.manager.app.TaskScheduler.b(this.d);
    }
    ...
    public void a(com.tsf.shell.f.i.ShortcutItem cVar, i iVar, ArrayList<Integer> arrayList, ArrayList<Integer> arrayList2) {
        if (!this.h) {
            ...
            if (this.g != null) {
                ...
                com.tsf.shell.manager.app.v.ScreenHelper.h().a(p, f, fQ);
                this.d.setFocus();
            }
        }
    }
    ...
    private void g() {
        if (this.o != null) {
            this.n = true;
            com.tsf.shell.manager.app.DataCoordinator.a(i().b, (Runnable) null);
    ...
    public void b(com.tsf.shell.f.i.ShortcutItem cVar) {
        ...
        this.q = com.tsf.shell.manager.app.v.ScreenHelper.h();
        this.q.a(p, f, fA);
    }

    private void a(int i, Runnable runnable, boolean z) {
        if (this.n) {
            com.tsf.shell.manager.app.DataCoordinator.a(i, runnable, z);
        } else {
            com.tsf.shell.manager.app.DataCoordinator.b(i, runnable, z);
        }
    }
    ...
    public void h() {
        if (this.n) {
            ...
            com.tsf.shell.manager.app.DataCoordinator.b();
        }
    }
    ...
    public void a(final int i, boolean z) {
        if (this.h && !this.i) {
            Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.e._f.WorkspaceEditor.4
                @Override // java.lang.Runnable
                public void run() {
                    int size = a.p.size();
                    for (int i2 = 0; i2 < size; i2++) {
            ...
            if (z) {
                ...
                this.f.alpha(0.0f);
                a(com.tsf.shell.manager.app.v.ScreenHelper.h().a(p.size()), runnable, z);
                this.f.alpha(fAlpha);
                this.f.visible(true);
                com.tsf.shell.manager.app.v.ScreenHelper.h().a();
                return;
            }
            a(com.tsf.shell.manager.app.v.ScreenHelper.h().a(p.size()), runnable, z);
            com.tsf.shell.manager.app.v.ScreenHelper.h().a();
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.e._f.WorkspaceEditor$a, reason: collision with other inner class name */
    ...
    static class b {
        ...
        public static void c(final com.tsf.shell.f.i.PageItem bVar) {
            ...
            builder.setNegativeButton(contextD.getString(EditTarget.i.public_action_cancel), new DialogInterface.OnClickListener() { // from class: com.tsf.shell.f.e._f.WorkspaceEditor.b.3
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i) {
                }
            });
    ...
    public class c extends com.censivn.C3DEngine.b.f.BaseRenderable {
        ...
        public void a() {
            ...
            com.tsf.shell.manager.app.v.ScreenHelper.h().a(this);
        }
        ...
        public void a(boolean z) {
            ...
            if (z) {
                com.tsf.shell.manager.app.v.ScreenHelper.h().b(this);
            }
        }
    ...
    @Override // com.tsf.shell.f.e._h.IconEditorHelper.a
