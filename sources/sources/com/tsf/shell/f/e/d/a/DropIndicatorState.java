...
public class DropIndicatorState extends BaseRenderable {
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.e.d.a.DropIndicatorState$c, reason: collision with other inner class name */
    ...
    public boolean b() {
        ...
        for (int i = 0; i < this.b.numChildren(); i++) {
            ...
            com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.e.d.a.DropIndicatorState.2
    ...
    public void a(a aVar) {
        for (int i = 0; i < this.b.numChildren(); i++) {
            ...
            if (aVar2 != aVar) {
                com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.e.d.a.DropIndicatorState.4
                    @Override // com.censivn.C3DEngine.b.g.TweenParams
                    public void a() {
                    }
                };
    ...
    private void e() {
        for (int i = 0; i < this.b.numChildren(); i++) {
            ...
            com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.e.d.a.DropIndicatorState.5
                @Override // com.censivn.C3DEngine.b.g.TweenParams
                public void a() {
                }
            };
