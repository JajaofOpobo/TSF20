...
public class DropIndicatorState extends j {
    ...
    public boolean b() {
        ...
        for (int i = 0; i < this.b.numChildren(); i++) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e.d.a.DropIndicatorState.2
    ...
    public void a(a aVar) {
        for (int i = 0; i < this.b.numChildren(); i++) {
            ...
            if (aVar2 != aVar) {
                com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e.d.a.DropIndicatorState.4
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a() {
                    }
                };
    ...
    private void e() {
        for (int i = 0; i < this.b.numChildren(); i++) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e.d.a.DropIndicatorState.5
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
                }
            };
