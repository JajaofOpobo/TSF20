    ...
    private void d() {
        ...
        switch (this.a) {
            case 0:
                ...
                setAABBPX((-this.d) / 2.0f, (-fA) / 2.0f, 0.0f, this.d / 2.0f, fA / 2.0f, 0.0f);
                break;
            case 1:
                setAABBPX(0.0f, (-fA) / 2.0f, 0.0f, this.d, fA / 2.0f, 0.0f);
                break;
            case 2:
                this.b.position().x -= this.d;
                this.c.position().x -= this.d;
                setAABBPX((-this.d) / 2.0f, (-fA) / 2.0f, 0.0f, 0.0f, fA / 2.0f, 0.0f);
                break;
        }
    }
}
