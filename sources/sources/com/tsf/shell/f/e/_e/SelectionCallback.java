...
public class SelectionCallback extends BaseRenderable {
    ...
    public void a() {
        if (this.j) {
            ...
            this.g = f2;
            this.d = f2;
            com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.e._e.SelectionCallback.1
    ...
    public void c() {
        if (this.i) {
            ...
            com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.e._e.SelectionCallback.3
                @Override // com.censivn.C3DEngine.b.g.TweenParams
                public void a() {
                    runnable.run();
                }
