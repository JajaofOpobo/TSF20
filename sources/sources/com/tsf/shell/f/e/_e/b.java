...
public class b extends j {
    ...
    public void a() {
        if (this.j) {
            ...
            this.g = f2;
            this.d = f2;
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._e.b.1
    ...
    public void c() {
        if (this.i) {
            this.i = false;
            a();
            final Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.e._e.b.2
                @Override // java.lang.Runnable
                public void run() {
                    b.this.removeFromParent();
                }
            };
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._e.b.3
                @Override // com.censivn.C3DEngine.b.g.d
                public void a() {
                    runnable.run();
                }
