...
public class a extends j {
    ...
    public a() {
        ...
        addChild(this.a);
        addChild(this.b);
        this.c = new b() { // from class: com.tsf.shell.f.e._e.a.1
            @Override // com.tsf.shell.f.e._e.a.b, java.lang.Runnable
            public void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void e() {
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e._e.a.2
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.e._e.a$a, reason: collision with other inner class name */
