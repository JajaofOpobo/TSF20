...
public class SelectionIndicator extends BaseRenderable {
    private C0093a b;
    private b c;
    ...
    public SelectionIndicator() {
        ...
        addChild(this.a);
        addChild(this.b);
        this.c = new SelectionCallback() { // from class: com.tsf.shell.f.e._e.SelectionIndicator.1
            @Override // com.tsf.shell.f.e._e.SelectionIndicator.b, java.lang.Runnable
            public void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void e() {
        com.censivn.C3DEngine.b.g.TweenParams dVar = new com.censivn.C3DEngine.b.g.TweenParams() { // from class: com.tsf.shell.f.e._e.SelectionIndicator.2
    ...
    /* JADX INFO: renamed from: com.tsf.shell.f.e._e.SelectionIndicator$a, reason: collision with other inner class name */
    class C0093a extends WorkspaceRowItem {
        public int a;
