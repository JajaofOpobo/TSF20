...
public class c extends com.tsf.shell.f.d.a.A {
    ...
    public c(int i, boolean z) {
        super(i, z);
        this.a = new com.tsf.shell.f.i._b.e.h().k;
    }
    ...
    public void a(i iVar, Number3d number3d, Number3d number3d2, Runnable runnable) {
        if (iVar.textures().size() != 0 && iVar.textures().get(0).textureElement != null) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.d.a._a.c.1
    ...
    public void a(k kVar, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.d.a._a.c.2
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
