package com.tsf.shell.f.d.a._a;
...
public class d extends com.tsf.shell.f.d.a.A {
    ...
    public void a(final com.censivn.C3DEngine.b.f._a.a aVar, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.d.a._a.d.1
    ...
    public void a(final com.censivn.C3DEngine.b.f._a.a aVar, final Runnable runnable, final boolean z) {
        ...
        final float fPxX2 = aVar.points().pxX(com.tsf.shell.manager.o.b.a.d);
        final float fPxY2 = aVar.points().pxY(com.tsf.shell.manager.o.b.a.d);
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.d.a._a.d.2
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
                if (runnable != null) {
                    runnable.run();
    ...
    private void b(final k kVar, final Runnable runnable) {
        ...
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.d.a._a.d.3
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
    ...
    public void c(final k kVar, final Runnable runnable) {
        ...
        final float fPxY = kVar.points().pxY(2);
        final float fPxY2 = kVar.points().pxY(3);
        com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.d.a._a.d.4
            @Override // com.censivn.C3DEngine.b.g.d
            public void a() {
                if (runnable != null) {
                    runnable.run();
