...
public class c extends com.tsf.shell.f.e._g.a.b {
    ...
    public c(b bVar) {
        ...
        a.C0095a.C0096a c0096a = new a.C0095a.C0096a() { // from class: com.tsf.shell.f.g.a.c.1
            ...
            public boolean a() {
                return com.tsf.shell.manager.app.v.a.C0126a.g();
            }

            @Override // com.tsf.shell.f.e._g.a.a.C0095a.C0096a
            public void b() {
                com.tsf.shell.manager.app.v.a.C0126a.a(true);
                c.this.b.d();
            }

            @Override // com.tsf.shell.f.e._g.a.a.C0095a.C0096a
            public void c() {
                com.tsf.shell.manager.app.v.a.C0126a.a(false);
                c.this.b.d();
            }
        };
        a.C0095a.C0096a c0096a2 = new a.C0095a.C0096a() { // from class: com.tsf.shell.f.g.a.c.2
            ...
            public void b() {
                ...
                com.tsf.shell.manager.app.v.a.C0126a.d();
            }
        ...
        this.c = new a.C0095a(b.d.effect_setting_desktop_menu_swing, x.c(b.i.menu_effect_swing), new a.C0095a.C0096a() { // from class: com.tsf.shell.f.g.a.c.3
            @Override // com.tsf.shell.f.e._g.a.a.C0095a.C0096a
            public boolean a() {
                return com.tsf.shell.manager.app.v.c.b();
            }

            @Override // com.tsf.shell.f.e._g.a.a.C0095a.C0096a
            public void b() {
                com.tsf.shell.manager.app.v.c.c();
                com.tsf.shell.manager.app.v.a.C0126a.d();
            }

            @Override // com.tsf.shell.f.e._g.a.a.C0095a.C0096a
            public void c() {
                com.tsf.shell.manager.app.v.c.d();
                com.tsf.shell.manager.app.v.a.C0126a.d();
            }
        });
        ...
        this.b.a(new com.censivn.C3DEngine.b.h.b.b() { // from class: com.tsf.shell.f.g.a.c.4
            ...
            public int a() {
                return com.tsf.shell.manager.app.v.a.C0126a.i();
            }
            ...
            public i a(int i, i iVar) {
                ...
                l lVarA = com.tsf.shell.manager.app.v.a.C0126a.a(i);
                h hVar2 = (h) hVar;
                if (lVarA.i()) {
                    hVar2.g();
                } else {
        ...
        this.b.a(new com.censivn.C3DEngine.b.h.b.f() { // from class: com.tsf.shell.f.g.a.c.5
            ...
            public void a(i iVar, int i, MotionEvent motionEvent) {
                l lVarA = com.tsf.shell.manager.app.v.a.C0126a.a(i);
                w.b();
                com.tsf.shell.manager.app.v.a.C0126a.c(lVarA);
                c.this.b.d();
            }
        });
        this.d = com.tsf.shell.manager.app.a.a(this, com.tsf.shell.manager.p.e.f);
    }
    ...
    public void onHide() {
        super.onHide();
        this.d.b();
        int i = com.tsf.shell.manager.app.v.a.C0126a.i();
        for (int i2 = 0; i2 < i; i2++) {
            com.tsf.shell.manager.app.v.a.C0126a.a(i2).l();
        }
    }
    ...
    public void onRecycle() {
        ...
        int i = com.tsf.shell.manager.app.v.a.C0126a.i();
        for (int i2 = 0; i2 < i; i2++) {
            com.tsf.shell.manager.app.v.a.C0126a.a(i2).h();
        }
        h.b();
        com.tsf.shell.manager.app.v.a.C0126a.j();
    }
}
