...
public class GestureMenuTextItem extends GestureMenuBlankItem {
    ...
    public GestureMenuTextItem(b bVar) {
        ...
        arrayList.add(new GestureMenuBlankItem.C0095a(GestureMenuOverlay.d.effect_setting_desktop_menu_random, x.c(GestureMenuOverlay.i.text_random), new GestureMenuBlankItem.C0095GestureMenuBlankItem.C0096a() { // from class: com.tsf.shell.f.g.a.GestureMenuTextItem.1
        ...
        this.b.a(new com.censivn.C3DEngine.b.h.b.DesktopTouchHandlerF() { // from class: com.tsf.shell.f.g.a.GestureMenuTextItem.3
            ...
            public void a(i iVar, int i, MotionEvent motionEvent) {
                ...
                com.tsf.shell.manager.app.v.ScreenHelper.d().b(GestureMenuTextItem.this.a.a());
                GestureMenuTextItem.this.b.d();
            }
        });
