...
public class ThemeFavoriteManager {
    ...
    public interface a {
        void a(ThemeModel kVar);

        void b(ThemeModel kVar);
    }
    ...
    public boolean a(Context context, ThemeModel kVar) {
        b();
    ...
    public boolean b(Context context, ThemeModel kVar) {
    ...
    public List<ThemeModel> a(Context context) throws Throwable {
        Cursor cursorQuery;
        Cursor cursor;
        b();
        try {
    ...
    */
    public boolean c(android.content.Context r12, com.tsf.extend.theme.ThemeModel r13) throws java.lang.Throwable {
        /*
            r11 = this;
            r8 = 1
            r10 = 0
        ...
        L69:
            ...
            goto L1e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.extend.theme.ThemeFavoriteManager.c(android.content.Context, com.tsf.extend.theme.ThemeModel):boolean");
    }
}
