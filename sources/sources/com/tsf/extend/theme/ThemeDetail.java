...
public class ThemeDetail extends FrameLayout implements DialogInterface.OnClickListener, View.OnClickListener, ViewTreeObserver.OnGlobalLayoutListener, PageActivity.a, a.InterfaceC0048a<List<k>>, PersonalizationActivity.n, l.a {
    ...
    */
    ...
    private void m() {
        int iA = PersonalizationActivity.a(getContext(), 2.0f);
        i iVar = new i(442511);
        iVar.a(iA);
    ...
    public void r() {
        ...
        if (top >= (-this.ae) && top <= this.ae) {
            float fAbs = Math.abs(top - this.af) / this.ae;
            int iA = a(this.ab, fAbs);
            int iA2 = a(this.ac, fAbs);
            this.d.setBackgroundColor(iA);
            this.d.setTextColor(iA2);
        }
    }
                ...
                if (this.K == null || this.K.getVisibility() != 0) {
                    ...
                    if (this.D == f.THEME_HASLOCAL || this.D == f.LOCAL_THEME || ((ao.b().f() && d(jH)) || this.aj != null)) {
                        if (com.tsf.extend.base.j.f.a(getContext(), "com.ksmobile.launcher")) {
                            ...
                            x.b(getContext(), "https://play.google.com/store/apps/details?id=com.ksmobile.launcher", "&referrer=utm_source%3Dtsf_theme_center_theme_cmlauncher" + jH);
                        }
                    } else if (!TextUtils.isEmpty(this.z.E()) && ao.b().g()) {
                        k kVarE = com.tsf.extend.wallpaper.l.a().e(this.z);
                        if (kVarE != null && !kVarE.H()) {
                            kVarE.e(true);
    ...
    private void D() {
        ...
        final Runnable runnable = new Runnable() { // from class: com.tsf.extend.theme.ThemeDetail.10
            @Override // java.lang.Runnable
            public void run() {
                ThemeDetail.this.q.startAnimation(animationLoadAnimation2);
            }
        };
        animationLoadAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: com.tsf.extend.theme.ThemeDetail.11
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationStart(Animation animation) {
            }
        ...
        this.q.startAnimation(animationLoadAnimation);
    }
    ...
    class a implements a.InterfaceC0048a<Pair<String, Bitmap>> {
        ...
        private void a() {
            int iMin;
            if (ThemeDetail.this.r.getVisibility() != 0 && this.a + this.b >= (iMin = Math.min(ThemeDetail.this.C, 3))) {
                if (this.a >= iMin || ThemeDetail.this.l()) {
