...
public class ThemeCmClubActivity extends CustomActivity {
    ...
    public File a(boolean z) {
        ...
        File file = new File(fileA.toString(), "camera_capture.jpg");
        if (z && file.exists()) {
            file.delete();
            return file;
        }
    ...
    protected void onActivityResult(int i, int i2, Intent intent) throws Throwable {
        ...
        if (i == 3 && i2 == -1 && intent != null && this.J != null) {
            g(intent);
        }
    }
    ...
    public void a(String str) {
        try {
            ...
            JSONArray jSONArrayOptJSONArray = jSONObject2.optJSONArray("launcher_preview");
    ...
    private class b implements Runnable {
        ...
        b(String str, String str2, List<String> list) {
            this.c = ThemeCmClubActivity.this.new a();
            this.d = str;
            this.e = str2;
            this.f = list;
        }
    ...
    private class d extends WebViewClient {
        ...
        private InputStream a(Uri uri, int i, int i2, int i3) throws Throwable {
            Bitmap bitmapA;
            try {
                bitmapA = ThemeCmClubActivity.a(ThemeCmClubActivity.this.f, uri, i, i2, false, i3);
            } catch (IOException e) {
                e.printStackTrace();
                bitmapA = null;
            }
        ...
        @Override // android.webkit.WebViewClient
        @TargetApi(11)
        public WebResourceResponse shouldInterceptRequest(WebView webView, String str) throws Throwable {
            File fileA;
            byte[] blob;
            ...
            String str3 = strArrSplit[length2];
            ...
            if ("icons".equals(str3)) {
                Cursor cursorQuery = ThemeCmClubActivity.this.getContentResolver().query(ThemeCmClubActivity.e, null, str2, null, null);
                if (cursorQuery == null || !cursorQuery.moveToFirst() || (blob = cursorQuery.getBlob(cursorQuery.getColumnIndexOrThrow("bitmap"))) == null || (byteArrayInputStream = new ByteArrayInputStream(blob)) == null) {
                    return null;
                }
            ...
            if ("image".equals(str3)) {
                ...
                InputStream inputStreamA = a(ThemeCmClubActivity.this.I.getData(), ThemeCmClubActivity.this.L.a, ThemeCmClubActivity.this.L.b, ThemeCmClubActivity.this.L.c);
                ThemeCmClubActivity.this.I = null;
                ThemeCmClubActivity.this.L = null;
                if (inputStreamA != null) {
                    return new WebResourceResponse("image/png", "UTF-8", inputStreamA);
                }
                return null;
            }
            if (!"camera".equals(str3) || (fileA = ThemeCmClubActivity.this.a(false)) == null || ThemeCmClubActivity.this.L == null) {
                return null;
            }
            InputStream inputStreamA2 = a(Uri.fromFile(fileA), ThemeCmClubActivity.this.L.a, ThemeCmClubActivity.this.L.b, ThemeCmClubActivity.this.L.c);
            ThemeCmClubActivity.this.L = null;
            if (inputStreamA2 != null) {
                return new WebResourceResponse("image/png", "UTF-8", inputStreamA2);
            }
            return null;
        }
    }
    ...
    public static String a(Context context) throws Throwable {
        Bitmap bitmap;
        File fileA = com.tsf.extend.theme.diy.e.a(context, ".image");
        if (fileA == null) {
            return null;
        }
        File file = new File(fileA.toString(), "the_wallpaper.jpg");
        if (file.exists()) {
            file.delete();
        }
    ...
    */
    public static void a(android.graphics.Bitmap r3, java.lang.String r4) throws java.lang.Throwable {
        /*
    ...
    public static Bitmap a(Context context, Uri uri, int i, int i2, boolean z, int i3) throws Throwable {
        ...
        if (inputStream == null) {
            try {
                inputStreamOpenInputStream2 = ("content".equals(uri.getScheme()) || "file".equals(uri.getScheme())) ? context.getContentResolver().openInputStream(uri) : new FileInputStream(new File(uri.toString()));
            } catch (Throwable th2) {
        ...
        try {
            ...
            if (i3 == 1) {
                ...
                if (width2 <= i && height2 <= i2) {
                    return a(bitmapDecodeStream, iA);
                }
                if (z2) {
                    height = bitmapDecodeStream.getHeight();
                    width = bitmapDecodeStream.getWidth();
                } else {
                    width = height2;
                    height = width2;
                }
                if (height / width >= 1.0f) {
                    i5 = (int) (width * ((i * 1.0f) / (height * 1.0f)));
                    i4 = i;
                } else {
                    i4 = (int) (((i2 * 1.0f) / (width * 1.0f)) * height);
                    i5 = i2;
                }
