...
public class ThemeBaseAdapter extends BaseAdapter {
    ...
    public void a(List<b> list, List<ThemeModel> list2) {
        B bVar;
    ...
    public static class b {
        ...
        public b(ThemeModel kVar, k kVar2, k kVar3) {
        ...
        public b(List<ThemeModel> list) {
            this.d = new ArrayList();
            this.d = list;
        }

        public b(ThemeModel kVar) {
            this.d = new ArrayList();
            this.e = kVar;
        }
    ...
    protected class C implements com.tsf.extend.base.d.BaseDataProvider.InterfaceC0048a<Pair<String, Bitmap>> {
        protected C() {
        }
    ...
    public boolean a(ThemeModel kVar) {
        if (kVar == null) {
            return false;
        }
        if (this.n != null) {
