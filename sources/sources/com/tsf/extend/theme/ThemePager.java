...
public class ThemePager extends FrameLayout implements View.OnClickListener, ViewPager.e, PagerIndicator.a, PersonalizationActivity.h, PersonalizationActivity.i, com.tsf.extend.wallpaper.q {
    ...
    protected void onFinishInflate() {
        ...
        int iA = 0;
        if (this.v) {
            iA = PersonalizationActivity.a(getContext(), 52.0f);
    ...
    private class b extends com.tsf.extend.base.support.a {
        ...
        public Object a(ViewGroup viewGroup, int i) {
            ...
            if (view == null) {
                switch (i) {
                    case 0:
                        rVar = new z(ThemePager.this.getContext(), (PageActivity) ThemePager.this.getContext(), m.j[1], ThemePager.this);
                        break;
                    case 1:
                        rVar = new z(ThemePager.this.getContext(), (PageActivity) ThemePager.this.getContext(), m.j[0], ThemePager.this);
                        break;
                    case 2:
                        rVar = new r(ThemePager.this.getContext(), (PageActivity) ThemePager.this.getContext(), m.j[3], ThemePager.this);
                        break;
                    default:
                        rVar = view;
                        break;
                }
                ((m) rVar).setDiyButtonCallback(ThemePager.this);
                ((com.tsf.extend.wallpaper.p) rVar).setScrollListener(ThemePager.this);
                ((com.tsf.extend.wallpaper.p) rVar).setHeadViewHeight(ThemePager.c);
                ThemePager.this.k.put(i, rVar);
            } else {
                rVar = view;
            }
            viewGroup.addView(rVar, this.b);
            return rVar;
        }
        ...
        if (this.k.indexOfValue(view) == this.e.getCurrentItem()) {
            ...
            if (this.k != null && this.k.size() > 0) {
                ...
                for (int i3 = 0; i3 < this.k.size(); i3++) {
                    View viewValueAt = this.k.valueAt(i3);
    ...
    public void b() {
        if (!this.p && this.g != null) {
            View viewB = this.g.b(this.i);
            if (viewB instanceof m) {
                this.p = true;
            }
        }
    }
