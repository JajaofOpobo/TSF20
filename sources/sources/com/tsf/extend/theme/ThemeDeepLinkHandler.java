...
public class ThemeDeepLinkHandler {
    ...
    private static String a(String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            String[] strArrSplit = str.split("referrer=utm_source%3D");
            if (strArrSplit.length > 1) {
                ...
                return str.replace("referrer=utm_source%3D" + strSubstring, "referrer=utm_source%3D" + str2);
            }
            return str;
        }
        return str;
