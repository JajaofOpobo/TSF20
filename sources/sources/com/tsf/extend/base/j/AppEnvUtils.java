...
public class AppEnvUtils {
    ...
    public static BitmapDrawable a(final WallpaperManager wallpaperManager) {
        try {
            ...
            return (BitmapDrawable) UiThreadUtils.a(new Callable<BitmapDrawable>() { // from class: com.tsf.extend.base.__j__.d.1
    ...
    public static BitmapDrawable c(final WallpaperManager wallpaperManager) {
        try {
            ...
            return (BitmapDrawable) UiThreadUtils.a(new Callable<BitmapDrawable>() { // from class: com.tsf.extend.base.__j__.d.2
                @Override // java.util.concurrent.Callable
                /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
                public BitmapDrawable call() {
                    try {
