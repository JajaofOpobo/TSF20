...
public class RippleUtils {
    ...
    public static Animator a(View view, boolean z) {
        final a aVar = new a();
        com.tsf.extend.base.j.ViewCompatUtils.a(view, aVar);
        final ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        view.setTag(view.getId(), valueAnimatorOfFloat);
        view.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: com.tsf.extend.base.__j__.s.1
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tsf.extend.base.__j__.s.2
