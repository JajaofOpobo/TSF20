...
import com.tsf.extend.base.j.AssetReaderUtils;
...
public class BrowserUtils {
    ...
    public static ComponentName a(Context context) {
        ...
        return a(context.getPackageManager(), intent, AssetReaderUtils.b(context, "raw", "browser"), true);
    }

    private static ComponentName a(PackageManager packageManager, Intent intent, List<AssetReaderUtils.a> list, boolean z) {
    ...
    private static ResolveInfo b(PackageManager packageManager, Intent intent, List<AssetReaderUtils.a> list, boolean z) {
    ...
    private static ResolveInfo a(PackageManager packageManager, Intent intent, List<AssetReaderUtils.a> list, boolean z, boolean z2) {
        ArrayList arrayList;
        boolean z3;
