...
public class JsonRequestBuilder {
    ...
    public static <T> j a(String str, JSONObject jSONObject, final com.tsf.extend.base.d.BaseDataProvider.InterfaceC0048a<T> interfaceC0048a, final a<T> aVar) {
        return new j(str, jSONObject, new n.b<JSONObject>() { // from class: com.tsf.extend.base.f.JsonRequestBuilder.1
        ...
        }, new n.a() { // from class: com.tsf.extend.base.f.JsonRequestBuilder.2
