...
public class m extends s implements Serializable {
    ...
    public static m a(JSONObject jSONObject, ai aiVar) {
        ...
        if (jSONObjectOptJSONObject != null && jSONObjectOptJSONObject.has("theme_id")) {
            mVar.d(jSONObjectOptJSONObject.optLong("theme_id", 0L));
            mVar.f(jSONObjectOptJSONObject.optString("theme_icon"));
            mVar.d(jSONObjectOptJSONObject.optString("wp_apk_url"));
        }
        return mVar;
    }
