...
public class WallpaperClip extends FrameLayout implements View.OnClickListener, PageActivity.a, a.b {
        ...
        if (z) {
            ...
            com.tsf.extend.base.j.z.a(2, new Runnable() { // from class: com.tsf.extend.wallpaper.WallpaperClip.1
                ...
                public void run() {
                    ...
                    boolean z2 = false;
                    final Bitmap bitmapD = WallpaperClip.this.d(true);
                    boolean z3 = (bitmapD == null || bitmapD.isRecycled()) ? false : true;
                    if (z3 && 0 == 0) {
    ...
    private void h() {
        ...
        com.tsf.extend.base.j.z.a(2, new Runnable() { // from class: com.tsf.extend.wallpaper.WallpaperClip.2
            ...
            public void run() {
                try {
                    Bitmap bitmapD = WallpaperClip.this.d(false);
                    if (bitmapD != null) {
                        aj.a(WallpaperClip.this.getContext(), bitmapD, WallpaperClip.this.o.g(), false, false);
                        if (x.a) {
                            bitmapD.compress(Bitmap.CompressFormat.PNG, 100, new FileOutputStream(new File(WallpaperClip.a(WallpaperClip.this.a), "test.png")));
