...
public class c extends FrameLayout implements Animator.AnimatorListener {
    ...
    public void setTabIndex(int i) {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            ...
            this.c = i;
            if (this.c == 1) {
                objectAnimatorOfFloat = ObjectAnimator.ofFloat(getSubmitView(), "translationX", this.b.getWidth(), 0.0f);
                objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(getCategoryView(), "translationX", 0.0f, -this.b.getWidth());
            } else {
                objectAnimatorOfFloat = ObjectAnimator.ofFloat(getCategoryView(), "translationX", -this.b.getWidth(), 0.0f);
                objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(getSubmitView(), "translationX", 0.0f, this.b.getWidth());
            }
