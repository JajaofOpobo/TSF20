...
public class v extends FrameLayout implements View.OnClickListener, AbsListView.OnScrollListener, AdapterView.OnItemClickListener, p {
    ...
    public void b(List<w> list, boolean z) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (bVar != null) {
                bVar.d.setText(((String) map.get(Integer.valueOf(bVar.a.a()))) + " " + this.k);
            }
        }
    }
    ...
    class a extends BaseAdapter {
        ...
        /* JADX INFO: renamed from: com.tsf.extend.wallpaper.v$a$a, reason: collision with other inner class name */
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        ...
        if (Math.abs(this.p - jCurrentTimeMillis) >= 1000) {
