...
public class b extends e implements Animatable {
        ...
        while (eventType != 1) {
            if (eventType == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    TypedArray typedArrayA = a(resources, theme, attributeSet, android.support.a.a.a.e);
                    int resourceId = typedArrayA.getResourceId(0, 0);
                    if (resourceId != 0) {
                        f fVarA = f.a(resources, resourceId, theme);
                        fVarA.a(false);
                        fVarA.setCallback(this.e);
                        if (this.b.b != null) {
                    ...
                    TypedArray typedArrayObtainAttributes = resources.obtainAttributes(attributeSet, android.support.a.a.a.f);
    ...
    /* JADX INFO: renamed from: android.support.a.a.b$b, reason: collision with other inner class name */
