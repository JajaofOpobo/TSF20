...
public class ActionBarOverlayLayout extends ViewGroup implements android.support.v4.view.z, m {
    static final int[] a = {a.C0012a.actionBarSize, R.attr.windowContentOverlay};
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iA2 = ad.a(iA, ai.i(this.d));
        setMeasuredDimension(ai.a(Math.max(iMax3 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), i, iA2), ai.a(Math.max(iMax4 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i2, iA2 << 16));
    }
