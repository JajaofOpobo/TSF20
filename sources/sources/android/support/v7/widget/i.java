...
class i {
    ...
    i(ProgressBar progressBar, g gVar) {
        this.c = progressBar;
        this.a = gVar;
    }
    ...
    void a(AttributeSet attributeSet, int i) {
        ...
        if (drawableB != null) {
            this.c.setIndeterminateDrawable(a(drawableB));
        }
        Drawable drawableB2 = aaVarA.b(1);
        if (drawableB2 != null) {
            this.c.setProgressDrawable(a(drawableB2, false));
        }
        aaVarA.a();
    }
    ...
    private Drawable a(Drawable drawable, boolean z) {
        if (drawable instanceof android.support.v4.a.a.i) {
            Drawable drawableA = ((android.support.v4.a.a.i) drawable).a();
            if (drawableA != null) {
                ((android.support.v4.a.a.i) drawable).a(a(drawableA, z));
            }
        } else {
