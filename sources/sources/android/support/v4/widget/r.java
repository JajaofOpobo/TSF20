    ...
    private void b() {
        ...
        Animation animation = new Animation() { // from class: android.support.v4.widget.r.1
            ...
            public void applyTransformation(float f, Transformation transformation) {
                ...
                float fA = r.this.a(aVar);
                float fG = aVar.g();
                float f2 = aVar.f();
                float fK = aVar.k();
                r.this.a(f, aVar);
                if (f <= 0.5f) {
                    aVar.b(f2 + (r.c.getInterpolation(f / 0.5f) * (0.8f - fA)));
                }
                if (f > 0.5f) {
                    aVar.c(((0.8f - fA) * r.c.getInterpolation((f - 0.5f) / 0.5f)) + fG);
                }
                aVar.d((0.25f * f) + fK);
                r.this.c((216.0f * f) + (1080.0f * (r.this.k / 5.0f)));
            }
        };
