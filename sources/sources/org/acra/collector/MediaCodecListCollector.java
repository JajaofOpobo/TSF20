...
public class MediaCodecListCollector {
    ...
    private enum CodecType {
        ...
        public static CodecType[] valuesCustom() {
            CodecType[] codecTypeArrValuesCustom = values();
            int length = codecTypeArrValuesCustom.length;
            CodecType[] codecTypeArr = new CodecType[length];
            System.arraycopy(codecTypeArrValuesCustom, 0, codecTypeArr, 0, length);
            return codecTypeArr;
        }
    }
        ...
        if (mediaCodecListClass != null && mediaCodecInfoClass != null) {
            try {
                ...
                for (int i = 0; i < iIntValue; i++) {
                    ...
                    sb.append(i).append(": ").append(getNameMethod.invoke(objInvoke, new Object[0])).append("\n");
                    sb.append("isEncoder: ").append(isEncoderMethod.invoke(objInvoke, new Object[0])).append("\n");
    ...
    private static String collectCapabilitiesForType(Object obj, String str) throws IllegalAccessException, InvocationTargetException {
        StringBuilder sb = new StringBuilder();
        ...
        if (objArr.length > 0) {
            ...
            for (int i2 = 0; i2 < objArr.length; i2++) {
                ...
                switch ($SWITCH_TABLE$org$acra$collector$MediaCodecListCollector$CodecType()[codecTypeIdentifyCodecType.ordinal()]) {
                    case 1:
