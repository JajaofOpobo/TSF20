...
class C0005c {
    ...
    /* renamed from: b */
    public static float[] m13928b(float[] fArr, int i, int i2) {
        if (i > i2) {
    ...
    /* renamed from: a */
    public static C0008b[] m13935a(String str) {
        if (str == null) {
            return null;
        }
        ...
        int i2 = 0;
        while (i < str.length()) {
            int m13934a = m13934a(str, i);
            String trim = str.substring(i2, m13934a).trim();
            if (trim.length() > 0) {
                m13932a(arrayList, trim.charAt(0), m13929b(trim));
            }
            i = m13934a + 1;
            i2 = m13934a;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            m13932a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0008b[]) arrayList.toArray(new C0008b[arrayList.size()]);
    }

    /* renamed from: a */
    public static C0008b[] m13930a(C0008b[] c0008bArr) {
        if (c0008bArr == null) {
            return null;
        }
        C0008b[] c0008bArr2 = new C0008b[c0008bArr.length];
        for (int i = 0; i < c0008bArr.length; i++) {
            c0008bArr2[i] = new C0008b(c0008bArr[i]);
        }
        return c0008bArr2;
    }

    /* renamed from: a */
    private static int m13934a(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: a */
    private static void m13932a(ArrayList<C0008b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0008b(c, fArr));
    }
    ...
    /* renamed from: b */
    private static float[] m13929b(String str) {
        int i;
    ...
    /* renamed from: a */
    private static void m13933a(String str, int i, C0007a c0007a) {
        c0007a.f17b = false;
        boolean z = false;
        boolean z2 = false;
        boolean z3 = false;
    ...
    public static class C0008b {
        ...
        private C0008b(char c, float[] fArr) {
            this.f18a = c;
            this.f19b = fArr;
        }

        private C0008b(C0008b c0008b) {
            this.f18a = c0008b.f18a;
            this.f19b = C0005c.m13928b(c0008b.f19b, 0, c0008b.f19b.length);
        }

        /* renamed from: a */
        public static void m13924a(C0008b[] c0008bArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < c0008bArr.length; i++) {
                m13925a(path, fArr, c, c0008bArr[i].f18a, c0008bArr[i].f19b);
                c = c0008bArr[i].f18a;
            }
        }

        /* renamed from: a */
        private static void m13925a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            int i;
            float f;
            float f2;
            float f3;
            ...
            while (i2 < fArr2.length) {
                switch (c2) {
                    case 'A':
                        m13926a(path, f22, f21, fArr2[i2 + 5], fArr2[i2 + 6], fArr2[i2 + 0], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
                    ...
                    case 'V':
                        ...
                        break;
                    case 'a':
                        m13926a(path, f22, f21, fArr2[i2 + 5] + f22, fArr2[i2 + 6] + f21, fArr2[i2 + 0], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
        ...
        /* renamed from: a */
        private static void m13926a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            double d;
            double d2;
            ...
            if (d12 < 0.0d) {
                ...
                m13926a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            ...
            double d15 = f5 * d;
            double d16 = d2 * f6;
            m13927a(path, (d15 * cos) - (d16 * sin), (d15 * sin) + (d16 * cos), f5, f6, f, f2, radians, atan2, atan22);
        }

        /* renamed from: a */
        private static void m13927a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
