...
public class ShaderColor extends Shader {
    ...
    public void createProgram(String str, String str2) {
        ...
        com.censivn.C3DEngine.h.a.a("glGetAttribLocation aColor");
    ...
    public void glColor4f(VObject3d vObject3d) {
        ...
        GLES20.glVertexAttrib4f(this.maColor4Handle, (vObject3d.defaultColor().r / 255.0f) * alpha, (vObject3d.defaultColor().g / 255.0f) * alpha, (vObject3d.defaultColor().b / 255.0f) * alpha, alpha);
    }
}
