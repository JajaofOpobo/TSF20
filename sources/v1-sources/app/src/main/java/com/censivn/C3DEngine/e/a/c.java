...
public final class c implements com.censivn.C3DEngine.g.b.a {
    ...
    public final void c(int i, int i2, int i3, int i4) {
        ...
        this.e = i3;
        this.f = i4;
        this.L = this.I.A * i3 * com.censivn.C3DEngine.a.a;
        this.M = this.I.A * i4 * com.censivn.C3DEngine.a.a;
    }
    ...
    public final void a(int i, int i2, int i3) {
        ...
        this.e = i2;
        this.f = i3;
        this.L = this.I.A * i2 * com.censivn.C3DEngine.a.b;
        this.M = this.I.A * i3 * com.censivn.C3DEngine.a.b;
    }
    ...
    public final void b(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        this.e = i3;
        this.f = i4;
        this.L = i5 * com.censivn.C3DEngine.a.a;
        this.M = i6 * com.censivn.C3DEngine.a.a;
    }
    ...
    public final void c(int i, int i2) {
        this.e = i;
        this.f = i2;
        this.L = this.I.A * i * com.censivn.C3DEngine.a.a;
        this.M = this.I.A * i2 * com.censivn.C3DEngine.a.a;
    }

    public final void b() {
        this.e = 1;
        this.f = 1;
        this.L = this.I.A * 1 * com.censivn.C3DEngine.a.b;
        this.M = this.I.A * 1 * com.censivn.C3DEngine.a.b;
    }
    ...
    public final void b(float f) {
        this.L = com.censivn.C3DEngine.a.a * f;
    }
    ...
    public final float g() {
        return this.L / com.censivn.C3DEngine.a.a;
    }
    ...
    public final void d(float f) {
        this.M = com.censivn.C3DEngine.a.a * f;
    }
    ...
    public final float i() {
        return this.M / com.censivn.C3DEngine.a.a;
    }
    ...
    public final void b(int i) {
        this.N = i * com.censivn.C3DEngine.a.a;
    }
    ...
    public final float k() {
        return this.N / com.censivn.C3DEngine.a.a;
    }
    ...
    public final void d(int i) {
        this.O = i * com.censivn.C3DEngine.a.a;
    }
    ...
    public final float m() {
        return this.O / com.censivn.C3DEngine.a.a;
    }
