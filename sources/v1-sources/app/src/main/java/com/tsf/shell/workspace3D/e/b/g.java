...
public class g extends l {
    ...
    public final int a(ArrayList arrayList, ArrayList arrayList2, int i, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        if (b == 0) {
            ...
            if (a.a == -1 || a.a == -2) {
                ...
                float f8 = (f4 * f7) / 2.0f;
                if (a.b > 0.0f) {
                    am = ((a.d + (a.c / 2.0f)) - (rVar.ap() * f7)) - f8;
                } else {
                    am = ((a.d - (a.c / 2.0f)) - (rVar.am() * f7)) + f8;
                }
                oVar.b = ((am - a.d) * abs) + a.d;
                oVar.d = f7;
                oVar.f = (oVar.b + (rVar.am() * f7)) - f8;
                oVar.e = oVar.b + (rVar.ap() * f7) + f8;
                oVar.c = 0.0f;
                oVar.i = 255.0f;
                a(oVar, rVar, f7, true);
                oVar.h = false;
                    ...
                    if (i2 > 1) {
                        ...
                        while (true) {
                            ...
                            if (f10 - 0.4f < this.e && i3 > 0) {
                                float ap = (((oVar3.f - (rVar2.ap() * this.e)) - ((this.e * f4) / 2.0f)) + (rVar2.am() * this.e)) - ((this.e * f4) / 2.0f);
                                o oVar5 = (o) arrayList.get(i3 - 1);
                                if (ap > oVar5.e) {
                                    a(oVar3, oVar4, rVar2, (oVar3.f - oVar5.e) / ((rVar2.ap() - rVar2.am()) + f4), f4);
                                    a(oVar4, f2, f3, f);
                                    break;
                                }
                            }
                    ...
                    if (i2 < i - 2) {
                        ...
                        while (true) {
                            ...
                            if (f12 - 0.4f < this.e && i5 < i - 1) {
                                float am2 = ((this.e * f4) / 2.0f) + (oVar7.e - (rVar3.am() * this.e)) + ((this.e * f4) / 2.0f) + (rVar3.ap() * this.e);
                                o oVar8 = (o) arrayList.get(i5 + 1);
                                if (am2 < oVar8.f) {
                                    b(oVar7, oVar6, rVar3, (oVar8.f - oVar7.e) / ((rVar3.ap() - rVar3.am()) + f4), f4);
                                    a(oVar6, f2, f3, f);
                                    break;
                                }
                            }
    ...
    private void a(o oVar, o oVar2, r rVar, float f, float f2) {
        ...
        oVar2.d = f;
        float f3 = (f2 * f) / 2.0f;
        oVar2.b = (oVar.f - (rVar.ap() * f)) - f3;
        oVar2.f = (oVar2.b + (rVar.am() * f)) - f3;
        oVar2.e = f3 + oVar2.b + (rVar.ap() * f);
        oVar2.c = 0.0f;
        a(oVar2, rVar, f, true);
        oVar2.h = false;
    }
    ...
    public final void a(ArrayList arrayList, ArrayList arrayList2, int i, float f, float f2, float f3, float f4) {
        ...
        if (f7 == 1.0f) {
            ...
            while (i2 < i) {
                ...
                o oVar = (o) arrayList.get(i2);
                oVar.b = f11 - rVar.am();
                oVar.f = (oVar.b + rVar.am()) - f9;
                oVar.e = oVar.b + rVar.ap() + f9;
                oVar.c = 0.0f;
                oVar.i = 255.0f;
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            oVar2.b = f2 - (rVar2.am() * f7);
            oVar2.f = (oVar2.b + (rVar2.am() * f7)) - f9;
            oVar2.e = oVar2.b + (rVar2.ap() * f7) + f9;
            oVar2.c = 0.0f;
            oVar2.i = 255.0f;
    ...
    public void a(r rVar, float f, float f2, float f3) {
        rVar.b(-2.1474836E9f, 0.0f + f, 0.0f, com.censivn.C3DEngine.a.b * 83.0f, f3 - f2);
    }
