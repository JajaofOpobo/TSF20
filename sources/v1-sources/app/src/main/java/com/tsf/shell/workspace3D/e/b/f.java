...
public class f extends l {
    ...
    public final int a(ArrayList arrayList, ArrayList arrayList2, int i, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        int b = b(f5, f6);
        if (b == 0) {
            com.tsf.shell.workspace3D.e.c.a a = a(-f6, f, f2, f3, i);
            if (a.a == -1 || a.a == -2) {
                ...
                float f8 = (f4 * f7) / 2.0f;
                if (a.b > 0.0f) {
                    ap = (((-a.d) - (a.c / 2.0f)) - (rVar.am() * f7)) + f8;
                } else {
                    ap = (((-a.d) + (a.c / 2.0f)) - (rVar.ap() * f7)) - f8;
                }
                oVar.b = ((ap + a.d) * abs) + (-a.d);
                oVar.d = f7;
                oVar.f = oVar.b + (rVar.ap() * f7) + f8;
                oVar.e = (oVar.b + (rVar.am() * f7)) - f8;
                oVar.c = 0.0f;
                oVar.i = 255.0f;
                a(oVar, rVar, f7, true);
                oVar.h = false;
                    ...
                    if (i2 > 1) {
                        ...
                        while (true) {
                            ...
                            if (f10 - 0.4f < this.e && i3 > 0) {
                                float am = ((this.e * f4) / 2.0f) + (oVar3.f - (rVar2.am() * this.e)) + ((this.e * f4) / 2.0f) + (rVar2.ap() * this.e);
                                o oVar5 = (o) arrayList.get(i3 - 1);
                                if (am < oVar5.e) {
                                    a(oVar3, oVar4, rVar2, (oVar5.e - oVar3.f) / ((rVar2.ap() - rVar2.am()) + f4), f4);
                                    a(oVar4, f2, f3, f);
                                    break;
                                }
                            }
                    ...
                    if (i2 < i - 2) {
                        ...
                        while (true) {
                            ...
                            if (f12 - 0.4f < this.e && i5 < i - 1) {
                                float ap2 = (((oVar7.e - (rVar3.ap() * this.e)) - ((this.e * f4) / 2.0f)) + (rVar3.am() * this.e)) - ((this.e * f4) / 2.0f);
                                o oVar8 = (o) arrayList.get(i5 + 1);
                                if (ap2 > oVar8.f) {
                                    b(oVar7, oVar6, rVar3, (oVar7.e - oVar8.f) / ((rVar3.ap() - rVar3.am()) + f4), f4);
                                    a(oVar6, f2, f3, f);
                                    break;
                                }
                            }
    ...
    private void a(o oVar, o oVar2, r rVar, float f, float f2) {
        ...
        oVar2.d = f;
        float f3 = (f2 * f) / 2.0f;
        oVar2.b = (oVar.f - (rVar.am() * f)) + f3;
        oVar2.f = oVar2.b + (rVar.ap() * f) + f3;
        oVar2.e = (oVar2.b + (rVar.am() * f)) - f3;
        oVar2.c = 0.0f;
        a(oVar2, rVar, f, true);
        oVar2.h = false;
    }
    ...
    public final void a(ArrayList arrayList, ArrayList arrayList2, int i, float f, float f2, float f3, float f4) {
        ...
        if (f7 == 1.0f) {
            ...
            while (i2 < i) {
                ...
                o oVar = (o) arrayList.get(i2);
                oVar.b = f11 - rVar.ap();
                oVar.f = oVar.b + rVar.ap() + f9;
                oVar.e = (oVar.b + rVar.am()) - f9;
                oVar.c = 0.0f;
                oVar.i = 255.0f;
        ...
        while (i3 < i) {
            ...
            oVar2.b = f12 - (rVar2.ap() * f7);
            oVar2.f = oVar2.b + (rVar2.ap() * f7) + f9;
            oVar2.e = (oVar2.b + (rVar2.am() * f7)) - f9;
            oVar2.c = 0.0f;
            oVar2.i = 255.0f;
    ...
    public void a(r rVar, float f, float f2, float f3) {
        rVar.b(-2.1474836E9f, (-f3) + f2, 0.0f, com.censivn.C3DEngine.a.b * 83.0f, 0.0f - f);
    }

    @Override // com.tsf.shell.workspace3D.e.b.a
    public final float a(float f, float f2) {
        return ((com.censivn.C3DEngine.a.k / 2) - p.a) + f2;
    }

    @Override // com.tsf.shell.workspace3D.e.b.a
    public final boolean a(Number3d number3d, r rVar, boolean z) {
        if (number3d.y < rVar.L().y) {
            return !z;
        }
        return z;
    }
    ...
    public b a(r rVar, float f) {
        float asin;
        b bVar = a.b;
        if ((com.censivn.C3DEngine.a.g - p.a) - rVar.L().y > f) {
            asin = 180.0f;
        } else {
        ...
        bVar.d = -176.0f;
        bVar.e = (-164.0f) + (bVar.b / 2.0f) + 4.0f;
        return bVar;
    }
