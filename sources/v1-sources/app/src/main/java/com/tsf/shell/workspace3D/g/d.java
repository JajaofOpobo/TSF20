...
final class d extends com.censivn.C3DEngine.e.b {
    private final /* synthetic */ com.censivn.C3DEngine.e.b C;
    private final /* synthetic */ com.censivn.C3DEngine.e.b a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    d(float f, com.censivn.C3DEngine.e.b bVar, com.censivn.C3DEngine.e.b bVar2) {
    ...
    public final void c() {
        ...
        float f = com.censivn.C3DEngine.a.m / 2;
        jVar = a.j;
        float f2 = jVar.L().y;
        this.a.L().x += 5.0f;
        this.C.L().x -= 5.0f;
