...
public class LongMap<V> {
    ...
    public V put(long j, V v) {
        ...
        int iHash2 = hash2(j);
        long j3 = this.keyTable[iHash2];
        if (j3 == j) {
            V v4 = this.valueTable[iHash2];
            this.valueTable[iHash2] = v;
            return v4;
        }
        int iHash3 = hash3(j);
        long j4 = this.keyTable[iHash3];
        if (j4 == j) {
            V v5 = this.valueTable[iHash3];
        ...
        push(j, v, i, j2, iHash2, j3, iHash3, j4);
        return null;
    }
    ...
    public V get(long j) {
        ...
        int iHash2 = (int) (((long) this.mask) & j);
        if (this.keyTable[iHash2] != j) {
            iHash2 = hash2(j);
            if (this.keyTable[iHash2] != j) {
                iHash2 = hash3(j);
                if (this.keyTable[iHash2] != j) {
    ...
    public V remove(long j) {
        ...
        int iHash2 = hash2(j);
        if (this.keyTable[iHash2] == j) {
            this.keyTable[iHash2] = 0;
            V v3 = this.valueTable[iHash2];
            this.valueTable[iHash2] = null;
            this.size--;
            return v3;
        }
        int iHash3 = hash3(j);
        if (this.keyTable[iHash3] == j) {
            this.keyTable[iHash3] = 0;
            V v4 = this.valueTable[iHash3];
            this.valueTable[iHash3] = null;
            this.size--;
            return v4;
        }
