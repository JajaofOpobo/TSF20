...
public abstract class Joint {
    ...
    protected Joint(World world, long j) {
        this.world = world;
        this.addr = j;
    }
    ...
    public JointDef.JointType getType() {
        ...
        return (iJniGetType <= 0 || iJniGetType >= JointDef.JointType.valueTypes.length) ? JointDef.JointType.Unknown : JointDef.JointType.valueTypes[iJniGetType];
    }
