    ...
    public static String read(Context context, String[] strArr) {
        try {
            ...
            for (String str : arrayList) {
                ...
                Object objInvoke = method.invoke(systemService, str, Long.valueOf(millis));
                if (objInvoke == null) {
                    sb.append("Nothing.").append('\n');
                } else {
                    Method method2 = objInvoke.getClass().getMethod("getText", Integer.TYPE);
                    Method method3 = objInvoke.getClass().getMethod("getTimeMillis", null);
                    Method method4 = objInvoke.getClass().getMethod("close", null);
                    Object objInvoke2 = objInvoke;
                    while (objInvoke2 != null) {
                        long jLongValue = ((Long) method3.invoke(objInvoke2, null)).longValue();
                        time.set(jLongValue);
                        sb.append("@").append(time.format2445()).append('\n');
                        String str2 = (String) method2.invoke(objInvoke2, 500);
                        if (str2 != null) {
                            sb.append("Text: ").append(str2).append('\n');
                        } else {
                            sb.append("Not Text!").append('\n');
                        }
                        method4.invoke(objInvoke2, null);
                        objInvoke2 = method.invoke(systemService, str, Long.valueOf(jLongValue));
                    }
                }
            }
            return sb.toString();
