...
public class f extends android.support.a.a.e {
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        C0001f c0001f = this.c;
        c0001f.b = new e();
        TypedArray typedArrayB = b(resources, theme, attributeSet, android.support.a.a.a.a);
        a(typedArrayB, xmlPullParser);
        typedArrayB.recycle();
    ...
    /* JADX INFO: renamed from: android.support.a.a.f$f, reason: collision with other inner class name */
    private static class C0001f extends Drawable.ConstantState {
        int a;
        e b;
        ColorStateList c;
        PorterDuff.Mode d;
    ...
    private static class c {
        ...
        public void a(Resources resources, AttributeSet attributeSet, Resources.Theme theme, XmlPullParser xmlPullParser) {
            TypedArray typedArrayB = android.support.a.a.e.b(resources, theme, attributeSet, android.support.a.a.a.b);
            a(typedArrayB, xmlPullParser);
            typedArrayB.recycle();
        }
    ...
    private static class a extends d {
        ...
        public void a(Resources resources, AttributeSet attributeSet, Resources.Theme theme, XmlPullParser xmlPullParser) {
            if (android.support.a.a.d.a(xmlPullParser, "pathData")) {
                TypedArray typedArrayB = android.support.a.a.e.b(resources, theme, attributeSet, android.support.a.a.a.d);
                a(typedArrayB);
                typedArrayB.recycle();
            }
        }
    ...
    private static class b extends d {
        ...
        public void a(Resources resources, AttributeSet attributeSet, Resources.Theme theme, XmlPullParser xmlPullParser) {
            TypedArray typedArrayB = android.support.a.a.e.b(resources, theme, attributeSet, android.support.a.a.a.c);
            a(typedArrayB, xmlPullParser);
            typedArrayB.recycle();
        }
