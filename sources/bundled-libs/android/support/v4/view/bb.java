...
public final class bb {
    ...
    static class a implements g {
        ...
        /* JADX INFO: renamed from: android.support.v4.view.bb$a$a, reason: collision with other inner class name */
        ...
        private void e(bb bbVar, View view) {
            Runnable runnableC0009a = this.a != null ? this.a.get(view) : null;
            if (runnableC0009a == null) {
                runnableC0009a = new RunnableC0009a(bbVar, view);
                if (this.a == null) {
                    this.a = new WeakHashMap<>();
                }
                this.a.put(view, runnableC0009a);
            }
            view.removeCallbacks(runnableC0009a);
            view.post(runnableC0009a);
        }
    }
