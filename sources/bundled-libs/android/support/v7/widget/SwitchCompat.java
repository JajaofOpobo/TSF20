...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        aa aaVarA = aa.a(context, attributeSet, a.k.SwitchCompat, i, 0);
        this.a = aaVarA.a(a.k.SwitchCompat_android_thumb);
        if (this.a != null) {
            this.a.setCallback(this);
        }
        this.b = aaVarA.a(a.k.SwitchCompat_track);
        if (this.b != null) {
            this.b.setCallback(this);
        }
        this.g = aaVarA.c(a.k.SwitchCompat_android_textOn);
        this.h = aaVarA.c(a.k.SwitchCompat_android_textOff);
        this.i = aaVarA.a(a.k.SwitchCompat_showText, true);
        this.c = aaVarA.e(a.k.SwitchCompat_thumbTextPadding, 0);
        this.d = aaVarA.e(a.k.SwitchCompat_switchMinWidth, 0);
        this.e = aaVarA.e(a.k.SwitchCompat_switchPadding, 0);
        this.f = aaVarA.a(a.k.SwitchCompat_splitTrack, false);
        int iG = aaVarA.g(a.k.SwitchCompat_switchTextAppearance, 0);
        if (iG != 0) {
            a(context, iG);
        }
        this.E = g.a();
    ...
    public void a(Context context, int i) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i, a.k.TextAppearance);
        ColorStateList colorStateList = typedArrayObtainStyledAttributes.getColorStateList(a.k.TextAppearance_android_textColor);
        if (colorStateList != null) {
            this.y = colorStateList;
        } else {
            this.y = getTextColors();
        }
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(a.k.TextAppearance_android_textSize, 0);
        if (dimensionPixelSize != 0 && dimensionPixelSize != this.x.getTextSize()) {
            this.x.setTextSize(dimensionPixelSize);
            requestLayout();
        }
        a(typedArrayObtainStyledAttributes.getInt(a.k.TextAppearance_android_typeface, -1), typedArrayObtainStyledAttributes.getInt(a.k.TextAppearance_android_textStyle, -1));
        if (typedArrayObtainStyledAttributes.getBoolean(a.k.TextAppearance_textAllCaps, false)) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (getMeasuredHeight() < iMax4) {
            setMeasuredDimension(ai.h(this), iMax4);
        }
    }
        ...
        if (this.b != null) {
            ...
            if (rectA != null) {
                if (rectA.left > rect.left) {
                    i4 += rectA.left - rect.left;
                }
                i3 = rectA.top > rect.top ? (rectA.top - rect.top) + i5 : i5;
                if (rectA.right > rect.right) {
                    i6 -= rectA.right - rect.right;
                }
                i2 = rectA.bottom > rect.bottom ? i7 - (rectA.bottom - rect.bottom) : i7;
            } else {
                i2 = i7;
                i3 = i5;
            }
    ...
    private int getThumbScrollRange() {
        ...
        if (this.b != null) {
            ...
            return ((((this.q - this.s) - rect.left) - rect.right) - rectA.left) - rectA.right;
        }
        return 0;
    }
