...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.k.ActionBar);
        this.a = typedArrayObtainStyledAttributes.getDrawable(a.k.ActionBar_background);
        this.b = typedArrayObtainStyledAttributes.getDrawable(a.k.ActionBar_backgroundStacked);
        this.j = typedArrayObtainStyledAttributes.getDimensionPixelSize(a.k.ActionBar_height, -1);
        if (getId() == a.f.split_action_bar) {
            this.d = true;
            this.c = typedArrayObtainStyledAttributes.getDrawable(a.k.ActionBar_backgroundSplit);
        }
    ...
    public void setTabContainer(t tVar) {
        if (this.g != null) {
            removeView(this.g);
        }
        this.g = tVar;
