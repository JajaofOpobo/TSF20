...
class a {
    ...
    private final View.OnClickListener N = new View.OnClickListener() { // from class: android.support.v7.app.a.1
        ...
        public void onClick(View view) {
            ...
            if (view == a.this.n && a.this.p != null) {
                messageObtain = Message.obtain(a.this.p);
            } else {
                messageObtain = (view != a.this.q || a.this.s == null) ? (view != a.this.t || a.this.v == null) ? null : Message.obtain(a.this.v) : Message.obtain(a.this.s);
            }
            ...
            if (this.e != null) {
                this.w.setOnScrollChangeListener(new NestedScrollView.b() { // from class: android.support.v7.app.a.2
                    ...
                    public void a(NestedScrollView nestedScrollView, int i3, int i4, int i5, int i6) {
                        a.b(nestedScrollView, viewFindViewById, view2);
                    }
                });
                this.w.post(new Runnable() { // from class: android.support.v7.app.a.3
                    @Override // java.lang.Runnable
                    public void run() {
                        a.b(a.this.w, viewFindViewById, view2);
                    }
                });
            } else {
                if (this.f != null) {
                    this.f.setOnScrollListener(new AbsListView.OnScrollListener() { // from class: android.support.v7.app.a.4
                        ...
                        public void onScroll(AbsListView absListView, int i3, int i4, int i5) {
                            a.b(absListView, viewFindViewById, view2);
                        }
                    });
                    this.f.post(new Runnable() { // from class: android.support.v7.app.a.5
                        @Override // java.lang.Runnable
                        public void run() {
                            a.b(a.this.f, viewFindViewById, view2);
                        }
                    });
                    return;
                }
    ...
    private void a(ViewGroup viewGroup) {
        ...
        if (this.g != null) {
            ...
            viewInflate = LayoutInflater.from(this.a).inflate(this.h, viewGroup, false);
        } else {
            viewInflate = null;
        }
    ...
    public static class C0013a {
        ...
        /* JADX INFO: renamed from: android.support.v7.app.a$a$a, reason: collision with other inner class name */
        ...
        private void b(final a aVar) {
            ...
            if (this.D) {
                if (this.H == null) {
                    cVar = new ArrayAdapter<CharSequence>(this.a, aVar.I, i, this.s) { // from class: android.support.v7.app.a.a.1
                        @Override // android.widget.ArrayAdapter, android.widget.Adapter
                        public View getView(int i2, View view, ViewGroup viewGroup) {
                            View view2 = super.getView(i2, view, viewGroup);
                            if (C0013a.this.C != null && C0013a.this.C[i2]) {
                    ...
                    cVar = new CursorAdapter(this.a, this.H, z) { // from class: android.support.v7.app.a.a.2
                        private final int d;
                        private final int e;
                ...
                if (this.H != null) {
                    cVar = new SimpleCursorAdapter(this.a, i2, this.H, new String[]{this.I}, new int[]{R.id.text1});
                } else if (this.t != null) {
                    cVar = this.t;
                } else {
                    cVar = new c(this.a, i2, R.id.text1, this.s);
                }
            }
            if (this.L != null) {
                this.L.a(listView);
            ...
            if (this.u != null) {
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: android.support.v7.app.a.a.3
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i3, long j) {
                        C0013a.this.u.onClick(aVar.b, i3);
                        if (!C0013a.this.E) {
                            aVar.b.dismiss();
                        }
                    }
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: android.support.v7.app.a.a.4
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i3, long j) {
                        if (C0013a.this.C != null) {
                            C0013a.this.C[i3] = listView.isItemChecked(i3);
                        }
                        C0013a.this.G.onClick(aVar.b, i3, listView.isItemChecked(i3));
                    }
                });
            }
            if (this.K != null) {
