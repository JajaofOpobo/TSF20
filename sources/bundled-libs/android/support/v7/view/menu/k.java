...
public class k implements l, View.OnKeyListener, ViewTreeObserver.OnGlobalLayoutListener, AdapterView.OnItemClickListener, PopupWindow.OnDismissListener {
    ...
    private class a extends BaseAdapter {
        ...
        public int getCount() {
            ArrayList<h> arrayListL = k.this.g ? this.b.l() : this.b.i();
            if (this.c < 0) {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            View viewInflate = view == null ? k.this.d.inflate(k.a, viewGroup, false) : view;
            m.a aVar = (m.a) viewInflate;
            if (k.this.b) {
        ...
        void a() {
            h hVarR = k.this.e.r();
            if (hVarR != null) {
                ArrayList<h> arrayListL = k.this.e.l();
