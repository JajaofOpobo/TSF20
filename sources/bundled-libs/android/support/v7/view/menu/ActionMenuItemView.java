...
public class ActionMenuItemView extends AppCompatTextView implements m.a, ActionMenuView.a, View.OnClickListener, View.OnLongClickListener {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.k.ActionMenuItemView, i, 0);
        this.i = typedArrayObtainStyledAttributes.getDimensionPixelSize(a.k.ActionMenuItemView_android_minWidth, 0);
    ...
    private class a extends ListPopupWindow.b {
        ...
        @Override // android.support.v7.widget.ListPopupWindow.b
        protected boolean b() {
            ListPopupWindow listPopupWindowA;
            return ActionMenuItemView.this.d != null && ActionMenuItemView.this.d.a(ActionMenuItemView.this.a) && (listPopupWindowA = a()) != null && listPopupWindowA.k();
        }
    }
}
