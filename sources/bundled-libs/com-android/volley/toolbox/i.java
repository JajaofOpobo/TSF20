...
public class i extends com.android.volley.l<Bitmap> {
    ...
    protected com.android.volley.n<Bitmap> a(com.android.volley.i iVar) {
        ...
        synchronized (f) {
            try {
                ...
                nVarA = com.android.volley.n.a(new com.android.volley.k(e));
            }
        }
        return nVarA;
    }
    ...
    private com.android.volley.n<Bitmap> b(com.android.volley.i iVar) {
        ...
        if (this.c == 0 && this.d == 0) {
            ...
            int iA = a(this.c, this.d, i, i2, this.e);
            int iA2 = a(this.d, this.c, i2, i, this.e);
        ...
        return com.android.volley.n.a(bitmapCreateScaledBitmap, e.a(iVar));
    }
    ...
    static int a(int i, int i2, int i3, int i4) {
        float f2 = 1.0f;
        while (f2 * 2.0f <= Math.min(((double) i) / ((double) i3), ((double) i2) / ((double) i4))) {
            f2 *= 2.0f;
        }
        return (int) f2;
    }
