...
public class Color4BufferList {
    ...
    public void putInColor4(int i, Color4 color4) {
        this.mBuffer.position(i * 4);
        color4.f2525r = (short) this.mBuffer.get();
        color4.f2524g = (short) this.mBuffer.get();
        color4.f2523b = (short) this.mBuffer.get();
        color4.f2522a = (short) this.mBuffer.get();
    }
    ...
    public void set(int i, Color4 color4) {
        this.mBuffer.position(i * 4);
        this.mBuffer.put(color4.f2525r);
        this.mBuffer.put(color4.f2524g);
        this.mBuffer.put(color4.f2523b);
        this.mBuffer.put(color4.f2522a);
    }
    ...
    /* renamed from: clone */
    public Color4BufferList m13944clone() {
