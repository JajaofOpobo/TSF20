...
public class Vertices {
    ...
    public Vertices(PointBufferManager pointBufferManager, UvBufferManager uvBufferManager, PointBufferManager pointBufferManager2, Color4BufferList color4BufferList) {
        ...
        this.hasColors = (this.mColors == null || this.mColors.size() <= 0) ? false : z;
    }
    ...
    public short addVertex(Number3d number3d, C0879Uv c0879Uv, Number3d number3d2, Color4 color4) {
        this.mPpoints.addPX(number3d);
        if (this.hasUvs) {
            this.mUvs.add(c0879Uv);
        }
        if (this.hasNormals) {
    ...
    /* renamed from: clone */
    public Vertices m13950clone() {
        return new Vertices(this.mPpoints.m13947clone(), this.mUvs.m13949clone(), this.mNormals.m13947clone(), this.mColors == null ? null : this.mColors.m13944clone());
    }
}
