...
public abstract class ItemInfo {
    ...
    public String title;
    private C3112b widget;

    /* renamed from: id */
    public int f2532id = -1;
    ...
    public void setWidget(C3112b c3112b) {
        this.widget = c3112b;
    }

    public C3112b getWidget() {
        return this.widget;
    }
    ...
    public void onUpdateLayoutInformation(ContentValues contentValues, C3112b c3112b) {
        if (!(c3112b instanceof C3124a) && c3112b != null) {
            if (C0892a.f2564O) {
                this.scale = c3112b.m3491u();
                this.cellX = (int) c3112b.position().f2526x;
                this.cellY = (int) c3112b.position().f2527y;
                this.rotation = (int) c3112b.rotation().f2528z;
            } else {
                this.scaleH = c3112b.m3491u();
                this.cellXH = (int) c3112b.position().f2526x;
                this.cellYH = (int) c3112b.position().f2527y;
                this.rotationH = (int) c3112b.rotation().f2528z;
            }
        }
        contentValues.put("container", Integer.valueOf(this.container));
        contentValues.put("screen", Integer.valueOf(this.screen));
    ...
    public void updateContainer(ContentValues contentValues, int i) {
        ...
        if (i2 != this.container) {
            ShellModel.C3435a.m2369a(this, i2, this.container);
        }
    ...
    public Bitmap getPhoto() {
        switch (this.iconType) {
            case 1:
                try {
                    ...
                    if (resourcesForApplication != null) {
                        return C4189x.m604a(resourcesForApplication, resourcesForApplication.getIdentifier(this.iconResource.resourceName, null, null));
                    }
                    return null;
                } catch (Exception e) {
                    return null;
            ...
            case 2:
                byte[] m2370a = ShellModel.C3435a.m2370a(this);
                if (m2370a != null) {
                    try {
                        return BitmapFactory.decodeByteArray(m2370a, 0, m2370a.length);
                    } catch (Exception e2) {
                        return null;
                    }
                }
    ...
    public void updateDatabase(ContentValues contentValues) {
        ShellModel.C3435a.m2371a(contentValues, this, (Runnable) null);
    }

    public void updateDatabase(ContentValues contentValues, Runnable runnable) {
        ShellModel.C3435a.m2371a(contentValues, this, runnable);
    }
