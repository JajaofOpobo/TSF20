...
import com.tsf.shell.utils.C4173j;
...
public class ThemeParser extends DefaultHandler {
    ...
    public static class InputStreamCallback {
        ...
        public InputStreamCallback(String str) {
            try {
                this.mContext = C0853a.m10856d().createPackageContext(str, 3);
                ...
                if (item.getNodeType() == 1) {
                    ...
                    if (nodeName.equals("lasso")) {
                        ...
                        if (ThemeElementType.getParserState(i, ThemeElementType.TYPE_SMART_BUTTON)) {
                            ...
                            themeDescription.shell.smartButtonWindowsColor = parseColor(themeDescription.shell.xml_smartButton_windows_color, C3084b.f9983b);
                        }
    ...
    private void parseFolderOrder(ThemeFolderDescription themeFolderDescription, Element element) {
        ...
        if (themeFolderDescription.nameTextFormat.auto) {
            ...
            themeFolderDescription.textPlaneY = C3566b.f11839a.f11770aa;
            themeFolderDescription.textPlaneWidth = C3566b.f11839a.f11752J + 2;
            themeFolderDescription.textPlaneHeight = C3566b.f11839a.f11753K + 2;
            themeFolderDescription.textWidth = C3566b.f11839a.f11752J + 2;
            themeFolderDescription.textHeight = C3566b.f11839a.f11753K + 2;
    ...
    public static int parseDimension(String str) {
        return C4173j.m675a(str);
    }

    public static int parseDimension(String str, float f) {
        return (int) (C4173j.m675a(str) * f * C0892a.f2570f);
    }
