...
public class ThemeDescription {
    ...
    public Bitmap getBitmapFromCache(String str, int i, int i2) {
        Bitmap m635d;
        if (i == 0 || i2 == 0 || (m635d = C4181q.m635d(ThemeCacheFileManager.getImageBitmap(str + ".png"), i, i2)) == null) {
            return null;
        }
        Bitmap copy = m635d.copy(Bitmap.Config.ARGB_8888, true);
        m635d.recycle();
        return copy;
    }

    public Bitmap getBitmap(String str, int i, int i2) {
        return C4181q.m635d(getBitmap(str), i, i2);
    }
