...
public class ThemeFolderDescription extends ThemeDescriptionInterface {
    ...
    public void addChildInformation(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9) {
        ...
        systemFolderChild.sourcePosition.f2526x = f;
        systemFolderChild.sourcePosition.f2527y = f2;
        systemFolderChild.sourcePosition.f2528z = f3;
        systemFolderChild.position.f2526x = f;
        systemFolderChild.position.f2527y = f2;
        systemFolderChild.position.f2528z = f3;
        systemFolderChild.rotation.f2526x = f4;
        systemFolderChild.rotation.f2527y = f5;
        systemFolderChild.rotation.f2528z = f6;
        systemFolderChild.scale.f2526x = f7;
        systemFolderChild.scale.f2527y = f8;
        systemFolderChild.scale.f2528z = f9;
