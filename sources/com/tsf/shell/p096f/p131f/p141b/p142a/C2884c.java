...
/* renamed from: com.tsf.shell.f.f.b.a.c */
/* loaded from: classes.dex */
public class C2884c extends C2885d {
    ...
    public C2884c(int i, boolean z, boolean z2, boolean z3) {
        super(i, z3);
        this.f9409b = z;
        this.f9410c = z2;
    }
    ...
    public void mo4359a(ArrayList<C0975i> arrayList, boolean z, Runnable runnable) {
        m4364a(arrayList, z, this.f9409b, runnable);
    }
        ...
        while (i < arrayList.size()) {
            ...
            if (c0975i instanceof C3112b) {
                ...
                if (z) {
                    ...
                    c0975i.scale().f2526x = 0.0f;
                    c0975i.scale().f2527y = 0.0f;
                    c0975i.alpha(0.0f);
                    if (this.f9410c) {
