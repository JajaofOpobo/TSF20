...
/* renamed from: com.tsf.shell.f.f.b.s */
/* loaded from: classes.dex */
public class C2910s extends C2948l {
    public C2910s(int i, boolean z) {
        super(i, C1306b.C1310d.desktop_transition_wave, z);
    }

    @Override // com.tsf.shell.p096f.p131f.C2948l
    /* renamed from: a */
    public void mo4141a(C2932g c2932g, float f) {
        c2932g.position().f2526x = (C0892a.f2553D * f) / 2.0f;
