...
/* renamed from: com.tsf.shell.f.f.b.p */
/* loaded from: classes.dex */
public class C2907p extends C2948l {
    public C2907p(int i, boolean z) {
        super(i, C1306b.C1310d.desktop_transition_slope_outside, z);
    }
    ...
    public void mo4141a(C2932g c2932g, float f) {
        ...
        scale2.f2527y = abs;
        scale.f2526x = abs;
        c2932g.rotation().f2527y = 40.0f * f;
        c2932g.position().f2526x = C0892a.f2553D * f * 0.65f;
    }
}
