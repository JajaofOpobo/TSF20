...
/* renamed from: com.tsf.shell.f.f.a.d.a.f */
/* loaded from: classes.dex */
public class C2832f extends C2826c {
    public C2832f(int i) {
        super(C1306b.C1310d.drawer_sort_time_latest, C1306b.C1315i.text_sort_latest_installed);
        this.f9202a = i;
        this.f9203b = new Comparator<C3112b>() { // from class: com.tsf.shell.f.f.a.d.a.f.1
            ...
            public final int compare(C3112b c3112b, C3112b c3112b2) {
                ...
                if (!(c3112b2 instanceof C3145b) && c3112b.mo3098s() <= c3112b2.mo3098s()) {
                    return c3112b.mo3098s() < c3112b2.mo3098s() ? -1 : 0;
                }
                return 1;
            }
        };
        this.f9204c = new Comparator<C0975i>() { // from class: com.tsf.shell.f.f.a.d.a.f.2
            @Override // java.util.Comparator
            /* renamed from: a */
