...
/* renamed from: com.tsf.shell.f.f.a.b.i */
/* loaded from: classes.dex */
public class C2743i extends AbstractC2745k {
    public C2743i(int i, boolean z) {
        super(i, C1306b.C1310d.drawer_transition_effect_scale, z);
    }

    @Override // com.tsf.shell.p096f.p131f.p132a.p136b.AbstractC2745k
    /* renamed from: a */
    public void mo4793a(C2676a c2676a, float f) {
        c2676a.scale().setAll((f * 1.0f) + 1.0f, (f * 1.0f) + 1.0f, 1.0f);
        c2676a.alpha(255 - ((int) (Math.abs(f) * 255.0f)));
    }

    @Override // com.tsf.shell.p096f.p131f.p132a.p136b.AbstractC2745k
    /* renamed from: a */
    public void mo4794a(C2676a c2676a) {
        c2676a.scale().setAll(1.0f, 1.0f, 1.0f);
    }
