...
/* renamed from: com.tsf.shell.f.f.a.b.g */
/* loaded from: classes.dex */
public class C2740g extends AbstractC2745k {

    /* renamed from: a */
    private static int f8979a = 0;

    /* renamed from: b */
    private static int f8980b = 0;

    public C2740g(int i, boolean z) {
        super(i, C1306b.C1310d.drawer_transition_effect_rotation_z, z);
    }
    ...
    public void mo4793a(C2676a c2676a, float f) {
        c2676a.rotation().f2528z = 90.0f * f;
        c2676a.position().f2526x = f8980b * f;
        c2676a.position().f2527y = f8979a * Math.abs(f);
    }
    ...
    public void mo4794a(C2676a c2676a) {
        ...
        c2676a.position().f2526x = 0.0f;
        c2676a.position().f2527y = 0.0f;
    }
