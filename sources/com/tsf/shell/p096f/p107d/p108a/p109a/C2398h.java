...
/* renamed from: com.tsf.shell.f.d.a.a.h */
/* loaded from: classes.dex */
public class C2398h extends AbstractC2374a {

    /* renamed from: a */
    private C2401b f7932a;

    public C2398h(int i, boolean z) {
        super(i, z);
    }
    ...
    public void mo5652a(final C0975i c0975i, Number3d number3d, Number3d number3d2, final Runnable runnable) {
        ...
        C1017d c1017d = new C1017d() { // from class: com.tsf.shell.f.d.a.a.h.1
            @Override // com.censivn.C3DEngine.p031b.p041g.C1017d
            /* renamed from: a */
            public void mo732a() {
                C1017d c1017d2 = new C1017d() { // from class: com.tsf.shell.f.d.a.a.h.1.1
                    @Override // com.censivn.C3DEngine.p031b.p041g.C1017d
                    /* renamed from: a */
                    public void mo732a() {
                        if (runnable != null) {
        ...
        c1017d.m10294l(1.25f);
        c1017d.m10293m(1.25f);
        C1014c.m10326a(m10456a);
        C1014c.m10325a(m10456a, 250, c1017d);
    }

    /* renamed from: a */
    public void m5653a(C0975i c0975i) {
    ...
    public C0975i mo5650e() {
        if (this.f7932a == null) {
            this.f7932a = new C2401b(this, true);
        }
        return this.f7932a;
    }
