...
/* renamed from: com.tsf.shell.f.c.a.a.b */
/* loaded from: classes.dex */
public class C2290b extends C2292d {
    ...
    public int mo5928a(ArrayList<C2310d> arrayList, ArrayList<C0975i> arrayList2, int i, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        if (mo5923b == 0) {
            ...
            if (a.f7533a == -1 || a.f7533a == -2) {
                ...
                float f8 = (f4 * f7) / 2.0f;
                if (a.f7534b > 0.0f) {
                    maxX = (((-a.f7536d) - (a.f7535c / 2.0f)) - (c0975i.minX() * f7)) + f8;
                } else {
                    maxX = (((-a.f7536d) + (a.f7535c / 2.0f)) - (c0975i.maxX() * f7)) - f8;
                }
                c2310d.f7537a = ((maxX + a.f7536d) * abs) + (-a.f7536d);
                c2310d.f7540d = f7;
                c2310d.f7542f = c2310d.f7537a + (c0975i.maxX() * f7) + f8;
                c2310d.f7541e = (c2310d.f7537a + (c0975i.minX() * f7)) - f8;
                c2310d.f7539c = 0.0f;
                ...
                if (i2 > 0) {
                    ...
                    m5944a(c2310d, c2310d2, arrayList2.get(i2 - 1), 1.0f - (a.f7534b * 0.2f), f4);
                    m5945a(c2310d2, f2, f3, 0.0f, f);
                    ...
                    if (i2 > 1) {
                        ...
                        while (true) {
                            ...
                            float f11 = f10 - 0.4f;
                            m5944a(c2310d3, c2310d4, c0975i2, f11, f4);
                            m5945a(c2310d4, f2, f3, 0.0f, f);
                            if (f11 - 0.4f < this.f7475e && i3 > 0) {
                                float minX = ((this.f7475e * f4) / 2.0f) + (c2310d3.f7542f - (c0975i2.minX() * this.f7475e)) + ((this.f7475e * f4) / 2.0f) + (c0975i2.maxX() * this.f7475e);
                                C2310d c2310d5 = arrayList.get(i3 - 1);
                                if (minX < c2310d5.f7541e) {
                                    m5944a(c2310d3, c2310d4, c0975i2, (c2310d5.f7541e - c2310d3.f7542f) / ((c0975i2.maxX() - c0975i2.minX()) + f4), f4);
                                    m5945a(c2310d4, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
                ...
                if (i2 < i - 1) {
                    ...
                    m5943b(c2310d, c2310d6, arrayList2.get(i2 + 1), (a.f7534b * 0.2f) + 1.0f, f4);
                    m5945a(c2310d6, f2, f3, 0.0f, f);
                    ...
                    if (i2 < i - 2) {
                        ...
                        while (true) {
                            ...
                            float f14 = f13 - 0.4f;
                            m5943b(c2310d7, c2310d6, c0975i3, f14, f4);
                            m5945a(c2310d6, f2, f3, 0.0f, f);
                            if (f14 - 0.4f < this.f7475e && i5 < i - 1) {
                                float maxX2 = (((c2310d7.f7541e - (c0975i3.maxX() * this.f7475e)) - ((this.f7475e * f4) / 2.0f)) + (c0975i3.minX() * this.f7475e)) - ((this.f7475e * f4) / 2.0f);
                                C2310d c2310d8 = arrayList.get(i5 + 1);
                                if (maxX2 > c2310d8.f7542f) {
                                    m5943b(c2310d7, c2310d6, c0975i3, (c2310d7.f7541e - c2310d8.f7542f) / ((c0975i3.maxX() - c0975i3.minX()) + f4), f4);
                                    m5945a(c2310d6, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
    ...
    /* renamed from: a */
    private void m5945a(C2310d c2310d, float f, float f2, float f3, float f4) {
        float f5 = -(f4 - f2);
        if (c2310d.f7542f > (-f)) {
    ...
    /* renamed from: a */
    private void m5944a(C2310d c2310d, C2310d c2310d2, C0975i c0975i, float f, float f2) {
        if (f < this.f7475e) {
            f = this.f7475e;
        }
        c2310d2.f7540d = f;
        float f3 = (f2 * f) / 2.0f;
        c2310d2.f7537a = (c2310d.f7542f - (c0975i.minX() * f)) + f3;
        c2310d2.f7542f = c2310d2.f7537a + (c0975i.maxX() * f) + f3;
        c2310d2.f7541e = (c2310d2.f7537a + (c0975i.minX() * f)) - f3;
        c2310d2.f7539c = 0.0f;
    ...
    /* renamed from: b */
    private void m5943b(C2310d c2310d, C2310d c2310d2, C0975i c0975i, float f, float f2) {
        if (f < this.f7475e) {
            f = this.f7475e;
        }
        c2310d2.f7540d = f;
        float f3 = (f2 * f) / 2.0f;
        c2310d2.f7537a = (c2310d.f7541e - (c0975i.maxX() * f)) - f3;
        c2310d2.f7542f = c2310d2.f7537a + (c0975i.maxX() * f) + f3;
        c2310d2.f7541e = (c2310d2.f7537a + (c0975i.minX() * f)) - f3;
        c2310d2.f7539c = 0.0f;
        mo5918a(c2310d2, c0975i, f, true);
    ...
    public void mo5929a(ArrayList<C2310d> arrayList, ArrayList<C0975i> arrayList2, int i, float f, float f2, float f3, float f4) {
        ...
        if (f7 == 1.0f) {
            ...
            while (i2 < i) {
                C0975i c0975i = arrayList2.get(i2);
                C2310d c2310d = arrayList.get(i2);
                c2310d.f7537a = f11 - c0975i.maxX();
                c2310d.f7542f = c2310d.f7537a + c0975i.maxX() + f9;
                c2310d.f7541e = (c2310d.f7537a + c0975i.minX()) - f9;
                c2310d.f7539c = 0.0f;
                c2310d.f7545i = 255.0f;
                ...
                c2310d.f7544h = false;
                i2++;
                f11 = (c0975i.minX() + c2310d.f7537a) - f8;
            }
            return;
        }
        int i3 = 0;
        ...
        while (i3 < i) {
            ...
            c2310d2.f7537a = f12 - (c0975i2.maxX() * f7);
            c2310d2.f7542f = c2310d2.f7537a + (c0975i2.maxX() * f7) + f9;
            c2310d2.f7541e = (c2310d2.f7537a + (c0975i2.minX() * f7)) - f9;
            c2310d2.f7539c = 0.0f;
            ...
            c2310d2.f7544h = false;
            i3++;
            f12 = ((c0975i2.minX() * f7) + c2310d2.f7537a) - f8;
        }
    }
    ...
    public void mo5925a(C0975i c0975i, float f, float f2, float f3) {
        c0975i.setAABBPX((-f3) + f2, -2.1474836E9f, 0.0f, -f, C0892a.f2566b * 83.0f, 0.0f);
    }
    ...
    public boolean mo5933a(Number3d number3d, C0975i c0975i, boolean z) {
        return number3d.f2526x < c0975i.position().f2526x ? !z : z;
    }
    ...
    public C2288a.C2289a mo5924a(C0975i c0975i, float f, float f2, float f3, float f4) {
        ...
        float f5 = (C0892a.f2550A - C2326f.f7566a) - c0975i.position().f2526x;
        if (f5 > f) {
            asin = 180.0f;
        } else {
        ...
        c2289a.f7479d = (90.0f - (f4 / 2.0f)) + f2;
        c2289a.f7480e = ((90.0f - (f4 - f2)) - (c2289a.f7477b / 2.0f)) - f3;
        return c2289a;
    }
