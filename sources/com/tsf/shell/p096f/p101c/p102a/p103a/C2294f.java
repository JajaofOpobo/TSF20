...
/* renamed from: com.tsf.shell.f.c.a.a.f */
/* loaded from: classes.dex */
public class C2294f extends C2297i {
    public C2294f() {
        this.f7473c = 0;
    }
    ...
    public int mo5928a(ArrayList<C2310d> arrayList, ArrayList<C0975i> arrayList2, int i, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        if (mo5923b == 0) {
            ...
            if (a.f7533a == -1 || a.f7533a == -2) {
                ...
                float f8 = (f4 * f7) / 2.0f;
                if (a.f7534b > 0.0f) {
                    minY = ((a.f7536d + (a.f7535c / 2.0f)) - (c0975i.maxY() * f7)) - f8;
                } else {
                    minY = ((a.f7536d - (a.f7535c / 2.0f)) - (c0975i.minY() * f7)) + f8;
                }
                c2310d.f7538b = ((minY - a.f7536d) * abs) + a.f7536d;
                c2310d.f7540d = f7;
                c2310d.f7542f = (c2310d.f7538b + (c0975i.minY() * f7)) - f8;
                c2310d.f7541e = c2310d.f7538b + (c0975i.maxY() * f7) + f8;
                c2310d.f7539c = 0.0f;
                ...
                if (i2 > 0) {
                    ...
                    m5930a(c2310d, c2310d2, arrayList2.get(i2 - 1), 1.0f - (a.f7534b * 0.2f), f4);
                    m5931a(c2310d2, f2, f3, 0.0f, f);
                    ...
                    if (i2 > 1) {
                        ...
                        while (true) {
                            ...
                            float f11 = f10 - 0.4f;
                            m5930a(c2310d3, c2310d4, c0975i2, f11, f4);
                            m5931a(c2310d4, f2, f3, 0.0f, f);
                            if (f11 - 0.4f < this.f7475e && i3 > 0) {
                                float maxY = (((c2310d3.f7542f - (c0975i2.maxY() * this.f7475e)) - ((this.f7475e * f4) / 2.0f)) + (c0975i2.minY() * this.f7475e)) - ((this.f7475e * f4) / 2.0f);
                                C2310d c2310d5 = arrayList.get(i3 - 1);
                                if (maxY > c2310d5.f7541e) {
                                    m5930a(c2310d3, c2310d4, c0975i2, (c2310d3.f7542f - c2310d5.f7541e) / ((c0975i2.maxY() - c0975i2.minY()) + f4), f4);
                                    m5931a(c2310d4, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
                ...
                if (i2 < i - 1) {
                    ...
                    m5927b(c2310d, c2310d6, arrayList2.get(i2 + 1), (a.f7534b * 0.2f) + 1.0f, f4);
                    m5931a(c2310d6, f2, f3, 0.0f, f);
                    ...
                    if (i2 < i - 2) {
                        ...
                        while (true) {
                            ...
                            float f14 = f13 - 0.4f;
                            m5927b(c2310d7, c2310d6, c0975i3, f14, f4);
                            m5931a(c2310d6, f2, f3, 0.0f, f);
                            if (f14 - 0.4f < this.f7475e && i5 < i - 1) {
                                float minY2 = ((this.f7475e * f4) / 2.0f) + (c2310d7.f7541e - (c0975i3.minY() * this.f7475e)) + ((this.f7475e * f4) / 2.0f) + (c0975i3.maxY() * this.f7475e);
                                C2310d c2310d8 = arrayList.get(i5 + 1);
                                if (minY2 < c2310d8.f7542f) {
                                    m5927b(c2310d7, c2310d6, c0975i3, (c2310d8.f7542f - c2310d7.f7541e) / ((c0975i3.maxY() - c0975i3.minY()) + f4), f4);
                                    m5931a(c2310d6, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
    ...
    /* renamed from: a */
    private void m5931a(C2310d c2310d, float f, float f2, float f3, float f4) {
        float f5 = f4 - f2;
        if (c2310d.f7542f < f) {
    ...
    /* renamed from: a */
    private void m5930a(C2310d c2310d, C2310d c2310d2, C0975i c0975i, float f, float f2) {
        if (f < this.f7475e) {
            f = this.f7475e;
        }
        c2310d2.f7540d = f;
        float f3 = (f2 * f) / 2.0f;
        c2310d2.f7538b = (c2310d.f7542f - (c0975i.maxY() * f)) - f3;
        c2310d2.f7542f = (c2310d2.f7538b + (c0975i.minY() * f)) - f3;
        c2310d2.f7541e = f3 + c2310d2.f7538b + (c0975i.maxY() * f);
        c2310d2.f7539c = 0.0f;
    ...
    /* renamed from: b */
    private void m5927b(C2310d c2310d, C2310d c2310d2, C0975i c0975i, float f, float f2) {
        if (f < this.f7475e) {
            f = this.f7475e;
        }
        c2310d2.f7540d = f;
        float f3 = (f2 * f) / 2.0f;
        c2310d2.f7538b = (c2310d.f7541e - (c0975i.minY() * f)) + f3;
        c2310d2.f7542f = (c2310d2.f7538b + (c0975i.minY() * f)) - f3;
        c2310d2.f7541e = f3 + c2310d2.f7538b + (c0975i.maxY() * f);
        c2310d2.f7539c = 0.0f;
        mo5918a(c2310d2, c0975i, f, true);
    ...
    public void mo5929a(ArrayList<C2310d> arrayList, ArrayList<C0975i> arrayList2, int i, float f, float f2, float f3, float f4) {
        ...
        if (f7 == 1.0f) {
            ...
            while (i2 < i) {
                C0975i c0975i = arrayList2.get(i2);
                C2310d c2310d = arrayList.get(i2);
                c2310d.f7538b = f10 - c0975i.minY();
                c2310d.f7542f = (c2310d.f7538b + c0975i.minY()) - f9;
                c2310d.f7541e = c2310d.f7538b + c0975i.maxY() + f9;
                c2310d.f7539c = 0.0f;
                c2310d.f7545i = 255.0f;
                ...
                c2310d.f7544h = false;
                i2++;
                f10 = c0975i.maxY() + c2310d.f7538b + f8;
            }
            return;
        }
        for (int i3 = 0; i3 < i; i3++) {
            ...
            c2310d2.f7538b = f2 - (c0975i2.minY() * f7);
            c2310d2.f7542f = (c2310d2.f7538b + (c0975i2.minY() * f7)) - f9;
            c2310d2.f7541e = c2310d2.f7538b + (c0975i2.maxY() * f7) + f9;
            c2310d2.f7539c = 0.0f;
            ...
            c2310d2.f7540d = f7;
            c2310d2.f7544h = false;
            f2 = (c0975i2.maxY() * f7) + c2310d2.f7538b + f8;
        }
    }
    ...
    public void mo5925a(C0975i c0975i, float f, float f2, float f3) {
        c0975i.setAABBPX(-2.1474836E9f, 0.0f + f, 0.0f, C0892a.f2566b * 83.0f, f3 - f2, 0.0f);
    }
    ...
    public boolean mo5933a(Number3d number3d, C0975i c0975i, boolean z) {
        if (number3d.f2527y < c0975i.position().f2527y) {
            return z;
        }
        return !z;
    }
    ...
    public C2288a.C2289a mo5924a(C0975i c0975i, float f, float f2, float f3, float f4) {
        ...
        c2289a.f7479d = (0.0f - (f4 / 2.0f)) + f2;
        c2289a.f7480e = ((0.0f - (f4 - f2)) - (c2289a.f7477b / 2.0f)) - f3;
        return c2289a;
    }
