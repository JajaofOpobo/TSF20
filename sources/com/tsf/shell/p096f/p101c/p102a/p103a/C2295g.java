...
/* renamed from: com.tsf.shell.f.c.a.a.g */
/* loaded from: classes.dex */
public class C2295g extends C2293e {
    public C2295g() {
        this.f7473c = 1;
    }
    ...
    @Override // com.tsf.shell.p096f.p101c.p102a.p103a.C2293e, com.tsf.shell.p096f.p101c.p102a.p103a.C2288a
    /* renamed from: b */
    ...
    public void mo5925a(C0975i c0975i, float f, float f2, float f3) {
        c0975i.setAABBPX(C0892a.f2566b * (-83.0f), (-f3) + f2, 0.0f, 2.1474836E9f, 0.0f - f, 0.0f);
    }
    ...
    public C2288a.C2289a mo5924a(C0975i c0975i, float f, float f2, float f3, float f4) {
        ...
        c2289a.f7479d = ((-180.0f) - (f4 / 2.0f)) + f2;
        c2289a.f7480e = (((-180.0f) - (f4 - f2)) - (c2289a.f7477b / 2.0f)) - f3;
        return c2289a;
    }
