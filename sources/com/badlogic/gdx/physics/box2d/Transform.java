...
public class Transform {
    ...
    public Vector2 mul(Vector2 vector2) {
        vector2.f2403x = this.vals[0] + (this.vals[2] * vector2.f2403x) + (this.vals[4] * vector2.f2404y);
        vector2.f2404y = this.vals[1] + (this.vals[3] * vector2.f2403x) + (this.vals[5] * vector2.f2404y);
        return vector2;
    }
    ...
    public void setPosition(Vector2 vector2) {
        this.vals[0] = vector2.f2403x;
        this.vals[1] = vector2.f2404y;
    }
}
