...
public class World {
    ...
    public void rayCast(RayCastCallback rayCastCallback, Vector2 vector2, Vector2 vector22) {
        ...
        jniRayCast(this.addr, vector2.f2403x, vector2.f2404y, vector22.f2403x, vector22.f2404y);
    }
    ...
    public void destroy() {
        C2224a.m6053a("BOX2D API", "destroy world id:" + this.addr);
        destroyAllJoint();
        destroyAllBody();
        this.bodies.clear();
        this.fixtures.clear();
    ...
    public World(Vector2 vector2, boolean z) {
        this.addr = newWorld(vector2.f2403x, vector2.f2404y, z);
        C2224a.m6053a("BOX2D API", "new world id:" + this.addr);
        for (int i = 0; i < 200; i++) {
    ...
    public Body createBody(BodyDef bodyDef) {
        Body body = new Body(this, jniCreateBody(this.addr, bodyDef.type.getValue(), bodyDef.position.f2403x, bodyDef.position.f2404y, bodyDef.angle, bodyDef.linearVelocity.f2403x, bodyDef.linearVelocity.f2404y, bodyDef.angularVelocity, bodyDef.linearDamping, bodyDef.angularDamping, bodyDef.allowSleep, bodyDef.awake, bodyDef.fixedRotation, bodyDef.bullet, bodyDef.active, bodyDef.inertiaScale));
        this.bodies.put(body.addr, body);
        C2224a.m6053a("BOX2D API", "createBody id:" + body.addr);
        return body;
    }
    ...
    public void destroyAllBody() {
        ...
        while (entries.hasNext()) {
            ...
            C2224a.m6053a("BOX2D API", "destroyBody id:" + body.addr);
    ...
    public Joint createJoint(JointDef jointDef) {
        ...
        C2224a.m6053a("BOX2D API", "createJoint id:" + joint.addr);
        return joint;
    }
    ...
    private long createProperJoint(JointDef jointDef) {
        if (jointDef.type == JointDef.JointType.DistanceJoint) {
            ...
            return jniCreateLineJoint(this.addr, lineJointDef.bodyA.addr, lineJointDef.bodyB.addr, lineJointDef.collideConnected, lineJointDef.localAnchorA.f2403x, lineJointDef.localAnchorA.f2404y, lineJointDef.localAnchorB.f2403x, lineJointDef.localAnchorB.f2404y, lineJointDef.localAxisA.f2403x, lineJointDef.localAxisA.f2404y, lineJointDef.enableLimit, lineJointDef.lowerTranslation, lineJointDef.upperTranslation, lineJointDef.enableMotor, lineJointDef.maxMotorForce, lineJointDef.motorSpeed);
        } else if (jointDef.type == JointDef.JointType.MouseJoint) {
            MouseJointDef mouseJointDef = (MouseJointDef) jointDef;
            return jniCreateMouseJoint(this.addr, mouseJointDef.bodyA.addr, mouseJointDef.bodyB.addr, mouseJointDef.collideConnected, mouseJointDef.target.f2403x, mouseJointDef.target.f2404y, mouseJointDef.maxForce, mouseJointDef.frequencyHz, mouseJointDef.dampingRatio);
        } else if (jointDef.type == JointDef.JointType.PrismaticJoint) {
            PrismaticJointDef prismaticJointDef = (PrismaticJointDef) jointDef;
            return jniCreatePrismaticJoint(this.addr, prismaticJointDef.bodyA.addr, prismaticJointDef.bodyB.addr, prismaticJointDef.collideConnected, prismaticJointDef.localAnchorA.f2403x, prismaticJointDef.localAnchorA.f2404y, prismaticJointDef.localAnchorB.f2403x, prismaticJointDef.localAnchorB.f2404y, prismaticJointDef.localAxis1.f2403x, prismaticJointDef.localAxis1.f2404y, prismaticJointDef.referenceAngle, prismaticJointDef.enableLimit, prismaticJointDef.lowerTranslation, prismaticJointDef.upperTranslation, prismaticJointDef.enableMotor, prismaticJointDef.maxMotorForce, prismaticJointDef.motorSpeed);
        } else if (jointDef.type == JointDef.JointType.PulleyJoint) {
            PulleyJointDef pulleyJointDef = (PulleyJointDef) jointDef;
            return jniCreatePulleyJoint(this.addr, pulleyJointDef.bodyA.addr, pulleyJointDef.bodyB.addr, pulleyJointDef.collideConnected, pulleyJointDef.groundAnchorA.f2403x, pulleyJointDef.groundAnchorA.f2404y, pulleyJointDef.groundAnchorB.f2403x, pulleyJointDef.groundAnchorB.f2404y, pulleyJointDef.localAnchorA.f2403x, pulleyJointDef.localAnchorA.f2404y, pulleyJointDef.localAnchorB.f2403x, pulleyJointDef.localAnchorB.f2404y, pulleyJointDef.lengthA, pulleyJointDef.maxLengthA, pulleyJointDef.lengthB, pulleyJointDef.maxLengthB, pulleyJointDef.ratio);
        } else if (jointDef.type == JointDef.JointType.RevoluteJoint) {
            RevoluteJointDef revoluteJointDef = (RevoluteJointDef) jointDef;
            return jniCreateRevoluteJoint(this.addr, revoluteJointDef.bodyA.addr, revoluteJointDef.bodyB.addr, revoluteJointDef.collideConnected, revoluteJointDef.localAnchorA.f2403x, revoluteJointDef.localAnchorA.f2404y, revoluteJointDef.localAnchorB.f2403x, revoluteJointDef.localAnchorB.f2404y, revoluteJointDef.referenceAngle, revoluteJointDef.enableLimit, revoluteJointDef.lowerAngle, revoluteJointDef.upperAngle, revoluteJointDef.enableMotor, revoluteJointDef.motorSpeed, revoluteJointDef.maxMotorTorque);
        } else if (jointDef.type == JointDef.JointType.WeldJoint) {
            WeldJointDef weldJointDef = (WeldJointDef) jointDef;
            return jniCreateWeldJoint(this.addr, weldJointDef.bodyA.addr, weldJointDef.bodyB.addr, weldJointDef.collideConnected, weldJointDef.localAnchorA.f2403x, weldJointDef.localAnchorA.f2404y, weldJointDef.localAnchorB.f2403x, weldJointDef.localAnchorB.f2404y, weldJointDef.referenceAngle);
        } else {
            return 0L;
        }
    }
    ...
    public void destroyAllJoint() {
        ...
        while (entries.hasNext()) {
            ...
            C2224a.m6053a("BOX2D API", "destroyJoint id:" + joint.addr);
    ...
    public void setGravity(Vector2 vector2) {
        jniSetGravity(this.addr, vector2.f2403x, vector2.f2404y);
    }

    public Vector2 getGravity() {
        jniGetGravity(this.addr, this.tmpGravity);
        this.gravity.f2403x = this.tmpGravity[0];
        this.gravity.f2404y = this.tmpGravity[1];
        return this.gravity;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0053, code lost:
        if ((r0.maskBits & r3.categoryBits) != 0) goto L20;
     */
    /*
