...
public class PolygonShape extends Shape {
    ...
    public void set(Vector2[] vector2Arr) {
        ...
        while (i2 < vector2Arr.length * 2) {
            fArr[i2] = vector2Arr[i].f2403x;
            fArr[i2 + 1] = vector2Arr[i].f2404y;
            i2 += 2;
            i++;
        }
    ...
    public void setAsBox(float f, float f2, Vector2 vector2, float f3) {
        jniSetAsBox(this.addr, f, f2, vector2.f2403x, vector2.f2404y, f3);
    }

    public void setAsEdge(Vector2 vector2, Vector2 vector22) {
        jniSetAsEdge(this.addr, vector2.f2403x, vector2.f2404y, vector22.f2403x, vector22.f2404y);
    }
    ...
    public void getVertex(int i, Vector2 vector2) {
        ...
        vector2.f2403x = verts[0];
        vector2.f2404y = verts[1];
    }
}
