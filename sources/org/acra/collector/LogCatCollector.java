...
public class LogCatCollector {
    ...
    public static String collectLogCat(String str) {
        ...
        String str2 = (!ACRA.getConfig().logcatFilterByPid() || Process.myPid() <= 0) ? null : String.valueOf(Integer.toString(myPid)) + "):";
        ...
        try {
            ACRA.log.mo11d(ACRA.LOG_TAG, "Retrieving logcat output...");
            ...
            try {
                ACRA.log.mo8e(ACRA.LOG_TAG, "LogCatCollector.collectLogCat could not retrieve data.", e);
