...
public class VTextureManager {
    ...
    private ArrayList mTextureList = new ArrayList();
    ...
    public TextureElement createTexture(Bitmap bitmap, boolean z) {
        TextureElement a = a.g().a(bitmap, z);
    ...
    public void replaceTextureByTween(final VObject3d vObject3d, final TextureElement textureElement, final TextureElement textureElement2, int i, final boolean z) {
        final int i2 = i / 2;
        x xVar = new x() { // from class: com.censivn.C3DEngine.api.core.VTextureManager.1
            @Override // com.censivn.C3DEngine.b.g.x
            public void a() {
                VTextureManager.this.replaceTexture(vObject3d, textureElement, textureElement2, z);
                x xVar2 = new x();
                xVar2.a(255);
                w.a(vObject3d.vTarget, i2, xVar2);
            }
        };
        xVar.a(0);
        w.a(vObject3d.vTarget, i2, xVar);
    }
    ...
    public void destroy() {
        com.tsf.shell.a.a.a("VTextureManager", "widget:" + this.appWidgetId + " destroy ");
