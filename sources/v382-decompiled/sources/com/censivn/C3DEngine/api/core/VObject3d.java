...
public class VObject3d implements VTweenTarget {
    ...
    public VObject3dContainer parent() {
        if (this.vTarget.parent() instanceof l) {
            return (VObject3dContainer) ((j) this.vTarget.parent()).getVirtualObject();
        }
        return null;
    }
    ...
    public boolean calTouchCollision(float f, float f2) {
        ...
        float a = k.a(this.vTarget.AABB_P1, this.vTarget.AABB_P2);
        float a2 = k.a(this.vTarget.AABB_P2, this.vTarget.AABB_P3);
        float a3 = k.a(this.vTarget.AABB_P3, this.vTarget.AABB_P1);
        if (a < 0.0f && a2 < 0.0f && a3 < 0.0f) {
            return true;
        }
        if (this.vTarget.doubleSidedClickEnabled() && a > 0.0f && a2 > 0.0f && a3 > 0.0f) {
            return true;
        }
        float a4 = k.a(this.vTarget.AABB_P2, this.vTarget.AABB_P3);
        float a5 = k.a(this.vTarget.AABB_P3, this.vTarget.AABB_P4);
        float a6 = k.a(this.vTarget.AABB_P4, this.vTarget.AABB_P2);
        if (a4 <= 0.0f || a5 <= 0.0f || a6 <= 0.0f) {
            return this.vTarget.doubleSidedClickEnabled() && a4 < 0.0f && a5 < 0.0f && a6 < 0.0f;
        }
        return true;
    }
    ...
    public VObject3d getHittingTarget(float f, float f2, boolean z) {
        j hittingTarget = this.vTarget.getHittingTarget(f, f2, z);
