...
public class TextureList {
    private ArrayList mTextureDescriptionList = new ArrayList();
    ...
    public TextureDescription get(int i) {
        return (TextureDescription) this.mTextureDescriptionList.get(i);
    }

    public TextureDescription getByElement(TextureElement textureElement) {
        Iterator it = this.mTextureDescriptionList.iterator();
        while (it.hasNext()) {
    ...
    public void destroyAllTexture() {
        Iterator it = this.mTextureDescriptionList.iterator();
        while (it.hasNext()) {
            a.g().a(((TextureDescription) it.next()).textureElement);
        }
        this.mTextureDescriptionList.clear();
        a.e().j();
    }
