...
public class i implements GLSurfaceView.Renderer {
    ...
    public i(com.censivn.C3DEngine.d.b bVar, GLSurfaceView gLSurfaceView) {
    ...
    protected void b() {
        ...
        while (it.hasNext()) {
            ((com.censivn.C3DEngine.b.f.j) it.next()).dispatchDraw();
        }
    }

    public void a(com.censivn.C3DEngine.b.f.j jVar) {
        this.d = this.d || jVar.isAnimationObject;
        if (jVar.isAnimationObject && jVar.isHighPriorityAnimationObject) {
            this.e = true;
        }
    }
    ...
    public void e() {
        ...
        float f3 = this.l;
        g.a(MatrixStack.rProjMatrix, 0, f3 * (-f2), f2 * this.l, -f2, f2, this.j.b().e, this.j.b().d);
        g.a(MatrixStack.rVMatrix, 0, this.j.b().a.x, this.j.b().a.y, this.j.b().a.z, this.j.b().b.x, this.j.b().b.y, this.j.b().b.z, this.j.b().c.x, this.j.b().c.y, this.j.b().c.z);
        g.a(MatrixStack.rSceneMatrix, 0, MatrixStack.rProjMatrix, 0, MatrixStack.rVMatrix, 0);
    }
    ...
    public void b(float f2, float f3) {
        ...
        g.a(MatrixStack.rProjMatrix, 0, ((-f4) * this.l) - f5, (this.l * f4) - f5, (-f4) - f6, f4 - f6, this.j.b().e, this.j.b().d);
        g.a(MatrixStack.rVMatrix, 0, f2, f3, this.j.b().a.z, f2, f3, this.j.b().b.z, this.j.b().c.x, this.j.b().c.y, this.j.b().c.z);
        g.a(MatrixStack.rSceneMatrix, 0, MatrixStack.rProjMatrix, 0, MatrixStack.rVMatrix, 0);
    }
    ...
    public com.censivn.C3DEngine.b.f.j c(float f2, float f3) {
        int size = this.j.d().size() - 1;
        while (true) {
            int i = size;
            if (i > -1) {
                com.censivn.C3DEngine.b.f.j hittingTarget = ((com.censivn.C3DEngine.b.f.j) this.j.d().get(i)).getHittingTarget(f2, f3, false);
