...
public class a extends l {
    ...
    private l c;
    private l d;
    private com.tsf.shell.e.a.b.c e;
    private float f;
    private float g;
    private float h;
    private float i;
    ...
    public a(j jVar, float f, float f2, float f3, float f4, float f5) {
        this.l = 1;
        this.m = 0.0f;
        this.n = 0.0f;
        this.o = 0.0f;
        ...
        this.d = new l();
        this.b = new l();
        this.c = new l() { // from class: com.censivn.C3DEngine.b.h.e.a.1
        ...
        this.e = new com.tsf.shell.e.a.b.c(this.f - (2.0f * f4), this.g, this.c);
        this.b.addChild(this.c);
        super.addChild(this.b);
        super.addChild(this.d);
        jVar = jVar == null ? this.b : jVar;
        this.b.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(jVar) { // from class: com.censivn.C3DEngine.b.h.e.a.2
            float a;
            ...
            public void e(MotionEvent motionEvent) {
                ...
                j hittingTarget = a.this.c.getHittingTarget(a2[0], a2[1], true);
            ...
            public void a(MotionEvent motionEvent, MotionEvent motionEvent2, float f6, float f7) {
                ...
                if (this.f) {
                    ...
                    a.this.o = d.a(a.this.o, a.this.n, a.this.m);
                    return;
                }
                if (this.d != null) {
        ...
        this.v = x.b(R.drawable.scrollcontainer_arrow);
        this.t = new m(24.0f * com.censivn.C3DEngine.b.b.a.c, 45.0f * com.censivn.C3DEngine.b.b.a.c, false);
        this.t.rotation().z = 180.0f;
        com.tsf.shell.manager.o.c.a(this.t, com.tsf.shell.manager.o.c.h);
        this.u = new m(24.0f * com.censivn.C3DEngine.b.b.a.c, 45.0f * com.censivn.C3DEngine.b.b.a.c, false);
        ...
        this.t.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(jVar) { // from class: com.censivn.C3DEngine.b.h.e.a.3
            @Override // com.censivn.C3DEngine.b.d.a
            public void a(MotionEvent motionEvent) {
                a.a = 0.1f;
                a.this.k();
        ...
        this.u.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(jVar) { // from class: com.censivn.C3DEngine.b.h.e.a.4
            @Override // com.censivn.C3DEngine.b.d.a
            public void a(MotionEvent motionEvent) {
                a.a = 0.1f;
                a.this.j();
    ...
    private void b(final m mVar) {
        if (mVar.parent() != null) {
            com.censivn.C3DEngine.b.g.x xVar = new com.censivn.C3DEngine.b.g.x() { // from class: com.censivn.C3DEngine.b.h.e.a.5
                @Override // com.censivn.C3DEngine.b.g.x
                public void a() {
                    a.this.d.removeChild(mVar);
                }
            };
            xVar.a(0);
            w.a(mVar);
    ...
    public void a(j jVar) {
        if ((jVar.position().x - (this.j / 2.0f)) + this.c.position().x >= this.f / 2.0f || jVar.position().x + (this.j / 2.0f) + this.c.position().x <= (-this.f) / 2.0f) {
            jVar.visible(false);
        } else {
            jVar.visible(true);
        }
    ...
    public boolean removeChild(j jVar) {
        int childIndexOf = this.c.getChildIndexOf(jVar);
        if (childIndexOf == -1) {
            return false;
        }
    ...
    private void e(int i) {
        int numChildren = this.c.numChildren();
        int i2 = i * this.l;
        int i3 = this.l + i2 > numChildren + (-1) ? numChildren - 1 : this.l + i2;
        ...
        for (int i4 = i2; i4 < i3 + 1; i4++) {
            j childAt = this.c.getChildAt(i4);
