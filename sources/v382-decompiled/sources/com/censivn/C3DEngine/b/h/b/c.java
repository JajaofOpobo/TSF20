...
public class c extends l implements com.censivn.C3DEngine.b.c.d, k, e, com.tsf.shell.e.i.b {
    private static l Q;
    private static com.tsf.shell.e.e.d.a.e R;
    private Number3d A;
    private Number3d B;
    private Number3d C;
    private Number3d D;
    ...
    public c(com.tsf.shell.e.f.g gVar, boolean z) {
        this(gVar, z, null);
    }

    public c(com.tsf.shell.e.f.g gVar, boolean z, d dVar) {
        this.k = 0.0f;
        this.l = 0.0f;
        this.m = false;
        this.n = false;
    ...
    private void a(boolean z) {
        ...
        int a = (int) com.censivn.C3DEngine.b.b.a.a(128.0f);
        this.e = ThemeManager.mix.interactiveArrange.getTextureElement(ThemeShellDescription.INTERACTIVE_ARRANGE_BG, a, a);
        this.b = new m(f, f, i, i) { // from class: com.censivn.C3DEngine.b.h.b.c.1
            @Override // com.censivn.C3DEngine.b.f.j
        ...
        addChild(this.b);
        this.h = new f() { // from class: com.censivn.C3DEngine.b.h.b.c.3
            ...
            public void b(MotionEvent motionEvent) {
                com.tsf.shell.e.i.c e = e(motionEvent);
                if (e != null && c.this.i.e()) {
                    ((com.tsf.shell.e.i.e) e).ap();
                }
            }
        };
        this.i = new com.tsf.shell.e.i.a(this, this) { // from class: com.censivn.C3DEngine.b.h.b.c.4
        ...
        this.c = new m(com.tsf.shell.manager.g.a.a, com.tsf.shell.manager.g.a.a, false);
        ...
        this.c.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this.b) { // from class: com.censivn.C3DEngine.b.h.b.c.5
            ...
            public void a(MotionEvent motionEvent, MotionEvent motionEvent2) {
                if (!this.b) {
                    ...
                    float[] a2 = x.a(motionEvent2);
                    c.this.K = (int) (a2[0] - c.this.a.position().x);
                    c.this.L = (int) (a2[1] - c.this.a.position().y);
                }
            }
        });
        addChild(this.c);
        ...
        if (Q == null) {
            Q = new l();
            com.tsf.shell.e.e.d.a.f fVar = new com.tsf.shell.e.e.d.a.f();
            fVar.a = com.censivn.C3DEngine.b.b.a.a(-130.0f);
            fVar.b = com.censivn.C3DEngine.b.b.a.a(128.0f);
            fVar.c = com.censivn.C3DEngine.b.b.a.a(50.0f);
            fVar.d = 0.0f;
            fVar.e = 38;
            fVar.f = com.censivn.C3DEngine.b.b.a.a(54.0f);
            fVar.g = 0;
            R = new com.tsf.shell.e.e.d.a.e(R.string.menu_multiple_choice, R.drawable.widget_folder_multi_choice, fVar);
            Q.addChild(R);
        }
    ...
    public void f() {
        ...
        xVar.a(255);
        w.a(R);
        w.a(R, VEasing.Back.easeIn, xVar);
    }
    ...
    public void a(com.tsf.shell.e.i.c cVar) {
        this.j.add(cVar.position().m4clone());
        com.censivn.C3DEngine.b.g.x xVar = new com.censivn.C3DEngine.b.g.x();
        xVar.e(0.0f);
        w.a(cVar, 500, xVar);
        cVar.a(this.i);
    ...
    private void h() {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            Number3d number3d = (Number3d) this.j.get(i11);
    ...
    private void b(int i, int i2) {
        float f = i - ((com.censivn.C3DEngine.b.b.a.a * 128.0f) / 2.0f);
        float f2 = i2 - ((com.censivn.C3DEngine.b.b.a.a * 128.0f) / 2.0f);
        if ((this.v.x + f) - this.b.points().pxX(15) < com.censivn.C3DEngine.b.b.a.a * 128.0f) {
            f = ((com.censivn.C3DEngine.b.b.a.a * 128.0f) + this.b.points().pxX(15)) - this.v.x;
        }
        if ((this.b.points().pxY(15) - this.v.y) + f2 < com.censivn.C3DEngine.b.b.a.a * 128.0f) {
            f2 = ((com.censivn.C3DEngine.b.b.a.a * 128.0f) - this.b.points().pxY(15)) + this.v.y;
        }
        this.c.position().x = this.G + f;
        this.c.position().y = (-this.H) - f2;
        Q.position().x = (this.b.points().pxX(15) + this.b.points().pxX(0)) / 2.0f;
        Q.position().y = this.c.position().y - com.censivn.C3DEngine.b.b.a.a(100.0f);
        this.b.points().pxX(13, this.o.x + f);
        this.b.points().pxX(9, this.p.x + f);
        this.b.points().pxX(5, this.q.x + f);
        this.b.points().pxX(1, this.r.x + f);
        this.b.points().pxX(12, this.s.x + f);
        this.b.points().pxX(8, this.t.x + f);
        this.b.points().pxX(4, this.u.x + f);
        this.b.points().pxX(0, f + this.v.x);
        this.b.points().pxY(0, this.v.y - f2);
        this.b.points().pxY(1, this.r.y - f2);
        this.b.points().pxY(2, this.w.y - f2);
        this.b.points().pxY(3, this.x.y - f2);
        this.b.points().pxY(4, this.u.y - f2);
        this.b.points().pxY(5, this.q.y - f2);
        this.b.points().pxY(6, this.y.y - f2);
        this.b.points().pxY(7, this.z.y - f2);
    }
    ...
    public void d() {
        if (!this.n && !this.m) {
            ...
            while (it.hasNext()) {
                ...
                this.O.a(jVar);
                ((com.tsf.shell.e.i.c) jVar).ad();
            }
            this.j.clear();
            com.censivn.C3DEngine.b.g.x xVar = new com.censivn.C3DEngine.b.g.x() { // from class: com.censivn.C3DEngine.b.h.b.c.7
    ...
    public void e() {
        if (!this.m) {
            int numChildren = this.d.numChildren();
            for (int i = 0; i < numChildren; i++) {
                com.censivn.C3DEngine.b.f.j childAt = this.d.getChildAt(i);
                Number3d number3d = (Number3d) this.j.get(i);
                childAt.position().x = (float) (r4.x + ((number3d.x - childAt.position().x) * 0.2d));
                childAt.position().y = (float) (r4.y + ((number3d.y - childAt.position().y) * 0.2d));
            }
        }
    }
    ...
    @Override // com.censivn.C3DEngine.b.h.b.e
    public void e(com.tsf.shell.e.i.c cVar) {
    }

    @Override // com.censivn.C3DEngine.b.h.b.e
    public void a(com.tsf.shell.e.i.c cVar, Number3d number3d) {
    }
