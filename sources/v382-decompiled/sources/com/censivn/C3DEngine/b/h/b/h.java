...
public class h extends l {
    ...
    public h(float f, float f2, float f3, float f4, float f5) {
        ...
        setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this) { // from class: com.censivn.C3DEngine.b.h.b.h.1
            boolean a = true;
            float b = 0.0f;
            boolean d = false;
            ...
            public void a(MotionEvent motionEvent, MotionEvent motionEvent2, float f6, float f7) {
                if (this.a) {
                    ...
                    h.this.c.invalidate();
                    this.b = h.this.c.position().x;
                    this.a = false;
                }
                h.this.g = this.b + (motionEvent2.getX() - motionEvent.getX());
            }

            @Override // com.censivn.C3DEngine.b.d.a
            public void e(MotionEvent motionEvent) {
                if (Math.abs(h.this.g - h.this.c.position().x) < 50.0f) {
                    this.d = false;
                } else {
                    this.d = true;
                }
                h.this.g = h.this.c.position().x;
                this.f = null;
            }
            ...
            public void a(MotionEvent motionEvent) {
                if (!this.d) {
                    ...
                    com.censivn.C3DEngine.b.f.j hittingTarget = h.this.c.getHittingTarget(a[0], a[1], true);
                    if (hittingTarget != null) {
                        h.this.a(hittingTarget, hittingTarget.getDisplayTag());
                    }
                }
            }
            ...
            public void c(MotionEvent motionEvent) {
                if (!this.d) {
                    ...
                    if (hittingTarget != null) {
                        ...
                        h.this.a(motionEvent, hittingTarget, hittingTarget.getDisplayTag());
                    }
                }
            }
            ...
            public void d(MotionEvent motionEvent) {
                if (this.f != null) {
                    h.this.b(motionEvent, this.f, this.f.getDisplayTag());
                    this.f = null;
                }
            }
            ...
            public void a(MotionEvent motionEvent, MotionEvent motionEvent2) {
                if (this.f != null) {
                    h.this.a(motionEvent, motionEvent2, this.f, this.f.getDisplayTag());
                }
            }
        });
        b();
    ...
    public void a(int i) {
        ...
        while (true) {
            ...
            com.censivn.C3DEngine.b.f.j childAt = this.c.getChildAt(i2);
        ...
        if (i2 != -1) {
            ...
            while (i2 < numChildren2) {
                com.censivn.C3DEngine.b.f.j childAt2 = this.c.getChildAt(i2);
                if (i2 == numChildren2 - 1) {
                    a(childAt2, i, new Runnable() { // from class: com.censivn.C3DEngine.b.h.b.h.2
    ...
    private void f() {
        if (this.l) {
            ...
            for (int i = 0; i < numChildren; i++) {
                com.censivn.C3DEngine.b.f.j childAt = this.c.getChildAt(i);
                if (i > this.a) {
                    childAt.removeFromParent();
                    this.b.add(childAt);
        ...
        if (this.a >= 0) {
            ...
            for (int i2 = 0; i2 < numChildren; i2++) {
                ...
                if (i2 != numChildren - 1 || childAt.getDisplayTag() == this.a) {
                    if (i2 == 0 && childAt.position().x + this.c.position().x > this.d && childAt.getDisplayTag() != 0 && (a = a(i, j())) != null) {
                        a.removeFromParent();
                    ...
                    com.censivn.C3DEngine.b.f.j a2 = a(i + 1, j());
                    a2.removeFromParent();
                    this.c.addChild(a2);
            ...
            if (numChildren == 0) {
                com.censivn.C3DEngine.b.f.j a3 = a(i, j());
                a3.removeFromParent();
                b(a3, i);
                this.c.addChild(a3);
                h();
    ...
    private com.censivn.C3DEngine.b.f.j j() {
        ...
        return (com.censivn.C3DEngine.b.f.j) this.b.remove(size - 1);
    }

    private void a(com.censivn.C3DEngine.b.f.j jVar, int i, Runnable runnable) {
        com.censivn.C3DEngine.b.f.j a;
        if (jVar.getDisplayTag() != i && (a = a(i, jVar)) != null) {
            a.setDisplayTag(i);
    ...
    private void b(com.censivn.C3DEngine.b.f.j jVar, int i) {
        com.censivn.C3DEngine.b.f.j a;
        if (jVar.getDisplayTag() != i && (a = a(i, jVar)) != null) {
            a.setDisplayTag(i);
    ...
    public void a(com.censivn.C3DEngine.b.f.j jVar, int i) {
    }

    public void a(MotionEvent motionEvent, com.censivn.C3DEngine.b.f.j jVar, int i) {
    }

    public void b(MotionEvent motionEvent, com.censivn.C3DEngine.b.f.j jVar, int i) {
    }

    public void a(MotionEvent motionEvent, MotionEvent motionEvent2, com.censivn.C3DEngine.b.f.j jVar, int i) {
    }
