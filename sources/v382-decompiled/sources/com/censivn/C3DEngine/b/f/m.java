...
public class m extends l {
    ...
    public m(float f, float f2, int i, int i2) {
        this(f, f2, i, i2, new Color4(255, 50, 0, 100), false, true, false);
    }

    public m(float f, float f2, int i, int i2, boolean z) {
        this(f, f2, i, i2, new Color4(255, 50, 0, 100), false, z, false);
    }

    public m(float f, float f2, int i, int i2, boolean z, boolean z2) {
        this(f, f2, i, i2, new Color4(255, 50, 0, 100), z, z2, false);
    }

    public m(float f, float f2, int i, int i2, Color4 color4, boolean z, boolean z2, boolean z3) {
