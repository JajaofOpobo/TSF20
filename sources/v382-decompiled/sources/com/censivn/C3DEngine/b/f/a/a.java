...
public class a extends l {
    ...
    public a(int i, int i2, int i3, int i4, j jVar, boolean z) {
    ...
    private void c(b bVar) {
        ...
        float f = (float) ((bVar.n.x * 3.141592653589793d) / 180.0d);
        float f2 = (float) ((bVar.n.y * 3.141592653589793d) / 180.0d);
        float f3 = (float) ((bVar.n.z * 3.141592653589793d) / 180.0d);
        bVar.p.rotateX(f);
        bVar.q.rotateX(f);
        bVar.r.rotateX(f);
        bVar.s.rotateX(f);
