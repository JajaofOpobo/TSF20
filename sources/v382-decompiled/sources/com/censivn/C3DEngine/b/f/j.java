...
public class j implements com.censivn.C3DEngine.b.g.b.a {
    ...
    public TextureElement cacheToTexture() {
        ...
        com.tsf.shell.e.a.a.a a = com.tsf.shell.manager.a.t.a(cacheWidth, cacheHeight);
        this.cacheTextureElement = com.censivn.C3DEngine.a.g().a(cacheWidth, cacheHeight, false);
        com.tsf.shell.manager.a.t.a(a, this.cacheTextureElement);
        position().setAll(0.0f, 0.0f, 0.0f);
        dispatchDraw();
        com.tsf.shell.manager.a.t.a();
        com.tsf.shell.manager.a.t.a(a);
    ...
    public boolean useVBO() {
        return this.mUseVBO && com.censivn.C3DEngine.a.i.g;
    }
    ...
    public void syncUpdatePointVBO() {
        if (!this.isUpdatePointsVBO) {
            ...
            com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.censivn.C3DEngine.b.f.j.1
                @Override // java.lang.Runnable
                public void run() {
                    j.this.updatePointsVBO();
                }
            });
        }
    }
    ...
    public void syncUpdateUvsVBO() {
        if (!this.isUpdateUvsVBO) {
            ...
            com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.censivn.C3DEngine.b.f.j.2
                @Override // java.lang.Runnable
                public void run() {
                    j.this.updateUvsVBO();
                }
    ...
    public void syncUpdateFacesVBO() {
        if (!this.isUpdateFacesVBO) {
            ...
            com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.censivn.C3DEngine.b.f.j.3
                @Override // java.lang.Runnable
                public void run() {
                    j.this.updateFacesVBO();
                }
            });
        }
    }
    ...
    public Number3d localRotationToGlobal(Number3d number3d) {
        while (true) {
            ...
            if (parent == null || (parent instanceof com.censivn.C3DEngine.a.k)) {
                break;
            }
            this = (j) parent;
        }
    ...
    public Number3d globalScaleToLocal(Number3d number3d) {
        ...
        while (true) {
            int i = size;
            if (i > -1) {
                Number3d scale = ((j) arrayList.get(i)).scale();
                number3d.x /= scale.x;
                number3d.y /= scale.y;
                number3d.z /= scale.z;
                size = i - 1;
    ...
    public Number3d globalRotationToLocal(Number3d number3d) {
        ...
        while (true) {
            int i = size;
            if (i > -1) {
                Number3d rotation = ((j) arrayList.get(i)).rotation();
                number3d.x -= rotation.x;
                number3d.y -= rotation.y;
    ...
    public Number3d localToGlobal(Number3d number3d) {
        while (true) {
            ...
            j jVar = (j) parent;
            number3d.x *= jVar.scale().x;
            number3d.y *= jVar.scale().y;
            number3d.z *= jVar.scale().z;
            this = jVar;
        }
        return number3d;
    }
    ...
    public Number3d globalToLocal(Number3d number3d) {
        ...
        while (true) {
            int i = size;
            if (i > -1) {
                PositionNumber3d position = ((j) arrayList.get(i)).position();
                Number3d scale = ((j) arrayList.get(i)).scale();
                number3d.x -= position.x;
                number3d.y -= position.y;
                ...
                number3d.y /= scale.y;
                number3d.z /= scale.z;
                number3d.rotateReverseAll(((j) arrayList.get(i)).rotation());
                size = i - 1;
            } else {
                return number3d;
            }
    ...
    public boolean calTouchCollision(float f, float f2) {
        ...
        com.censivn.C3DEngine.a.g.b(this.TEMP_AABB_TL, 0, this.AABB_MATRIX, 0, this.AABB_TL, 0);
        com.censivn.C3DEngine.a.g.b(this.TEMP_AABB_TR, 0, this.AABB_MATRIX, 0, this.AABB_TR, 0);
        com.censivn.C3DEngine.a.g.b(this.TEMP_AABB_BL, 0, this.AABB_MATRIX, 0, this.AABB_BL, 0);
        com.censivn.C3DEngine.a.g.b(this.TEMP_AABB_BR, 0, this.AABB_MATRIX, 0, this.AABB_BR, 0);
        ...
        float a = k.a(this.AABB_P1, this.AABB_P2);
        float a2 = k.a(this.AABB_P2, this.AABB_P3);
        float a3 = k.a(this.AABB_P3, this.AABB_P1);
        if (a < 0.0f && a2 < 0.0f && a3 < 0.0f) {
            return true;
        }
        if (this.doubleSidedClickEnabled && a > 0.0f && a2 > 0.0f && a3 > 0.0f) {
            return true;
        }
        float a4 = k.a(this.AABB_P2, this.AABB_P3);
        float a5 = k.a(this.AABB_P3, this.AABB_P4);
        float a6 = k.a(this.AABB_P4, this.AABB_P2);
        if (a4 <= 0.0f || a5 <= 0.0f || a6 <= 0.0f) {
            return this.doubleSidedClickEnabled && a4 < 0.0f && a5 < 0.0f && a6 < 0.0f;
        }
        return true;
    }
    ...
    public void copyAABB(j jVar) {
        this.AABB_TL[0] = jVar.AABB_TL[0];
        this.AABB_TL[1] = jVar.AABB_TL[1];
        this.AABB_TL[2] = jVar.AABB_TL[2];
        this.AABB_TL[3] = jVar.AABB_TL[3];
        this.AABB_TR[0] = jVar.AABB_TR[0];
        this.AABB_TR[1] = jVar.AABB_TR[1];
        this.AABB_TR[2] = jVar.AABB_TR[2];
        this.AABB_TR[3] = jVar.AABB_TR[3];
        this.AABB_BL[0] = jVar.AABB_BL[0];
        this.AABB_BL[1] = jVar.AABB_BL[1];
        this.AABB_BL[2] = jVar.AABB_BL[2];
        this.AABB_BL[3] = jVar.AABB_BL[3];
        this.AABB_BR[0] = jVar.AABB_BR[0];
        this.AABB_BR[1] = jVar.AABB_BR[1];
        this.AABB_BR[2] = jVar.AABB_BR[2];
        this.AABB_BR[3] = jVar.AABB_BR[3];
    }
    ...
    public void calAABB(float f, float f2, float f3) {
        ...
        if (i <= 0) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                j jVar = (j) lVar.children().get(i2);
                if (!jVar.isAABBInit) {
                    jVar.calAABB();
                }
                f10 = Math.min(f10, jVar.AABB_TL[0] + jVar.position().x);
                f11 = Math.min(f11, jVar.AABB_BL[1] + jVar.position().y);
                f12 = Math.min(f12, jVar.AABB_TL[2] + jVar.position().z);
                f13 = Math.max(f13, jVar.AABB_TR[0] + jVar.position().x);
                f14 = Math.max(f14, jVar.AABB_TL[1] + jVar.position().y);
                f15 = Math.max(f15, jVar.position().z + jVar.AABB_TL[2]);
            }
            f4 = f15;
            f5 = f14;
            f6 = f13;
    ...
    public j getHittingObjectTarget(MotionEvent motionEvent, boolean z) {
        float[] a = x.a(motionEvent);
        return getHittingObjectTarget(a[0], a[1], z);
    }

    public j getHittingObjectTarget(float f, float f2, boolean z) {
        if (!visible()) {
            return null;
        }
        if (!z) {
        ...
        l lVar = (l) this;
        int size = lVar.children().size() - 1;
        while (true) {
            int i = size;
            if (i <= -1) {
                return null;
            }
            j hittingObjectTarget = ((j) lVar.children().get(i)).getHittingObjectTarget(f, f2, false);
    ...
    public j getHittingTarget(float f, float f2, boolean z) {
        ...
        while (true) {
            ...
            j hittingTarget = ((j) lVar.children().get(i)).getHittingTarget(f, f2, false);
    ...
    public void setFocus() {
        if (getMouseEventListener() != null) {
            com.censivn.C3DEngine.a.h.d().a(getMouseEventListener());
        }
    }

    public void killFocus() {
        com.censivn.C3DEngine.a.h.d().a((com.censivn.C3DEngine.b.d.a) null);
    }
    ...
    public void transferCanvas(float f, float f2, float f3, float f4) {
        ...
        if (z && (this instanceof l)) {
            ...
            int size = lVar.children().size();
            for (int i = 0; i < size; i++) {
                ((j) lVar.children().get(i)).transferCanvas(f7, 0.0f, f8, 0.0f);
            }
        }
    }
    ...
    public void transferCanvasV(float f, float f2, float f3, float f4) {
        ...
        if (z && (this instanceof l)) {
            ...
            int size = lVar.children().size();
            for (int i = 0; i < size; i++) {
                ((j) lVar.children().get(i)).transferCanvasV(f, f7, f3, f8);
            }
        }
    }
