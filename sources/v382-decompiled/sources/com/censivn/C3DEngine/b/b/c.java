...
public class c extends l {
    ...
    public i a(j jVar) {
        if ((jVar instanceof i) && jVar.parent() != null && jVar.parent() == this) {
            return (i) jVar;
        }
        if (jVar.parent() != null && (jVar.parent() instanceof j)) {
            return a((j) jVar.parent());
        }
        return null;
    }
    ...
    public c() {
        ...
        this.d = (int) a.a(4.0f);
        this.f = new m(this.a, this.d, false);
    ...
    public void c() {
        int i;
        com.censivn.C3DEngine.b.g.x xVar;
        mouseEnabled(false);
        int numChildren = numChildren();
        int i2 = 0;
        int i3 = 0;
        while (i2 < numChildren) {
            j childAt = getChildAt(i2);
            ...
            if (!childAt.visible()) {
                ...
                if (i2 == numChildren - 1) {
                    xVar = new com.censivn.C3DEngine.b.g.x() { // from class: com.censivn.C3DEngine.b.b.c.2
                    ...
                    xVar = new com.censivn.C3DEngine.b.g.x();
                }
                xVar.h(layoutParams.g);
                xVar.a(com.censivn.C3DEngine.b.g.a.n);
                xVar.b(i3 * 60);
                xVar.a(255);
                w.a(childAt);
                w.a(childAt, 1000, xVar);
                i = i3 + 1;
            }
            i2++;
            i3 = i;
    ...
    private boolean a(Number3d number3d, j jVar) {
        b layoutParams = jVar.getLayoutParams();
        float f = jVar.position().y + number3d.y;
