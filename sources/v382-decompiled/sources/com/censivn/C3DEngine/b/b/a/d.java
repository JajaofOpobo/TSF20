...
public class d extends l {
    ...
    private l c = new l() { // from class: com.censivn.C3DEngine.b.b.a.d.1
        ...
        setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this) { // from class: com.censivn.C3DEngine.b.b.a.d.2
            ...
            public void e(MotionEvent motionEvent) {
                ...
                if (this.h) {
                    ...
                    j hittingTarget = d.this.getHittingTarget(a2[0], a2[1], true);
            ...
            public void a(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
                if (this.h) {
                    ...
                    if (this.f) {
                        ...
                        if (!d.this.o) {
                            d.this.h = com.tsf.shell.e.e.d.a(d.this.h, d.this.g, d.this.f, d.a);
                            return;
                        }
                        return;
                    }
            ...
            public void b(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
                ...
                d.this.h = com.tsf.shell.e.e.d.a(d.this.h, f);
            }
        });
    }
    ...
    public void g() {
        ...
        if (this.p != null && this.p.alpha() != 0.0f) {
            com.censivn.C3DEngine.b.g.x xVar = new com.censivn.C3DEngine.b.g.x() { // from class: com.censivn.C3DEngine.b.b.a.d.3
    ...
    private void q() {
        if (this.q != null) {
            this.r = true;
            com.censivn.C3DEngine.b.g.x xVar = new com.censivn.C3DEngine.b.g.x() { // from class: com.censivn.C3DEngine.b.b.a.d.4
                @Override // com.censivn.C3DEngine.b.g.x
                public void a() {
                    if (d.this.q != null) {
    ...
    public void onDrawStart() {
        if (getAnimationObjectState()) {
            ...
            if (this.b && !this.o && !this.r) {
                ...
                this.s = (f5 / com.tsf.shell.e.e.d.a) * 1.5f;
                if (this.s > 0.0f) {
