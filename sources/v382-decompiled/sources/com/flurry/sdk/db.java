...
public final class db {
    ...
    public db(int i, String str, Map map, long j, boolean z) {
        this.a = i;
        this.b = str;
        this.c = map;
        this.d = j;
        ...
        try {
            ...
            if (this.c == null) {
                ...
                for (Map.Entry entry : this.c.entrySet()) {
                    dataOutputStream.writeUTF(fe.a((String) entry.getKey()));
                    dataOutputStream.writeUTF(fe.a((String) entry.getValue()));
                }
            }
