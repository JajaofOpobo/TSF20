...
public class LongMap {
    ...
    public Object put(long j, Object obj) {
        ...
        push(j, obj, i, j2, hash2, j3, hash3, j4);
        return null;
    }
    ...
    private void putResize(long j, Object obj) {
        if (j == 0) {
            this.zeroValue = obj;
            this.hasZeroValue = true;
            return;
    ...
    private void push(long j, Object obj, int i, long j2, int i2, long j3, int i3, long j4) {
    ...
    private void putStash(long j, Object obj) {
    ...
    private Object getStash(long j) {
        long[] jArr = this.keyTable;
        int i = this.capacity;
        int i2 = this.stashSize + i;
        while (i < i2) {
    ...
    Object removeStash(long j) {
        long[] jArr = this.keyTable;
        int i = this.capacity;
        int i2 = i + this.stashSize;
        for (int i3 = i; i3 < i2; i3++) {
            if (jArr[i3] == j) {
                Object obj = this.valueTable[i3];
                removeStashIndex(i3);
                this.size--;
                return obj;
            }
    ...
    public class Entries extends a implements Iterable, Iterator {
        private Entry entry;

        @Override // com.badlogic.gdx.utils.a, java.util.Iterator
    ...
    public class Values extends a implements Iterable, Iterator {
        @Override // com.badlogic.gdx.utils.a, java.util.Iterator
        public /* bridge */ /* synthetic */ void remove() {
            super.remove();
        }
        ...
        public Object next() {
            Object obj;
            if (this.nextIndex == -1) {
                obj = this.map.zeroValue;
            } else {
                obj = this.map.valueTable[this.nextIndex];
            }
            this.currentIndex = this.nextIndex;
            findNextIndex();
            return obj;
