...
import com.tsf.shell.widget.cubeclock.p;
...
public class a extends VObject3dContainer {
    ...
    private com.tsf.shell.widget.cubeclock.c k;
    private boolean c = false;
    public float a = 1.0f;

    public a(com.tsf.shell.widget.cubeclock.c cVar) {
        this.k = cVar;
        this.j = this.k.q;
    ...
    private void e() {
        Bitmap a = t.a(this.k.a, p.cube_clock_widget_setting_bg);
        this.b = this.k.b.createTexture(a, true);
        a.recycle();
        Bitmap a2 = t.a(this.k.a, p.cube_clock_plus);
        this.d = this.k.b.createTexture(a2, true);
        a2.recycle();
        Bitmap a3 = t.a(this.k.a, p.cube_clock_minus);
        this.e = this.k.b.createTexture(a3, true);
        a3.recycle();
        Bitmap a4 = t.a(this.k.a, p.cube_clock_light);
        this.f = this.k.b.createTexture(a4, true);
        a4.recycle();
    }
