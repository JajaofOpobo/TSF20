...
public class l {
    ...
    public l(com.censivn.C3DEngine.b.f.a.b bVar, com.censivn.C3DEngine.b.f.a.b bVar2) {
        this.a = 0.0f;
        this.b = 0.0f;
        this.c = 0.0f;
        this.d = 0.0f;
    ...
    public void a(long j) {
        if (j >= this.j && this.j != -1) {
            ...
            float abs = (float) (Math.abs(f / 3.141592653589793d) * 255.0d);
