...
public class v extends VRectangle {
    ...
    public v() {
        ...
        this.i = 496.0f;
        if (a == null) {
            Bitmap a2 = aj.a(AlarmWidget.h, "back_number");
            a = AlarmWidget.c.createTexture(a2, true);
            a2.recycle();
        }
        if (b == null) {
            Bitmap a3 = aj.a(AlarmWidget.h, "back_number_minute");
            b = AlarmWidget.c.createTexture(a3, true);
            a3.recycle();
        }
        a(0);
    }
    ...
    public static void a() {
        AlarmWidget.e.post(new Runnable() { // from class: com.tsf.shell.widget.alarm.v.1
