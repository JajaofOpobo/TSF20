...
public class i {
    public static Uri a(Context context) {
        ...
        return f.a(context).a(a.a, contentValues);
    }

    public static Cursor b(Context context) {
        return new f(context).a(a.a, a.b, null, null, "_id ASC");
    }

    private static Cursor g(Context context) {
        return new f(context).a(a.a, a.b, "enabled=1", null, null);
    }

    public static Alarm a(Context context, int i) {
        Cursor a = f.a(context).a(ContentUris.withAppendedId(a.a, i), a.b, null, null, null);
        if (a != null) {
    ...
    public static void a(Context context, int i, boolean z, int i2, int i3, b bVar, boolean z2, String str, String str2) {
        ContentValues contentValues = new ContentValues(8);
        long j = 0;
        if (!bVar.c()) {
            j = a(i2, i3, bVar).getTimeInMillis();
        }
        u.d("**  setAlarm * idx " + i + " hour " + i2 + " minutes " + i3 + " enabled " + z + " time " + j);
        ...
        f.a(context).a(ContentUris.withAppendedId(a.a, i), contentValues, null, null);
        d(context);
    }
    ...
    private static void a(Context context, Alarm alarm, boolean z) {
        ...
        f.a(context).a(ContentUris.withAppendedId(a.a, alarm.a), contentValues, null, null);
    }
    ...
    private static void a(Context context, Alarm alarm, long j) {
        ...
        u.d("** setAlert id " + alarm.a + " atTime " + j);
    ...
    static Calendar a(int i, int i2, b bVar) {
        Calendar calendar = Calendar.getInstance();
