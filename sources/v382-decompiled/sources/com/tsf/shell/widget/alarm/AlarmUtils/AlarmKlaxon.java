...
public class AlarmKlaxon extends Service {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (alarm == null) {
            u.d("AlarmKlaxon failed to parse the alarm from the intent");
            stopSelf();
            return 2;
        }
        if (this.e != null) {
    ...
    private void b(Alarm alarm) {
        a();
        u.d("AlarmKlaxon.play() " + alarm.a + " alert " + alarm.i);
        if (!alarm.j) {
            Uri uri = alarm.i;
            if (uri == null) {
                uri = RingtoneManager.getDefaultUri(4);
                u.d("Using default alarm: " + uri.toString());
            }
            ...
            this.d.setOnErrorListener(new MediaPlayer.OnErrorListener() { // from class: com.tsf.shell.widget.alarm.AlarmUtils.AlarmKlaxon.3
                ...
                public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
                    u.c("Error occurred while playing audio.");
                    mediaPlayer.stop();
                    mediaPlayer.release();
            ...
            try {
                if (this.g.getCallState() != 0) {
                    u.d("Using the in-call alarm");
                    this.d.setVolume(0.125f, 0.125f);
                    a(getResources(), this.d, ae.in_call_alarm);
                } else {
                    this.d.setDataSource(this, uri);
                }
                a(this.d);
            } catch (Exception e) {
                u.d("Using the fallback ringtone");
                try {
                    this.d.reset();
                    a(getResources(), this.d, ae.fallbackring);
                    a(this.d);
                } catch (Exception e2) {
                    u.a("Failed to play fallback ringtone", new StringBuilder().append(e2).toString());
                }
            }
        }
        if (alarm.g) {
