...
class ai extends VTweenParam {
    ...
    public ai(VObject3d vObject3d, int i, int i2, Bitmap bitmap, int i3, int i4, int i5, int i6) {
        this.i = vObject3d;
        this.j = i3;
        this.d = i;
        this.e = i2;
    ...
    public void onComplete() {
        int i;
        u.c("onComplete id : " + this.d + "   max:" + this.e);
        if (this.d == this.e - 1 && this.h != null) {
            aj.a(this.j, this.h, 0, 0);
            this.h.recycle();
        }
        ...
        int i2 = this.d;
        i = ah.a;
        vTweenParam.setTimeout((i2 * i) + this.f);
