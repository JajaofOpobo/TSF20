...
public class x extends VObject3dContainer {
    public float a = 0.0f;
    public float b = 0.0f;
    public float c = 0.0f;
    public float d = 0.0f;
    ...
    public void a(float f, float f2) {
        ...
        invalidate();
        u.c("targetRad:" + this.j + "     radian:" + this.k);
    }

    public void a() {
        VTween.to(new VValueTweenTarget(), 500, new VTweenParam() { // from class: com.tsf.shell.widget.alarm.x.1
