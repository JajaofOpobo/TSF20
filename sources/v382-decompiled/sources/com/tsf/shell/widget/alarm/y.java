...
public class y extends VObject3dContainer {
    ...
    private void d() {
        ...
        Bitmap b = aj.b(AlarmWidget.h, "progress_bar");
        this.o = AlarmWidget.c.createTexture(b, true);
        b.recycle();
        a(this.o.id);
        ...
        ByteBuffer allocateDirect = ByteBuffer.allocateDirect(this.e.length * 3 * 4);
        allocateDirect.order(ByteOrder.nativeOrder());
        this.a = allocateDirect.asFloatBuffer();
        this.a.position(0);
        ByteBuffer allocateDirect2 = ByteBuffer.allocateDirect(this.e.length * 2 * 4);
        allocateDirect2.order(ByteOrder.nativeOrder());
        this.b = allocateDirect2.asFloatBuffer();
        this.b.position(0);
        ByteBuffer allocateDirect3 = ByteBuffer.allocateDirect(this.e.length * 4 * 4);
    ...
    public void a() {
        this.f = true;
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.widget.alarm.y.1
            float a;
            ...
            public void onUpdate(float f) {
                y.this.g = this.a * (1.0f - f);
            }

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                Bitmap b = aj.b(AlarmWidget.h, "progress_bar");
                aj.a(y.this.o.id, b, 0, 0);
                b.recycle();
                VTween.to(y.this, 1500, new VTweenParam() { // from class: com.tsf.shell.widget.alarm.y.1.1
                    @Override // com.censivn.C3DEngine.api.tween.VTweenParam
                    public void onComplete() {
                        y.this.f = false;
                    }
    ...
    public void b() {
        ...
        this.n = this.g % 89.2d;
        for (int i = 0; i < 1; i++) {
            double a = a((((int) this.m) * 89.2d) + 38.0d);
            double a2 = a(90.0d - this.n);
            double a3 = a(this.n / 2.0d);
            Math.sin(a3);
            Math.cos(a3);
