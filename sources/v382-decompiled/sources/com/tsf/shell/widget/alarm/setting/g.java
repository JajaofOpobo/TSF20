...
class g extends BaseAdapter {
    ...
    final /* synthetic */ PlaceSelectActivity b;

    public g(PlaceSelectActivity placeSelectActivity) {
        this.b = placeSelectActivity;
        a();
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (i == 0) {
            a(SettingActivity.a.getString(af.autosetmylocation), view);
            imageView.setImageResource(ab.activity_list_location_ico);
        } else {
            com.tsf.shell.widget.alarm.d.a aVar = (com.tsf.shell.widget.alarm.d.a) this.a.get(i - 1);
