...
public class a {
    public static com.tsf.shell.widget.alarm.d.c a(Context context) {
        try {
            ...
            return cVar;
        } catch (com.tsf.shell.widget.alarm.d.b.c e2) {
            e2.printStackTrace();
            return null;
        }
    }
    ...
    public static ArrayList a(String str) {
        ...
        u.c("getCityList request:" + str2);
        c cVar = new c();
        try {
            com.b.a.c.a(str2, cVar);
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        return cVar.a();
    ...
    public static void a(Context context, byte[] bArr) {
        try {
            com.b.a.a.a(context, "CacheV2", bArr);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static byte[] b(Context context) {
        try {
            return com.b.a.a.b(context, "CacheV2");
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
