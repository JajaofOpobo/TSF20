...
public class b extends e {
    ...
    public b(Context context, VTextureManager vTextureManager) {
        ...
        this.a = new f(this, 0, 0, c * ItemInfo.APP_VERSION_CODE, c * 64);
        this.b = new f(this, 0, c * 64, c * ItemInfo.APP_VERSION_CODE, c * 64);
    }
    ...
    public String e() {
        String string = this.i.getString(af.abbrev_wday_month_day_no_year);
