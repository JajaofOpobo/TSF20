...
public class v {
    public static String a(String str) {
        return String.valueOf(String.valueOf(String.valueOf(String.valueOf(String.valueOf(String.valueOf(String.valueOf(str) + "AndroidVersion:" + Build.VERSION.RELEASE + "\n") + "SDKVersion:" + Build.VERSION.SDK + "\n") + "DeviceModel:" + Build.MODEL + "\n") + "Product:" + Build.PRODUCT + "\n") + "Device:" + Build.DEVICE + "\n") + "Board:" + Build.BOARD + "\n") + "Rom:" + Build.DISPLAY + "\n";
    }
    ...
    public static String c(Context context, String str) {
        new DisplayMetrics();
        return String.valueOf(str) + "Density:" + context.getResources().getDisplayMetrics().density + "\n";
    }

    public static String b(String str) {
        try {
            BufferedReader bufferedReader = new BufferedReader(new FileReader("/proc/version"), ACRAConstants.DEFAULT_BUFFER_SIZE_IN_BYTES);
    ...
    public static String d(Context context, String str) {
        String str2;
        try {
            str2 = String.valueOf(str) + "AvailMemory:" + b(context) + "\n";
        } catch (Exception e) {
            str2 = str;
        }
        try {
            return String.valueOf(str2) + "TotalMemory:" + c(context) + "\n";
        } catch (Exception e2) {
            return str2;
        }
    }
