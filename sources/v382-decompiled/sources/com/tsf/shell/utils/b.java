...
public class b {
    ...
    public static ArrayList a(int i2) {
        com.tsf.shell.e.i.b.e.i ba;
        ArrayList arrayList = new ArrayList();
        Iterator it = b(i2).iterator();
        while (it.hasNext()) {
            com.tsf.shell.e.i.b.e.i a2 = com.tsf.shell.manager.a.w.a().a((ComponentName) it.next());
    ...
    private static boolean a(ComponentName componentName, ArrayList arrayList) {
