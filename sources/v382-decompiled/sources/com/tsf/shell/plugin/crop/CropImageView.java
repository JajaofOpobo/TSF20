...
public class CropImageView extends View {
    ...
    private void a() {
        this.f = new m();
        this.e = new f(getContext(), this.f);
    }
    ...
    public Bitmap getCropBitmap() {
        ...
        if (this.e.d != null) {
            ...
            e.a("maskShapeScale:" + f3 + "   sourceScale:" + f2 + "      maskScale:" + e);
        }
        canvas.save();
        canvas.scale(f2, f2);
        ...
        canvas2.save();
        if (this.e.d != null) {
            float e2 = f2 * this.e.e();
            paint2.setStrokeWidth(18.0f / e2);
            this.j.a(canvas2, e2, paint2, 10.0f);
        } else {
            Path path = new Path();
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getPointerCount() > 1) {
            this.g = g.NULL;
            e.a("pointerNum:" + motionEvent.getAction());
