...
public class f implements d {
    ...
    public void a(g gVar, float f, float f2) {
        if (gVar == g.TOP) {
            float d = d(f2);
            if (this.t) {
                if (c(this.c.g * ((this.c.d - d) / this.c.h))) {
                    this.a.f(d);
                    return;
                }
                return;
        ...
        if (gVar == g.LEFT) {
            float e = e(f);
            if (this.t) {
                if (b(this.c.h * ((this.c.c - e) / this.c.g))) {
                    this.a.e(e);
                    return;
                }
                return;
        ...
        if (gVar == g.BOTTOM) {
            float g = g(f2);
            if (this.t) {
                if (c(this.c.g * ((g - this.c.b) / this.c.h))) {
                    this.a.g(g);
                    return;
                }
                return;
    ...
    @Override // com.tsf.shell.plugin.crop.d
    public void a() {
        h();
    }
}
