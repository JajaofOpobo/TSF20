...
public class Animation implements Parcelable {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: com.tsf.shell.plugin.widget.Animation.1
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public Animation createFromParcel(Parcel parcel) {
            return new Animation(parcel, null);
        }
    ...
    /* synthetic */ Animation(Parcel parcel, Animation animation) {
        this(parcel);
    }
