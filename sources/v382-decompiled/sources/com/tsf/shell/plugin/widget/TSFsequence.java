...
public class TSFsequence implements Parcelable {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: com.tsf.shell.plugin.widget.TSFsequence.1
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public TSFsequence createFromParcel(Parcel parcel) {
            return new TSFsequence(parcel, null);
        }
    ...
    /* synthetic */ TSFsequence(Parcel parcel, TSFsequence tSFsequence) {
        this(parcel);
    }
