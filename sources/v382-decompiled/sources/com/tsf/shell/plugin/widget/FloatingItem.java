...
public class FloatingItem implements Parcelable {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: com.tsf.shell.plugin.widget.FloatingItem.1
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public FloatingItem createFromParcel(Parcel parcel) {
            return new FloatingItem(parcel, null);
        }
    ...
    /* synthetic */ FloatingItem(Parcel parcel, FloatingItem floatingItem) {
        this(parcel);
    }
