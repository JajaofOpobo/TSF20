...
public class e extends android.support.v4.app.p {
    ...
    public e(android.support.v4.app.k kVar, List list, Context context) {
        super(kVar);
        this.c = context;
    ...
    public Fragment a(int i) {
        ...
        bundle.putParcelable("resolveInfo", (Parcelable) this.a.get(i - 1));
        zVar.g(bundle);
        return zVar;
    }
    ...
    public CharSequence c(int i) {
        if (i == 0) {
            return this.c.getString(r.theme_picker_theme_picker_gallery_apps);
        }
        String str = "";
