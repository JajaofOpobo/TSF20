...
public class p extends q {
    ...
    private Bitmap b(int i) {
        com.tsf.shell.plugin.themepicker.g.a("ImageResizer", "processBitmap - " + i);
    ...
    public static Bitmap a(FileDescriptor fileDescriptor, int i, int i2, l lVar) {
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
    ...
    private static void a(BitmapFactory.Options options, l lVar) {
        ...
        if (lVar != null && (a = lVar.a(options)) != null) {
            options.inBitmap = a;
        }
    }
