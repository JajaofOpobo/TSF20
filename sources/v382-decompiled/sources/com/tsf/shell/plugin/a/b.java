        ...
        while (true) {
            ...
            if (b3 >= -5) {
                if (b3 < -1) {
                    ...
                    if (i6 == 0 || i6 == 1) {
                        throw new c("invalid padding byte '=' at byte offset " + i5);
                    }
                    if ((i6 == 3 && i8 > 2) || (i6 == 4 && i8 > 1)) {
                        throw new c("padding byte '=' falsely signals end of encoded value at offset " + i5);
                    }
                    if (b4 != 61 && b4 != 10) {
                ...
                throw new c("Bad Base64 input character at " + i5 + ": " + ((int) bArr[i5 + i]) + "(decimal)");
            }
        }
        if (i6 != 0) {
            if (i6 == 1) {
