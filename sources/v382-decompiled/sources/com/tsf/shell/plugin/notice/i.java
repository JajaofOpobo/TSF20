...
public class i {
    /* JADX WARN: Type inference failed for: r0v1, types: [com.tsf.shell.plugin.notice.i$1] */
    public static void a(final Context context, final j jVar, final boolean z) {
        if (c(context)) {
            new Thread() { // from class: com.tsf.shell.plugin.notice.i.1
