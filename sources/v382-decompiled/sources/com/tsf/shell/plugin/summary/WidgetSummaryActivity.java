...
public class WidgetSummaryActivity extends Activity implements MediaPlayer.OnPreparedListener, View.OnClickListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(e.activity_main_widget_summary);
        if (str != null) {
            ((TextView) findViewById(d.textView1)).setText(str);
        }
        if (Locale.getDefault().getLanguage().equals("zh")) {
            ((ImageView) findViewById(d.imageView3)).setImageResource(c.launcher_text_summary_cn);
        }
        this.b = (AbsoluteLayout) findViewById(d.AbsoluteLayout1);
        this.b.getViewTreeObserver().addOnGlobalLayoutListener(this);
        this.c = (VideoView) findViewById(d.videoView1);
        this.c.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/raw/preview_color_hd"));
        this.c.setOnPreparedListener(this);
        this.c.setZOrderOnTop(false);
        this.c.start();
        findViewById(d.imageView1).setOnClickListener(this);
        findViewById(d.imageView2).setOnClickListener(this);
        findViewById(d.imageView3).setOnClickListener(this);
        findViewById(d.imageView4).setOnClickListener(this);
        findViewById(d.imageView5).setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        ...
        if (id == d.imageView3) {
            b();
        } else if (id == d.imageView4) {
            b();
        } else if (id == d.imageView5) {
            a();
        }
    }
