...
public class SwipeyTabs extends ViewGroup implements bn {
    ...
    public SwipeyTabs(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f = obtainStyledAttributes.getColor(R.styleable.SwipeyTabs_bottomBarColor, this.f);
        this.d = obtainStyledAttributes.getDimensionPixelSize(R.styleable.SwipeyTabs_bottomBarHeight, 2);
        this.e = obtainStyledAttributes.getDimensionPixelSize(R.styleable.SwipeyTabs_tabIndicatorHeight, 3);
