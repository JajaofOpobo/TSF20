...
public class a {
    ...
    public static void a(m mVar, SQLiteDatabase sQLiteDatabase) {
        ...
        d(mVar, sQLiteDatabase);
        b(mVar, sQLiteDatabase);
        e(mVar, sQLiteDatabase);
    ...
    public static void b(m mVar, SQLiteDatabase sQLiteDatabase) {
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                d.a(launcherShortcut3DInfo, mVar, sQLiteDatabase);
    ...
    public static void c(m mVar, SQLiteDatabase sQLiteDatabase) {
        ArrayList b = b.b(4);
        ArrayList arrayList = new ArrayList();
    ...
    public static void d(m mVar, SQLiteDatabase sQLiteDatabase) {
        ArrayList b = b.b(6);
        ArrayList arrayList = new ArrayList();
        Iterator it = b.iterator();
        while (it.hasNext()) {
    ...
    public static void e(m mVar, SQLiteDatabase sQLiteDatabase) {
        float f;
        float f2;
        ArrayList arrayList = new ArrayList();
        ...
        com.tsf.shell.manager.o.a aVar = com.tsf.shell.manager.o.b.a;
        ...
        float f10 = (aVar.T * 4.0f) + ((4.0f - 1.0f) * f5);
        float f11 = (aVar.U * f8) + ((f8 - 1.0f) * f6);
        float f12 = (aVar.T * 4.0f) + ((4.0f - 1.0f) * f5);
        float f13 = (aVar.U * f9) + ((f9 - 1.0f) * f6);
        ...
        float f24 = (aVar.T / 2.0f) + ((-f2) / 2.0f) + ((f2 - f10) / 2.0f);
        float f25 = ((f21 - ((f14 / 2.0f) * f17)) - f16) - (aVar.U / 2.0f);
        float f26 = ((f2 / 2.0f) - (((f2 - f3) - f13) / 2.0f)) - (aVar.U / 2.0f);
        float f27 = f20 + (f15 * f18) + f16 + (aVar.T / 2.0f);
        float f28 = aVar.T + f5;
        float f29 = aVar.U + f6;
        int i = 0;
        while (true) {
            ...
            if (i2 < arrayList.size()) {
                ...
                d.a(a("cloud2", 0, (300.0f * com.censivn.C3DEngine.b.b.a.c) + 0.0f, (120.0f * com.censivn.C3DEngine.b.b.a.c) + f21, (300.0f * com.censivn.C3DEngine.b.b.a.c) + f22, (120.0f * com.censivn.C3DEngine.b.b.a.c) + f23, 0.8f, 0.9f), mVar, sQLiteDatabase);
                d.a(a("cloud4", 0, 0.0f - (200.0f * com.censivn.C3DEngine.b.b.a.c), f21 - (250.0f * com.censivn.C3DEngine.b.b.a.c), f22 - (200.0f * com.censivn.C3DEngine.b.b.a.c), f23 - (250.0f * com.censivn.C3DEngine.b.b.a.c), 1.3f, 1.8f), mVar, sQLiteDatabase);
                ...
                d.a(launcherWidget3DInfo, mVar, sQLiteDatabase);
                return;
            }
        }
    }
    ...
    public static LauncherShortcut3DInfo a(int i, int i2, int i3) {
        ...
        c b = com.tsf.shell.manager.action.b.b(i);
