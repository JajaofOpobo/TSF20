...
public class DefaultIconItem {
    ...
    public Bitmap getBitmap(a aVar) {
        ...
        if (this.bitmapReference == null || this.bitmapReference.get() == null || ((Bitmap) this.bitmapReference.get()).isRecycled()) {
            this.bitmapReference = new SoftReference(this.description.getBitmap(this, aVar));
        }
        return (Bitmap) this.bitmapReference.get();
    }

    public void recycle() {
        if (this.bitmapReference != null && this.bitmapReference.get() != null) {
            ((Bitmap) this.bitmapReference.get()).recycle();
        }
        this.style = null;
    }
}
