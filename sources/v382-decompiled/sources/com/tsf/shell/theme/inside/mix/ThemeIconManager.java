...
public class ThemeIconManager extends ThemeMixElementManager implements b {
    ...
    public Bitmap getPreviewBitmap(int i, int i2) {
        return r.d(getIconThemeIcon(), i, i2);
    }
    ...
    public Bitmap getDefaultIconBackBitmap(a aVar) {
        return this.mIconDescription.getBackBitmap(aVar);
    }

    public Bitmap getDefaultIconUponBitmap(a aVar) {
        return this.mIconDescription.getUponBitmap(aVar);
    }

    public Bitmap getDefaultIconMaskBitmap(a aVar) {
    ...
    public void startIconPackagePicker() {
        ...
        this.mPickerActivityResultId = Home.b().a(intent, (b) this);
    }

    @Override // com.censivn.C3DEngine.b.c.b
    public void onActivityResult(int i, int i2, Intent intent) {
        if (i2 == -1 && i == this.mPickerActivityResultId) {
            String stringExtra = intent.getStringExtra(ThemePickerActivity.t);
