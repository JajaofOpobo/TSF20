...
public class ThemeIconInfoLayout extends ThemeInfoLayout {
    ...
    public ThemeIconInfoLayout() {
        setTitle(R.string.text_icon);
        this.mPreviewPlane = new m(com.censivn.C3DEngine.b.b.a.a(500.0f), com.censivn.C3DEngine.b.b.a.a(500.0f), false);
        ...
        this.mUpdateBitmapRunnable = new Runnable() { // from class: com.tsf.shell.theme.inside.mix.menu.item.detail.ThemeIconInfoLayout.1
            ...
            public void run() {
                if (ThemeIconInfoLayout.this.mInfo != null) {
                    Bitmap iconPreviewBitmap = ThemeIconInfoLayout.this.mLoader.getIconPreviewBitmap(com.censivn.C3DEngine.a.d(), ThemeIconInfoLayout.this.mInfo.packagename, (int) com.censivn.C3DEngine.b.b.a.a(500.0f));
                    Bitmap iconPreviewBitmap2 = iconPreviewBitmap == null ? IconPreviewLoader.getIconPreviewBitmap(com.tsf.shell.manager.a.w.a().d(), (int) com.censivn.C3DEngine.b.b.a.a(500.0f)) : iconPreviewBitmap;
            ...
            public void run() {
                if (ThemeIconInfoLayout.this.mInfo != null) {
                    if (ThemeIconInfoLayout.this.bitmapReference != null && ThemeIconInfoLayout.this.bitmapReference.get() != null && !((Bitmap) ThemeIconInfoLayout.this.bitmapReference.get()).isRecycled()) {
                        ...
                        ThemeIconInfoLayout.this.mGetBitmapFailTimes++;
                        return;
                    }
                }
                if (ThemeIconInfoLayout.this.bitmapReference != null && ThemeIconInfoLayout.this.bitmapReference.get() != null) {
