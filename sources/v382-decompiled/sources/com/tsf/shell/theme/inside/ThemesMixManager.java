...
import com.tsf.shell.manager.b.h;
...
public class ThemesMixManager {
    ...
    private ArrayList managerLists;
    ...
    public static String getTypeTitle(Context context, int i) {
        ...
        switch (i) {
            case 2:
                i2 = R.string.text_icon_theme;
                break;
            case 4:
                i2 = R.string.text_clock;
                break;
            case 8:
                i2 = R.string.widget_folder;
                break;
            case 16:
                i2 = R.string.widget_contact;
                break;
            case 33:
                i2 = R.string.theme_element_other;
                break;
            case ThemeElementType.TYPE_DESKTOP /* 257 */:
                i2 = R.string.mn_screen;
                break;
            case ThemeElementType.TYPE_DESKTOP_EFFECT /* 513 */:
                i2 = R.string.text_desktop_effect;
                break;
            case ThemeElementType.TYPE_SMART_BUTTON /* 1025 */:
                i2 = R.string.text_smart_button;
                break;
            case ThemeElementType.TYPE_ICON_MENU /* 2049 */:
                i2 = R.string.theme_element_icon_menu;
                break;
            case ThemeElementType.TYPE_WIDGET_RESIZE /* 4097 */:
                i2 = R.string.theme_element_resize;
                break;
            case ThemeElementType.TYPE_LASSO /* 8193 */:
                i2 = R.string.mn_action_lasso_mode;
                break;
            case ThemeElementType.TYPE_ARRANGE /* 16385 */:
                i2 = R.string.pop_menu_arrangement;
                break;
            case ThemeElementType.TYPE_UNREAD_COUNT /* 32769 */:
                i2 = R.string.mn_unread_count;
                break;
            case ThemeElementType.TYPE_APP_MUTIL_CHOICE /* 131073 */:
                i2 = R.string.menu_multiple_choice;
                break;
            case ThemeElementType.TYPE_ACTION /* 524289 */:
                i2 = R.string.mn_action_app_drawer;
                break;
        }
        if (i2 != 0) {
    ...
    public ThemesMixManager(ThemeManager themeManager) {
        ...
        if (h.d()) {
            h.b(false);
            Iterator it = this.managerLists.iterator();
            while (it.hasNext()) {
                ThemeMixElementManager themeMixElementManager = (ThemeMixElementManager) it.next();
                resetTheme(themeMixElementManager.getType(), themeMixElementManager.getThemePackageName());
            }
        ...
        ThemeManager.getInstance().addListener(new ThemeManager.ThemeListener() { // from class: com.tsf.shell.theme.inside.ThemesMixManager.1
            ...
            public void onThemeUpdate(String str) {
                ...
                while (it2.hasNext()) {
                    ThemeMixElementManager themeMixElementManager2 = (ThemeMixElementManager) it2.next();
                    if (themeMixElementManager2.themeUpdate(str)) {
                        Context context = null;
                        try {
                            context = a.d().createPackageContext(themeMixElementManager2.getThemePackageName(), 3);
                        } catch (PackageManager.NameNotFoundException e) {
                        }
                        if (context != null) {
                            ThemeElementCacher.cacheThemeImage(context, themeMixElementManager2.getType());
                            ThemeElementCacher.cacheThemeXml(context, themeMixElementManager2.getType());
                            arrayList.add(themeMixElementManager2);
                        }
                    }
                }
    ...
    public ArrayList getThemeMixElementManagerLists() {
    ...
    public void showLoading() {
        a.a().a(new Runnable() { // from class: com.tsf.shell.theme.inside.ThemesMixManager.2
            ...
            public void run() {
                com.tsf.shell.e.a.a(x.c(R.string.tsf_loading_content));
            }
        });
    }
