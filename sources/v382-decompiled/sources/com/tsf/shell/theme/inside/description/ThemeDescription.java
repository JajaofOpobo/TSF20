...
public class ThemeDescription {
    ...
    public static Bitmap getPreviewBitmap(Context context, String str, boolean z) {
        ...
        Bitmap bitmap = null;
        if (z) {
            return ThemeCacheFileManager.getImageBitmap(String.valueOf(str) + ".png");
        }
    ...
    public Bitmap getBitmapFromCache(String str, int i, int i2) {
        Bitmap d;
        if (i == 0 || i2 == 0 || (d = r.d(ThemeCacheFileManager.getImageBitmap(String.valueOf(str) + ".png"), i, i2)) == null) {
            return null;
        }
    ...
    public Bitmap getBitmap(String str, int i, int i2) {
        return r.d(getBitmap(str), i, i2);
    }

    public Bitmap getBitmap(String str) {
        Bitmap imageBitmap = ThemeCacheFileManager.getImageBitmap(String.valueOf(str) + ".png");
        if (imageBitmap == null) {
