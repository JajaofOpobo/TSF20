...
public class ThemeUnreadCountManager extends ThemeMixElementManager {
    ...
    public static Bitmap createPreviewBitmap(Context context, Context context2, int i, int i2, boolean z) {
        return r.d(createPreviewBitmap(context, context2, z), i, i2);
    }
    ...
    public static Bitmap createPreviewBitmap(Bitmap bitmap) {
        ...
        try {
            ...
            int random = (int) (10.0d + (Math.random() * 200.0d));
            com.tsf.shell.manager.o.a.a aVar = new com.tsf.shell.manager.o.a.a();
            aVar.h(36);
            aVar.i(-1);
            Bitmap b = aVar.b(Integer.toString(random));
            int width = b.getWidth();
            Bitmap e = ((float) width) + (com.censivn.C3DEngine.b.b.a.b * 28.0f) > ((float) createScaledBitmap.getWidth()) ? r.e(createScaledBitmap, createScaledBitmap.getWidth() / 2, width + ((int) (com.censivn.C3DEngine.b.b.a.b * 28.0f))) : createScaledBitmap;
