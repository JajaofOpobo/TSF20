...
public class ThemeConfigManager {
    ...
    public static void saveThemeMixConfig(String str, String str2, String str3, int i) {
        SharedPreferences.Editor configSharedPreferencesEditor = getConfigSharedPreferencesEditor();
        configSharedPreferencesEditor.putString(String.valueOf(str) + "_name", str2);
        configSharedPreferencesEditor.putString(String.valueOf(str) + "_packagename", str3);
        configSharedPreferencesEditor.putInt(String.valueOf(str) + "_version", i);
        configSharedPreferencesEditor.commit();
    }

    public static ElementConfig getThemeMixConfig(String str) {
        config.name = getConfigSharedPreferences().getString(String.valueOf(str) + "_name", x.c(R.string.app_name));
        config.packagename = getConfigSharedPreferences().getString(String.valueOf(str) + "_packagename", "");
        config.version = getConfigSharedPreferences().getInt(String.valueOf(str) + "_version", 0);
        return config;
    }
