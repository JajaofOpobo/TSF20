...
public class b {
    ...
    public static char a(String str) {
        if (str != null && str.length() > 0) {
            ...
            if (!d(upperCase)) {
                ...
                if (h.containsKey(of)) {
                    return ((Character) h.get(of)).charValue();
                }
                if (i.containsKey(Character.valueOf(upperCase))) {
                    return ((Character) i.get(Character.valueOf(upperCase))).charValue();
                }
    ...
    public static ArrayList a(ArrayList arrayList) {
        ...
        Collections.sort(dVar, new Comparator() { // from class: com.tsf.shell.e.f.a.a.b.1
    ...
    public static String a(c cVar) {
        return Character.toString(a(cVar.p_()));
    }
    ...
    public static int a(ArrayList arrayList, com.tsf.shell.e.f.a.a.a.b bVar) {
        final Collator collator = Collator.getInstance(Locale.getDefault());
        arrayList.add(bVar);
        Collections.sort(arrayList, new Comparator() { // from class: com.tsf.shell.e.f.a.a.b.2
            @Override // java.util.Comparator
            /* renamed from: a, reason: merged with bridge method [inline-methods] */
            public int compare(com.tsf.shell.e.f.a.a.a.c cVar, com.tsf.shell.e.f.a.a.a.c cVar2) {
                if ((cVar instanceof com.tsf.shell.e.f.a.a.a.b) && (cVar2 instanceof com.tsf.shell.e.f.a.a.a.b)) {
                    return collator.compare(((com.tsf.shell.e.f.a.a.a.b) cVar).g(), ((com.tsf.shell.e.f.a.a.a.b) cVar2).g());
                }
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            if (((com.tsf.shell.e.f.a.a.a.c) arrayList.get(i2)) == bVar) {
                return i2;
            }
        }
        return 0;
