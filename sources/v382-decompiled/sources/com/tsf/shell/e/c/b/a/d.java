...
public class d implements a {
    ...
    public d(e eVar, com.tsf.shell.manager.o.a aVar) {
        this.j = eVar;
        this.k = aVar;
        this.b = aVar.H;
        this.c = aVar.H / 2.0f;
    ...
    @Override // com.tsf.shell.e.c.b.a.a
    public void a(j jVar) {
        jVar.setAABBPX((-this.d) / 2.0f, -com.censivn.C3DEngine.b.b.a.g, 0.0f, this.d / 2.0f, com.censivn.C3DEngine.b.b.a.h + (com.censivn.C3DEngine.b.b.a.g / 2.0f), 0.0f);
    }
    ...
    public void a(ArrayList arrayList, int i) {
        ...
        float f4 = com.tsf.shell.e.i.b.d.b.l.c().folder.nameTextFormat.auto ? -this.k.Y : (-(com.tsf.shell.e.i.b.d.b.m.f + com.tsf.shell.e.i.b.d.b.m.h)) / 2.0f;
        float f5 = -this.k.Y;
        if (f3 == 0.93f) {
            float f6 = f / i;
            float f7 = f6 / 2.0f;
            ...
            for (int i2 = 0; i2 < i; i2++) {
                com.tsf.shell.e.c.b.b bVar = (com.tsf.shell.e.c.b.b) arrayList.get(i2);
                bVar.c = f8;
                bVar.a = f8;
                bVar.b = f5;
                bVar.d = f4;
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            ...
            for (int i6 = 0; i6 < i; i6++) {
                int i7 = (this.i * i5) + i6;
                if (i7 <= i - 1) {
                    com.tsf.shell.e.c.b.b bVar2 = (com.tsf.shell.e.c.b.b) arrayList.get(i7);
    ...
    @Override // com.tsf.shell.e.c.b.a.a
    public c a(Number3d number3d, ArrayList arrayList, int i) {
        c cVar = c.c;
        float f = number3d.x;
        int size = arrayList.size();
        if (i == -1) {
            for (int i2 = 0; i2 < size; i2++) {
                if (f < ((com.tsf.shell.e.c.b.b) arrayList.get(i2)).a) {
                    cVar.a = i2;
                    a(number3d, arrayList, cVar);
                    return cVar;
                }
            }
            cVar.a = size;
        ...
        for (int i3 = 0; i3 < size; i3++) {
            com.tsf.shell.e.c.b.b bVar = (com.tsf.shell.e.c.b.b) arrayList.get(i3);
            if (i != i3 && f <= bVar.a) {
                if (i3 > i) {
                    cVar.a = i3 - 1;
                    a(number3d, arrayList, cVar);
    ...
    private void a(Number3d number3d, ArrayList arrayList, c cVar) {
        int size = arrayList.size();
        float f = number3d.x;
        cVar.b = 0;
        for (int i = 0; i < size; i++) {
            com.tsf.shell.e.c.b.b bVar = (com.tsf.shell.e.c.b.b) arrayList.get(i);
            if (f >= bVar.h && f <= bVar.g) {
                cVar.b = i;
            }
        }
    }
