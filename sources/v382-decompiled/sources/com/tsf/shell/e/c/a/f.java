...
public class f implements k {
    ...
    public static com.tsf.shell.e.c.a.a.a h;
    public static com.tsf.shell.e.c.a.a.a i;
    public static com.tsf.shell.e.c.a.a.a j;
    public static com.tsf.shell.e.c.a.a.a k;
    public static com.tsf.shell.e.c.a.a.a l;
    public static com.tsf.shell.e.c.a.a.a m;
    ...
    private l D;
    private l E;
    private com.tsf.shell.e.h.e F;
    private com.tsf.shell.e.h.e G;
    private x K;
    private x L;
    private m M;
    private h N;
    ...
    private x am;
    private x an;
    public com.tsf.shell.e.c.a.a.a n;
    public Runnable r;
    private l s;
    private l t;
    private float w;
    ...
    public static String b() {
        Cursor query = com.censivn.C3DEngine.a.d().getContentResolver().query(com.tsf.shell.x.a, null, null, null, null);
        String str = "";
    ...
    public f(boolean z) {
        ...
        if (z) {
            ...
            this.af = com.tsf.shell.manager.b.g.e();
        }
        h = new com.tsf.shell.e.c.a.a.g();
        i = new com.tsf.shell.e.c.a.a.i();
        j = new com.tsf.shell.e.c.a.a.f();
        k = new com.tsf.shell.e.c.a.a.h();
        l = new com.tsf.shell.e.c.a.a.c();
        m = new com.tsf.shell.e.c.a.a.d();
    ...
    public void a(ArrayList arrayList, String str) {
        Iterator it = com.tsf.shell.utils.h.a(arrayList, str, ",", false).iterator();
        while (it.hasNext()) {
            a((ItemInfo) it.next());
        }
    ...
    public void a(int i2, boolean z) {
        if (this.aa != i2) {
            ...
            this.P.alpha(a2);
            if (z) {
                com.tsf.shell.manager.b.g.a(i2);
            }
        }
    }
    ...
    public void a(l lVar, g gVar) {
        ...
        this.ag.l(1.0f);
        this.ag.m(1.0f);
        this.ah = new x() { // from class: com.tsf.shell.e.c.a.f.1
        ...
        this.t = new l() { // from class: com.tsf.shell.e.c.a.f.9
                    ...
                    if (Math.abs(f.this.O - f.this.w) < 0.2f) {
                        ...
                        if (!f.this.Y) {
                            if (com.censivn.C3DEngine.b.b.a.O) {
                                com.tsf.shell.manager.b.g.a(f.this.O);
                            } else {
                                com.tsf.shell.manager.b.g.b(f.this.O);
                            }
                        }
                    }
                }
        ...
        B();
        this.E = new l();
        this.F = new com.tsf.shell.e.h.e();
        this.F.b(0.0f);
        this.E.addChild(this.F);
        this.G = new com.tsf.shell.e.h.e();
        this.G.b(0.0f);
        this.E.addChild(this.G);
        this.R = new a(this.C, this);
        this.C.setMouseEventListener(this.R);
        this.P = new m(this.I.width, this.I.height, false);
        ...
        this.Q = new m(this.I.width, this.I.height, false);
        this.Q.textures().addElement(this.I);
        this.C.addChild(this.Q);
        this.C.calAABB(3.0f, 3.0f, 1.0f);
        this.P.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this.P) { // from class: com.tsf.shell.e.c.a.f.10
            private float b;
        ...
        this.M = new m(0.0f, this.J.height * com.censivn.C3DEngine.b.b.a.b);
        this.M.textures().addElement(this.J);
        this.M.alpha(0.0f);
        this.K = new x();
        this.K.a(255);
        this.L = new x() { // from class: com.tsf.shell.e.c.a.f.11
            @Override // com.censivn.C3DEngine.b.g.x
            public void a() {
        ...
        this.N = new h(this.H.width, this.H.height, new i(this.H.width / 2, this.H.height / 2, this.H.height)) { // from class: com.tsf.shell.e.c.a.f.12
            @Override // com.censivn.C3DEngine.b.f.j
            public j getHittingTarget(float f10, float f11, boolean z2) {
        ...
        this.N.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this.N) { // from class: com.tsf.shell.e.c.a.f.13
            boolean a = true;
            boolean b = true;
            j d;
        ...
        a(0.0f, true);
        float c2 = com.censivn.C3DEngine.b.b.a.O ? com.tsf.shell.manager.b.g.c() : com.tsf.shell.manager.b.g.d();
        if (!this.Y) {
            boolean z2 = com.tsf.shell.manager.b.g.c() == 0.0f && com.tsf.shell.manager.b.g.d() == 0.0f;
            if (c2 == 0.0f) {
                f6 = (int) (com.tsf.shell.manager.o.b.a.H * 6 * 0.95f);
                f5 = (-f6) / 2.0f;
                f7 = com.censivn.C3DEngine.b.b.a.C;
            } else {
                Number3d f10 = com.censivn.C3DEngine.b.b.a.O ? com.tsf.shell.manager.b.g.f() : com.tsf.shell.manager.b.g.g();
                float f11 = f10.x;
                float f12 = f10.y;
                f5 = f11;
                f6 = c2;
        ...
        if (!this.Y && z) {
            if (com.censivn.C3DEngine.b.b.a.O) {
                com.tsf.shell.manager.b.g.a(this.O);
                com.tsf.shell.manager.b.g.a(this.u, this.v);
            } else {
                com.tsf.shell.manager.b.g.b(this.O);
                com.tsf.shell.manager.b.g.b(this.u, this.v);
            }
        }
        a(com.tsf.shell.manager.b.g.b(), false);
        com.tsf.shell.manager.a.h.c().a(new y() { // from class: com.tsf.shell.e.c.a.f.14
            @Override // com.tsf.shell.e.f.y
            public void a(com.tsf.shell.e.f.g gVar2) {
                if (gVar2.t() == -1) {
                    if (f.this.ad) {
                        f.this.v();
                    }
    ...
    public void j() {
        com.tsf.shell.e.c.a.a.b a2 = this.n.a(this.t, this.G.a, 8.0f, 4.0f, 24.0f);
        if (a2 != null) {
    ...
    public void k() {
        com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.e.c.a.f.15
    ...
    public void l() {
        if (this.r == null) {
            this.r = new Runnable() { // from class: com.tsf.shell.e.c.a.f.16
                @Override // java.lang.Runnable
                public void run() {
                    f.this.G.b(0.0f);
                    f.this.F.b(0.0f);
    ...
    public void m() {
        if (!this.ab) {
            this.ab = true;
            com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.e.c.a.f.2
                @Override // java.lang.Runnable
                public void run() {
                    ...
                    com.censivn.C3DEngine.b.g.w.a(f.this.M);
                    com.censivn.C3DEngine.b.g.w.a(f.this.M, VEasing.Linear.easeNone, f.this.K);
                }
            });
        }
    }
    ...
    public void n() {
        if (this.ab) {
            this.ab = false;
            com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.e.c.a.f.3
                @Override // java.lang.Runnable
                public void run() {
                    com.censivn.C3DEngine.b.g.w.a(f.this.M);
                    com.censivn.C3DEngine.b.g.w.a(f.this.M, VEasing.Linear.easeNone, f.this.L);
                }
            });
        }
    }
    ...
    private void a(com.tsf.shell.e.c.a.a.a aVar) {
        this.n = aVar;
        this.S.e();
    }

    private void b(com.tsf.shell.e.c.a.a.a aVar) {
        if (aVar != this.n) {
            this.n = aVar;
            this.S.e();
        }
    ...
    private void c(boolean z) {
        ...
        } else if (this.n instanceof com.tsf.shell.e.c.a.a.e) {
            this.v = com.censivn.C3DEngine.b.b.a.C + a;
            F();
        } else {
            if (abs > abs2) {
        ...
        if (z && !this.Y) {
            if (this.n instanceof com.tsf.shell.e.c.a.a.e) {
                com.tsf.shell.manager.b.g.a(this.u, this.v);
            } else {
                com.tsf.shell.manager.b.g.b(this.u, this.v);
            }
        ...
        if (!this.Y) {
            ...
            if (this.v > 0.0f) {
                if (z) {
                    ...
                    com.censivn.C3DEngine.b.g.w.a(this.N, 300, xVar);
                } else {
            ...
            if (z) {
                ...
                xVar2.e(90.0f);
                com.censivn.C3DEngine.b.g.w.a(this.N);
                com.censivn.C3DEngine.b.g.w.a(this.N, 300, xVar2);
            } else {
                this.N.rotation().z = 90.0f;
            }
            this.D.rotation().z = -90.0f;
    ...
    private void G() {
        if (!this.Y) {
            com.censivn.C3DEngine.a.a().d(new Runnable() { // from class: com.tsf.shell.e.c.a.f.4
                @Override // java.lang.Runnable
                public void run() {
                    com.tsf.shell.manager.b.g.a(f.this.af);
                }
            });
        }
    }
    ...
    public void v() {
        if (this.ad) {
            ...
            x xVar = new x() { // from class: com.tsf.shell.e.c.a.f.5
                @Override // com.censivn.C3DEngine.b.g.x
                public void a(float f2) {
                    f.this.a(a2 * (1.0f - f2), true);
                }
            };
            com.censivn.C3DEngine.b.g.w.a(this.ae);
            com.censivn.C3DEngine.b.g.w.a(this.ae, 600, xVar);
            H();
        }
    }
    ...
    private void d(boolean z) {
        this.P.visible(true);
        if (z) {
            com.censivn.C3DEngine.b.g.w.a(this.P);
            com.censivn.C3DEngine.b.g.w.a(this.P, 600, this.ag);
        } else {
    ...
    private void H() {
        com.censivn.C3DEngine.b.g.w.a(this.P);
        com.censivn.C3DEngine.b.g.w.a(this.P, 600, this.ah);
    }
    ...
    public void a(final Runnable runnable, boolean z) {
        if (!this.ad) {
            ...
            if (z) {
                x xVar = new x() { // from class: com.tsf.shell.e.c.a.f.6
                    @Override // com.censivn.C3DEngine.b.g.x
                ...
                com.censivn.C3DEngine.b.g.w.a(this.ae);
                com.censivn.C3DEngine.b.g.w.a(this.ae, 500, xVar);
            } else {
                a(a2, z2);
                if (runnable != null) {
                    runnable.run();
    ...
    public void b(boolean z) {
        if (!this.al) {
            ...
            if (z) {
                if (this.an == null) {
                    this.an = new x() { // from class: com.tsf.shell.e.c.a.f.7
                        @Override // com.censivn.C3DEngine.b.g.x
                        public void a() {
                ...
                this.an.f(a2.x);
                this.an.h(a2.y);
                com.censivn.C3DEngine.b.g.w.a(this.t);
                com.censivn.C3DEngine.b.g.w.a(this.t, 600, this.an);
                return;
            }
    ...
    public void z() {
        if (this.al && this.Z) {
            ...
            if (this.am == null) {
                this.am = new x() { // from class: com.tsf.shell.e.c.a.f.8
                    @Override // com.censivn.C3DEngine.b.g.x
                    public void a() {
            ...
            this.am.h(b2.y);
            com.censivn.C3DEngine.b.g.w.a(this.t);
            com.censivn.C3DEngine.b.g.w.a(this.t, 600, this.am);
        }
    }
    ...
    public void a(int i2, int i3, int i4, int i5) {
        ...
        float f3;
        boolean z = false;
        if (((this.n instanceof com.tsf.shell.e.c.a.a.e) && com.censivn.C3DEngine.b.b.a.O) || ((this.n instanceof com.tsf.shell.e.c.a.a.j) && !com.censivn.C3DEngine.b.b.a.O)) {
            z = true;
        }
        Number3d f4 = com.censivn.C3DEngine.b.b.a.O ? com.tsf.shell.manager.b.g.f() : com.tsf.shell.manager.b.g.g();
