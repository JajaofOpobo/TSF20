...
public class d extends e {
    ...
    public int a(ArrayList arrayList, ArrayList arrayList2, int i, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        if (b == 0) {
            ...
            if (a.a == -1 || a.a == -2) {
                ...
                float f8 = (f4 * f7) / 2.0f;
                if (a.b > 0.0f) {
                    minX = ((a.d + (a.c / 2.0f)) - (jVar.maxX() * f7)) - f8;
                } else {
                    minX = ((a.d - (a.c / 2.0f)) - (jVar.minX() * f7)) + f8;
                }
                dVar.a = ((minX - a.d) * abs) + a.d;
                dVar.d = f7;
                dVar.f = (dVar.a + (jVar.minX() * f7)) - f8;
                dVar.e = dVar.a + (jVar.maxX() * f7) + f8;
                dVar.c = 0.0f;
                dVar.i = 255.0f;
                a(dVar, jVar, f7, true);
                dVar.h = false;
                    ...
                    if (i2 > 1) {
                        ...
                        while (true) {
                            ...
                            if (f11 - 0.4f < this.e && i3 > 0) {
                                float maxX = (((dVar3.f - (jVar2.maxX() * this.e)) - ((this.e * f4) / 2.0f)) + (jVar2.minX() * this.e)) - ((this.e * f4) / 2.0f);
                                com.tsf.shell.e.c.a.d dVar5 = (com.tsf.shell.e.c.a.d) arrayList.get(i3 - 1);
                                if (maxX > dVar5.e) {
                                    a(dVar3, dVar4, jVar2, (dVar3.f - dVar5.e) / ((jVar2.maxX() - jVar2.minX()) + f4), f4);
                                    a(dVar4, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
                    ...
                    if (i2 < i - 2) {
                        ...
                        while (true) {
                            ...
                            if (f14 - 0.4f < this.e && i5 < i - 1) {
                                float minX2 = ((this.e * f4) / 2.0f) + (dVar7.e - (jVar3.minX() * this.e)) + ((this.e * f4) / 2.0f) + (jVar3.maxX() * this.e);
                                com.tsf.shell.e.c.a.d dVar8 = (com.tsf.shell.e.c.a.d) arrayList.get(i5 + 1);
                                if (minX2 < dVar8.f) {
                                    b(dVar7, dVar6, jVar3, (dVar8.f - dVar7.e) / ((jVar3.maxX() - jVar3.minX()) + f4), f4);
                                    a(dVar6, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
    ...
    private void a(com.tsf.shell.e.c.a.d dVar, com.tsf.shell.e.c.a.d dVar2, com.censivn.C3DEngine.b.f.j jVar, float f, float f2) {
        ...
        dVar2.d = f;
        float f3 = (f2 * f) / 2.0f;
        dVar2.a = (dVar.f - (jVar.maxX() * f)) - f3;
        dVar2.f = (dVar2.a + (jVar.minX() * f)) - f3;
        dVar2.e = f3 + dVar2.a + (jVar.maxX() * f);
        dVar2.c = 0.0f;
        a(dVar2, jVar, f, true);
        dVar2.h = false;
    }
    ...
    public void a(ArrayList arrayList, ArrayList arrayList2, int i, float f, float f2, float f3, float f4) {
        ...
        if (f7 == 1.0f) {
            ...
            while (i2 < i) {
                com.censivn.C3DEngine.b.f.j jVar = (com.censivn.C3DEngine.b.f.j) arrayList2.get(i2);
                com.tsf.shell.e.c.a.d dVar = (com.tsf.shell.e.c.a.d) arrayList.get(i2);
                dVar.a = f11 - jVar.minX();
                dVar.f = (dVar.a + jVar.minX()) - f9;
                dVar.e = dVar.a + jVar.maxX() + f9;
                dVar.c = 0.0f;
                dVar.i = 255.0f;
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            dVar2.a = f2 - (jVar2.minX() * f7);
            dVar2.f = (dVar2.a + (jVar2.minX() * f7)) - f9;
            dVar2.e = dVar2.a + (jVar2.maxX() * f7) + f9;
            dVar2.c = 0.0f;
            dVar2.i = 255.0f;
    ...
    public void a(com.censivn.C3DEngine.b.f.j jVar, float f, float f2, float f3) {
        jVar.setAABBPX(0.0f + f, -2.1474836E9f, 0.0f, f3 - f2, com.censivn.C3DEngine.b.b.a.b * 83.0f, 0.0f);
    }
    ...
    public b a(com.censivn.C3DEngine.b.f.j jVar, float f, float f2, float f3, float f4) {
        float asin;
        b bVar = a.b;
        if (((-com.censivn.C3DEngine.b.b.a.z) - com.tsf.shell.e.c.a.f.a) + jVar.position().x > f) {
            asin = 180.0f;
        } else {
        ...
        bVar.d = ((f4 / 2.0f) - 90.0f) - f2;
        bVar.e = ((f4 - f2) - 90.0f) + (bVar.b / 2.0f) + f3;
        return bVar;
    }
