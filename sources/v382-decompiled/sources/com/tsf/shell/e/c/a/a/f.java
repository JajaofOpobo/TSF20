...
public class f extends j {
    ...
    public int a(ArrayList arrayList, ArrayList arrayList2, int i, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        if (b == 0) {
            ...
            if (a.a == -1 || a.a == -2) {
                ...
                float f8 = (f4 * f7) / 2.0f;
                if (a.b > 0.0f) {
                    maxY = (((-a.d) - (a.c / 2.0f)) - (jVar.minY() * f7)) + f8;
                } else {
                    maxY = (((-a.d) + (a.c / 2.0f)) - (jVar.maxY() * f7)) - f8;
                }
                dVar.b = ((maxY + a.d) * abs) + (-a.d);
                dVar.d = f7;
                dVar.f = dVar.b + (jVar.maxY() * f7) + f8;
                dVar.e = (dVar.b + (jVar.minY() * f7)) - f8;
                dVar.c = 0.0f;
                dVar.i = 255.0f;
                a(dVar, jVar, f7, true);
                dVar.h = false;
                    ...
                    if (i2 > 1) {
                        ...
                        while (true) {
                            ...
                            if (f11 - 0.4f < this.e && i3 > 0) {
                                float minY = ((this.e * f4) / 2.0f) + (dVar3.f - (jVar2.minY() * this.e)) + ((this.e * f4) / 2.0f) + (jVar2.maxY() * this.e);
                                com.tsf.shell.e.c.a.d dVar5 = (com.tsf.shell.e.c.a.d) arrayList.get(i3 - 1);
                                if (minY < dVar5.e) {
                                    a(dVar3, dVar4, jVar2, (dVar5.e - dVar3.f) / ((jVar2.maxY() - jVar2.minY()) + f4), f4);
                                    a(dVar4, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
                    ...
                    if (i2 < i - 2) {
                        ...
                        while (true) {
                            ...
                            if (f14 - 0.4f < this.e && i5 < i - 1) {
                                float maxY2 = (((dVar7.e - (jVar3.maxY() * this.e)) - ((this.e * f4) / 2.0f)) + (jVar3.minY() * this.e)) - ((this.e * f4) / 2.0f);
                                com.tsf.shell.e.c.a.d dVar8 = (com.tsf.shell.e.c.a.d) arrayList.get(i5 + 1);
                                if (maxY2 > dVar8.f) {
                                    b(dVar7, dVar6, jVar3, (dVar7.e - dVar8.f) / ((jVar3.maxY() - jVar3.minY()) + f4), f4);
                                    a(dVar6, f2, f3, 0.0f, f);
                                    break;
                                }
                            }
    ...
    private void a(com.tsf.shell.e.c.a.d dVar, com.tsf.shell.e.c.a.d dVar2, com.censivn.C3DEngine.b.f.j jVar, float f, float f2) {
        ...
        dVar2.d = f;
        float f3 = (f2 * f) / 2.0f;
        dVar2.b = (dVar.f - (jVar.minY() * f)) + f3;
        dVar2.f = dVar2.b + (jVar.maxY() * f) + f3;
        dVar2.e = (dVar2.b + (jVar.minY() * f)) - f3;
        dVar2.c = 0.0f;
        a(dVar2, jVar, f, true);
        dVar2.h = false;
    }
    ...
    public void a(ArrayList arrayList, ArrayList arrayList2, int i, float f, float f2, float f3, float f4) {
        ...
        if (f7 == 1.0f) {
            ...
            while (i2 < i) {
                com.censivn.C3DEngine.b.f.j jVar = (com.censivn.C3DEngine.b.f.j) arrayList2.get(i2);
                com.tsf.shell.e.c.a.d dVar = (com.tsf.shell.e.c.a.d) arrayList.get(i2);
                dVar.b = f11 - jVar.maxY();
                dVar.f = dVar.b + jVar.maxY() + f9;
                dVar.e = (dVar.b + jVar.minY()) - f9;
                dVar.c = 0.0f;
                dVar.i = 255.0f;
        ...
        while (i3 < i) {
            ...
            dVar2.b = f12 - (jVar2.maxY() * f7);
            dVar2.f = dVar2.b + (jVar2.maxY() * f7) + f9;
            dVar2.e = (dVar2.b + (jVar2.minY() * f7)) - f9;
            dVar2.c = 0.0f;
            dVar2.i = 255.0f;
    ...
    public void a(com.censivn.C3DEngine.b.f.j jVar, float f, float f2, float f3) {
        jVar.setAABBPX(-2.1474836E9f, (-f3) + f2, 0.0f, com.censivn.C3DEngine.b.b.a.b * 83.0f, 0.0f - f, 0.0f);
    }
    ...
    public boolean a(Number3d number3d, com.censivn.C3DEngine.b.f.j jVar, boolean z) {
        return number3d.y < jVar.position().y ? !z : z;
    }
    ...
    public b a(com.censivn.C3DEngine.b.f.j jVar, float f, float f2, float f3, float f4) {
        ...
        bVar.d = ((f4 / 2.0f) - 180.0f) - f2;
        bVar.e = ((f4 - f2) - 180.0f) + (bVar.b / 2.0f) + f3;
        return bVar;
    }
