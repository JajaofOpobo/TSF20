...
import com.tsf.shell.e.i.c.a.r;
...
public class l {
    public static Bitmap a(Context context, Date date) {
        Bitmap b = r.b(context, R.drawable.widget_preview_calendar_content);
        ...
        canvas.drawText(String.valueOf(months[gregorianCalendar.get(2)]) + "-" + gregorianCalendar.get(1), 270.0f + 2.0f, 44.0f + 2.0f, paint);
        paint.setTextSize(18.0f);
        paint.setColor(-1426063361);
        gregorianCalendar.add(2, -1);
        String str = "● " + months[gregorianCalendar.get(2)];
        paint.setTextAlign(Paint.Align.LEFT);
        canvas.drawText(str, 12.0f + 2.0f, 44.0f + 2.0f, paint);
        gregorianCalendar.add(2, 2);
        String str2 = "● " + months[gregorianCalendar.get(2)];
        paint.setTextAlign(Paint.Align.RIGHT);
        canvas.drawText(str2, 532.0f + 2.0f, 44.0f + 2.0f, paint);
        String[] shortWeekdays = dateFormatSymbols.getShortWeekdays();
        paint.setTextSize(18.0f);
        paint.setColor(-2279409);
        paint.setTextAlign(Paint.Align.CENTER);
        int firstDayOfWeek = gregorianCalendar.getFirstDayOfWeek();
        com.tsf.shell.e.i.c.a.j.a("mFirstDay:" + firstDayOfWeek);
        if (firstDayOfWeek == 1) {
        ...
        for (int i = 0; i < 7; i++) {
            canvas.drawText(new StringBuilder().append(gregorianCalendar.get(3)).toString(), 24.0f + 2.0f, (i * 38) + 135 + 2.0f, paint);
        ...
        for (int i2 = 0; i2 < 42; i2++) {
            ...
            canvas.drawText(new StringBuilder().append(gregorianCalendar2.get(5)).toString(), i3 + 2.0f, i4 + 2.0f, paint);
