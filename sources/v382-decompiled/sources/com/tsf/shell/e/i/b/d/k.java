...
public class k implements com.censivn.C3DEngine.b.c.k {
    public static j N;
    public static j O;
    ...
    public com.censivn.C3DEngine.b.f.l E;
    ...
    private x U;
    private f W;
    private com.tsf.shell.preference.a.a.g X;
    public int a;
    public int b;
    public int c;
    public int d;
    ...
    public k() {
        ...
        this.X = new com.tsf.shell.preference.a.a.g() { // from class: com.tsf.shell.e.i.b.d.k.1
    ...
    private void m() {
        this.T = new x() { // from class: com.tsf.shell.e.i.b.d.k.2
            @Override // com.censivn.C3DEngine.b.g.x
            public void a() {
                k.this.I.visible(false);
            }
        };
        this.T.a(0);
        this.U = new x();
    ...
    public void h() {
        if (!this.V) {
            this.V = true;
            w.a(this.I);
            w.a(this.I, VEasing.Linear.easeNone, this.U);
            this.I.visible(true);
        }
    }
    ...
    public void i() {
        if (this.V) {
            this.V = false;
            w.a(this.I);
            w.a(this.I, VEasing.Linear.easeNone, this.T);
        }
    }

    private void n() {
        N = new j(1.0f, com.censivn.C3DEngine.b.b.a.b * 11.0f, true, c());
        N.visible(false);
        N.alpha(0.0f);
        O = new j(1.0f, com.censivn.C3DEngine.b.b.a.b * 11.0f, false, c());
        O.visible(false);
        O.alpha(0.0f);
    }
    ...
    public void k() {
        this.B = com.tsf.shell.utils.x.b(R.drawable.widget_folder_add_button, com.tsf.shell.manager.g.a.i, com.tsf.shell.manager.g.a.i);
        this.C = com.tsf.shell.utils.x.b(R.drawable.widget_folder_multi_choice, com.tsf.shell.manager.g.a.i, com.tsf.shell.manager.g.a.i);
        this.D = com.tsf.shell.utils.x.b(R.drawable.widget_folder_rename, com.tsf.shell.manager.g.a.i, com.tsf.shell.manager.g.a.i);
        ...
        if (this.E == null) {
            this.F = new com.censivn.C3DEngine.b.f.l();
            this.W = new f();
            this.W.a(this.F);
            ...
            this.I = new i(com.censivn.C3DEngine.b.b.a.b * 12.0f, this.n);
            this.I.setDefaultColor(new Color4(255, 255, 255, 100));
            this.I.alpha(0.0f);
            this.I.visible(false);
            this.G = new com.censivn.C3DEngine.b.f.l();
            this.H = new m(500.0f * com.censivn.C3DEngine.b.b.a.c, 64.0f * com.censivn.C3DEngine.b.b.a.c, 1, 1);
            this.H.calAABB();
            ...
            this.J = new p();
            this.J.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this.J) { // from class: com.tsf.shell.e.i.b.d.k.3
    ...
    private void b(boolean z) {
        ...
        for (int i3 = 0; i3 < c().folder.sampleCount; i3++) {
            ThemeFolderDescription.SystemFolderChild systemFolderChild = (ThemeFolderDescription.SystemFolderChild) c().folder.getSampleInformaiton().get(i3);
    ...
    private void o() {
        ...
        int[] a2 = com.tsf.shell.utils.x.a(i4 - ((int) (80.0f * com.censivn.C3DEngine.b.b.a.b)), i6 - ((int) (a + (180.0f * com.censivn.C3DEngine.b.b.a.b))), i, i2, 0, 0);
        this.a = a2[0];
        this.b = a2[1];
    ...
    private void p() {
        this.M = new com.censivn.C3DEngine.b.d.a(this.H) { // from class: com.tsf.shell.e.i.b.d.k.4
            @Override // com.censivn.C3DEngine.b.d.a
    ...
    public void a(final b bVar) {
        com.censivn.C3DEngine.a.a().a(new Runnable() { // from class: com.tsf.shell.e.i.b.d.k.5
            ...
            public void run() {
                ...
                builder.setTitle(d.getString(R.string.rename_folder_title));
                builder.setView(inflate);
                String string = d.getString(R.string.public_action_ok);
                final b bVar2 = bVar;
                builder.setPositiveButton(string, new DialogInterface.OnClickListener() { // from class: com.tsf.shell.e.i.b.d.k.5.1
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i) {
                        bVar2.a(editText.getText().toString());
                    }
                });
                builder.setNegativeButton(d.getString(R.string.public_action_cancel), new DialogInterface.OnClickListener() { // from class: com.tsf.shell.e.i.b.d.k.5.2
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i) {
                    }
                });
    ...
    public void a(boolean z) {
        this.W.c();
        if (z) {
            x xVar = new x() { // from class: com.tsf.shell.e.i.b.d.k.6
                @Override // com.censivn.C3DEngine.b.g.x
                public void a() {
                    k.this.E.visible(false);
                }
            };
            xVar.a(0);
            xVar.l(0.0f);
