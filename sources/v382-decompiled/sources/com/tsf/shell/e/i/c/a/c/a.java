...
public class a extends l {
    ...
    public void a() {
        ...
        for (int i = 0; i < 30; i++) {
            com.censivn.C3DEngine.b.f.a.b a = this.g.a(i);
            this.n[i] = new b(a, 250.0f, ((-12.0f) * i) + 90.0f);
            a.b(0, 0, 1, 1);
            a.h();
        }
        int i2 = 0;
        while (true) {
            ...
            com.censivn.C3DEngine.b.f.a.b a2 = this.g.a(i3);
            int i4 = i3 + 3;
            if (i4 >= 30) {
                i4 %= 30;
            }
            this.m.add(new e(a2, this.g.a(i4)));
            i2 = i3 + 2;
        }
        this.g.calAABB();
        ...
        for (int i5 = 0; i5 < size; i5++) {
            ...
            com.censivn.C3DEngine.b.f.a.b a3 = this.v.a(i5);
            a3.a(0.0f);
            a3.b(0, 0, this.p, 4);
            eVar.a(a3);
        }
    ...
    public void b() {
        ...
        Bitmap a = a(this.o, (int) (40.0f * XHDScale));
        com.censivn.C3DEngine.a.g().a(this.t, a);
        a.recycle();
        Bitmap a2 = a(this.o, this.p, 4);
        com.censivn.C3DEngine.a.g().a(this.q, a2);
        a2.recycle();
        Bitmap b = b(this.o, (int) (20.0f * XHDScale), (int) (230.0f * XHDScale));
        com.censivn.C3DEngine.a.g().a(this.r, b);
        b.recycle();
        Bitmap b2 = b(this.o, (int) (24.0f * XHDScale), (int) (XHDScale * 170.0f));
        com.censivn.C3DEngine.a.g().a(this.s, b2);
        b2.recycle();
    }
    ...
    private void f() {
        ...
        x xVar = new x() { // from class: com.tsf.shell.e.i.c.a.c.a.1
        ...
        w.a(this.i);
        w.a(this.i, 1500, xVar);
        float f2 = (parseInt2 / 60.0f) * 360.0f;
        if (Math.abs(f - f2) < 6.0f) {
        }
        x xVar2 = new x() { // from class: com.tsf.shell.e.i.c.a.c.a.2
            @Override // com.censivn.C3DEngine.b.g.x
