...
public class h extends VObject3dContainer {
    ...
    private void a(float f, float f2) {
        ...
        if (f2 > 0.0f) {
            if (Math.abs(f) > f2) {
                ...
                this.y = this.m.top;
                com.tsf.shell.e.i.c.a.j.a("IS THIS FLITER?");
            }
        ...
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.e.i.c.a.a.h.1
    ...
    public h(VObject3dContainer vObject3dContainer) {
        j = a.a / 1.8f;
        this.t = j / a.b;
        n = 545.0f * j;
        o = 350.0f * j;
        ...
        this.g = new VObject3dContainer() { // from class: com.tsf.shell.e.i.c.a.a.h.2
            @Override // com.censivn.C3DEngine.api.core.VObject3d
            public void onDrawStart() {
                h.this.a.d();
            }
        };
        this.f = new VObject3dContainer() { // from class: com.tsf.shell.e.i.c.a.a.h.3
            @Override // com.censivn.C3DEngine.api.core.VObject3d
            public void onDrawStart() {
                if (!h.this.u) {
                    if (Math.abs(h.this.x - h.this.l.a.x) >= 1.0f || Math.abs(h.this.y - h.this.l.a.y) >= 1.0f || h.this.v) {
                        float f2 = (h.this.y - h.this.l.a.y) * h.this.s;
                        h.this.l.a.set(((h.this.x - h.this.l.a.x) * h.this.s) + h.this.l.a.x, f2 + h.this.l.a.y);
                        h.this.a(h.this.l);
                    } else {
                        h.this.a.c();
                        ...
                        h.this.u = true;
                        if (!h.this.w) {
                            com.tsf.shell.e.i.c.a.j.a("FINISH AND CHANGE TEXTURE");
                            h.this.w = true;
                        }
                    }
                }
    ...
    public void a(i iVar) {
        ...
        a(this.q, this.p, (this.m.width() / 2.0f) * Math.max(1.0f - iVar.b, 0.0f));
    }
