...
public class m extends o {
    ...
    public m(VTextureManager vTextureManager, Context context, float f, float f2) {
    ...
    public void h() {
        j.a("scaleAndMovePreview");
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.e.i.c.a.m.1
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void i() {
        j.a("restoreScaleAndMove");
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.e.i.c.a.m.2
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.e.i.c.a.m.2.1
                    @Override // com.censivn.C3DEngine.api.tween.VTweenParam
                    public void onComplete() {
                        m.this.h();
                    }
                ...
                VTween.to(m.this, 1, vTweenParam2);
            }
        };
    ...
    private void j() {
        ...
        VTween.to(this.A, 500, vTweenParam);
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.e.i.c.a.m.3
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                m.this.v.setZOrderOnTop();
                m.this.r.setZOrderOnTop();
                m.this.y.visible(false);
                m.this.i();
            }

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onUpdate(float f) {
                m.this.o.rotation().x = m.this.n.rotation().x;
                m.this.p.rotation().x = m.this.n.rotation().x;
                m.this.q.rotation().x = m.this.n.rotation().x;
                m.this.y.rotation().x = m.this.n.rotation().x + 180.0f;
                if (f > 0.5f) {
                    m.this.b(true);
                }
            }
        ...
        while (true) {
            int i2 = i;
            if (i2 < 5) {
                VObject3d vObject3d = (VObject3d) this.x.get(i2);
    ...
    public void k() {
        ...
        this.y.visible(true);
        VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.e.i.c.a.m.4
            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                m.this.a();
            }
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(R.drawable.widget_preview_music_p1, (VObject3d) this.x.get(0));
            a(R.drawable.widget_preview_music_p2, (VObject3d) this.x.get(1));
            a(R.drawable.widget_preview_music_p3, (VObject3d) this.x.get(2));
            a(R.drawable.widget_preview_music_p4, (VObject3d) this.x.get(3));
            a(R.drawable.widget_preview_music_p5, (VObject3d) this.x.get(4));
            a(R.drawable.widget_preview_music_title, this.w);
            a(R.drawable.widget_preview_music_control, this.n, this.o, this.p, this.q, this.r, this.v);
            c(z);
        }
    }
    ...
    public void a(int i, TextureElement textureElement) {
        if (i == R.drawable.widget_preview_music_p1) {
            this.b = textureElement;
            return;
        }
        if (i == R.drawable.widget_preview_music_p2) {
            this.c = textureElement;
            return;
        }
        if (i == R.drawable.widget_preview_music_p3) {
            this.d = textureElement;
            return;
        }
        if (i == R.drawable.widget_preview_music_p4) {
            this.e = textureElement;
            return;
        }
        if (i == R.drawable.widget_preview_music_p5) {
            this.f = textureElement;
        } else if (i == R.drawable.widget_preview_music_title) {
            this.g = textureElement;
        } else if (i == R.drawable.widget_preview_music_control) {
    ...
    public void d() {
        ...
        if (this.l) {
            ...
            while (true) {
                int i2 = i;
                if (i2 < 5) {
                    ((VObject3d) this.x.get(i2)).textures().removeAll();
                    i = i2 + 1;
                } else {
