...
public abstract class b extends com.tsf.shell.e.i.e implements p {
    ...
    private float q;
    private boolean r;
    private com.tsf.shell.e.d.a.a s;
    private boolean t;
    private c u;
    ...
    public void d(com.tsf.shell.e.e.g gVar) {
        if (gVar instanceof b) {
            b((com.censivn.C3DEngine.b.f.j) gVar);
        }
    }

    @Override // com.tsf.shell.e.i.c, com.tsf.shell.e.e.g
    public void e(com.tsf.shell.e.e.g gVar) {
        if ((gVar instanceof b) && this.u != null) {
            com.tsf.shell.e.i.b.d.b a2 = a((b) gVar, false);
            a2.K().screen = K().screen;
            a2.ad();
            a2.setMouseEventListener(new com.tsf.shell.e.i.a.c(a2));
        }
    }
    ...
    public com.tsf.shell.e.i.a.c aH() {
        return new com.tsf.shell.e.i.a.d(this);
    }
    ...
    @Override // com.tsf.shell.e.i.e, com.censivn.C3DEngine.b.f.l
    public void onDrawChildEnd() {
        super.onDrawChildEnd();
    }

    @Override // com.tsf.shell.e.i.c, com.tsf.shell.e.e.g
    public void g(com.tsf.shell.e.e.g gVar) {
        I();
        super.g(gVar);
    }
    ...
    public void a(com.tsf.shell.e.d.a.a aVar) {
        b(aVar);
    }
    ...
    public void b(com.tsf.shell.e.d.a.a aVar) {
        if (this.b) {
    ...
    public boolean a(com.censivn.C3DEngine.b.f.j jVar) {
        if (this.u == null) {
            this.u = aS();
        }
        if (this.u == null) {
        ...
        this.u.a.a(this, this.u.b, jVar);
        return true;
    }

    public void b(com.censivn.C3DEngine.b.f.j jVar) {
        if (this.u != null) {
            this.u.a.a(jVar, new Runnable() { // from class: com.tsf.shell.e.i.b.e.b.1
    ...
    public com.tsf.shell.e.i.b.d.b a(b bVar, boolean z) {
        com.tsf.shell.e.i.b.d.b bVar2 = this.u.a;
    ...
    public static c aU() {
        c cVar = new c();
        cVar.a = new com.tsf.shell.e.i.b.d.b(new LauncherDrawerFolder3DInfo(true));
        cVar.b = new j();
        w++;
        return cVar;
    }
