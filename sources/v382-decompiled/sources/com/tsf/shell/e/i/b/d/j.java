...
public class j extends m {
    ...
    public j(float f, float f2, boolean z, ThemeDescription themeDescription) {
        ...
        this.h = new m(19.0f * com.censivn.C3DEngine.b.b.a.b, 10.0f * com.censivn.C3DEngine.b.b.a.b, false);
    ...
    private void e() {
        ...
        while (true) {
            ...
            if (i3 < 8) {
                ...
                this.a.put((Color.red(i2) / 255.0f) * alpha2);
                this.a.put((Color.green(i2) / 255.0f) * alpha2);
                this.a.put((Color.blue(i2) / 255.0f) * alpha2);
                this.a.put(alpha2);
                i = i3 + 1;
            } else {
                return;
