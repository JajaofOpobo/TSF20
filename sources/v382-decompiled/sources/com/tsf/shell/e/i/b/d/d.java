...
public class d {
    ...
    public com.tsf.shell.e.a.a.a b;
    public int c;
    public int d;
    public int e;
    public int f;
    ...
    public void a(b bVar) {
        if (bVar.u != null) {
            ...
            if (bVar.visible()) {
                ...
                if (bVar.renderChildren()) {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        com.censivn.C3DEngine.b.f.j jVar = (com.censivn.C3DEngine.b.f.j) bVar.children().get(i2);
            ...
            bVar.alpha(l);
            bVar.visible(Boolean.valueOf(visible));
            if (z) {
                c(bVar);
            }
        }
