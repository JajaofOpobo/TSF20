...
public class c extends o {
    ...
    public void h() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.e.i.c.a.c.1
    ...
    private void i() {
        VTweenParam vTweenParam = new VTweenParam() { // from class: com.tsf.shell.e.i.c.a.c.2
            private boolean b = false;

            @Override // com.censivn.C3DEngine.api.tween.VTweenParam
            public void onComplete() {
                VTweenParam vTweenParam2 = new VTweenParam() { // from class: com.tsf.shell.e.i.c.a.c.2.1
                    @Override // com.censivn.C3DEngine.api.tween.VTweenParam
                    public void onComplete() {
                        c.this.h();
                    }
                ...
                VTween.to(c.this, 1, vTweenParam2);
            }
    ...
    public void a(boolean z) {
        if (!this.l) {
            this.l = true;
            a(R.drawable.widget_preview_alarm_frontbg, this.h);
            a(R.drawable.widget_preview_alarm_front_content, this.m);
            a(R.drawable.widget_preview_alarm_back_bg, this.t);
            a(R.drawable.widget_preview_alarm_small_circle, this.s);
            a(R.drawable.widget_preview_alarm_toggle, this.r);
            a(R.drawable.widget_preview_alarm_week, this.q);
            c(z);
        }
    }
