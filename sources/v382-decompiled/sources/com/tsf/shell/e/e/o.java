...
public class o extends com.censivn.C3DEngine.b.f.l {
    private int a = 0;
    private com.censivn.C3DEngine.b.f.h b = new com.censivn.C3DEngine.b.f.h();
    private com.censivn.C3DEngine.b.f.o c;
    private float d;
    ...
    public o(int i, int i2) {
        ...
        this.b.a(i);
        this.b.calAABB();
        this.c = new com.censivn.C3DEngine.b.f.o();
        this.c.d(50);
        this.c.c(i2);
        this.c.b(1);
        this.c.b();
        ...
        setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this) { // from class: com.tsf.shell.e.e.o.1
