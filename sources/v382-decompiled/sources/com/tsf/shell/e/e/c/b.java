...
public class b extends l {
    ...
    private void c() {
        ...
        while (i < this.h) {
            ...
            for (int i4 = 0; i4 < this.h; i4++) {
                this.c[a(i4, i)] = new c(this, ((i4 * this.i) * this.j) - (this.j / 2.0f), ((i * this.i) * this.j) - (this.j / 2.0f), 0.0f, i4, i);
                int a = a(i4, i);
                this.n[(a * 2) + 0] = 0.5f;
                this.n[(a * 2) + 1] = 0.5f;
                if (i4 == 0) {
    ...
    public void a(float f, float f2, float f3, float f4, float f5) {
        float f6 = this.o;
        c cVar = this.c[a(0, 0)];
        c cVar2 = this.c[a(1, 0)];
        c cVar3 = this.c[a(0, 1)];
        c cVar4 = this.c[a(1, 1)];
        cVar2.d = cVar.d + f6;
        cVar3.e = cVar.e + f6;
        cVar4.d = cVar.d + f6;
        cVar4.e = cVar.e + f6;
        c cVar5 = this.c[a(0, this.p)];
        c cVar6 = this.c[a(1, this.p)];
        c cVar7 = this.c[a(0, this.q)];
        c cVar8 = this.c[a(1, this.q)];
        cVar6.d = cVar5.d + f6;
        cVar7.e = cVar5.e - f6;
        cVar8.d = cVar5.d + f6;
        cVar8.e = cVar5.e - f6;
        c cVar9 = this.c[a(this.p, this.p)];
        c cVar10 = this.c[a(this.q, this.p)];
        c cVar11 = this.c[a(this.p, this.q)];
        c cVar12 = this.c[a(this.q, this.q)];
        cVar10.d = cVar9.d - f6;
        cVar11.e = cVar9.e - f6;
        cVar12.d = cVar9.d - f6;
        cVar12.e = cVar9.e - f6;
        c cVar13 = this.c[a(this.p, 0)];
        c cVar14 = this.c[a(this.q, 0)];
        c cVar15 = this.c[a(this.p, 1)];
        c cVar16 = this.c[a(this.q, 1)];
        cVar14.d = cVar13.d - f6;
        cVar15.e = cVar13.e + f6;
        cVar16.d = cVar13.d - f6;
        cVar16.e = f6 + cVar13.e;
    }
    ...
    public void a(float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        for (int i = 0; i < this.h; i++) {
            for (int i2 = 0; i2 < this.h; i2++) {
                c cVar = this.c[a(i2, i)];
                cVar.g = f5;
                cVar.d = (((i2 * this.i) * f3) + f) - (f3 / 2.0f);
                cVar.e = (((i * this.i) * f4) + f2) - (f4 / 2.0f);
            }
        }
        float f9 = (this.h - 1) / 2.0f;
        for (int i3 = 0; i3 < this.h; i3++) {
            float f10 = (i3 - f9) / f9;
            this.c[a(i3, this.p)].e = (float) (r7.e + (f7 * Math.cos((f10 * 3.141592653589793d) / 2.0d)));
            this.c[a(i3, this.q)].e = (float) (r7.e + (f7 * Math.cos((f10 * 3.141592653589793d) / 2.0d)));
            this.c[a(i3, 0)].e = (float) (r7.e - (f7 * Math.cos((f10 * 3.141592653589793d) / 2.0d)));
            this.c[a(i3, 1)].e = (float) (r7.e - (f7 * Math.cos((f10 * 3.141592653589793d) / 2.0d)));
        }
        for (int i4 = 0; i4 < this.h; i4++) {
            float f11 = (i4 - f9) / f9;
            this.c[a(this.p, i4)].d = (float) (r6.d + (f8 * Math.cos((f11 * 3.141592653589793d) / 2.0d)));
            this.c[a(this.q, i4)].d = (float) (r6.d + (f8 * Math.cos((f11 * 3.141592653589793d) / 2.0d)));
            this.c[a(0, i4)].d = (float) (r6.d - (f8 * Math.cos((f11 * 3.141592653589793d) / 2.0d)));
            this.c[a(1, i4)].d = (float) (r6.d - (f8 * Math.cos((f11 * 3.141592653589793d) / 2.0d)));
        }
    }

    private void d() {
        final j jVar = this.x.b;
        x xVar = new x() { // from class: com.tsf.shell.e.e.c.b.7
        ...
        xVar.a(50);
        w.a(jVar);
        w.a(jVar, (int) (300.0f * this.A), xVar);
    }
    ...
    public void a(final float f, final float f2, final float f3, final Runnable runnable) {
        final Runnable runnable2 = new Runnable() { // from class: com.tsf.shell.e.e.c.b.8
        ...
        final x xVar = new x() { // from class: com.tsf.shell.e.e.c.b.9
            @Override // com.censivn.C3DEngine.b.g.x
            public void a(float f7) {
                ...
                float f12 = sqrt * f7;
                b.this.b(sqrt, sqrt, f10, f11, 1.0f);
            }
        ...
        x xVar2 = new x() { // from class: com.tsf.shell.e.e.c.b.10
            @Override // com.censivn.C3DEngine.b.g.x
            public void a(float f7) {
            }
            ...
            public void a() {
                ...
                w.a(b.this, (int) (200.0f * b.this.A), xVar);
            }
        };
        xVar2.a(0);
        w.a(this);
        w.a(this, (int) (400.0f * this.A), xVar2);
        this.B = false;
    }

    public void b(final float f, final float f2, final float f3, final Runnable runnable) {
        final Runnable runnable2 = new Runnable() { // from class: com.tsf.shell.e.e.c.b.11
            @Override // java.lang.Runnable
            public void run() {
                b.this.b(0.0f, 0.0f, f3, f3, 1.0f);
                b.this.x.position().x = f;
        ...
        if (!this.B) {
            if (this.G < 0.1f) {
                ...
                final x xVar = new x() { // from class: com.tsf.shell.e.e.c.b.12
                    @Override // com.censivn.C3DEngine.b.g.x
                ...
                final x xVar2 = new x() { // from class: com.tsf.shell.e.e.c.b.13
                    @Override // com.censivn.C3DEngine.b.g.x
                    public void a(float f4) {
                        float f5 = 10.0f * b.this.x.d;
                        float f6 = 40.0f * b.this.x.d;
                ...
                x xVar3 = new x() { // from class: com.tsf.shell.e.e.c.b.14
                    @Override // com.censivn.C3DEngine.b.g.x
                    public void a(float f4) {
                        float f5 = 10.0f * b.this.x.d;
                    ...
                    @Override // com.censivn.C3DEngine.b.g.x
                    public void a() {
                        w.a(b.this, (int) (100.0f * b.this.A), xVar2);
                    }
                };
                w.a(this);
                w.a(this, (int) (this.A * 200.0f), xVar3);
                return;
            }
        }
        this.w = 2;
        ...
        final x xVar4 = new x() { // from class: com.tsf.shell.e.e.c.b.1
            @Override // com.censivn.C3DEngine.b.g.x
            public void a(float f7) {
                ...
                float f10 = f9 + ((f3 - f9) * f7);
                float f11 = f8 + ((f3 - f8) * f7);
                b.this.b(sqrt, sqrt * f7, f10, f11, 0.5f);
            }
        ...
        xVar4.a(com.censivn.C3DEngine.b.g.a.a);
        final x xVar5 = new x() { // from class: com.tsf.shell.e.e.c.b.2
            @Override // com.censivn.C3DEngine.b.g.x
            public void a(float f7) {
            }
            ...
            public void b(float f7) {
                ...
                float f9 = 40.0f * b.this.x.d;
                b.this.b(sqrt, 0.0f, (f8 * f7) + f8, (50.0f * b.this.x.d) - (f9 * f7), 0.5f);
            }

            @Override // com.censivn.C3DEngine.b.g.x
            public void a() {
                w.a(b.this, (int) (300.0f * b.this.A), xVar4);
            }
        };
        xVar5.a(com.censivn.C3DEngine.b.g.a.a);
        final x xVar6 = new x() { // from class: com.tsf.shell.e.e.c.b.3
            @Override // com.censivn.C3DEngine.b.g.x
            public void a(float f7) {
            }
            ...
            public void b(float f7) {
                ...
                b.this.b(sqrt * f7, 0.0f, f10, f11, 0.5f);
            }

            @Override // com.censivn.C3DEngine.b.g.x
            public void a() {
                w.a(b.this, (int) (200.0f * b.this.A), xVar5);
            }
        };
        x xVar7 = new x() { // from class: com.tsf.shell.e.e.c.b.4
            @Override // com.censivn.C3DEngine.b.g.x
            public void a(float f7) {
            }
            ...
            public void a() {
                b.this.rotation().z = degrees;
                w.a(b.this, (int) (200.0f * b.this.A), xVar6);
            }
        };
        w.a(this);
        w.a(this, (int) (this.A * 200.0f), xVar7);
        this.B = false;
    }
    ...
    public void a(final float f, final float f2, final float f3, final float f4) {
        ...
        this.G = 0.0f;
        alpha(0.0f);
        x xVar = new x() { // from class: com.tsf.shell.e.e.c.b.5
            @Override // com.censivn.C3DEngine.b.g.x
                        ...
                        if (f18 < f14 || f18 >= f15) {
                            if (f18 < f15 || f18 >= f16) {
                                ...
                                if (f18 >= f17 && f18 < 1.0f) {
                                    ...
                                    b.this.a(0.0f, 0.0f, f3, f4, 0.8f, (float) Math.cos(f21 * 3.141592653589793d * 1.5d));
                                    b.this.a(0.0f, 0.0f, f3, f4, 0.2f);
                                    b.this.a((((float) Math.cos(f21 * 3.141592653589793d * 1.5d)) * 0.05f) + 1.0f);
                                }
                            }
                        }
                    }
    ...
    public void b(final float f, final float f2, final float f3, final float f4) {
        ...
        this.G = 0.0f;
        x xVar = new x() { // from class: com.tsf.shell.e.e.c.b.6
            @Override // com.censivn.C3DEngine.b.g.x
            public void a(float f22) {
                ...
                if (f22 >= f18 && f22 < f19) {
                    ...
                    b.this.E = f37;
                    b.this.F = sqrt;
                    b.this.b(sqrt, f37, f35, f36, 0.5f);
                    return;
                }
                if (f22 >= f19 && f22 < f20) {
                    ...
                    b.this.E = sqrt;
                    b.this.F = sqrt;
                    b.this.b(sqrt, sqrt, f41, f42, 1.0f);
                    return;
                }
                if (f22 >= f20 && f22 < f21) {
                ...
                if (f22 >= f21 && f22 < 1.0f) {
                    ...
                    b.this.a(0.0f, 0.0f, f3, f4, 0.8f, (float) Math.cos(f45 * 3.141592653589793d * 1.5d));
                    b.this.a(0.0f, 0.0f, f3, f4, 0.2f);
                    b.this.a((((float) Math.cos(f45 * 3.141592653589793d * 1.5d)) * 0.05f) + 1.0f);
                }
            }
    ...
    private c[] c(float f, float f2, float f3, float f4) {
        if (f4 < f3) {
            return new c[]{new c(this, -f4, f2, 0.0f), new c(this, -f4, f, 0.0f), new c(this, -f3, f - f3, 0.0f), new c(this, -f3, f, 0.0f)};
        }
        return new c[]{new c(this, -f4, f2, 0.0f), new c(this, -f4, f2 + f4, 0.0f), new c(this, -f3, f2, 0.0f), new c(this, -f3, f, 0.0f)};
    }

    private c[] d(float f, float f2, float f3, float f4) {
        if (f4 < f3) {
            return new c[]{new c(this, f4, f2, 0.0f), new c(this, f4, f, 0.0f), new c(this, f3, f - f3, 0.0f), new c(this, f3, f, 0.0f)};
        }
        return new c[]{new c(this, f4, f2, 0.0f), new c(this, f4, f2 + f4, 0.0f), new c(this, f3, f2, 0.0f), new c(this, f3, f, 0.0f)};
    ...
    private c a(c[] cVarArr, float f) {
        c cVar = new c(this, 0.0f, 0.0f, 0.0f, 0, 0);
        float f2 = (float) ((cVarArr[1].a - cVarArr[0].a) * 3.0d);
        float f3 = (float) (((cVarArr[2].a - cVarArr[1].a) * 3.0d) - f2);
        float f4 = ((cVarArr[3].a - cVarArr[0].a) - f2) - f3;
        float f5 = (float) ((cVarArr[1].b - cVarArr[0].b) * 3.0d);
        float f6 = (float) (((cVarArr[2].b - cVarArr[1].b) * 3.0d) - f5);
        float f7 = ((cVarArr[3].b - cVarArr[0].b) - f5) - f6;
        float f8 = f * f;
        float f9 = f8 * f;
        cVar.a = (f2 * f) + (f3 * f8) + (f4 * f9) + cVarArr[0].a;
        cVar.b = (f7 * f9) + (f6 * f8) + (f5 * f) + cVarArr[0].b;
        return cVar;
    }
