...
public class q implements com.censivn.C3DEngine.b.c.d {
    private static TextureElement a;
    private static TextureElement b;
    private static com.censivn.C3DEngine.b.f.l c;
    ...
    private com.censivn.C3DEngine.b.f.l p;
    private r q;
    private i r;
    ...
    public q(com.censivn.C3DEngine.b.f.l lVar, r rVar) {
        this.p = lVar;
        this.q = rVar;
    }
    ...
    public void a(int i2, int i3) {
        if (!this.s) {
            ...
            c.scale().x = 0.0f;
            c.scale().y = 0.0f;
            com.censivn.C3DEngine.b.g.x xVar = new com.censivn.C3DEngine.b.g.x() { // from class: com.tsf.shell.e.e.q.1
            ...
            xVar.l(1.0f);
            xVar.m(1.0f);
            xVar.a((com.censivn.C3DEngine.b.g.v) new com.censivn.C3DEngine.b.g.e());
            com.censivn.C3DEngine.b.g.w.a(c, 380, xVar);
            n = i2;
            o = i3;
    ...
    public void a(int i2, boolean z) {
        if (this.s) {
            this.s = false;
            if (!z) {
                com.censivn.C3DEngine.a.h.d().a((com.censivn.C3DEngine.b.d.a) null, true);
            }
            com.censivn.C3DEngine.b.g.w.a(c);
            f();
            this.q.a(i2);
            this.r.b();
            this.p = null;
    ...
    public void o() {
        if (b == null) {
            ...
            arrayList.add(com.censivn.C3DEngine.a.d().getString(R.string.pop_menu_arrangement));
            arrayList.add(com.censivn.C3DEngine.a.d().getString(R.string.pop_menu_gather));
            arrayList.add(com.censivn.C3DEngine.a.d().getString(R.string.text_delete));
            arrayList.add(com.censivn.C3DEngine.a.d().getString(R.string.pop_menu_create_folder));
            arrayList.add(com.censivn.C3DEngine.a.d().getString(R.string.pop_menu_mulit_choice));
            Bitmap a2 = s.a(arrayList);
    ...
    public void e() {
        if (f == null) {
            ThemeManager.mix.lasso.addElementListener(new DynamicThemeRunnable() { // from class: com.tsf.shell.e.e.q.2
                ...
                public void onReloadTheme(ThemeDescription themeDescription) {
                    if (q.b != null) {
                        com.censivn.C3DEngine.a.g().a(q.b);
                        q.b = null;
                    }
                    q.this.o();
                }
        ...
        f.alpha(0.0f);
        com.censivn.C3DEngine.b.g.x xVar = new com.censivn.C3DEngine.b.g.x() { // from class: com.tsf.shell.e.e.q.3
            @Override // com.censivn.C3DEngine.b.g.x
            public void a(float f2) {
                for (int i3 = 0; i3 < 5; i3++) {
                    com.censivn.C3DEngine.b.f.a.b a3 = q.f.a(i3);
                    a3.m.spX(iArr[i3][0] * f2);
                    a3.m.spY(iArr[i3][1] * f2);
                    a3.f();
                }
                q.f.alpha((int) (255.0f * f2));
            }
        };
        xVar.a(255);
        xVar.a((com.censivn.C3DEngine.b.g.v) new com.censivn.C3DEngine.b.g.e());
        com.censivn.C3DEngine.b.g.w.a(l, 700, xVar);
        c.addChild(f);
    }

    public void f() {
        if (f != null) {
            com.censivn.C3DEngine.b.g.w.a(l);
            for (int i2 = 0; i2 < 5; i2++) {
                com.censivn.C3DEngine.b.f.a.b a2 = f.a(i2);
                a2.m.spX(0.0f);
                a2.m.spY(0.0f);
    ...
    private static void p() {
        ...
        c = new com.censivn.C3DEngine.b.f.l();
        d = new com.censivn.C3DEngine.b.f.a.a(6, 40, 240, 320) { // from class: com.tsf.shell.e.e.q.4
            @Override // com.censivn.C3DEngine.b.f.j
            public void onKillFocus() {
                if (q.k != null) {
                    com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.e.e.q.4.1
        ...
        j = new com.censivn.C3DEngine.b.d.a(d) { // from class: com.tsf.shell.e.e.q.5
            ...
            public void a(MotionEvent motionEvent, MotionEvent motionEvent2) {
                int i2 = 5;
                if (q.m) {
                    float[] b2 = com.tsf.shell.utils.x.b(motionEvent2.getX(), motionEvent2.getY());
                    if (com.tsf.shell.utils.x.b(q.n, q.o, b2[0], b2[1]) > 50.0f) {
                        q.m = false;
                    }
                } else {
                    i2 = q.b(motionEvent2);
    ...
    private static void a(final com.censivn.C3DEngine.b.f.a.b bVar) {
        com.censivn.C3DEngine.b.d.a aVar = new com.censivn.C3DEngine.b.d.a(d) { // from class: com.tsf.shell.e.e.q.6
            @Override // com.censivn.C3DEngine.b.d.a
            public void e(MotionEvent motionEvent) {
                q.c(bVar.J);
            }
    ...
    public static int b(MotionEvent motionEvent) {
        ...
        float b2 = com.tsf.shell.utils.x.b(i4, i5, i2, i3);
        float f2 = i2 - i4;
        if (i3 - i5 > 0.0f) {
            atan = (float) (Math.atan(f2 / r0) / 0.017453292519943295d);
        } else {
            atan = ((float) (Math.atan(f2 / r0) / 0.017453292519943295d)) + 180.0f;
        }
        if (atan < 0.0f) {
            atan += 360.0f;
        }
