...
public class a extends l {
    ...
    private void a(TextureElement textureElement, int i, float f, int i2, float f2, final Runnable runnable) {
        ...
        this.a.b = ((TextureElement) this.h.get(0)).id;
        this.a.a(textureElement.width, textureElement.height);
        a(0.0f);
        final float f3 = this.c;
        final float f4 = 1.0f - this.c;
        x xVar = new x() { // from class: com.tsf.shell.e.e.b.a.1
            @Override // com.censivn.C3DEngine.b.g.x
            public void a(float f5) {
                float f6 = f3 + (f4 * f5);
                if (f6 < 0.0f) {
                    m.a(this, "BlurContainer -> blur : precent:" + f6 + "    startProgress" + f3 + "    diffProgress:" + f4 + "     precent" + f5);
                }
                a.this.a(f6);
            }
    ...
    public void a(float f) {
        ...
        if (f >= 1.0f) {
            this.a.a = ((TextureElement) this.h.get(this.h.size() - 2)).id;
            this.a.b = ((TextureElement) this.h.get(this.h.size() - 1)).id;
            this.a.c = 1.0f;
            this.a.d = (int) this.b;
            return;
        }
        ...
        int i = (int) (f / f2);
        float f3 = (f % f2) / f2;
        this.a.a = i == 0 ? this.k.id : ((TextureElement) this.h.get(i - 1)).id;
        this.a.b = ((TextureElement) this.h.get(i)).id;
        this.a.c = f3;
    ...
    public void a(int i, final Runnable runnable) {
        ...
        x xVar = new x() { // from class: com.tsf.shell.e.e.b.a.2
            @Override // com.censivn.C3DEngine.b.g.x
    ...
    public TextureElement b() {
        ...
        return (TextureElement) this.h.get(this.h.size() - 1);
    }
    ...
    private void a(TextureElement textureElement, int i, float f) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            if (i5 == 0) {
                e.a(com.censivn.C3DEngine.a.d(), this.k, (TextureElement) this.h.get(i5), (TextureElement) this.i.get(i5), (com.tsf.shell.e.a.a.a) this.j.get(i5));
            } else {
                e.a(com.censivn.C3DEngine.a.d(), (TextureElement) this.h.get(i5 - 1), (TextureElement) this.h.get(i5), (TextureElement) this.i.get(i5), (com.tsf.shell.e.a.a.a) this.j.get(i5));
            }
        }
        System.currentTimeMillis();
    }
    ...
    private void c() {
        while (this.h.size() > 0) {
            GLES20.glDeleteTextures(1, new int[]{((TextureElement) this.h.remove(0)).id}, 0);
        }
        while (this.i.size() > 0) {
            GLES20.glDeleteTextures(1, new int[]{((TextureElement) this.i.remove(0)).id}, 0);
        }
        while (this.j.size() > 0) {
            com.tsf.shell.manager.a.t.a((com.tsf.shell.e.a.a.a) this.j.remove(0));
        }
    }
}
