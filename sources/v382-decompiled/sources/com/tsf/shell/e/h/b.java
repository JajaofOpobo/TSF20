...
public class b implements com.censivn.C3DEngine.b.c.d, k {
    public static int b = -1725816286;
    private l d;
    private com.tsf.shell.e.e.c.a e;
    private c f;
    private l g;
    private e k;
    private com.tsf.shell.manager.f.c l;
    private float m;
    private float o;
    private float p;
    private a r;
    private com.tsf.shell.e.h.a.c s;
    public int a = 47;
    ...
    public com.tsf.shell.e.h.a.c a() {
        return this.s;
    }

    public com.tsf.shell.e.e.c.a b() {
        return this.e;
    }
    ...
    public void f() {
        x xVar = new x();
        xVar.h((-com.censivn.C3DEngine.b.b.a.E) / 2.0f);
        xVar.a(0);
        w.a(this.d);
        w.a(this.d, 350, xVar);
    }
    ...
    public void a(l lVar) {
        ...
        this.t = com.tsf.shell.manager.b.g.aa();
        this.a = this.t ? com.tsf.shell.manager.b.g.Z() : 0;
        this.c = 80.0f * com.censivn.C3DEngine.b.b.a.c;
        this.s = new com.tsf.shell.e.h.a.c();
        this.d = new l();
        this.k = new e();
        this.k.b(0.0f);
        this.l = new com.tsf.shell.manager.f.c() { // from class: com.tsf.shell.e.h.b.1
        ...
        this.e = new com.tsf.shell.e.e.c.a(128.0f, ThemeManager.mix.smartButton.getTheme().shell.smartButtonWindowsColor, (int) ((this.a / 100.0f) * 255.0f), com.tsf.shell.utils.x.a(R.drawable.bubble_icon), 1000, com.censivn.C3DEngine.b.b.a.c) { // from class: com.tsf.shell.e.h.b.2
            @Override // com.tsf.shell.e.e.c.a
            public void d() {
            }

            @Override // com.tsf.shell.e.e.c.a, com.censivn.C3DEngine.b.f.j
        ...
        this.f = new c(this);
        this.e.a(this.f);
        this.g.setMouseEventListener(new d(this, this.g) { // from class: com.tsf.shell.e.h.b.3
            @Override // com.tsf.shell.e.h.d, com.censivn.C3DEngine.b.d.a
    ...
    private void r() {
        Number3d w = com.censivn.C3DEngine.b.b.a.O ? com.tsf.shell.manager.b.g.w() : com.tsf.shell.manager.b.g.x();
    ...
    public void i() {
        if (!this.h && !this.e.getAnimationObjectState()) {
            this.h = true;
            x xVar = new x() { // from class: com.tsf.shell.e.h.b.4
    ...
    public void m() {
        if (this.j) {
            this.j = false;
            this.k.a(0.0f, new Runnable() { // from class: com.tsf.shell.e.h.b.5
    ...
    public void n() {
        if (!i.l()) {
            com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.e.h.b.6
                @Override // java.lang.Runnable
                public void run() {
                    b.this.n();
                }
        ...
        if (com.tsf.shell.e.e.g.e.mCurrentMenu == null && this.h && !this.i && com.tsf.shell.manager.a.h.B() && !com.tsf.shell.manager.a.h.s().a() && !com.tsf.shell.manager.a.v.e.e()) {
            com.tsf.shell.e.b.a();
    ...
    public void q() {
        if (this.n) {
            ...
            if (com.censivn.C3DEngine.b.b.a.O) {
                com.tsf.shell.manager.b.g.c(this.o, this.p);
            } else {
                com.tsf.shell.manager.b.g.d(this.o, this.p);
            }
        }
    }
