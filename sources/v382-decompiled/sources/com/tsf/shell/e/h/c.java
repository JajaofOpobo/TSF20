...
public class c extends l {
    ...
    private g h;
    private com.tsf.shell.e.i.b.e.b j;
    ...
    private com.tsf.shell.e.i.b.e.b i = a(12, com.tsf.shell.manager.p.f.l);
    ...
    public c(b bVar) {
        ...
        this.g.addChild(a(VEasing.Back.easeIn, com.tsf.shell.manager.p.f.a));
        this.g.addChild(a(300, com.tsf.shell.manager.p.f.e));
        this.g.addChild(a(800));
        this.g.addChild(a(1700));
        this.g.addChild(a(1500, com.tsf.shell.manager.p.f.k));
        ...
        this.g.e();
        addChild(this.g);
        this.h = new g(this, this.a.b().c(), this.b - (com.censivn.C3DEngine.b.b.a.c * 10.0f), com.tsf.shell.manager.o.b.b.U, com.tsf.shell.manager.o.b.b.T, 40.0f * com.censivn.C3DEngine.b.b.a.c, 0.0f * com.censivn.C3DEngine.b.b.a.c);
        this.h.position().y = (-com.tsf.shell.manager.o.b.b.U) - this.e;
        this.h.d();
        addChild(this.h);
    }

    public com.tsf.shell.e.i.b.e.b a(int i) {
        com.tsf.shell.e.i.b.e.b a = com.tsf.shell.manager.l.a.a(i, com.tsf.shell.manager.o.b.b);
        a(a);
        return a;
    }

    private com.tsf.shell.e.i.b.e.b a(int i, int i2) {
        final com.tsf.shell.e.i.b.e.b a = a(i);
        final LauncherShortcutStandardInfo launcherShortcutStandardInfo = (LauncherShortcutStandardInfo) a.K();
        com.tsf.shell.manager.p.g a2 = com.tsf.shell.manager.a.a.a(i2);
        if (a2.a()) {
            launcherShortcutStandardInfo.enableNotifPoint();
            a2.a(new h() { // from class: com.tsf.shell.e.h.c.1
    ...
    public static void a(final com.tsf.shell.e.i.b.e.b bVar) {
        bVar.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(bVar) { // from class: com.tsf.shell.e.h.c.2
    ...
    public void e() {
        int numChildren = this.f.numChildren();
        for (int i = 0; i < numChildren; i++) {
            ((com.tsf.shell.e.i.b.e.b) this.f.getChildAt(i)).aB();
        }
        int numChildren2 = this.g.numChildren();
        for (int i2 = 0; i2 < numChildren2; i2++) {
            ((com.tsf.shell.e.i.b.e.b) this.g.getChildAt(i2)).aB();
        }
    }
}
