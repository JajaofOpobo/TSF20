...
public class a extends h {
    ...
    public a(b bVar) {
        ...
        while (true) {
            ...
            if (i4 < a.size()) {
                ...
                a2.e(1, 1);
                Number3d number3d2 = (Number3d) a.get(i4);
                a2.m.x = number3d2.x;
                a2.m.y = number3d2.y;
                a2.h();
                i = i4 + 1;
            } else {
                this.g = new Runnable() { // from class: com.tsf.shell.e.d.e.a.1
                    @Override // java.lang.Runnable
                    public void run() {
                        com.censivn.C3DEngine.a.a().b(a.this.h, 300L);
                    }
                };
                this.h = new Runnable() { // from class: com.tsf.shell.e.d.e.a.2
                    @Override // java.lang.Runnable
                    public void run() {
                        a.this.d = false;
                    }
                };
                this.i = new Runnable() { // from class: com.tsf.shell.e.d.e.a.3
                    @Override // java.lang.Runnable
                    public void run() {
    ...
    public static TextureElement a() {
        if (j == null) {
            j = x.b(R.drawable.effect_icon_scene);
        }
        return j;
    }
}
