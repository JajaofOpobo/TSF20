...
public class c extends h {
    ...
    public c(d dVar) {
        ...
        com.censivn.C3DEngine.b.f.a.b a = aVar.a(4);
        a.a(0, 0, 1, 1, com.censivn.C3DEngine.b.b.a.a(60.0f), com.censivn.C3DEngine.b.b.a.a(60.0f));
        a.h();
        for (int i = 0; i < 4; i++) {
            com.censivn.C3DEngine.b.f.a.b a2 = aVar.a(i);
            a2.a(1, 0, 1, 1, com.censivn.C3DEngine.b.b.a.a(60.0f), com.censivn.C3DEngine.b.b.a.a(60.0f));
            a2.o.setAll(0.0f, 0.0f, 1.0f);
            a2.h();
        }
        this.b = new Runnable() { // from class: com.tsf.shell.e.d.c.a.c.1
            @Override // java.lang.Runnable
            public void run() {
                com.censivn.C3DEngine.a.a().b(c.this.c, 300L);
            }
        };
        this.c = new Runnable() { // from class: com.tsf.shell.e.d.c.a.c.2
            @Override // java.lang.Runnable
            public void run() {
                c.this.g.b((com.censivn.C3DEngine.b.f.a.a) c.this.e, c.this.d);
            }
        };
        this.d = new Runnable() { // from class: com.tsf.shell.e.d.c.a.c.3
            @Override // java.lang.Runnable
            public void run() {
                c.this.a = false;
            }
        };
        this.f = new Runnable() { // from class: com.tsf.shell.e.d.c.a.c.4
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void onDrawStart() {
        ...
        if (h.id == 0) {
            com.censivn.C3DEngine.a.g().a(h, R.drawable.menu_effect_element);
        }
    }
