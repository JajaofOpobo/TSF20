...
public class b extends FrameLayout {
    ...
    public c a;
    public com.tsf.shell.e.i.b.b.a b;
    public Canvas c;
    private boolean d;
    private Object e;
    ...
    public b(Context context, c cVar, com.tsf.shell.e.i.b.b.a aVar) {
        super(context);
        this.d = false;
        this.e = new Object();
        this.a = cVar;
        ...
        this.e = new Object();
        this.c = new Canvas();
        this.h = new Runnable() { // from class: com.tsf.shell.d.b.1
                    ...
                    synchronized (b.this.e) {
                        if (b.this.f != null) {
                            ...
                            if (bitmap != null) {
                                ...
                                com.censivn.C3DEngine.a.a().a(new Runnable() { // from class: com.tsf.shell.d.b.1.1
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        b.this.invalidate();
                                    }
    ...
    public void a(int i, int i2) {
        if (Build.VERSION.SDK_INT >= 16) {
            try {
                ...
                String str = "";
                if (this.b != null) {
                    String str2 = String.valueOf("") + "packagename:" + this.b.f;
                    ItemInfo K = this.b.K();
                    str = (K == null || !(K instanceof LauncherAppWidgetInfo)) ? str2 : String.valueOf(str2) + "   launcherinfo:    " + ((LauncherAppWidgetInfo) K).providerName;
                }
                hashMap.put("error", str);
                n.a("EVENT_ISSUSE_UPDATE_APP_WIDGET_SIZE", hashMap);
            }
        }
    }
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (!this.b.a) {
            synchronized (this.e) {
                ...
                if (this.b.h == null) {
                    com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.d.b.2
                        @Override // java.lang.Runnable
                        public void run() {
