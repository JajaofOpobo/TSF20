...
public class i extends ViewGroup {
    ...
    public e getCurrentScreenLayout() {
        return this.i.n().s();
    }

    public void a(View view, e eVar, int i, int i2, int i3, int i4, boolean z) {
        g gVar;
        if (eVar != null) {
            g gVar2 = (g) view.getLayoutParams();
            if (gVar2 == null) {
                gVar = new g(i, i2, i3, i4);
            } else {
                gVar2.a = i;
                gVar2.b = i2;
                gVar2.d = i3;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        boolean z;
        boolean z2;
        if (com.censivn.C3DEngine.a.h.d().b() || !p) {
            return false;
        }
        ...
        switch (action & 255) {
            case 0:
                ...
                com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.d.i.1
    ...
    public boolean a(MotionEvent motionEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            if (((e) getChildAt(i)).a(motionEvent)) {
                return true;
            }
        }
        return false;
            ...
            case 1:
                if (this.d == 1) {
                    ...
                    if (Math.abs(yVelocity) > this.k || Math.abs(xVelocity) > this.k) {
                        com.censivn.C3DEngine.a.h.d().d(this.h, motionEvent, xVelocity, yVelocity);
                    }
                    if (this.j != null) {
                        this.j.recycle();
                        this.j = null;
                ...
                com.censivn.C3DEngine.a.h.d().k(motionEvent);
                break;
            case 2:
                if (this.d == 1 && !this.g) {
                    com.censivn.C3DEngine.a.h.d().c(this.h, motionEvent, 0.0f, 0.0f);
                    break;
                }
                break;
        }
    ...
    public f getCurrentCellInfo() {
        e s = com.tsf.shell.manager.a.h.n().s();
        if (s == null) {
            return null;
        }
        return s.getTag();
