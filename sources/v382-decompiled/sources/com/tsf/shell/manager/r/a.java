...
public class a {
    ...
    public static float[] a(c cVar, float f, float f2) {
        float[] fArr = {f, f2};
        float u = cVar.u();
        if (cVar instanceof com.tsf.shell.e.i.b.c.a) {
            ...
            if ((cVar.maxY() * u) + f2 > com.censivn.C3DEngine.b.b.a.s) {
                fArr[1] = com.censivn.C3DEngine.b.b.a.s - (u * cVar.maxY());
            } else if ((cVar.minY() * u) + f2 < com.censivn.C3DEngine.b.b.a.u) {
                fArr[1] = com.censivn.C3DEngine.b.b.a.u - (u * cVar.minY());
            }
        } else {
            if ((cVar.maxX() * u) + f > com.censivn.C3DEngine.b.b.a.A) {
                fArr[0] = com.censivn.C3DEngine.b.b.a.A - (cVar.maxX() * u);
            } else if ((cVar.minX() * u) + f < com.censivn.C3DEngine.b.b.a.z) {
                fArr[0] = com.censivn.C3DEngine.b.b.a.z - (cVar.minX() * u);
            }
            if ((cVar.maxY() * u) + f2 > com.censivn.C3DEngine.b.b.a.s) {
                fArr[1] = com.censivn.C3DEngine.b.b.a.s - (u * cVar.maxY());
            } else if ((cVar.minY() * u) + f2 < com.censivn.C3DEngine.b.b.a.u) {
