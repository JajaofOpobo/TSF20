...
import com.tsf.shell.services.b;
...
public class a implements b {
    ...
    public void a() {
        ...
        try {
            ...
            k.a(Home.b(), R.string.mn_unread_download_notic, R.string.public_action_ok, R.string.public_action_cancel, new Runnable() { // from class: com.tsf.shell.manager.q.a.5
                @Override // java.lang.Runnable
                public void run() {
                    l.a(Home.b(), "com.tsf.shell.services.notifier");
                }
            }, (Runnable) null);
        }
    }
    ...
    public void a(i iVar) {
        if (this.i == null && com.tsf.shell.utils.b.a(iVar.b)) {
            this.i = iVar;
            if (this.g) {
        ...
        if (this.j == null && com.tsf.shell.utils.b.b(iVar.b)) {
            this.j = iVar;
            if (this.g) {
        ...
        if (this.m == null && com.tsf.shell.utils.b.e(iVar.b)) {
            this.m = iVar;
            if (this.g) {
        ...
        if (this.l == null && com.tsf.shell.utils.b.c(iVar.b)) {
            this.l = iVar;
            if (this.g) {
        ...
        if (this.k == null && com.tsf.shell.utils.b.d(iVar.b)) {
            this.k = iVar;
            if (this.g) {
    ...
    @Override // com.tsf.shell.services.b
    public void a(int i) {
        int i2 = 1;
        this.a = i;
        if (this.j != null && this.j.h() != i) {
            RenderRunnable renderRunnable = new RenderRunnable(i2, i2) { // from class: com.tsf.shell.manager.q.a.11
    ...
    public void b(int i) {
        ...
        if (this.i != null && this.i.h() != this.b) {
            RenderRunnable renderRunnable = new RenderRunnable(i2, i2) { // from class: com.tsf.shell.manager.q.a.12
                @Override // com.censivn.C3DEngine.api.message.RenderRunnable, java.lang.Runnable
                public void run() {
                    if (a.this.i != null) {
                        a.this.i.a(a.this.b);
    ...
    public void d(int i) {
        ...
        if (this.k != null && this.k.h() != this.c) {
            RenderRunnable renderRunnable = new RenderRunnable(i2, i2) { // from class: com.tsf.shell.manager.q.a.2
                @Override // com.censivn.C3DEngine.api.message.RenderRunnable, java.lang.Runnable
                public void run() {
                    if (a.this.k != null) {
                        a.this.k.a(a.this.c);
    ...
    public void e(int i) {
        ...
        if (this.l != null && this.l.h() != this.e) {
            RenderRunnable renderRunnable = new RenderRunnable(i2, i2) { // from class: com.tsf.shell.manager.q.a.3
                @Override // com.censivn.C3DEngine.api.message.RenderRunnable, java.lang.Runnable
                public void run() {
                    if (a.this.l != null) {
                        a.this.l.a(a.this.e);
    ...
    public void f(int i) {
        ...
        if (this.m != null && this.m.h() != this.f) {
            RenderRunnable renderRunnable = new RenderRunnable(i2, i2) { // from class: com.tsf.shell.manager.q.a.4
                @Override // com.censivn.C3DEngine.api.message.RenderRunnable, java.lang.Runnable
                public void run() {
                    if (a.this.m != null) {
                        a.this.m.a(a.this.f);
