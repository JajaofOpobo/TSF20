...
public class a {
    ...
    public void a(Canvas canvas, Bitmap bitmap, boolean z) {
        if (bitmap.getWidth() != this.H || bitmap.getHeight() != this.I) {
            m.a(bitmap, "drawIconToCanvas icon size error  w:" + bitmap.getWidth() + "   h:" + bitmap.getHeight() + "  sw:" + this.H + "  sh:" + this.I);
        }
    ...
    public void a(j jVar, boolean z) {
        if (z) {
            jVar.setAABBPX(this.L, this.N, 0.0f, this.M, this.O, 0.0f);
        } else {
            jVar.setAABBPX(this.P, this.R, 0.0f, this.Q, this.S, 0.0f);
        }
    }

    public void a(j jVar, float f, float f2, boolean z) {
        if (z) {
            jVar.setAABBPX(this.L + f, this.N + f2, 0.0f, this.M + f, this.O + f2, 0.0f);
        } else {
            jVar.setAABBPX(this.P + f, this.R + f2, 0.0f, this.Q + f, this.S + f2, 0.0f);
        }
    }
}
