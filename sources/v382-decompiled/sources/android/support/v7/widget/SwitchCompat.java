...
public class SwitchCompat extends CompoundButton {
    ...
    private final android.support.v7.internal.widget.f E;
    private Drawable a;
    private Drawable b;
    private int c;
    private int d;
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, android.support.v7.a.b.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        android.support.v7.internal.widget.i a = android.support.v7.internal.widget.i.a(context, attributeSet, android.support.v7.a.h.SwitchCompat, i, 0);
        this.a = a.a(android.support.v7.a.h.SwitchCompat_android_thumb);
        if (this.a != null) {
            this.a.setCallback(this);
        }
        this.b = a.a(android.support.v7.a.h.SwitchCompat_track);
        if (this.b != null) {
            this.b.setCallback(this);
        }
        this.g = a.b(android.support.v7.a.h.SwitchCompat_android_textOn);
        this.h = a.b(android.support.v7.a.h.SwitchCompat_android_textOff);
        this.i = a.a(android.support.v7.a.h.SwitchCompat_showText, true);
        this.c = a.a(android.support.v7.a.h.SwitchCompat_thumbTextPadding, 0);
        this.d = a.a(android.support.v7.a.h.SwitchCompat_switchMinWidth, 0);
        this.e = a.a(android.support.v7.a.h.SwitchCompat_switchPadding, 0);
        this.f = a.a(android.support.v7.a.h.SwitchCompat_splitTrack, false);
        int b = a.b(android.support.v7.a.h.SwitchCompat_switchTextAppearance, 0);
        if (b != 0) {
            a(context, b);
        }
        this.E = a.b();
    ...
    public void a(Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(i, android.support.v7.a.h.TextAppearance);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(android.support.v7.a.h.TextAppearance_android_textColor);
        if (colorStateList != null) {
            this.y = colorStateList;
        } else {
            this.y = getTextColors();
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(android.support.v7.a.h.TextAppearance_android_textSize, 0);
        if (dimensionPixelSize != 0 && dimensionPixelSize != this.x.getTextSize()) {
            this.x.setTextSize(dimensionPixelSize);
            requestLayout();
        }
        a(obtainStyledAttributes.getInt(android.support.v7.a.h.TextAppearance_android_typeface, -1), obtainStyledAttributes.getInt(android.support.v7.a.h.TextAppearance_android_textStyle, -1));
        if (obtainStyledAttributes.getBoolean(android.support.v7.a.h.TextAppearance_textAllCaps, false)) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        int i7 = rect.right;
        if (this.a != null) {
            Rect a = android.support.v7.internal.widget.a.a(this.a);
        ...
        if (getMeasuredHeight() < max2) {
            setMeasuredDimension(ak.e(this), max2);
        }
    }
    ...
    private void a(boolean z) {
        ...
        final float f2 = (z ? 1 : 0) - f;
        this.C = new Animation() { // from class: android.support.v7.widget.SwitchCompat.1
            @Override // android.view.animation.Animation
            protected void applyTransformation(float f3, Transformation transformation) {
                SwitchCompat.this.setThumbPosition(f + (f2 * f3));
            }
        };
    ...
    public void setChecked(boolean z) {
        super.setChecked(z);
        boolean isChecked = isChecked();
        if (getWindowToken() != null && ak.f(this)) {
            a(isChecked);
        } else {
            a();
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.a != null) {
            rect = android.support.v7.internal.widget.a.a(this.a);
        } else {
            rect = android.support.v7.internal.widget.a.a;
        }
        if (this.b != null) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable != null) {
            if (this.f && drawable2 != null) {
                Rect a = android.support.v7.internal.widget.a.a(drawable2);
