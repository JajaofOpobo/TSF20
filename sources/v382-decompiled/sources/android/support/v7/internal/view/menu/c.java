...
public final class c implements android.support.v4.c.a.b {
    ...
    private int q;
    private View r;
    private android.support.v4.view.j s;
    private v t;
    ...
    c(a aVar, int i, int i2, int i3, int i4, CharSequence charSequence, int i5) {
        this.q = 0;
        this.l = aVar;
        this.a = i2;
        this.b = i;
    ...
    public boolean a() {
        if ((this.o != null && this.o.onMenuItemClick(this)) || this.l.a(this.l.j(), this)) {
            return true;
        }
        if (this.n != null) {
            this.n.run();
    ...
    public Drawable getIcon() {
        ...
        if (this.k != 0) {
            Drawable a = android.support.v7.internal.widget.f.a(this.l.d(), this.k);
            this.k = 0;
            this.j = a;
            return a;
        }
    ...
    public android.support.v4.view.j i() {
        return this.s;
    }
