...
final class y implements android.support.v4.a.d {
    final int a;
    final Bundle b;
    w c;
    ...
    void e() {
        ...
        if (!this.i && this.d != null && this.m) {
            this.m = false;
            this.d.a((android.support.v4.a.d) this);
            this.d.c();
        }
    }
    ...
    void a(android.support.v4.a.c cVar, Object obj) {
        String str;
        if (this.c != null) {
            if (this.o.e == null) {
                str = null;
    ...
    public void a(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (this.d != null) {
            this.d.a(String.valueOf(str) + "  ", fileDescriptor, printWriter, strArr);
        }
        if (this.e || this.f) {
            printWriter.print(str);
