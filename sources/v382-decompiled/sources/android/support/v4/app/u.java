...
public class u extends Fragment {
    ...
    private final Runnable aj = new Runnable() { // from class: android.support.v4.app.u.1
        @Override // java.lang.Runnable
        public void run() {
            u.this.b.focusableViewAvailable(u.this.b);
        }
    };
    private final AdapterView.OnItemClickListener ak = new AdapterView.OnItemClickListener() { // from class: android.support.v4.app.u.2
    ...
    public View a(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        linearLayout.addView(new ProgressBar(i, null, R.attr.progressBarStyleLarge), new FrameLayout.LayoutParams(-2, -2));
    ...
    private void a() {
        if (this.b == null) {
            ...
            if (o instanceof ListView) {
                ...
                if (this.d == null) {
                    this.c = o.findViewById(R.id.empty);
                } else {
