...
public class a extends VObject3dContainer {
    ...
    private void e() {
        Bitmap a = r.a(this.k.a, o.a.cube_clock_widget_setting_bg);
        this.b = this.k.b.createTexture(a, true);
        a.recycle();
        Bitmap a2 = r.a(this.k.a, o.a.cube_clock_plus);
        this.d = this.k.b.createTexture(a2, true);
        a2.recycle();
        Bitmap a3 = r.a(this.k.a, o.a.cube_clock_minus);
        this.e = this.k.b.createTexture(a3, true);
        a3.recycle();
        Bitmap a4 = r.a(this.k.a, o.a.cube_clock_light);
