    ...
    public void a(final com.tsf.shell.widget.alarm.d.c cVar) {
        this.e.post(new Runnable() { // from class: com.tsf.shell.widget.alarm.g.3
            ...
            public void run() {
                ...
                new b(g.this.k, g.this.i, g.this.i.b, 100, false);
                new b(g.this.l, g.this.i, g.this.i.c, VEasing.Back.easeIn, false);
                new b(g.this.j, g.this.i, g.this.i.a, 300, false);
                new b(g.this.m, g.this.i, g.this.i.d, VEasing.Linear.easeNone, true);
            }
