...
public class f implements AlarmWidget.b {
    ...
    public void d() {
        ...
        new b(this, this.c, a.a[parseInt / 10], 0);
        new b(this, this.d, a.a[parseInt % 10], VEasing.Back.easeIn);
        new b(this, this.f, a.a[parseInt2 / 10], VEasing.Linear.easeNone);
        new b(this, this.g, a.a[parseInt2 % 10], 600);
    }
