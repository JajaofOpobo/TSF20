...
public class c extends f {
    ...
    /* renamed from: com.tsf.shell.widget.a.a.c$c  reason: collision with other inner class name */
    /* loaded from: classes.dex */
    ...
    class b extends com.censivn.C3DEngine.b.d.a {
        ...
        public void a(final MotionEvent motionEvent) {
            com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.widget.a.a.c.b.1
                ...
                public void run() {
                    Number3d l = b.this.l(motionEvent);
                    c.this.b.a(l.x, l.y);
                }
            });
        }
        ...
        public void a(MotionEvent motionEvent, final MotionEvent motionEvent2, float f, float f2) {
            com.censivn.C3DEngine.a.a().c(new Runnable() { // from class: com.tsf.shell.widget.a.a.c.b.2
                @Override // java.lang.Runnable
                public void run() {
                    Number3d l = b.this.l(motionEvent2);
                    c.this.b.a(l.x, l.y);
                }
            });
        }
        ...
        public Number3d l(MotionEvent motionEvent) {
            ...
            number3d.y = 0.0f - (motionEvent.getY() - (VInformation.getScreenHeight() / 2.0f));
            number3d.z = 0.0f;
    ...
    class a extends com.censivn.C3DEngine.b.f.a.a {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: com.tsf.shell.widget.a.a.c$a$a  reason: collision with other inner class name */
        /* loaded from: classes.dex */
        public class C0170a extends com.censivn.C3DEngine.b.g.d {
            int C;
            int D;
            int E;
            boolean a = true;
        ...
        public void b(int[] iArr) {
            for (int i = 0; i < 14; i++) {
                ...
                c0170a.b(i * 40);
                c0170a.c(iArr[i]);
                com.censivn.C3DEngine.b.g.c.a(a, 90, c0170a);
            }
        }
    ...
    public void f() {
        if (this.e.id == 0) {
            Bitmap a2 = a(-1, 100, 100);
            com.censivn.C3DEngine.a.g().a(this.e, a2);
            a2.recycle();
        }
        if (this.f.id == 0) {
            Bitmap b2 = b(-1, (int) com.censivn.C3DEngine.b.b.a.a(30.0f));
            com.censivn.C3DEngine.a.g().a(this.f, b2);
            b2.recycle();
        }
    }
}
