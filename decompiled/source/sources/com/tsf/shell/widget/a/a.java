...
public class a extends com.censivn.C3DEngine.b.f.j {
    ...
    public void a() {
        ...
        for (int i = 0; i < 60; i++) {
            ...
            this.u[i] = new b(a2, 250.0f, ((-6.0f) * i) + 90.0f);
            a2.b(0, 0, 1, 1);
            a2.h();
        }
        for (int i2 = 0; i2 < 60; i2 += 2) {
            ...
            this.t.add(new j(a3, this.j.a(i3)));
        }
        this.j.calAABB();
    ...
    private void f() {
        ...
        if (Math.abs(this.D - this.G) > 1.0f || abs > 1.0f || abs2 > 1.0f) {
            invalidate();
    ...
    /* renamed from: com.tsf.shell.widget.a.a$a  reason: collision with other inner class name */
    /* loaded from: classes.dex */
