...
public class b {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:36:0x00db, code lost:
        throw new com.tsf.shell.plugin.a.c("single trailing character at offset " + (r14 - 1));
     */
    ...
    */
    public static byte[] a(byte[] r12, int r13, int r14, byte[] r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tsf.shell.plugin.a.b.a(byte[], int, int, byte[]):byte[]");
    }
}
