...
public class d extends Fragment implements View.OnClickListener, k.h {
    ...
    public View a(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(f.h.theme_perview_wallpaper_fragment, viewGroup, false);
        this.f = (GridView) inflate.findViewById(f.C0155f.gridView);
        ...
        this.f.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.tsf.shell.plugin.themepicker.wallpaper.d.2
            ...
            public void onGlobalLayout() {
                int floor = (int) Math.floor(d.this.f.getWidth() / (d.this.a + d.this.c));
                if (floor > 0) {
                    int width = (d.this.f.getWidth() / floor) - d.this.c;
                    d.this.d.b(floor);
                    d.this.d.a(width);
                    if (h.e()) {
        ...
        ((ImageView) inflate.findViewById(f.C0155f.imageView1)).setImageDrawable(this.h.loadIcon(i().getPackageManager()));
        ((TextView) inflate.findViewById(f.C0155f.textView1)).setText(this.h.loadLabel(i().getPackageManager()));
        this.i = (TextView) inflate.findViewById(f.C0155f.textView2);
        this.ai = (TextView) inflate.findViewById(f.C0155f.textView3);
    ...
    private class a extends BaseAdapter implements AdapterView.OnItemClickListener {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (i < this.e) {
                ...
                d.this.e.a(Integer.valueOf(this.g[i - this.e]), recyclingImageView);
