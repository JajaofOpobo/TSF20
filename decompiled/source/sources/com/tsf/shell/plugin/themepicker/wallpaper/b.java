...
public class b extends Fragment implements View.OnClickListener {
    ...
    public View a(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(f.h.theme_preview_gallery_fragment, viewGroup, false);
        this.a = (GridView) inflate.findViewById(f.C0155f.gridView);
        ...
        this.a.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.tsf.shell.plugin.themepicker.wallpaper.b.1
            ...
            public void onGlobalLayout() {
                int width = b.this.a.getWidth() - applyDimension3;
        ...
        ((ImageView) inflate.findViewById(f.C0155f.imageView1)).setImageResource(f.e.ic_launcher_wallpaper);
        ((TextView) inflate.findViewById(f.C0155f.textView1)).setText(f.j.theme_picker_theme_picker_gallery_apps);
