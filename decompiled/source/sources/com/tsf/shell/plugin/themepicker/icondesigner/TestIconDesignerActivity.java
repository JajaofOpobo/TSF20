...
public class TestIconDesignerActivity extends Activity implements View.OnClickListener, c.a, k.f {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.f = new d();
        com.tsf.shell.plugin.themepicker.e.b("getThemePreviewCount Cost :" + (System.currentTimeMillis() - currentTimeMillis));
    }
    ...
    public void onClick(View view) {
        ...
        com.tsf.shell.plugin.themepicker.e.b("load bitmap Cost :" + (System.currentTimeMillis() - currentTimeMillis));
        ((ImageView) findViewById(f.C0155f.imageView1)).setImageBitmap(a);
        this.c++;
        this.e = this.a.size();
        if (this.c >= this.e) {
            this.c = 0;
