...
public class LinePageIndicator extends View implements c {
    ...
    public LinePageIndicator(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!isInEditMode()) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f.k.LinePageIndicator, i, 0);
            this.f = obtainStyledAttributes.getBoolean(f.k.LinePageIndicator_centered, z);
            this.g = obtainStyledAttributes.getDimension(f.k.LinePageIndicator_lineWidth, dimension);
            this.h = obtainStyledAttributes.getDimension(f.k.LinePageIndicator_gapWidth, dimension2);
            setStrokeWidth(obtainStyledAttributes.getDimension(f.k.LinePageIndicator_strokeWidth, dimension3));
            this.a.setColor(obtainStyledAttributes.getColor(f.k.LinePageIndicator_unselectedColor, color2));
            this.b.setColor(obtainStyledAttributes.getColor(f.k.LinePageIndicator_selectedColor, color));
            Drawable drawable = obtainStyledAttributes.getDrawable(f.k.LinePageIndicator_android_background);
            if (drawable != null) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (action) {
            ...
            case 3:
                if (!this.l) {
                    ...
                    if (this.e > 0 && motionEvent.getX() < f - f2) {
                        ...
                        return true;
                    } else if (this.e < b - 1 && motionEvent.getX() > f2 + f) {
                        if (action != 3) {
                            this.c.setCurrentItem(this.e + 1);
                            return true;
                        }
                ...
                return true;
            case 2:
                float c = t.c(motionEvent, t.a(motionEvent, this.k));
                float f3 = c - this.j;
            ...
            case 5:
                ...
                this.j = t.c(motionEvent, b2);
                this.k = t.b(motionEvent, b2);
                return true;
            case 6:
                int b3 = t.b(motionEvent);
                if (t.b(motionEvent, b3) == this.k) {
                    this.k = t.b(motionEvent, b3 == 0 ? 1 : 0);
                }
    ...
    private int c(int i) {
        ...
        if (mode == 1073741824 || this.c == null) {
            ...
            f = ((b - 1) * this.h) + getPaddingLeft() + getPaddingRight() + (this.c.getAdapter().b() * this.g);
