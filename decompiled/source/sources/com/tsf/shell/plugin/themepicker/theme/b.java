...
public class b extends Fragment implements View.OnClickListener {
    ...
    public void a(Bundle bundle) {
        ...
        this.f = new a(i(), queryIntentActivities);
    }
    ...
    public View a(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.b = (GridView) inflate.findViewById(f.C0155f.gridView);
        ...
        ((ImageView) inflate.findViewById(f.C0155f.imageView1)).setImageResource(f.e.theme_preview_tsf_ico);
        ((TextView) inflate.findViewById(f.C0155f.textView1)).setText(f.j.theme_picker_system);
        inflate.findViewById(f.C0155f.linearLayout1).setOnClickListener(this);
        inflate.findViewById(f.C0155f.imageView2).setVisibility(8);
        return inflate;
    }
    ...
    private class a extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (i < this.e) {
                ...
                b.this.e.a(this.g.get(i - this.e), recyclingImageView);
