...
public class TitlePageIndicator extends View implements com.tsf.shell.plugin.themepicker.indicator.c {
    ...
    public TitlePageIndicator(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!isInEditMode()) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f.k.TitlePageIndicator, i, 0);
            this.v = obtainStyledAttributes.getDimension(f.k.TitlePageIndicator_footerLineHeight, dimension);
            this.m = a.a(obtainStyledAttributes.getInteger(f.k.TitlePageIndicator_footerIndicatorStyle, integer));
            this.p = obtainStyledAttributes.getDimension(f.k.TitlePageIndicator_footerIndicatorHeight, dimension2);
            this.q = obtainStyledAttributes.getDimension(f.k.TitlePageIndicator_footerIndicatorUnderlinePadding, dimension3);
            this.r = obtainStyledAttributes.getDimension(f.k.TitlePageIndicator_footerPadding, dimension4);
            this.n = b.a(obtainStyledAttributes.getInteger(f.k.TitlePageIndicator_linePosition, integer2));
            this.t = obtainStyledAttributes.getDimension(f.k.TitlePageIndicator_topPadding, dimension8);
            this.s = obtainStyledAttributes.getDimension(f.k.TitlePageIndicator_titlePadding, dimension6);
            this.u = obtainStyledAttributes.getDimension(f.k.TitlePageIndicator_clipPadding, dimension7);
            this.i = obtainStyledAttributes.getColor(f.k.TitlePageIndicator_selectedColor, color2);
            this.h = obtainStyledAttributes.getColor(f.k.TitlePageIndicator_android_textColor, color3);
            this.g = obtainStyledAttributes.getBoolean(f.k.TitlePageIndicator_selectedBold, z);
            float dimension9 = obtainStyledAttributes.getDimension(f.k.TitlePageIndicator_android_textSize, dimension5);
            int color4 = obtainStyledAttributes.getColor(f.k.TitlePageIndicator_footerColor, color);
            ...
            Drawable drawable = obtainStyledAttributes.getDrawable(f.k.TitlePageIndicator_android_background);
            if (drawable != null) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float f3;
        super.onDraw(canvas);
        if (this.a != null && (b2 = this.a.getAdapter().b()) != 0) {
            ...
            while (true) {
                ...
                if ((rect6.left > 0 && rect6.left < i4) || (rect6.right > 0 && rect6.right < i4)) {
                    ...
                    canvas.drawText(c2, 0, c2.length(), rect6.left, this.t + rect6.bottom, this.f);
                    if (z3 && z) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (action) {
            ...
            case 3:
                ...
                return true;
            case 2:
                float c2 = t.c(motionEvent, t.a(motionEvent, this.y));
                float f5 = c2 - this.x;
            ...
            case 5:
                ...
                this.y = t.b(motionEvent, b3);
                return true;
            case 6:
                int b4 = t.b(motionEvent);
                if (t.b(motionEvent, b4) == this.y) {
                    this.y = t.b(motionEvent, b4 == 0 ? 1 : 0);
                }
    ...
    private CharSequence c(int i) {
        CharSequence c2 = this.a.getAdapter().c(i);
        if (c2 == null) {
            return "";
        }
        return c2;
