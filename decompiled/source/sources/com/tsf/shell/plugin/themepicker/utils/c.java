...
public class c {
        ...
        synchronized (this.e) {
            if (this.b == null || this.b.a()) {
                ...
                if (this.d.g && file != null) {
                    ...
                    if (a(file) > this.d.b) {
                        try {
                            this.b = com.tsf.shell.plugin.themepicker.utils.b.a(file, 1, 1, this.d.b);
                            com.tsf.shell.plugin.themepicker.e.a("ImageCache", "Disk cache initialized");
                        } catch (IOException e) {
                            this.d.c = null;
                            com.tsf.shell.plugin.themepicker.e.c("ImageCache", "initDiskCache - " + e);
                        }
                    }
                }
            }
    ...
    public BitmapDrawable a(String str) {
        ...
        if (this.c != null) {
            bitmapDrawable = this.c.a((android.support.v4.d.f<String, BitmapDrawable>) str);
        }
            ...
            if (this.b != null) {
                try {
                    if (!this.b.a()) {
                        this.b.close();
                        this.b = null;
                        com.tsf.shell.plugin.themepicker.e.a("ImageCache", "Disk cache closed");
                    }
                } catch (IOException e) {
                    com.tsf.shell.plugin.themepicker.e.c("ImageCache", "close - " + e);
                }
            }
        }
    }
