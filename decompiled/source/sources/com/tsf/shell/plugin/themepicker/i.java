...
public class i extends Fragment implements View.OnClickListener, k.h {
    ...
    public View a(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(f.h.theme_perview_icon_fragment, viewGroup, false);
        this.e = (GridView) inflate.findViewById(f.C0155f.gridView);
        ...
        this.e.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.tsf.shell.plugin.themepicker.i.2
            ...
            public void onGlobalLayout() {
                int floor = (int) Math.floor(i.this.e.getWidth() / (i.this.a + i.this.b));
                if (floor > 0) {
                    int width = (i.this.e.getWidth() / floor) - i.this.b;
                    i.this.c.b(floor);
                    i.this.c.a(width);
        ...
        ((ImageView) inflate.findViewById(f.C0155f.imageView1)).setImageDrawable(this.g.loadIcon(i().getPackageManager()));
        ((TextView) inflate.findViewById(f.C0155f.textView1)).setText(this.g.loadLabel(i().getPackageManager()));
        this.h = (TextView) inflate.findViewById(f.C0155f.textView2);
        this.i = (TextView) inflate.findViewById(f.C0155f.textView3);
        inflate.findViewById(f.C0155f.linearLayout1).setOnClickListener(this);
        ((ImageView) inflate.findViewById(f.C0155f.imageView2)).setOnClickListener(this);
        return inflate;
    }
    ...
    private class a extends BaseAdapter implements AdapterView.OnItemClickListener {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (i < this.e) {
                ...
                if (this.g != null) {
                    i.this.d.a(Integer.valueOf(this.g[i - this.e]), recyclingImageView);
                    imageView = recyclingImageView;
                } else {
                    i.this.d.a(this.h[i - this.e], recyclingImageView);
                    imageView = recyclingImageView;
                }
            }
            return imageView;
    ...
    public void onClick(View view) {
        if (view.getId() == f.C0155f.linearLayout1) {
            if (view.getId() == f.C0155f.linearLayout1) {
                ...
                if (i instanceof SildingMenuLayout.d) {
                    ((SildingMenuLayout.d) i).h();
                }
            }
        } else if (view.getId() == f.C0155f.imageView2) {
