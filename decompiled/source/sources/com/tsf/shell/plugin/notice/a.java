            ...
            try {
                ...
                if (!attribute.equals("") && a(context, attribute, Integer.valueOf(element.getAttribute("max")).intValue())) {
                    ...
                    if (!g.a(packageManager, attribute2)) {
                        ...
                        Bitmap createScaledBitmap = Bitmap.createScaledBitmap(BitmapFactory.decodeByteArray(a, 0, a.length), 96, 96, true);
                        String attribute3 = element.getAttribute("title");
                        String attribute4 = element.getAttribute("text");
                        Notification.Builder builder = new Notification.Builder(context);
                        builder.setSmallIcon(f.a.ic_update).setContentIntent(activity).setContentTitle(attribute3).setLargeIcon(createScaledBitmap).setWhen(System.currentTimeMillis()).setContentText(attribute4).setAutoCancel(true);
