...
public class a extends h {
    ...
    /* renamed from: com.tsf.shell.preference.a.a.a.a$a  reason: collision with other inner class name */
    /* loaded from: classes.dex */
    public class C0162a extends com.censivn.C3DEngine.b.f.k {
        private m d;
        private float e;
    ...
    public a(String str) {
        ...
        this.b = new com.censivn.C3DEngine.b.f.a.a(12, 100, 300, (int) VEasing.Linear.easeNone);
        ...
        while (true) {
            ...
            a3.i().x = (i3 * (a + a2)) + f + (a / 2.0f);
            a3.i().y = (f2 - (i4 * (a + a2))) - (a / 2.0f);
        ...
        for (int i5 = 0; i5 < 4; i5++) {
            C0162a c0162a = new C0162a(strArr[i5]);
            c0162a.alpha(0.0f);
            c0162a.position().x = this.i + (i5 * (this.g + this.h));
    ...
    public void h() {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            com.censivn.C3DEngine.b.g.c.a(a7);
            com.censivn.C3DEngine.b.g.c.a(a7, 1000, dVar);
        }
        int i3 = 0;
        while (true) {
            int i4 = i3;
    ...
    public void m() {
        for (int i = 0; i < 12; i++) {
            ...
            com.censivn.C3DEngine.b.g.c.a(a, 1000, dVar);
        }
