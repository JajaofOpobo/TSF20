...
public class f extends i {
    ...
    public void j() {
        ...
        final int ar = com.tsf.shell.manager.b.e.ar();
        builder.setSingleChoiceItems(new String[]{x.c(b.i.mn_folder_animation_quick), x.c(b.i.mn_folder_animation_normal)}, ar, new DialogInterface.OnClickListener() { // from class: com.tsf.shell.preference.a.a.f.3
