...
public class a extends com.censivn.C3DEngine.b.e.f {
    ...
    private void h() {
        if (this.d.id == 0) {
            Bitmap a = x.a(b.d.preference_screen_frame, com.tsf.shell.manager.g.a.q, com.tsf.shell.manager.g.a.q);
            com.censivn.C3DEngine.a.g().a(this.d, a);
            a.recycle();
        }
        if (this.e.id == 0) {
            Bitmap a2 = x.a(b.d.preference_screen_widget_clock);
            com.censivn.C3DEngine.a.g().a(this.e, a2);
            a2.recycle();
        }
        if (this.g.id == 0) {
            Bitmap a3 = x.a(b.d.preference_screen_dock);
