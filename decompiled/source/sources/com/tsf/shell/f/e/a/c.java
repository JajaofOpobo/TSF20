...
public class c {
        ...
        if (!d) {
            ...
            e = new g(com.censivn.C3DEngine.b.b.a.z, com.censivn.C3DEngine.b.b.a.A, com.censivn.C3DEngine.b.b.a.b * (-80.0f), com.censivn.C3DEngine.b.b.a.b * 80.0f, com.tsf.shell.manager.o.b.a.T) { // from class: com.tsf.shell.f.e.a.c.3
                ...
                public i a(int i2, i iVar) {
                    com.censivn.C3DEngine.b.f.a.a aVar;
                    if (iVar == null) {
                        aVar = com.tsf.shell.manager.o.b.a.b();
                        aVar.a(true);
                        aVar.calAABB();
                    } else {
                        aVar = iVar;
                    ...
                    aVar.textures().clear();
                    aVar.textures().addElement(((com.tsf.shell.f.i.b.e.g) c.j.get(i2)).aZ());
                    return aVar;
                }
            ...
            b.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(b) { // from class: com.tsf.shell.f.e.a.c.4
                ...
                public void e(MotionEvent motionEvent) {
                    ...
                    i hittingTarget = this.c.getHittingTarget(a2[0], a2[1], true);
    ...
    public static void a() {
        j.clear();
        ArrayList<com.tsf.shell.f.i.b.e.g> d2 = com.tsf.shell.manager.a.w.a().a.d();
        if (k != null) {
            Iterator<com.tsf.shell.f.i.b.e.g> it = d2.iterator();
            while (it.hasNext()) {
                com.tsf.shell.f.i.b.e.g next = it.next();
                if (!k.contains(next.bd())) {
                    j.add(next);
                }
            }
            d2.clear();
        ...
        Iterator<com.tsf.shell.f.i.b.e.g> it2 = d2.iterator();
        while (it2.hasNext()) {
            j.add(it2.next());
        }
    }
