...
public abstract class d {
    ...
    private com.tsf.shell.f.e.g.a.b getFirstAvailableMenu(int i) {
        ...
        int i2 = 0;
        while (it.hasNext()) {
            com.tsf.shell.f.e.g.a.b next = it.next();
    ...
    public void setMenuItems(ArrayList<com.tsf.shell.f.e.g.a.b> arrayList) {
        ...
        while (it.hasNext()) {
            com.tsf.shell.f.e.g.a.b next = it.next();
            next.setMenu(this);
            next.onLayout(com.censivn.C3DEngine.b.b.a.z, (-this.mHeight) / 2.0f, com.censivn.C3DEngine.b.b.a.A, this.mHeight / 2.0f);
            ...
            if (this.mOffsetMenuHeight != menuHeight) {
                ...
                com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e.g.d.6
                    ...
                    public void a(float f3) {
                        d.this.mOffsetMenuHeight = f2 + ((menuHeight - f2) * f3);
