...
public class t extends com.censivn.C3DEngine.b.f.j implements b.a {
    ...
    /* loaded from: classes.dex */
    public static class c extends com.censivn.C3DEngine.b.f.b.a {
                ...
                public void a(MotionEvent motionEvent, MotionEvent motionEvent2, float f3, float f4) {
                    if (t.e) {
                        ...
                        if (this.b + x + (t.c.b.b() / 2.0f) <= com.censivn.C3DEngine.b.b.a.t) {
                            if ((this.b + x) - (t.c.b.b() / 2.0f) < com.censivn.C3DEngine.b.b.a.r) {
                        ...
                        if ((this.d - y) + (t.c.b.c() / 2.0f) <= com.censivn.C3DEngine.b.b.a.s) {
                            if ((this.d - y) - (t.c.b.c() / 2.0f) < com.censivn.C3DEngine.b.b.a.u) {
        ...
        public void a(int i) {
            ...
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.e.t.c.5
                ...
                public void a(float f2) {
                    ...
                    if (e != c.this.q) {
                        c.this.g.g(e + ((c.this.q - e) * f2));
                    }
                    if (a2 != c.this.r) {
                        c.this.g.c(a2 + ((c.this.r - a2) * f2));
                    }
                    if (d != c.this.s) {
                        c.this.g.e(d + ((c.this.s - d) * f2));
                    }
                }
        ...
        private void a(int i, boolean z) {
            switch (i) {
                case 0:
                    int a2 = (int) ((com.censivn.C3DEngine.b.b.a.I - t.a.position().y) - a());
                    int d = ((int) ((com.censivn.C3DEngine.b.b.a.I - t.a.position().y) + d())) - a2;
                    if (z) {
                        int[] a3 = a(t.d.a, a2, t.d.d, d, true);
                        t.d.b = a3[1];
                        t.d.e = a3[3];
                        t.c.ag();
                        return;
                    }
                    b(t.d.a, a2, t.d.d, d, true);
                    return;
                case 1:
                    int a4 = (int) (a() + d());
                    if (z) {
                        int[] a5 = a(t.d.a, t.d.b, t.d.d, a4, false);
                        t.d.e = a5[3];
                        t.c.ag();
                        return;
                    }
                    b(t.d.a, t.d.b, t.d.d, a4, false);
                    return;
                case 2:
                    int f = (int) ((t.a.position().x - f()) + com.censivn.C3DEngine.b.b.a.H);
                    int e = ((int) ((t.a.position().x + e()) + com.censivn.C3DEngine.b.b.a.H)) - f;
                    if (z) {
                        int[] a6 = a(f, t.d.b, e, t.d.e, true);
                        t.d.a = a6[0];
                        t.d.d = a6[2];
                        t.c.ag();
                        return;
                    }
                    b(f, t.d.b, e, t.d.e, true);
                    return;
                case 3:
                    int f2 = (int) (f() + e());
                    if (z) {
                        int[] a7 = a(t.d.a, t.d.b, f2, t.d.e, false);
                        t.d.d = a7[2];
                        t.c.ag();
                        return;
                    }
                    b(t.d.a, t.d.b, f2, t.d.e, false);
                    return;
                default:
                    return;
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public static class a extends com.censivn.C3DEngine.b.d.a {
        private float a;
        private float b;
        private int d;
        private c e;
