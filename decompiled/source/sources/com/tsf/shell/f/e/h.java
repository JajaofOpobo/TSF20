...
public class h {
    ...
    public boolean a(com.censivn.C3DEngine.b.f.i iVar, float f2, float f3, float f4, float f5) {
        Number3d clone = iVar.position().m4clone();
        clone.x += com.censivn.C3DEngine.b.b.a.H;
        clone.y = com.censivn.C3DEngine.b.b.a.I - clone.y;
        if (a(f2, f3, f4, f5, iVar.minX() + clone.x, iVar.minY() + clone.y, iVar.maxX() + clone.x, iVar.minY() + clone.y) || a(f2, f3, f4, f5, iVar.maxX() + clone.x, iVar.minY() + clone.y, iVar.maxX() + clone.x, iVar.maxY() + clone.y) || a(f2, f3, f4, f5, iVar.minX() + clone.x, iVar.maxY() + clone.y, iVar.maxX() + clone.x, iVar.maxY() + clone.y)) {
            return true;
        }
        if (a(f2, f3, f4, f5, iVar.minX() + clone.x, iVar.minY() + clone.y, iVar.minX() + clone.x, clone.y + iVar.maxY())) {
            return true;
        }
        return false;
    }
    ...
    public boolean b(MotionEvent motionEvent) {
        ...
        if (this.p != null) {
            ...
            if (motionEvent == null) {
                ...
                float[] a2 = x.a(motionEvent, new float[2]);
    ...
    public void c(MotionEvent motionEvent) {
        float[] b2 = x.b(motionEvent.getX(), motionEvent.getY());
        e.position().x = b2[0];
        e.position().y = b2[1];
