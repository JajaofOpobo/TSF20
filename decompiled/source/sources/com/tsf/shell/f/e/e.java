...
public class e extends com.censivn.C3DEngine.b.f.j {
    ...
    public static ArrayList<com.tsf.shell.f.i.c> c() {
        ArrayList<com.tsf.shell.f.i.c> b2 = b();
    ...
    public void onDrawStart() {
        if (c != null) {
            ...
            Iterator<com.censivn.C3DEngine.b.f.i> it = children().iterator();
            while (it.hasNext()) {
                com.censivn.C3DEngine.b.f.i next = it.next();
                next.position().x += ((iVar.position().x + (10.0f * com.censivn.C3DEngine.b.b.a.c)) - next.position().x) * f2;
                PositionNumber3d position = next.position();
                position.y = ((iVar.position().y - next.position().y) * f2) + position.y;
                iVar = next;
            }
        }
    }
    ...
    public void onDrawChildStart() {
        ...
        while (true) {
            numChildren--;
            if (numChildren > -1) {
                com.censivn.C3DEngine.b.f.i childAt = getChildAt(numChildren);
