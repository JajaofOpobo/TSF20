...
public class b extends j {
    ...
    public void a(float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        for (int i3 = 0; i3 < this.h; i3++) {
            ...
            aVar2.e = (float) (aVar2.e + (f7 * Math.cos((f10 * 3.141592653589793d) / 2.0d)));
            a aVar3 = this.c[a(i3, this.q)];
            aVar3.e = (float) (aVar3.e + (f7 * Math.cos((f10 * 3.141592653589793d) / 2.0d)));
            a aVar4 = this.c[a(i3, 0)];
            aVar4.e = (float) (aVar4.e - (f7 * Math.cos((f10 * 3.141592653589793d) / 2.0d)));
            a aVar5 = this.c[a(i3, 1)];
            aVar5.e = (float) (aVar5.e - (f7 * Math.cos((f10 * 3.141592653589793d) / 2.0d)));
        }
        for (int i4 = 0; i4 < this.h; i4++) {
            float f11 = (i4 - f9) / f9;
            a aVar6 = this.c[a(this.p, i4)];
            aVar6.d = (float) (aVar6.d + (f8 * Math.cos((f11 * 3.141592653589793d) / 2.0d)));
            a aVar7 = this.c[a(this.q, i4)];
            aVar7.d = (float) (aVar7.d + (f8 * Math.cos((f11 * 3.141592653589793d) / 2.0d)));
            a aVar8 = this.c[a(0, i4)];
            aVar8.d = (float) (aVar8.d - (f8 * Math.cos((f11 * 3.141592653589793d) / 2.0d)));
            a aVar9 = this.c[a(1, i4)];
            aVar9.d = (float) (aVar9.d - (f8 * Math.cos((f11 * 3.141592653589793d) / 2.0d)));
        }
    }
    ...
    public void b(final float f, final float f2, final float f3, final Runnable runnable) {
        ...
        final d dVar6 = new d() { // from class: com.tsf.shell.f.e.c.b.3
            ...
            public void b(float f7) {
                ...
                float f10 = sqrt * f7;
                b.this.b(f10, 0.0f, f8 - (f9 * f7), f8 - ((50.0f * b.this.x.d) * f7), 0.5f);
            }
    ...
    private a[] c(float f, float f2, float f3, float f4) {
        return f4 < f3 ? new a[]{new a(-f4, f2, 0.0f), new a(-f4, f, 0.0f), new a(-f3, f - f3, 0.0f), new a(-f3, f, 0.0f)} : new a[]{new a(-f4, f2, 0.0f), new a(-f4, f2 + f4, 0.0f), new a(-f3, f2, 0.0f), new a(-f3, f, 0.0f)};
    }
    ...
    private a a(a[] aVarArr, float f) {
        ...
        float f2 = (float) ((aVarArr[1].a - aVarArr[0].a) * 3.0d);
        float f3 = (float) (((aVarArr[2].a - aVarArr[1].a) * 3.0d) - f2);
        float f4 = (float) ((aVarArr[1].b - aVarArr[0].b) * 3.0d);
        float f5 = (float) (((aVarArr[2].b - aVarArr[1].b) * 3.0d) - f4);
        float f6 = f * f;
        float f7 = f6 * f;
        float f8 = f2 * f;
        aVar.a = f8 + (f3 * f6) + ((((aVarArr[3].a - aVarArr[0].a) - f2) - f3) * f7) + aVarArr[0].a;
        aVar.b = ((((aVarArr[3].b - aVarArr[0].b) - f4) - f5) * f7) + (f5 * f6) + (f4 * f) + aVarArr[0].b;
        return aVar;
    }
