...
public class c {
    ...
    public com.tsf.shell.f.f.a.a.a.b a(String str) {
        ...
        while (it.hasNext()) {
            ...
            if (next instanceof com.tsf.shell.f.f.a.a.a.b) {
                com.tsf.shell.f.f.a.a.a.b bVar = (com.tsf.shell.f.f.a.a.a.b) next;
    ...
    public c() {
        ...
        this.n = new a() { // from class: com.tsf.shell.f.f.a.a.c.1
            ...
            public void a(g gVar, boolean z) {
                String a2 = b.a(gVar);
                com.tsf.shell.f.f.a.a.a.b a3 = c.this.a(a2);
                if (a3 == null) {
                    c.this.b(b.a(a2, gVar));
                    return;
                }
                a3.a(gVar);
            }
            ...
            @Override // com.tsf.shell.f.f.a.a.c.a, com.tsf.shell.manager.a.c.a
            public void b(g gVar, boolean z) {
                com.tsf.shell.f.f.a.a.a.b a2 = c.this.a(gVar);
                if (a2 != null) {
                    a2.b(gVar);
                }
            }
    ...
    public void j() {
        ...
        this.p.a(new AnonymousClass8(a2, d), 0);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.tsf.shell.f.f.a.a.c$8  reason: invalid class name */
    /* loaded from: classes.dex */
    public class AnonymousClass8 implements Runnable {
        ...
        public void run() {
            c.this.p.a(com.censivn.C3DEngine.b.b.a.z + com.censivn.C3DEngine.b.b.a.a(50.0f), this.b, 600, new Runnable() { // from class: com.tsf.shell.f.f.a.a.c.8.1
                ...
                public void run() {
                    c.this.k();
                    final float b = c.this.k.b() + AnonymousClass8.this.a;
                    final float c = c.this.k.c() - AnonymousClass8.this.a;
                    final float f = c - b;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.tsf.shell.f.f.a.a.c$9  reason: invalid class name */
    /* loaded from: classes.dex */
    public class AnonymousClass9 extends com.censivn.C3DEngine.b.g.d {
        final /* synthetic */ float a;
        final /* synthetic */ float b;
    ...
    public void f() {
        if (this.e.parent() == null && com.tsf.shell.manager.a.w.a().b()) {
            ...
            this.e.alpha(255.0f);
            final j a2 = com.tsf.shell.manager.a.j.a(this.g);
            ...
            Runnable runnable = new Runnable() { // from class: com.tsf.shell.f.f.a.a.c.10
                ...
                public void run() {
                    ...
                    ArrayList<g> d = com.tsf.shell.manager.a.w.a().d();
                    ArrayList arrayList = new ArrayList();
                    Iterator<g> it = d.iterator();
                    while (it.hasNext()) {
                        g next = it.next();
                        if (next.K() != null && !((LauncherShortcutAppInfo) next.K()).isHide) {
                            arrayList.add(next);
                        }
                    }
                    ArrayList<b.c> a3 = b.a(arrayList);
                    ...
                    while (it2.hasNext()) {
                        com.tsf.shell.f.f.a.a.a.c a4 = c.this.a(it2.next());
                        a4.a(c.this.q, false);
                        a4.e();
                    }
                    a2.addChild(c.this.e);
                    c.this.e();
                    c.this.m.g();
                    c.this.d.c();
                    c.this.l.f();
    ...
    public com.tsf.shell.f.f.a.a.a.c a(b.c cVar) {
        com.tsf.shell.f.f.a.a.a.b c2 = this.h.c();
        c2.a(cVar);
        this.f.addChild(c2);
        this.i.add(c2);
        return c2;
    ...
    public com.tsf.shell.f.f.a.a.a.c b(b.c cVar) {
        com.tsf.shell.f.f.a.a.a.b c2 = this.h.c();
        c2.a(cVar);
        this.f.addChildAt(c2, b.a(this.i, c2) + 1);
        return c2;
    }
    ...
    public void g() {
        ...
        com.tsf.shell.manager.a.j.a(new Runnable() { // from class: com.tsf.shell.f.f.a.a.c.2
            ...
            public void run() {
                ...
                while (it.hasNext()) {
                    com.tsf.shell.f.f.a.a.a.c cVar = (com.tsf.shell.f.f.a.a.a.c) it.next();
                    cVar.f();
                    cVar.removeFromParent();
                    if (!(cVar instanceof d)) {
