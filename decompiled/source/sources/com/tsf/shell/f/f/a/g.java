    ...
    public void a(final String str) {
        com.censivn.C3DEngine.a.a().a(new Runnable() { // from class: com.tsf.shell.f.f.a.g.7
            ...
            public void run() {
                ...
                builder.setTitle(d.getString(b.i.text_rename));
                builder.setView(inflate);
                builder.setPositiveButton(d.getString(b.i.public_action_ok), new DialogInterface.OnClickListener() { // from class: com.tsf.shell.f.f.a.g.7.1
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i) {
                        String obj = editText.getText().toString();
                        g.this.e.a(obj);
                        com.tsf.shell.manager.b.e.k(obj);
                    }
                });
                builder.setNegativeButton(d.getString(b.i.public_action_cancel), new DialogInterface.OnClickListener() { // from class: com.tsf.shell.f.f.a.g.7.2
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i) {
                    }
                });
