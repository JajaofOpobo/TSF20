...
public class a extends c {
        ...
        this.c = new Comparator<i>() { // from class: com.tsf.shell.f.f.a.d.a.a.2
            ...
            public final int compare(i iVar, i iVar2) {
                ...
                if ((iVar instanceof com.tsf.shell.f.i.b.e.b) && (iVar2 instanceof com.tsf.shell.f.i.b.e.b)) {
                    ItemInfo K = ((com.tsf.shell.f.i.b.e.b) iVar).K();
                    return a.this.e.compare(((com.tsf.shell.f.i.b.e.b) iVar2).K().title, K.title);
                }
                return 0;
            }
        };
    ...
    public int a(i iVar) {
        ...
        g gVar = (g) iVar;
        if (gVar.bd() == null || gVar.bd().a == null || (a = com.tsf.shell.manager.a.w.a().a(gVar.bd().a.getComponent())) == null || a.K() == null) {
            return 0;
        }
