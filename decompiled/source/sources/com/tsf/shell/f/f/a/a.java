...
public class a extends c {
    ...
    /* renamed from: com.tsf.shell.f.f.a.a$a  reason: collision with other inner class name */
    /* loaded from: classes.dex */
    ...
    public void a(i iVar, int i, boolean z) {
        ...
        if (numChildren == h.m) {
            com.tsf.shell.f.i.b bVar = (com.tsf.shell.f.i.b) children().get(numChildren - 1);
            if (this.g && com.tsf.shell.manager.a.h.n().t() == -1 && !com.tsf.shell.manager.a.h.t().aq()) {
                final i a = com.tsf.shell.manager.a.h.t().a(bVar);
                a.removeFromParent();
                ...
                com.censivn.C3DEngine.b.g.c.a(a, VEasing.Linear.easeNone, dVar);
            }
    ...
    public boolean removeChild(i iVar) {
        ...
        if (numChildren() == 0) {
            ...
            if (this.d != null && this.d.e() != 0) {
                com.tsf.shell.f.i.b c = this.d.c();
                this.d.removeChild(c);
                super.addChild(c);
                c.position().y = h.E.get(numChildren() - 1).y;
        ...
        while (it.hasNext()) {
            ...
            if (next instanceof com.tsf.shell.f.i.b) {
                dVar = new com.censivn.C3DEngine.b.g.d() { // from class: com.tsf.shell.f.f.a.a.2
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a() {
                        a.this.children().remove(next);
                    }
                };
                dVar.f(next.position().x + com.censivn.C3DEngine.b.b.a.D);
        ...
        if (visible()) {
            ...
            if (renderChildren()) {
                ...
                while (true) {
                    ...
                    i childAt = getChildAt(numChildren);
