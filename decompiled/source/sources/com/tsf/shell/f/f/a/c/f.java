...
public class f extends i {
    ...
    public void e(com.tsf.shell.f.i.c cVar, MotionEvent motionEvent) {
        ...
        } else if (cVar.parent() == this.g.l()) {
            cVar.visible(true);
            cVar.scale().setAll(1.0f, 1.0f, 1.0f);
            Number3d.TEMPNUMBER3D.reset();
            Number3d localToGlobal = cVar.localToGlobal(Number3d.TEMPNUMBER3D);
            this.g.removeChild(cVar);
            com.tsf.shell.f.f.a.a ap = this.a.ap();
            cVar.position().setAllFrom(ap.globalToLocal(localToGlobal));
            ap.addChildAt(cVar, 0);
            this.a.a(cVar, ap, 0);
            this.a.ao().c();
        }
    }
