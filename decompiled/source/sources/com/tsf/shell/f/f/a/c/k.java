...
public class k extends i {
    ...
    public k(com.tsf.shell.f.f.a.h hVar, com.tsf.shell.f.f.a.f fVar) {
        ...
        e().addChild(this.h);
        e.a a2 = com.tsf.shell.manager.a.a.a(com.tsf.shell.manager.p.e.i);
        if (a2.a()) {
            l = new com.tsf.shell.f.e.k();
            a2.a(new e.a.C0142a() { // from class: com.tsf.shell.f.f.a.c.k.5
    ...
    public void b(boolean z) {
        ...
        float a2 = com.censivn.C3DEngine.b.b.a.a(200.0f);
        ...
        float a3 = com.censivn.C3DEngine.b.b.a.a(20.0f);
        int i = 0;
        float f4 = f3;
        while (i < numChildren) {
            com.tsf.shell.f.f.a.c.a.b bVar = this.g.get(i);
            ...
            bVar.b((i * 20) + 250);
            if (i < 3) {
                com.censivn.C3DEngine.b.g.c.a.a aVar = new com.censivn.C3DEngine.b.g.c.a.a(bVar, (i / 3) + 2, a2) { // from class: com.tsf.shell.f.f.a.c.k.6
    ...
    public void a() {
        ...
        for (int i = 0; i < this.g.size(); i++) {
            ...
            float a2 = com.censivn.C3DEngine.b.b.a.a(200.0f);
            if (i < 3) {
                com.censivn.C3DEngine.b.g.c.a.a aVar = new com.censivn.C3DEngine.b.g.c.a.a(bVar, (i / 3) + 2, a2) { // from class: com.tsf.shell.f.f.a.c.k.8
                    @Override // com.censivn.C3DEngine.b.g.d
                    public void a() {
                    }
                };
