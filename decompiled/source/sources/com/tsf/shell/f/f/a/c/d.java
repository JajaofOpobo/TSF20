    ...
    private void c() {
        ...
        this.g.a(new com.censivn.C3DEngine.b.h.b.b() { // from class: com.tsf.shell.f.f.a.c.d.1
            ...
            public com.censivn.C3DEngine.b.f.i a(int i, com.censivn.C3DEngine.b.f.i iVar) {
                com.censivn.C3DEngine.b.f.i iVar2;
                if (iVar == null) {
                    iVar2 = new com.tsf.shell.f.g.a.h();
                    iVar2.calAABB();
                } else {
                    iVar2 = iVar;
                }
                com.tsf.shell.f.f.a.b.k a = d.this.h.a(i);
                com.tsf.shell.f.g.a.h hVar = (com.tsf.shell.f.g.a.h) iVar2;
                if (a.i()) {
                    hVar.g();
                } else {
                    hVar.h();
                ...
                hVar.e.textures().addElement(a.a(com.tsf.shell.f.g.a.h.e(), com.tsf.shell.f.g.a.h.f()));
                return iVar2;
            }
        });
