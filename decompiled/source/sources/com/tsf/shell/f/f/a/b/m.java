...
public abstract class m extends k {
    ...
    public class a implements Comparator<com.censivn.C3DEngine.b.f.i> {
        ...
        public int compare(com.censivn.C3DEngine.b.f.i iVar, com.censivn.C3DEngine.b.f.i iVar2) {
            ...
            float floatValue = ((Float) iVar.getTag()).floatValue();
            float floatValue2 = ((Float) iVar2.getTag()).floatValue();
    ...
    public void a(com.censivn.C3DEngine.b.f.j jVar) {
        ...
        while (it.hasNext()) {
            ...
            if (jVar2.visible()) {
                ArrayList<com.censivn.C3DEngine.b.f.i> children = jVar2.children();
                int size = children.size() - 1;
                while (true) {
                    int i = size;
                    if (i > -1) {
                        this.k.add(children.get(i));
                        size = i - 1;
                    }
                }
            }
        ...
        com.censivn.C3DEngine.b.f.j aA = com.tsf.shell.manager.a.h.t().aA();
        MatrixStack.glPushMatrix();
        MatrixStack.glTranslatef(0.0f, 0.0f, -this.f);
        MatrixStack.glRotatef(aA.rotation().x, 1.0f, 0.0f, 0.0f);
        MatrixStack.glTranslatef(0.0f, 0.0f, this.f);
        Iterator<com.censivn.C3DEngine.b.f.i> it2 = this.k.iterator();
        while (it2.hasNext()) {
            com.censivn.C3DEngine.b.f.i next = it2.next();
            com.censivn.C3DEngine.b.f.i iVar = (com.censivn.C3DEngine.b.f.i) next.parent();
            MatrixStack.glPushMatrix();
            MatrixStack.glTranslatef(iVar.position().x, iVar.position().y, iVar.position().z);
            MatrixStack.glRotatef(iVar.rotation().y, 0.0f, 1.0f, 0.0f);
            if (next.visible()) {
                com.censivn.C3DEngine.b.f.j jVar3 = (com.censivn.C3DEngine.b.f.j) next;
                MatrixStack.glPushMatrix();
                jVar3.onDrawStart();
                jVar3.drawShader();
                ...
                if (jVar3.renderChildren()) {
                    int numChildren = jVar3.numChildren();
