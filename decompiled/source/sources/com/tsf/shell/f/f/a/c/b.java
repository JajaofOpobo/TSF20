...
public class b extends c.a {
    ...
    private void h() {
        ...
        this.b = new l(this.i, 1.0f) { // from class: com.tsf.shell.f.f.a.c.b.1
            ...
            public com.censivn.C3DEngine.b.f.i a(int i) {
                return b.this.a.l().getChildAt(i);
            }
        };
        ...
        e eVar = new e(b.d.drawer_layout_folder, 70, x.c(b.i.pop_menu_create_folder)) { // from class: com.tsf.shell.f.f.a.c.b.3
            ...
            public void a() {
                ...
                if (numChildren > 0) {
                    ...
                    while (true) {
                        ...
                        com.tsf.shell.f.i.b.e.b bVar = (com.tsf.shell.f.i.b.e.b) b.this.a.l().getChildAt(i2);
                        if (bVar.ao()) {
                            arrayList.add(bVar);
                        }
                        i = i2 - 1;
        ...
        this.f = eVar;
        this.d.add(eVar);
        e eVar2 = new e(b.d.drawer_layout_reset, 70, x.c(b.i.text_reset)) { // from class: com.tsf.shell.f.f.a.c.b.4
            @Override // com.tsf.shell.f.f.a.c.e
            public void a() {
                b.this.i();
            }
        ...
        float f2 = com.censivn.C3DEngine.b.b.a.D / (size + 1);
        float f3 = com.censivn.C3DEngine.b.b.a.z + (com.censivn.C3DEngine.b.b.a.D / (size + 1));
        ...
        if (numChildren > 0) {
            ...
            while (it.hasNext()) {
                ...
                if (iVar instanceof com.tsf.shell.f.i.b.e.b) {
                    ...
                    int b = this.c.b((com.tsf.shell.f.i.b) bVar);
                    int i = b % com.tsf.shell.f.f.a.h.m;
                    com.tsf.shell.f.f.a.a e = this.c.e(b);
    ...
    public void a(com.tsf.shell.f.i.c cVar, MotionEvent motionEvent) {
        if ((cVar.parent() instanceof com.tsf.shell.f.f.a.a) && (cVar instanceof com.tsf.shell.f.i.b.e.b)) {
            ...
            j();
        } else if (cVar.parent() == this.a.l() && (cVar instanceof com.tsf.shell.f.i.b.e.b)) {
            ...
            j();
        } else if ((cVar.parent() instanceof com.tsf.shell.f.f.a.a) && (cVar instanceof com.tsf.shell.f.i.b.d.b)) {
    ...
    public void b(com.tsf.shell.f.i.c cVar, MotionEvent motionEvent) {
        ...
        if (jVar == this.a.l()) {
            ...
            while (it3.hasNext()) {
                com.tsf.shell.f.i.c next = it3.next();
                com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d();
                dVar.l(1.0f);
                dVar.m(1.0f);
                com.censivn.C3DEngine.b.g.c.a(next);
                com.censivn.C3DEngine.b.g.c.a(next, VEasing.Back.easeIn, dVar);
            }
