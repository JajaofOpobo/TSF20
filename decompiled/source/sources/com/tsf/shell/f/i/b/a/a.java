...
public class a extends j {
    ...
    private void h() {
        ...
        com.censivn.C3DEngine.e.b a = com.censivn.C3DEngine.e.i.a(i.a.MAX_3DS, com.censivn.C3DEngine.a.d().getResources(), com.censivn.C3DEngine.a.b() + ":raw/widget_airship", true);
        a.c();
    ...
    private void i() {
        ...
        k kVar = new k(150.0f, 150.0f) { // from class: com.tsf.shell.f.i.b.a.a.3
            @Override // com.censivn.C3DEngine.b.f.i
            public void onDrawStart() {
                if (!a.this.a) {
                    rotation().z += 25.0f;
    ...
    private void j() {
        ...
        ArrayList<com.censivn.C3DEngine.c.a.a.b> b = this.k.b();
        com.censivn.C3DEngine.c.a.a.b bVar = b.get(this.m);
        bVar.d = false;
        bVar.f = false;
        bVar.e = false;
        com.censivn.C3DEngine.c.a.a.b bVar2 = b.get(this.n);
        bVar2.d = false;
        bVar2.f = false;
        bVar2.e = false;
        a(d());
    ...
    public void f() {
        if (this.b.id == 0) {
            Bitmap a = x.a(b.d.widget_airship_body);
            com.censivn.C3DEngine.a.g().a(this.b, a);
            a.recycle();
        }
        if (this.c.id == 0) {
            Bitmap a2 = x.a(b.d.widget_airship_propeller);
