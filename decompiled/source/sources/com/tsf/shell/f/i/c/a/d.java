...
public class d extends j {
    ...
    public void a(int i, TextureElement textureElement) {
        ...
        } else if (i == b.d.widget_preview_gallery_item1) {
            this.d[1] = textureElement;
        } else if (i == b.d.widget_preview_gallery_item2) {
            this.d[2] = textureElement;
        } else if (i == b.d.widget_preview_gallery_item3) {
            this.d[3] = textureElement;
        } else if (i == b.d.widget_preview_gallery_item4) {
            this.d[4] = textureElement;
        } else if (i == b.d.widget_preview_gallery_item5) {
