...
public class a extends com.tsf.shell.f.i.b implements a.InterfaceC0025a {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        if (i2 == -1) {
            if (i == this.s) {
                ...
                floatingItem.a();
                this.b = floatingItem;
                com.censivn.C3DEngine.a.a().a(new RenderRunnable(2, 1) { // from class: com.tsf.shell.f.i.b.c.a.1
        ...
        com.censivn.C3DEngine.a.a().a(new RenderRunnable(2, 1) { // from class: com.tsf.shell.f.i.b.c.a.2
            @Override // com.censivn.C3DEngine.api.message.RenderRunnable, java.lang.Runnable
            public void run() {
                com.tsf.shell.manager.a.i.a(a.this);
            }
    ...
    public boolean q() {
        ...
        if (this.b.h) {
            this.k = new b(this.b.l, this.b.k, this.b.j, this.b.i, a.width, a.height);
        } else {
            this.k = new C0114a(a.width * com.censivn.C3DEngine.b.b.a.b, a.height * com.censivn.C3DEngine.b.b.a.b, false);
        }
        this.k.setAnimationObjectState(true);
    ...
    /* renamed from: com.tsf.shell.f.i.b.c.a$a  reason: collision with other inner class name */
    /* loaded from: classes.dex */
