        ...
        if (com.tsf.shell.manager.a.A.a()) {
            if (bVar == null || !bVar.O()) {
                ...
                if (motionEvent != null && (this.c instanceof com.tsf.shell.f.e.f) && !this.g.D()) {
                    ...
                    if (fVar.o()) {
                        com.tsf.shell.f.e.f a2 = fVar.a((int) f, (int) f2);
                        if (a2 != null) {
                            fVar.f(a2);
                        } else {
                            fVar.p();
                ...
                if (!bVar.D()) {
                    ...
                    } else if (bVar == null || bVar.K() == null || bVar.K().title == null || !bVar.K().title.equals(x.c(b.i.panda))) {
                        ItemInfo K = bVar.K();
                        if (!(K instanceof LauncherShortcutStandardInfo) || (launcherShortcutStandardInfo = (LauncherShortcutStandardInfo) K) == null || launcherShortcutStandardInfo.intent == null || launcherShortcutStandardInfo.intent.getIntExtra("action", -1) != 19) {
    ...
    public void a(MotionEvent motionEvent, MotionEvent motionEvent2) {
        ...
        if (this.l) {
            if (this.g.D()) {
                ...
                float[] a2 = x.a(motionEvent2, this.r);
            ...
            if (motionEvent2.getPointerCount() == 2) {
                if (this.g.M()) {
                    ...
                    this.g.rotation().z = this.k - (this.j - l);
                }
            } else if (this.m) {
                a.a(motionEvent2.getX(), motionEvent2.getY(), this.h, this.i);
            } else if (this.n && (this.c instanceof com.tsf.shell.f.e.f)) {
                this.q.a((com.tsf.shell.f.e.f) this.c, motionEvent2);
            }
        } else if (this.p != null && this.g.Q()) {
