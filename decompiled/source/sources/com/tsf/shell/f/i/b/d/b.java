...
public class b extends com.tsf.shell.f.i.c implements com.tsf.shell.f.e.a.a, h.a, m, a.InterfaceC0113a {
    ...
    public b az() {
        ...
        Iterator<com.censivn.C3DEngine.b.f.i> it = this.o.children().iterator();
        while (it.hasNext()) {
            com.censivn.C3DEngine.b.f.i next = it.next();
            if (next instanceof com.tsf.shell.f.i.b.e.g) {
                LauncherShortcutAppInfo bb = ((com.tsf.shell.f.i.b.e.g) next).bb();
                bb.container = launcherFolder3DInfo.id;
                ShellModel.a.a(new ContentValues(), bb, (Runnable) null);
    ...
    public b(ItemInfo itemInfo) {
        ...
        this.W = new com.tsf.shell.f.i.a(this, this) { // from class: com.tsf.shell.f.i.b.d.b.18
            ...
            public boolean a(com.tsf.shell.f.i.b.e.b bVar) {
                if (b.this.aU() == 2) {
                    b.this.R.e();
                    if (b.this.R.c() && com.tsf.shell.manager.b.e.as()) {
                        b.this.R.a(false);
                        return true;
                    }
                }
                if (com.tsf.shell.manager.b.e.as()) {
                    b.this.m(false);
                }
                return true;
            }
        ...
        ArrayList<ItemInfo> a2 = com.tsf.shell.utils.h.a(((LauncherFolder3DInfo) itemInfo).getItemInfo(), itemInfo.config, ",", true);
        int size = a2.size();
        for (int i = 0; i < size; i++) {
            ItemInfo itemInfo2 = a2.get(i);
            if (i < l.K) {
                a(itemInfo2, false);
            } else {
                a(itemInfo2, true);
    ...
    private void a(ItemInfo itemInfo, boolean z) {
        com.tsf.shell.f.i.b.e.b bVar = (com.tsf.shell.f.i.b.e.b) itemInfo.getWidget();
        if (bVar == null) {
    ...
    public void aJ() {
        if (!this.af) {
            ...
            String str = "";
            for (int i = 0; i < this.o.children().size(); i++) {
    ...
    public void a(com.tsf.shell.f.i.b.e.b bVar, boolean z) {
        ArrayList<com.tsf.shell.f.i.c> av = bVar.av();
        if (av != null && av.size() > 0) {
            Iterator<com.tsf.shell.f.i.c> it = av.iterator();
            while (it.hasNext()) {
                com.tsf.shell.f.i.c next = it.next();
                LauncherShortcut3DInfo launcherShortcut3DInfo = (LauncherShortcut3DInfo) next.K();
    ...
    public void a(final String str) {
        if (str != "") {
            ...
            com.censivn.C3DEngine.a.a().c(new RenderRunnable(1, 1) { // from class: com.tsf.shell.f.i.b.d.b.20
                ...
                public void run() {
                    ...
                    if (b.this.aa != null) {
                        if (b.this.aa.parent() instanceof com.tsf.shell.f.c.b.a) {
                            com.tsf.shell.f.c.b.b a2 = com.tsf.shell.manager.a.g.a.a(b.this.aa);
                            b.this.L.x = a2.a;
                            b.this.L.y = a2.b;
                            b.this.M.z = a2.e;
                        } else {
                    ...
                    com.tsf.shell.manager.a.j.a(new Runnable() { // from class: com.tsf.shell.f.i.b.d.b.4.1
                        ...
                        public void run() {
                            ...
                            if (b.this.N != null) {
                                ArrayList<com.tsf.shell.f.i.c> av = b.this.N.av();
                                if (av != null && av.size() > 0) {
                                    Iterator<com.tsf.shell.f.i.c> it = av.iterator();
                                    while (it.hasNext()) {
    ...
    public void a(boolean z, final Runnable runnable, boolean z2) {
        ...
        if (aW > 0) {
            ...
            int i8 = aW - 1;
            while (i8 > -1) {
                final com.tsf.shell.f.i.b.e.b bVar2 = (com.tsf.shell.f.i.b.e.b) this.o.children().get((aW - i8) - 1);
    ...
    public void a(com.censivn.C3DEngine.b.f.i iVar, com.tsf.shell.f.i.b.e.g gVar) {
        ...
        Number3d globalToLocal = this.o.globalToLocal(iVar.localToGlobal(Number3d.TEMPNUMBER3D3));
    ...
    public void e(com.tsf.shell.f.e.f fVar) {
        ...
        if (bVar.as()) {
            ArrayList<com.tsf.shell.f.i.c> aw = bVar.aw();
            int size = aw.size();
            for (int i = 0; i < size; i++) {
                arrayList.add((com.tsf.shell.f.i.b.e.b) aw.get((size - i) - 1));
            }
        }
        arrayList.add(bVar);
        bi();
