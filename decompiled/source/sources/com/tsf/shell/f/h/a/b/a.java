...
public class a implements c.a {
    ...
    private void l() {
        while (!this.c.children().isEmpty()) {
            ...
            if (removeChildAt instanceof C0112a) {
                C0112a c0112a = (C0112a) removeChildAt;
                c0112a.q();
    ...
    private void n() {
        ...
        ArrayList<g> a = com.tsf.shell.manager.a.w.a().a().a(this.e);
        l();
        if (a.isEmpty()) {
            this.c.addChild(m());
            return;
        ...
        while (true) {
            ...
            if (i2 < a.size()) {
                ...
                C0112a c = this.d.c();
                c.a(gVar.bd());
                c.scale().setAll(0.9f, 0.9f, 1.0f);
                c.k.textures().clear();
                c.k.textures().addElement(gVar.aZ());
                this.c.addChild(c);
                i = i2 + 1;
            } else {
                return;
    ...
    /* renamed from: com.tsf.shell.f.h.a.b.a$a  reason: collision with other inner class name */
    /* loaded from: classes.dex */
