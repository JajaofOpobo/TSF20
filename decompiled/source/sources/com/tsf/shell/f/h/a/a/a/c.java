...
public class c extends j implements a.InterfaceC0098a {
    ...
    public void j() {
        ...
        Bitmap a = this.f.a().a(com.tsf.shell.f.h.a.a.d.c, com.tsf.shell.f.h.a.a.d.c, true);
        if (a != null) {
    ...
    public void b(boolean z) {
        ...
        this.i.clear();
        Iterator<a.c> it = this.f.a().f.iterator();
        while (it.hasNext()) {
            a.c next = it.next();
            d c = this.h.c();
            c.a(next);
        ...
        Iterator<a.C0126a> it2 = this.f.a().g.iterator();
        while (it2.hasNext()) {
