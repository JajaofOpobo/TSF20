...
public class e extends com.censivn.C3DEngine.b.f.a.a {
    ...
    public e() {
        ...
        this.o = 0.0f;
        if (k == null) {
            Bitmap a2 = x.a(b.d.dock_operation_border);
            k = com.censivn.C3DEngine.a.g().a(a2, false);
            a2.recycle();
            Bitmap a3 = x.a(b.d.dock_operation_border_point);
            l = com.censivn.C3DEngine.a.g().a(a3, false);
            a3.recycle();
        }
        ...
        com.censivn.C3DEngine.b.f.a.b a4 = a(0);
        uvs().set(a4.a, 1.0f, 1.0f);
        uvs().set(a4.b, 0.0f, 1.0f);
        uvs().set(a4.c, 1.0f, 0.0f);
        uvs().set(a4.d, 0.0f, 0.0f);
        com.censivn.C3DEngine.b.f.a.b a5 = a(1);
        uvs().set(a5.b, 1.0f, 1.0f);
        uvs().set(a5.a, 0.0f, 1.0f);
        uvs().set(a5.d, 1.0f, 0.0f);
        uvs().set(a5.c, 0.0f, 0.0f);
    ...
    public void b(float f) {
        ...
        if (f2 < 45.0f) {
            ...
            com.censivn.C3DEngine.b.f.a.b a2 = a(0);
            uvs().set(a2.a, 1.0f, 1.0f);
            uvs().set(a2.b, 0.0f, 1.0f);
            uvs().set(a2.c, (this.a - tan) / this.a, 0.0f);
            uvs().set(a2.d, 0.0f, 0.0f);
            com.censivn.C3DEngine.b.f.a.b a3 = a(1);
            uvs().set(a3.a, 0.0f, 1.0f);
            uvs().set(a3.b, 1.0f, 1.0f);
            uvs().set(a3.c, 0.0f, 0.0f);
            uvs().set(a3.d, (this.a - tan) / this.a, 0.0f);
        } else {
            float f3 = f / 2.0f;
            ...
            uvs().set(a5.a, 0.0f, 1.0f);
            uvs().set(a5.b, 1.0f, 1.0f);
            uvs().set(a5.c, 0.0f, (this.a - tan2) / this.a);
            uvs().set(a5.d, 0.0f, (this.a - tan2) / this.a);
            a5.m.x = -1.0f;
        }
        e();
    }
    ...
    private void e() {
        com.censivn.C3DEngine.b.f.a.b a2 = a(0);
        points().setPX(a2.a, this.g);
        points().setPX(a2.b, this.h);
        points().setPX(a2.c, this.i);
        points().setPX(a2.d, this.j);
        com.censivn.C3DEngine.b.f.a.b a3 = a(1);
        points().setPX(a3.a, this.c);
        points().setPX(a3.b, this.d);
        points().setPX(a3.c, this.e);
        points().setPX(a3.d, this.f);
        updatePointsVBO();
        updateUvsVBO();
    }
