...
public class c extends j {
    ...
    public com.tsf.shell.f.i.b.e.b a(int i) {
        com.tsf.shell.f.i.b.e.b a = com.tsf.shell.manager.l.a.a(i, com.tsf.shell.manager.o.b.b);
        a(a);
        return a;
    }

    private com.tsf.shell.f.i.b.e.b a(int i, int i2) {
        final com.tsf.shell.f.i.b.e.b a = a(i);
        final LauncherShortcutStandardInfo launcherShortcutStandardInfo = (LauncherShortcutStandardInfo) a.K();
        e.a a2 = com.tsf.shell.manager.a.a.a(i2);
        if (a2.a()) {
            launcherShortcutStandardInfo.enableNotifPoint();
            a2.a(new e.a.C0142a() { // from class: com.tsf.shell.f.h.c.1
