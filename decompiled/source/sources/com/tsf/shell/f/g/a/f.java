...
public class f extends a {
    ...
    public f(b bVar) {
        ...
        this.b.a(new com.censivn.C3DEngine.b.h.b.b() { // from class: com.tsf.shell.f.g.a.f.1
            ...
            public i a(int i, i iVar) {
                com.tsf.shell.f.d.b.a.d a = com.tsf.shell.manager.a.v.f.a(i);
                com.tsf.shell.f.d.b.a.b e = a.e();
                e.removeFromParent();
                if (a.i()) {
                    e.g();
                } else {
        ...
        this.b.a(new com.censivn.C3DEngine.b.h.b.f() { // from class: com.tsf.shell.f.g.a.f.2
            ...
            public void a(i iVar, int i, MotionEvent motionEvent) {
                w.b();
                com.tsf.shell.manager.a.v.f.a((com.tsf.shell.f.f.f) com.tsf.shell.manager.a.v.f.a(i));
                f.this.b.d();
            }
        });
    ...
    public void onRecycle() {
        ...
        int i = com.tsf.shell.manager.a.v.f.i();
        for (int i2 = 0; i2 < i; i2++) {
            com.tsf.shell.f.d.b.a.d a = com.tsf.shell.manager.a.v.f.a(i2);
            a.h();
            a.d();
            a.a();
        }
