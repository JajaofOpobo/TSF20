    ...
    public g(b bVar) {
        ...
        this.b.a(new com.censivn.C3DEngine.b.h.b.b() { // from class: com.tsf.shell.f.g.a.g.2
            ...
            public i a(int i, i iVar) {
                com.tsf.shell.f.d.c.a.d a = com.tsf.shell.manager.a.v.e.a(i);
                com.tsf.shell.f.d.c.a.c b = a.b();
                b.removeFromParent();
                if (a.i()) {
                    b.g();
                } else {
        ...
        this.b.a(new com.censivn.C3DEngine.b.h.b.f() { // from class: com.tsf.shell.f.g.a.g.3
            ...
            public void a(i iVar, int i, MotionEvent motionEvent) {
                w.b();
                com.tsf.shell.manager.a.v.e.a((com.tsf.shell.f.f.f) com.tsf.shell.manager.a.v.e.a(i));
