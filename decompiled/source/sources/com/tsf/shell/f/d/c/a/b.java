...
public class b extends d {
    ...
    public void a(com.censivn.C3DEngine.b.f.a.a aVar, Runnable runnable) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            com.censivn.C3DEngine.b.g.c.a(a3);
            com.censivn.C3DEngine.b.g.c.a(a3, 500, dVar);
            f2 -= f;
        }
    }
    ...
    public void b(com.censivn.C3DEngine.b.f.a.a aVar, Runnable runnable) {
        for (int i = 0; i < 4; i++) {
            ...
            com.censivn.C3DEngine.b.g.c.a(a, 500, dVar);
        }
    }
    ...
    public void a(ArrayList<Integer> arrayList, float f, float f2) {
        float f3;
        ArrayList<a.c> c2 = com.tsf.shell.manager.a.v.e.d().c();
    ...
    public void a() {
        ...
        for (int i = 0; i < numChildren; i++) {
            a(c2.get((numChildren - i) - 1), i, this.a);
        }
    }
