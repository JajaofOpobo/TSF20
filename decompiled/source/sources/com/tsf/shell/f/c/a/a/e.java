...
public class e extends i {
    ...
    public int a(ArrayList<com.tsf.shell.f.c.a.d> arrayList, ArrayList<com.censivn.C3DEngine.b.f.i> arrayList2, int i, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        if (b == 0) {
            ...
            if (a.a == -1 || a.a == -2) {
                ...
                float f8 = (f4 * f7) / 2.0f;
                if (a.b > 0.0f) {
                    maxY = (((-a.d) - (a.c / 2.0f)) - (iVar.minY() * f7)) + f8;
                } else {
                    maxY = (((-a.d) + (a.c / 2.0f)) - (iVar.maxY() * f7)) - f8;
                }
                dVar.b = ((maxY + a.d) * abs) + (-a.d);
                dVar.d = f7;
                    ...
                    if (i2 > 1) {
                        ...
                        while (true) {
                            ...
                            if (f11 - 0.4f < this.e && i3 > 0) {
                                float minY = ((this.e * f4) / 2.0f) + (dVar3.f - (iVar2.minY() * this.e)) + ((this.e * f4) / 2.0f) + (iVar2.maxY() * this.e);
                    ...
                    if (i2 < i - 2) {
                        ...
                        while (true) {
                            ...
                            if (f14 - 0.4f < this.e && i5 < i - 1) {
                                float maxY2 = (((dVar7.e - (iVar3.maxY() * this.e)) - ((this.e * f4) / 2.0f)) + (iVar3.minY() * this.e)) - ((this.e * f4) / 2.0f);
    ...
    public void a(ArrayList<com.tsf.shell.f.c.a.d> arrayList, ArrayList<com.censivn.C3DEngine.b.f.i> arrayList2, int i, float f, float f2, float f3, float f4) {
        ...
        if (f7 == 1.0f) {
            ...
            while (i2 < i) {
                ...
                dVar.h = false;
                i2++;
                f11 = (iVar.minY() + dVar.b) - f8;
            }
            return;
        }
        int i3 = 0;
        float f12 = (-f2) - com.tsf.shell.manager.o.b.a.Y;
        while (i3 < i) {
            com.censivn.C3DEngine.b.f.i iVar2 = arrayList2.get(i3);
            com.tsf.shell.f.c.a.d dVar2 = arrayList.get(i3);
            dVar2.b = f12 - (iVar2.maxY() * f7);
    ...
    public a.C0080a a(com.censivn.C3DEngine.b.f.i iVar, float f, float f2, float f3, float f4) {
        float asin;
        a.C0080a c0080a = a.b;
        float f5 = (com.censivn.C3DEngine.b.b.a.B - com.tsf.shell.f.c.a.f.a) - iVar.position().y;
        if (f5 > f) {
            asin = 180.0f;
        } else {
