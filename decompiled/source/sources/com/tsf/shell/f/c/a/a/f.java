...
public class f extends i {
    ...
    public int a(ArrayList<com.tsf.shell.f.c.a.d> arrayList, ArrayList<com.censivn.C3DEngine.b.f.i> arrayList2, int i, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        int b = b(f5, f6);
        if (b == 0) {
            com.tsf.shell.f.c.a.b.a a = a(f6, f, f2, f3, i);
            if (a.a == -1 || a.a == -2) {
                ...
                float f8 = (f4 * f7) / 2.0f;
                if (a.b > 0.0f) {
                    minY = ((a.d + (a.c / 2.0f)) - (iVar.maxY() * f7)) - f8;
                } else {
                    minY = ((a.d - (a.c / 2.0f)) - (iVar.minY() * f7)) + f8;
                }
                    ...
                    if (i2 > 1) {
                        ...
                        while (true) {
                            ...
                            if (f11 - 0.4f < this.e && i3 > 0) {
                                float maxY = (((dVar3.f - (iVar2.maxY() * this.e)) - ((this.e * f4) / 2.0f)) + (iVar2.minY() * this.e)) - ((this.e * f4) / 2.0f);
                    ...
                    if (i2 < i - 2) {
                        ...
                        while (true) {
                            ...
                            if (f14 - 0.4f < this.e && i5 < i - 1) {
                                float minY2 = ((this.e * f4) / 2.0f) + (dVar7.e - (iVar3.minY() * this.e)) + ((this.e * f4) / 2.0f) + (iVar3.maxY() * this.e);
    ...
    public a.C0080a a(com.censivn.C3DEngine.b.f.i iVar, float f, float f2, float f3, float f4) {
        float asin;
        a.C0080a c0080a = a.b;
        float f5 = ((-com.censivn.C3DEngine.b.b.a.C) - com.tsf.shell.f.c.a.f.a) + iVar.position().y;
        if (f5 > f) {
            asin = 180.0f;
        } else {
