...
public class a {
    ...
    static {
        ...
        a.put(Integer.valueOf((int) ItemInfo.APP_INTENT), aVar12.a());
        b.a aVar13 = new b.a();
        aVar13.c(a.C0020a.perm_storage_bg).b(a.e.perm_wallpaper_desc).a("7").a(a.e.storage_text);
        a.put(Integer.valueOf((int) ItemInfo.APP_VERSION_CODE), aVar13.a());
    }
    ...
    public boolean a(d.b bVar, c cVar, b bVar2, boolean z, int i, String... strArr) {
        if (!d.a(this.f, strArr)) {
            ...
            this.m = true;
            this.n = i;
            List<String> b2 = d.b(this.f, strArr);
            com.tsf.shell.a.a.b b3 = b(i, b2);
    ...
    public void a(int i, String[] strArr, int[] iArr) {
        ...
        if (!(arrayList2.size() == 0 && arrayList.size() > 0)) {
            ...
            if (arrayList2.size() > 0) {
                ...
                a(i, false, d.a.USER_REJECT_AUTH, arrayList2);
                return;
            }
            a(i, false, d.a.SYSTEM_CANCEL_AUTH, arrayList2);
            return;
        }
    ...
    private void a(final int i, final List<String> list) {
        ...
        com.tsf.shell.a.a.b b2 = b(i, list);
        if (b2 != null) {
            this.c.a(8);
            this.c.a(i, b2.a(), this.f.getString(b2.b()), new DialogInterface.OnClickListener() { // from class: com.tsf.shell.a.a.a.1
    ...
    private void a(final int i, final List<String> list, final String[] strArr, final boolean z) {
        ...
        if (b(i, list) != null) {
            ...
            this.b.a(i, e, new DialogInterface.OnClickListener() { // from class: com.tsf.shell.a.a.a.4
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i2) {
                    if (i2 == -1) {
                        a.this.b.dismiss();
    ...
    private StringBuilder c(int i, List<String> list) {
        ...
        for (Integer num : keySet) {
            if ((num.intValue() & g) == num.intValue() && a(num.intValue()) && (bVar = a.get(num)) != null) {
                if (sb.length() > 0) {
                    sb.append(", ");
                }
    ...
    private String d(int i, List<String> list) {
        ...
        c2.append(" ").append(this.f.getString(a.e.permission_denied));
        return c2.toString();
    }

    private String e(int i, List<String> list) {
        StringBuilder c2 = c(i, list);
        return this.f.getResources().getQuantityString(a.d.permission_denied_guide_desc, c2.toString().contains(",") ? 2 : 1, c2.toString());
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: com.tsf.shell.a.a.a$a  reason: collision with other inner class name */
    /* loaded from: classes.dex */
