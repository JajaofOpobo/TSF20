...
public class a extends VObject3dContainer {
    ...
    public class b extends VObject3dContainer {
        ...
        public void b() {
            if (this.m == null) {
                Bitmap a = x.a(this.c, b.d.wallpaper_living_preview_dot);
                this.m = this.a.a(a, true);
                a.recycle();
                this.j.textures().addElement(this.m);
                Bitmap a2 = x.a(this.c, b.d.wallpaper_living_preview_beam);
                this.n = this.a.a(a2, true);
                a2.recycle();
                this.i.textures().addElement(this.n);
                Bitmap a3 = a(x.a(this.c, b.d.wallpaper_living_preview_background), this.d, this.e);
        ...
        /* renamed from: com.tsf.shell.manager.wallpaper.a$b$a  reason: collision with other inner class name */
        /* loaded from: classes.dex */
        public class C0149a {
            float a;
            float b;
            ...
            public C0149a(VButtonItem vButtonItem) {
                ...
                float a = b.this.a(0.1f, 0.9f, false);
    ...
    /* renamed from: com.tsf.shell.manager.wallpaper.a$a  reason: collision with other inner class name */
    /* loaded from: classes.dex */
