...
public class ShellWallpaperManager extends BroadcastReceiver {
    ...
    public static void a(Context context) {
        ArrayList<Integer> b2 = k.b(context);
        if (b2 != null && b2.size() > 0 && b2.get(0).intValue() != 0) {
            try {
                WallpaperManager.getInstance(context).setResource(b2.get(0).intValue());
            } catch (Exception e2) {
                e2.printStackTrace();
            }
    ...
    /* loaded from: classes.dex */
    public class b extends com.censivn.C3DEngine.b.f.k {
        ...
        public void d() {
            int a = a(com.tsf.shell.manager.b.e.Z());
            this.j = a;
            this.i = a;
        }
        ...
        public void onDrawStart() {
            ...
            } else if (ShellWallpaperManager.this.i < ShellWallpaperManager.this.h && !ShellWallpaperManager.this.k) {
        ...
        private void e() {
            synchronized (ShellWallpaperManager.this.n) {
                ...
                BitmapDrawable c = ShellWallpaperManager.c(ShellWallpaperManager.this.g);
                System.currentTimeMillis();
                if (c != null) {
