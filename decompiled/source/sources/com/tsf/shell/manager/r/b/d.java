...
public class d extends com.tsf.shell.manager.r.b.c<a> {
    ...
    public void b() {
        if (!this.h) {
            this.h = true;
            Iterator<b.a> it = com.tsf.shell.manager.a.d.a().iterator();
            while (it.hasNext()) {
                c cVar = new c();
                cVar.c = it.next().a;
                this.f.add(cVar);
    ...
    public class b extends a {
        ...
        public com.tsf.shell.f.i.b.e.b a(i iVar) {
            ...
            if (this.f.id == 0) {
                ...
                if (a2 != null) {
                    a2 = q.a(a2, com.tsf.shell.manager.o.b.c.H, com.tsf.shell.manager.o.b.c.I);
                }
    ...
    public class c extends a {
        ...
        @Override // com.tsf.shell.manager.r.b.d.a
        public void a(a aVar) {
            com.tsf.shell.f.i.b.e.b a = com.tsf.shell.manager.l.a.a(this.c, com.tsf.shell.manager.o.b.a);
            a.position().y = d.this.b.getScreenFreeSpaceCenter();
        ...
        @Override // com.tsf.shell.manager.r.b.d.a
        public void b() {
            com.tsf.shell.f.i.b.e.b a = com.tsf.shell.manager.l.a.a(this.c, d.this.b.b().b());
            a.K().onUpdatePhoto(null, null);
            d.this.b.b().a(a);
        }
