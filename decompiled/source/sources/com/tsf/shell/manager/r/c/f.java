...
public class f {
    public static com.tsf.shell.f.i.c.g a(Context context, String str, String str2, String str3, com.tsf.shell.manager.a.f fVar) {
        com.tsf.shell.f.i.c.g a = a(str2, fVar);
        b(a, context, str, str2, str3, fVar);
        return a;
    }
    ...
    public static com.tsf.shell.f.i.c.g a(String str, com.tsf.shell.manager.a.f fVar) {
        ...
        if (str.equals("com.tsf.shell.widget.music")) {
            gVar = new com.tsf.shell.f.i.c.b(0.42f, 0.0f, 0.0f) { // from class: com.tsf.shell.manager.r.c.f.5
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.41f, 0.0f, (-40.0f) * com.censivn.C3DEngine.b.b.a.c) { // from class: com.tsf.shell.manager.r.c.f.6
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.33f, 0.0f, com.censivn.C3DEngine.b.b.a.c * (-15.0f)) { // from class: com.tsf.shell.manager.r.c.f.7
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.28f, 0.0f, com.censivn.C3DEngine.b.b.a.c * (-15.0f)) { // from class: com.tsf.shell.manager.r.c.f.8
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.6f * com.censivn.C3DEngine.b.b.a.c, 0.0f, 0.0f) { // from class: com.tsf.shell.manager.r.c.f.9
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.5f, 0.0f, (-20.0f) * com.censivn.C3DEngine.b.b.a.c) { // from class: com.tsf.shell.manager.r.c.f.10
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.5f, 0.0f, (-10.0f) * com.censivn.C3DEngine.b.b.a.c) { // from class: com.tsf.shell.manager.r.c.f.11
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.45f, 0.0f, 0.0f) { // from class: com.tsf.shell.manager.r.c.f.12
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.55f, 0.0f, (-50.0f) * com.censivn.C3DEngine.b.b.a.c) { // from class: com.tsf.shell.manager.r.c.f.2
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
            ...
            gVar = new com.tsf.shell.f.i.c.b(0.45f, 0.0f, 0.0f) { // from class: com.tsf.shell.manager.r.c.f.3
                @Override // com.tsf.shell.f.i.c.b
                public k g_() {
                ...
                private void p() {
                    if (this.l.id == 0) {
                        ...
                        try {
                            ...
                            com.censivn.C3DEngine.a.d();
                            Context createPackageContext = d.createPackageContext(str2, 3);
                        ...
                        if (bitmap == null) {
                            bitmap = x.a(b.d.sym_def_app_icon, (int) this.k.b(), (int) this.k.c());
                        }
