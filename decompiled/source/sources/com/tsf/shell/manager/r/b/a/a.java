    ...
    public a(final com.tsf.shell.manager.r.b.a aVar, String str) {
        ...
        this.c.a(new com.censivn.C3DEngine.b.h.b.b() { // from class: com.tsf.shell.manager.r.b.a.a.5
            ...
            public i a(int i, i iVar) {
                ...
                cVar3.k.textures().addElement(a.aZ());
                return cVar;
            }
        });
                    ...
                    if (!a.this.e.isEmpty()) {
                        ...
                        while (true) {
                            ...
                            if (gVar != a) {
                                g ba = gVar.ba();
                                Number3d.TEMPNUMBER3D.reset();
                                ba.position().setAllFrom(iVar.localToGlobal(Number3d.TEMPNUMBER3D));
                                ba.rotation().setAll(0.0f, 0.0f, 0.0f);
                                this.c.a((com.tsf.shell.f.i.c) ba);
                            }
                            i2 = i3 + 1;
                        }
                        a.this.b();
