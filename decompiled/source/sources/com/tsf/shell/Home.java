...
public final class Home extends ActivityGroup implements View.OnLongClickListener, com.tsf.shell.a, com.tsf.shell.manager.bind.c {
        ...
        if (this.s) {
            ...
            if (z) {
                ...
                if (!com.tsf.shell.manager.b.f.a()) {
                    ...
                    int b2 = com.tsf.shell.manager.b.f.b();
                    switch (b2) {
                        case 0:
                            com.tsf.shell.manager.b.f.a(b2 + 1);
                            e();
                            break;
                        default:
    ...
    /* renamed from: com.tsf.shell.Home$10  reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    public void i() {
        com.censivn.C3DEngine.a.a().a(new RenderRunnable(1, 1) { // from class: com.tsf.shell.Home.15
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!this.s || (!k() && com.censivn.C3DEngine.b.c.b.a())) {
            ...
            if (this.s) {
                menu.add(0, 3, 0, b.i.text_preferences).setIcon(17301573).setAlphabeticShortcut('N');
                menu.add(0, 1, 0, b.i.menu_manage_apps).setIcon(17301570).setAlphabeticShortcut('M');
                Intent intent = new Intent("android.settings.SETTINGS");
                intent.setFlags(270532608);
                menu.add(0, 4, 0, b.i.menu_settings).setIcon(17301577).setAlphabeticShortcut('P').setIntent(intent);
            }
            return true;
        }
        return false;
    ...
    public boolean onLongClick(View view) {
        ...
        if (this.g.a()) {
            ...
            } else if (!com.tsf.shell.manager.a.A.a()) {
                return true;
            } else {
    ...
    protected Dialog onCreateDialog(int i) {
        switch (i) {
            ...
            case 11:
                return new AlertDialog.Builder(this).setMessage(b.i.shell_download_new_version_or_not).setPositiveButton(b.i.public_action_update, new DialogInterface.OnClickListener() { // from class: com.tsf.shell.Home.7
                ...
                }).setNegativeButton(b.i.public_action_cancel, new DialogInterface.OnClickListener() { // from class: com.tsf.shell.Home.6
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i2) {
                    }
                }).create();
