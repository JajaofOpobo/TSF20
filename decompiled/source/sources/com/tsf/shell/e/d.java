...
public class d extends ViewGroup {
    ...
    public boolean a(MotionEvent motionEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            b bVar2 = (b) ((com.tsf.shell.e.b) getChildAt(i)).getLayoutParams();
            if (x > bVar2.a && x < bVar2.a + bVar.getWidth() && y > bVar2.b) {
                if (y < bVar.getHeight() + bVar2.b) {
                    return true;
                }
            }
        }
