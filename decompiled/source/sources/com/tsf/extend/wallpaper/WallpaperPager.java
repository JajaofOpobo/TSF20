...
public class WallpaperPager extends FrameLayout implements ViewPager.e, PagerIndicator.a, c.a, PersonalizationActivity.i, q {
    ...
    private void c() {
        ...
        String[] strArr = this.r ? new String[]{getResources().getString(f.g.wallpaper_categories), getResources().getString(f.g.tab_new), getResources().getString(f.g.tab_hot)} : new String[]{getResources().getString(f.g.wallpaper_categories), getResources().getString(f.g.tab_pg_live_wallpaper), getResources().getString(f.g.tab_new), getResources().getString(f.g.tab_hot)};
    ...
    /* loaded from: classes.dex */
    public class a extends com.tsf.extend.base.support.a {
        private int c;
        private int d;
        private int e;
        ...
        public Object a(ViewGroup viewGroup, int i) {
            View view;
            View view2 = (View) WallpaperPager.this.q.get(i);
            if (view2 == null) {
                if (i == this.b) {
                    view = new v(viewGroup.getContext(), WallpaperPager.this.h, this.g);
                    ((v) view).setChooseWallpaperOnLine(WallpaperPager.this.r);
                } else if (i == this.c) {
                    view = new af(viewGroup.getContext(), ai.LiveWallpaperTabType, WallpaperPager.this.h, this.g);
                } else if (i == this.d) {
                    Intent intent = WallpaperPager.this.h.getIntent();
                    view = new ae(viewGroup.getContext(), WallpaperPager.this.h, "6".equals(intent.getStringExtra("inlet")) && intent.getIntExtra("target", -1) == 1, this.g);
                    ((ae) view).setChooseWallpaperOnLine(WallpaperPager.this.r);
                } else if (i == this.e) {
                    view = new ad(viewGroup.getContext(), ai.HotType, WallpaperPager.this.h, this.g);
                    ((ad) view).setChooseWallpaperOnLine(WallpaperPager.this.r);
                } else {
                    view = view2;
                }
                ((p) view).setScrollListener(WallpaperPager.this);
                ((p) view).setHeadViewHeight(WallpaperPager.this.r ? 0 : WallpaperPager.b);
                WallpaperPager.this.q.put(i, view);
            } else {
                view = view2;
            }
