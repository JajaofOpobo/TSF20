...
public class WallpaperClipImageView extends View {
                    ...
                    case 2:
                        if (WallpaperClipImageView.this.b != -1 && WallpaperClipImageView.this.b(motionEvent)) {
                            if (WallpaperClipImageView.this.b == 0) {
                                float[] a = WallpaperClipImageView.this.a(motionEvent.getX() - WallpaperClipImageView.this.c.x, motionEvent.getY() - WallpaperClipImageView.this.c.y);
                                if (a[0] != 0.0f || a[1] != 0.0f) {
                                    WallpaperClipImageView.this.k = true;
                                    WallpaperClipImageView.this.n.set(WallpaperClipImageView.this.m);
                                    WallpaperClipImageView.this.n.postTranslate(a[0], a[1]);
                                ...
                                float[] a2 = WallpaperClipImageView.this.a(WallpaperClipImageView.c(motionEvent) / WallpaperClipImageView.this.a);
                                if (a2 != null) {
                                    WallpaperClipImageView.this.n.set(WallpaperClipImageView.this.m);
                                    WallpaperClipImageView.this.n.postScale(a2[0], a2[0], a2[3], a2[4]);
                                    WallpaperClipImageView.this.e.set(WallpaperClipImageView.this.n);
                                    WallpaperClipImageView.this.invalidate();
                                    WallpaperClipImageView.this.n.postTranslate(a2[1], a2[2]);
                                    WallpaperClipImageView.this.e.set(WallpaperClipImageView.this.n);
                                    WallpaperClipImageView.this.invalidate();
                                    break;
                                }
    ...
    private void a(boolean z) {
        ...
        final float a = a(this.f != null ? this.f : this.e, rectF);
        ...
        if (this.h.g()) {
            ...
            if (width > d2) {
                d = this.h.e() / this.g.getHeight();
            } else {
                d = this.h.d() / this.g.getWidth();
            }
            matrix.postScale(d, d);
            matrix.postTranslate(this.h.a() - (((this.g.getWidth() * d) - this.h.d()) / 2.0f), this.h.b() - (((this.g.getHeight() * d) - this.h.e()) / 2.0f));
            this.j = d;
        }
        this.k = false;
        if (z) {
            ...
            final float a2 = a(matrix, rectF2);
            if (x.a) {
                Log.d("ClipWallpaper", "start Animation targetScale:" + a2 + " targetRect:" + rectF2);
            }
            this.f = new Matrix();
            if (Build.VERSION.SDK_INT >= 11) {
                ...
                this.l.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tsf.extend.wallpaper.WallpaperClipImageView.1
                    ...
                    public void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        if (WallpaperClipImageView.this.f != null) {
                            ...
                            WallpaperClipImageView.this.f.postScale(f2, f2);
                            WallpaperClipImageView.this.f.postTranslate(f3, f4);
                            if (x.a) {
    ...
    public RectF getDisplayRect() {
        ...
        float a = this.h.a() - rectF.left;
        float b = this.h.b() - rectF.top;
        float d = this.h.d() + a;
        float e = this.h.e() + b;
        float f = this.h.f() / (rectF.right - rectF.left);
        if (x.a) {
            Log.d("ClipWallpaper", "image in stroken rect:" + new RectF(a, b, d, e) + " scaleRate:" + f);
        }
        RectF rectF2 = new RectF(a * f, b * f, d * f, f * e);
        if (x.a) {
    ...
    public float[] a(float f, float f2) {
        ...
        float f4 = c.left - rectF.left;
        float f5 = c.bottom - rectF.bottom;
        float f6 = c.right - rectF.right;
        if (f > f4) {
            f = f4;
        } else if (f < f6) {
            f = f6;
    ...
    public float[] a(float f) {
        ...
        RectF rectF = new RectF();
        float a = (5.0f * this.j) / a(this.m, rectF);
        Rect c = this.h.c();
        if (this.i) {
            f2 = (c.bottom - c.top) / (rectF.bottom - rectF.top);
        } else {
            f2 = (c.right - c.left) / (rectF.right - rectF.left);
        }
        if (x.a) {
            Log.d("ClipWallpaper", "prepareScale minScale:" + f2 + " maxScale:" + a + " targetImageRect:" + rectF + " wallpaperRect" + c + " mSrcBitmapWidthMore:" + this.i);
        }
        if (f > a) {
            f = a;
        } else if (f < f2) {
        ...
        pointF.set((c.left + c.right) / 2.0f, (c.top + c.bottom) / 2.0f);
        Matrix matrix = new Matrix();
        matrix.set(this.m);
        matrix.postScale(f, f, pointF.x, pointF.y);
        a(matrix, rectF);
        if (rectF.left > c.left) {
            f3 = c.left - rectF.left;
        } else {
            f3 = rectF.right < ((float) c.right) ? c.right - rectF.right : 0.0f;
        }
        if (rectF.top > c.top) {
            f4 = c.top - rectF.top;
        } else if (rectF.bottom < c.bottom) {
            f4 = c.bottom - rectF.bottom;
        }
        if (x.a) {
            ...
            a(matrix2, rectF2);
            Log.d("ClipWallpaper", "result scale:" + f + " maxScale:" + a + " minScale:" + f2 + " dx:" + f3 + " dy:" + f4 + " logRect:" + rectF2 + " no did Offset rect:" + rectF);
        }
