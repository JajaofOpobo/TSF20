        ...
        if (Build.VERSION.SDK_INT >= 11) {
            ...
            this.g.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tsf.extend.wallpaper.CustomWallpaperShadowView.1
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    CustomWallpaperShadowView.this.e.set((int) (rect2.left + ((rect3.left - rect2.left) * f.floatValue())), (int) (rect2.top + ((rect3.top - rect2.top) * f.floatValue())), (int) (rect2.right + ((rect3.right - rect2.right) * f.floatValue())), (int) ((f.floatValue() * (rect3.bottom - rect2.bottom)) + rect2.bottom));
