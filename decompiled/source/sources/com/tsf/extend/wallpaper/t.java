...
public class t extends BaseAdapter implements View.OnClickListener {
    ...
    public static List<d> c(List<m> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        boolean z = true;
        if (view == null) {
            view2 = LayoutInflater.from(this.c).inflate(f.C0052f.wallpaper_list_item, (ViewGroup) null);
            c cVar = new c();
            this.d.add(cVar);
            cVar.a = (ImageView) view2.findViewById(f.e.img_left);
            cVar.b = (ImageView) view2.findViewById(f.e.img_right);
            cVar.c = (TextView) view2.findViewById(f.e.download_left);
            cVar.d = (TextView) view2.findViewById(f.e.download_right);
            cVar.e = (ImageView) view2.findViewById(f.e.user_tag_left);
            cVar.f = (ImageView) view2.findViewById(f.e.user_tag_right);
            cVar.g = (ImageView) view2.findViewById(f.e.live_tag_left);
            cVar.h = (ImageView) view2.findViewById(f.e.live_tag_right);
            if (this.f != null) {
                this.f.a(cVar, view2);
            }
    ...
    /* loaded from: classes.dex */
    public class b implements a.InterfaceC0048a<Pair<String, Bitmap>> {
        private b() {
        }
