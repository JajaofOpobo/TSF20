...
public class r extends com.tsf.extend.g implements View.OnClickListener {
    ...
    private void b() {
        View inflate = LayoutInflater.from(getContext()).inflate(f.C0052f.theme_recommend_dialog, (ViewGroup) null);
        this.b = (ImageView) inflate.findViewById(f.e.cover);
        this.c = (TextView) inflate.findViewById(f.e.download);
        this.f = (ImageView) inflate.findViewById(f.e.cancel);
        this.g = (ProgressBar) inflate.findViewById(f.e.progressbar);
