...
public class d extends FrameLayout implements DialogInterface.OnClickListener, TextWatcher, View.OnClickListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private void d() {
        ...
        if (b == null) {
            ...
            if (!TextUtils.isEmpty(e)) {
                ...
                String substring = indexOf != -1 ? trim.substring(0, indexOf) : b;
    ...
    private void a(String str) {
        ...
        String str2 = "";
        if ("1".equals(str)) {
            str2 = getContext().getString(f.g.uplaod_wallpaper_dialog_no_network);
            i = f.g.uplaod_wallpaper_dialog_check_network;
        } else if ("2".equals(str)) {
            str2 = getContext().getString(f.g.uplaod_wallpaper_dialog_mobile_network);
            long a = this.b.a();
            if (a != -1) {
                str2 = String.format(str2, a(a));
            }
            i = f.g.uplaod_wallpaper_dialog_ok;
        }
        f();
        this.k = new e.a(getContext()).a(str2).b(f.g.uplaod_wallpaper_dialog_cancel, this).a(i, this).a();
        this.k.a(str);
        try {
            this.k.a(true);
        } catch (Exception e) {
    ...
    public void onGlobalLayout() {
        ...
        if (height > 0) {
            ...
            if (Build.VERSION.SDK_INT >= 11) {
                i = this.c.getCategoryRealY();
            }
            int i2 = i <= 0 ? a * 10 : i;
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f.getLayoutParams();
            layoutParams.topMargin = i2;
            this.f.setLayoutParams(layoutParams);
            int height2 = i2 + this.f.getHeight() + i.a(6.0f);
            FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.e.getLayoutParams();
            layoutParams2.topMargin = height2;
            this.e.setLayoutParams(layoutParams2);
            int height3 = height2 + this.e.getHeight() + (a * 2);
