...
public class t extends BaseAdapter {
    ...
    private void f() {
        ...
        int a2 = com.tsf.extend.base.j.i.a(15.0f);
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            dVar.f.setTag(dVar);
            View findViewById = view.findViewById(f.e.theme_item_download_layout_left);
            ...
            dVar.m.setTag(dVar);
            View findViewById2 = view.findViewById(f.e.theme_item_download_layout_right);
            ...
            dVar.t.setTag(dVar);
            View findViewById3 = view.findViewById(f.e.theme_item_download_layout_mid);
            ...
            PageActivity pageActivity = (PageActivity) this.b;
    ...
    private void a(View view, a aVar, int i) {
        ...
        switch (aVar) {
            case Left:
                View findViewById = view.findViewById(f.e.theme_img_left);
                layoutParams.setMargins(this.g, i2, this.h, this.k);
                view2 = findViewById;
                break;
            case Mid:
                View findViewById2 = view.findViewById(f.e.theme_img_mid);
                layoutParams.setMargins(this.l, i2, this.l, this.k);
                view2 = findViewById2;
                break;
            case Right:
                View findViewById3 = view.findViewById(f.e.theme_img_right);
    ...
    /* loaded from: classes.dex */
    public class c implements a.InterfaceC0048a<Pair<String, Bitmap>> {
        /* JADX INFO: Access modifiers changed from: protected */
        public c() {
        }
