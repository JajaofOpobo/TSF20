    ...
    private ServiceConnection i = new ServiceConnection() { // from class: com.tsf.extend.theme.ThemeDetailActivity.1
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            try {
                ...
                for (a aVar : ThemeDetailActivity.this.h) {
                    aVar.a(ThemeDetailActivity.this.f);
                }
    ...
    public boolean a(String str, boolean z, com.tsf.extend.base.c.a aVar) {
        ...
        try {
            ...
            if (str.startsWith("DIY://")) {
                Object b = com.tsf.extend.theme.diy.e.b(str.substring("DIY://".length()) + File.separator + "diy.config", "isLocalDiy");
