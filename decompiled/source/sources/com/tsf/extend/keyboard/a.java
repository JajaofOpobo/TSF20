...
public class a extends com.tsf.extend.base.d.a {
    ...
    private C0054a b(JSONObject jSONObject) {
        ...
        try {
            ...
            if (jSONObject.has("data")) {
                ...
                if (f.a(h.b().getApplicationContext(), optString)) {
                    newArrayList.remove(bVar);
                }
                if (f.a(h.b().getApplicationContext(), optString2)) {
    ...
    /* renamed from: com.tsf.extend.keyboard.a$a  reason: collision with other inner class name */
    /* loaded from: classes.dex */
        ...
        z.a(2, new Runnable() { // from class: com.tsf.extend.keyboard.a.1
            ...
            public void run() {
                ...
                if (a instanceof com.tsf.extend.base.b.a) {
                    aVar = (com.tsf.extend.base.b.a) a;
                } else {
                    aVar = a instanceof C0054a ? (C0054a) a : null;
                }
                if (aVar != null) {
