...
public class VObject3d implements VTweenTarget {
    ...
    public boolean calTouchCollision(float f, float f2) {
        ...
        float a = i.a.a(this.vTarget.AABB_P1, this.vTarget.AABB_P2);
        float a2 = i.a.a(this.vTarget.AABB_P2, this.vTarget.AABB_P3);
        float a3 = i.a.a(this.vTarget.AABB_P3, this.vTarget.AABB_P1);
        if (a >= 0.0f || a2 >= 0.0f || a3 >= 0.0f) {
            if (!this.vTarget.doubleSidedClickEnabled() || a <= 0.0f || a2 <= 0.0f || a3 <= 0.0f) {
                float a4 = i.a.a(this.vTarget.AABB_P2, this.vTarget.AABB_P3);
                float a5 = i.a.a(this.vTarget.AABB_P3, this.vTarget.AABB_P4);
                float a6 = i.a.a(this.vTarget.AABB_P4, this.vTarget.AABB_P2);
