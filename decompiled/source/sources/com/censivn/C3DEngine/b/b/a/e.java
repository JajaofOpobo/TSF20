        ...
        setMouseEventListener(new com.censivn.C3DEngine.b.d.a(this) { // from class: com.censivn.C3DEngine.b.b.a.e.2
            ...
            public void e(MotionEvent motionEvent) {
                ...
                if (this.h) {
                    ...
                    i hittingTarget = e.this.getHittingTarget(a2[0], a2[1], true);
    ...
    public void onDrawStart() {
        if (getAnimationObjectState()) {
            ...
            if (this.e) {
                ...
                position.y = ((this.h - this.c.position().y) * 0.7f) + position.y;
            } else {
                float f2 = 0.1f;
                boolean z = true;
                if (this.l) {
                ...
                position2.y = ((this.h - this.c.position().y) * f2) + position2.y;
            ...
            if (this.b && !this.l && !this.o) {
                float f3 = this.f - this.c.position().y;
                float f4 = this.c.position().y - this.g;
                if (f3 > 0.0f) {
                    this.j = 0;
                } else {
                    this.j = 1;
                ...
                this.p = (f3 / com.tsf.shell.f.e.c.a) * 1.5f;
                if (this.p > 0.0f) {
