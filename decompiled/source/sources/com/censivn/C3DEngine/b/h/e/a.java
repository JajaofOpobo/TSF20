...
public class a extends j {
    ...
    public a(i iVar, float f, float f2, float f3, float f4, float f5) {
        ...
        this.b.setMouseEventListener(new com.censivn.C3DEngine.b.d.a(iVar) { // from class: com.censivn.C3DEngine.b.h.e.a.2
            ...
            public void e(MotionEvent motionEvent) {
                ...
                i hittingTarget = a.this.c.getHittingTarget(a2[0], a2[1], true);
            ...
            public void b(MotionEvent motionEvent, MotionEvent motionEvent2, float f6, float f7) {
                ...
                if (this.f) {
                    ...
                    } else if (f6 >= 0.0f || a.this.r >= a.this.q - 1) {
                        a.this.m();
                        return;
    ...
    private void e(int i) {
        ...
        int i4 = (i3 - i2) + 1;
        float f = this.w ? ((this.f - (((i4 - 1) * this.k) + (i4 * this.j))) / 2.0f) + ((-this.f) / 2.0f) + (i * this.f) + (this.j / 2.0f) : ((-this.f) / 2.0f) + (i * this.f) + this.h + (this.j / 2.0f);
        for (int i5 = i2; i5 < i3 + 1; i5++) {
            i childAt = this.c.getChildAt(i5);
