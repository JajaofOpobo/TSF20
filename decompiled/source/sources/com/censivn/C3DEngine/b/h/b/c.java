...
public class c extends j implements b.a, e.a, d, a.InterfaceC0113a {
    ...
    private void a(boolean z) {
        ...
        int a2 = (int) com.censivn.C3DEngine.b.b.a.a(128.0f);
        this.e = ThemeManager.mix.interactiveArrange.getTextureElement(ThemeShellDescription.INTERACTIVE_ARRANGE_BG, a2, a2);
        this.b = new k(128.0f, 128.0f, 3, 3) { // from class: com.censivn.C3DEngine.b.h.b.c.1
            @Override // com.censivn.C3DEngine.b.f.i
        ...
        this.h = new e() { // from class: com.censivn.C3DEngine.b.h.b.c.3
            ...
            public void b(MotionEvent motionEvent) {
                com.tsf.shell.f.i.b e = e(motionEvent);
                if (e != null && c.this.i.e()) {
                    ((com.tsf.shell.f.i.c) e).ap();
                }
            }
        };
            ...
            public void a(MotionEvent motionEvent, MotionEvent motionEvent2) {
                if (this.b) {
                    if (c.this.M) {
                        ...
                        c.this.K = (int) (a3[0] - c.this.a.position().x);
                        c.this.L = (int) (a3[1] - c.this.a.position().y);
                    }
    ...
    public void a(ArrayList<com.tsf.shell.f.i.b> arrayList) {
        ...
        while (it.hasNext()) {
            ...
            this.j.add(next.position().m4clone());
            com.censivn.C3DEngine.b.g.d dVar = new com.censivn.C3DEngine.b.g.d();
            dVar.e(0.0f);
            com.censivn.C3DEngine.b.g.c.a(next, 500, dVar);
            next.a(this.i);
        }
        this.h.b(arrayList);
        h();
    ...
    public void e() {
        ...
        if (!this.m) {
            ...
            for (int i = 0; i < numChildren; i++) {
                ...
                childAt.position().x = (float) (position.x + ((number3d.x - childAt.position().x) * 0.2d));
                childAt.position().y = (float) (position2.y + ((number3d.y - childAt.position().y) * 0.2d));
            }
        }
    }
