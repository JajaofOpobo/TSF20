...
public class ab implements n {
    ...
    public ab(Toolbar toolbar, boolean z, int i, int i2) {
        ...
        if (z) {
            aa a = aa.a(toolbar.getContext(), null, a.k.ActionBar, a.C0012a.actionBarStyle, 0);
            ...
            Drawable a4 = a.a(a.k.ActionBar_homeAsUpIndicator);
            if (a4 != null) {
                d(a4);
            }
        ...
        this.a.setNavigationOnClickListener(new View.OnClickListener() { // from class: android.support.v7.widget.ab.1
            ...
            {
                this.a = new android.support.v7.view.menu.a(ab.this.a.getContext(), 0, 16908332, 0, 0, ab.this.i);
            }
