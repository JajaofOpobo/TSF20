...
public abstract class a extends ViewGroup {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, a.k.ActionBar, a.C0012a.actionBarStyle, 0);
    ...
    public bb a(int i, long j) {
        ...
        if (i == 0) {
            ...
            bb a = ai.l(this).a(1.0f);
            a.a(j);
            a.a(this.a.a(a, i));
            return a;
        }
        bb a2 = ai.l(this).a(0.0f);
        a2.a(j);
        a2.a(this.a.a(a2, i));
        return a2;
    }
