    ...
    */
    ...
    public class b extends ListPopupWindow {
        ...
        void b() {
            ...
            Drawable d = d();
            if (d != null) {
                d.getPadding(AppCompatSpinner.this.l);
            ...
            if (AppCompatSpinner.this.k == -2) {
                int a = AppCompatSpinner.this.a((SpinnerAdapter) this.d, d());
                int i3 = (AppCompatSpinner.this.getContext().getResources().getDisplayMetrics().widthPixels - AppCompatSpinner.this.l.left) - AppCompatSpinner.this.l.right;
                if (a <= i3) {
                    i3 = a;
                }
                f(Math.max(i3, (width - paddingLeft) - paddingRight));
