...
public class SearchView extends LinearLayoutCompat implements android.support.v7.view.c {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.N = g.a();
        aa a2 = aa.a(context, attributeSet, a.k.SearchView, i, 0);
        ...
        this.f.setBackgroundDrawable(a2.a(a.k.SearchView_queryBackground));
        this.g.setBackgroundDrawable(a2.a(a.k.SearchView_submitBackground));
        this.h.setImageDrawable(a2.a(a.k.SearchView_searchIcon));
        this.i.setImageDrawable(a2.a(a.k.SearchView_goIcon));
        this.j.setImageDrawable(a2.a(a.k.SearchView_closeIcon));
        this.k.setImageDrawable(a2.a(a.k.SearchView_voiceIcon));
        this.m.setImageDrawable(a2.a(a.k.SearchView_searchIcon));
        this.n = a2.a(a.k.SearchView_searchHintIcon);
        this.o = a2.g(a.k.SearchView_suggestionRowLayout, a.h.abc_search_dropdown_item_icons_2line);
        this.p = a2.g(a.k.SearchView_commitIcon, 0);
        ...
        int e = a2.e(a.k.SearchView_android_maxWidth, -1);
        if (e != -1) {
            setMaxWidth(e);
        }
        this.s = a2.c(a.k.SearchView_defaultQueryHint);
        this.C = a2.c(a.k.SearchView_queryHint);
    ...
    public void u() {
        ...
        if (this.l.getWidth() > 1) {
            ...
            if (this.y) {
                i = resources.getDimensionPixelSize(a.d.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(a.d.abc_dropdownitem_icon_width);
            } else {
                i = 0;
            }
            ...
            this.d.setDropDownWidth((i + ((this.l.getWidth() + rect.left) + rect.right)) - paddingLeft);
        }
    }
    ...
    private Intent a(Cursor cursor, int i, String str) {
        ...
        try {
            ...
            return a(a3, a4 == null ? null : Uri.parse(a4), u.a(cursor, "suggest_intent_extra_data"), u.a(cursor, "suggest_intent_query"), i, str);
        } catch (RuntimeException e) {
            try {
