...
class u extends android.support.v4.widget.x implements View.OnClickListener {
    ...
    private CharSequence b(CharSequence charSequence) {
        if (this.r == null) {
            ...
            this.d.getTheme().resolveAttribute(a.C0012a.textColorSearchUrl, typedValue, true);
    ...
    private Drawable a(String str) {
        ...
        try {
            ...
            Drawable b = b(str2);
            if (b == null) {
                Drawable a2 = android.support.v4.content.a.a(this.m, parseInt);
                a(str2, a2);
                return a2;
            }
            return b;
