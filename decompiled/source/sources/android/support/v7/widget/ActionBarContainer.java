...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        this.a = obtainStyledAttributes.getDrawable(a.k.ActionBar_background);
        this.b = obtainStyledAttributes.getDrawable(a.k.ActionBar_backgroundStacked);
        this.j = obtainStyledAttributes.getDimensionPixelSize(a.k.ActionBar_height, -1);
        if (getId() == a.f.split_action_bar) {
            this.d = true;
            this.c = obtainStyledAttributes.getDrawable(a.k.ActionBar_backgroundSplit);
        }
