...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        this.c = 0;
        this.e = 8388659;
        aa a = aa.a(context, attributeSet, a.k.LinearLayoutCompat, i, 0);
        int a2 = a.a(a.k.LinearLayoutCompat_android_orientation, -1);
        if (a2 >= 0) {
            setOrientation(a2);
        }
        int a3 = a.a(a.k.LinearLayoutCompat_android_gravity, -1);
        if (a3 >= 0) {
            setGravity(a3);
        }
        boolean a4 = a.a(a.k.LinearLayoutCompat_android_baselineAligned, true);
        if (!a4) {
            setBaselineAligned(a4);
        }
        this.g = a.a(a.k.LinearLayoutCompat_android_weightSum, -1.0f);
        this.b = a.a(a.k.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.h = a.a(a.k.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.a(a.k.LinearLayoutCompat_divider));
        this.n = a.a(a.k.LinearLayoutCompat_showDividers, 0);
        this.o = a.e(a.k.LinearLayoutCompat_dividerPadding, 0);
        a.a();
    }
    ...
    void a(int i, int i2) {
        ...
        while (i21 < virtualChildCount) {
            ...
            if (b == null) {
                ...
                if (i21 < i19 && layoutParams.g > 0.0f) {
        ...
        int a2 = ai.a(Math.max(this.f, getSuggestedMinimumHeight()), i2, 0);
        int i29 = (16777215 & a2) - this.f;
        if (z7 || (i29 != 0 && f2 > 0.0f)) {
            if (this.g > 0.0f) {
                f2 = this.g;
            }
        ...
        setMeasuredDimension(ai.a(Math.max(i3 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), i, i16), a2);
        if (z6) {
    ...
    void b(int i, int i2) {
        ...
        int a2 = ai.a(Math.max(this.f, getSuggestedMinimumWidth()), i, 0);
        int i29 = (16777215 & a2) - this.f;
        if (z7 || (i29 != 0 && f3 > 0.0f)) {
            if (this.g > 0.0f) {
                f3 = this.g;
        ...
        setMeasuredDimension(((-16777216) & i16) | a2, ai.a(Math.max(i3 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i2, i16 << 16));
        if (z6) {
    ...
    void a(int i, int i2, int i3, int i4) {
        ...
        while (i10 < virtualChildCount) {
            ...
            if (b == null) {
                ...
                switch (android.support.v4.view.e.a(i12, ai.e(this)) & 7) {
                    case 1:
    ...
    void b(int i, int i2, int i3, int i4) {
        ...
        int[] iArr = this.i;
        int[] iArr2 = this.j;
        switch (android.support.v4.view.e.a(this.e & 8388615, ai.e(this))) {
            case 1:
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.h = -1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.k.LinearLayoutCompat_Layout);
            this.g = obtainStyledAttributes.getFloat(a.k.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.h = obtainStyledAttributes.getInt(a.k.LinearLayoutCompat_Layout_android_layout_gravity, -1);
