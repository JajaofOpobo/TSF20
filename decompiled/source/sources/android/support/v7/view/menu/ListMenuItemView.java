...
public class ListMenuItemView extends LinearLayout implements m.a {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.g = obtainStyledAttributes.getDrawable(a.k.MenuView_android_itemBackground);
        this.h = obtainStyledAttributes.getResourceId(a.k.MenuView_android_itemTextAppearance, -1);
        this.j = obtainStyledAttributes.getBoolean(a.k.MenuView_preserveIconSpacing, false);
        this.i = context;
