...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public final class f extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                case 1:
                    this.b.a(data.getString("data_package_name"), data.getInt("data_calling_uid"), data.getBundle("data_root_hints"), new e(message.replyTo));
                    return;
                case 2:
                    this.b.a(new e(message.replyTo));
                    return;
                case 3:
                    this.b.a(data.getString("data_media_item_id"), data.getBundle("data_options"), new e(message.replyTo));
                    return;
                case 4:
                    this.b.b(data.getString("data_media_item_id"), data.getBundle("data_options"), new e(message.replyTo));
                    return;
                case 5:
                    this.b.a(data.getString("data_media_item_id"), (ResultReceiver) data.getParcelable("data_result_receiver"));
                    return;
                case 6:
                    this.b.b(new e(message.replyTo));
                    return;
                case 7:
                    this.b.c(new e(message.replyTo));
                    return;
                default:
    ...
    public void a(String str, b bVar, Bundle bundle) {
        ...
        for (Bundle bundle2 : arrayList) {
            if (android.support.v4.media.a.a(bundle, bundle2)) {
                return;
            }
        }
