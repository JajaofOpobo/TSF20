...
public class SwipeRefreshLayout extends ViewGroup implements android.support.v4.view.x, android.support.v4.view.z {
    ...
    public boolean a() {
        ...
        if (Build.VERSION.SDK_INT < 14) {
            ...
            if (ai.b(this.d, -1) || this.d.getScrollY() > 0) {
                z = true;
            }
            return z;
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (a2) {
            case 0:
                ...
                break;
            case 1:
                int a3 = android.support.v4.view.t.a(motionEvent, this.u);
                if (a3 < 0) {
                    Log.e(c, "Got ACTION_UP event but don't have an active pointer id.");
                    return false;
                }
                this.t = false;
                b((android.support.v4.view.t.d(motionEvent, a3) - this.r) * 0.5f);
                this.u = -1;
                return false;
            case 2:
                int a4 = android.support.v4.view.t.a(motionEvent, this.u);
                if (a4 < 0) {
                    Log.e(c, "Got ACTION_MOVE event but have an invalid active pointer id.");
                    return false;
                }
                float d = (android.support.v4.view.t.d(motionEvent, a4) - this.r) * 0.5f;
                if (this.t) {
                    if (d > 0.0f) {
                        a(d);
                        break;
            ...
            case 5:
                ...
                this.u = android.support.v4.view.t.b(motionEvent, b);
                break;
            case 6:
                a(motionEvent);
                break;
    ...
    private void a(MotionEvent motionEvent) {
        int b = android.support.v4.view.t.b(motionEvent);
        if (android.support.v4.view.t.b(motionEvent, b) == this.u) {
            this.u = android.support.v4.view.t.b(motionEvent, b == 0 ? 1 : 0);
        }
    }
}
