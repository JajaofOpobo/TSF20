...
public final class p extends o implements android.support.v4.view.n {
        ...
        synchronized (this) {
            if (this.k != null && (size2 = this.k.size()) > 0) {
                ...
                for (int i5 = 0; i5 < size2; i5++) {
                    ...
                    printWriter.print(": ");
                    printWriter.println((g) this.k.get(i5));
                }
            }
    ...
    Animation a(Fragment fragment, int i, boolean z, int i2) {
        ...
        Animation a2 = fragment.a(i, z, fragment.P);
        if (a2 == null) {
            if (fragment.P == 0 || (loadAnimation = AnimationUtils.loadAnimation(this.o.g(), fragment.P)) == null) {
                if (i != 0 && (b2 = b(i, z)) >= 0) {
                    switch (b2) {
                        case 1:
    ...
    */
    ...
    boolean a(Handler handler, String str, int i, int i2) {
        ...
        if (str == null && i < 0 && (i2 & 1) == 0) {
            ...
            g remove = this.i.remove(size);
            SparseArray<Fragment> sparseArray = new SparseArray<>();
            SparseArray<Fragment> sparseArray2 = new SparseArray<>();
            remove.a(sparseArray, sparseArray2);
            remove.a(true, (g.b) null, sparseArray, sparseArray2);
            g();
        } else {
            int i3 = -1;
            if (str != null || i >= 0) {
            ...
            while (i5 <= size4) {
                ...
                i5++;
                bVar = ((g) arrayList.get(i5)).a(i5 == size4, bVar, sparseArray3, sparseArray4);
            }
            g();
        }
        return true;
            ...
            if (fragmentManagerState.a != null) {
                ...
                if (fragmentManagerState.c != null) {
                    ...
                    for (int i5 = 0; i5 < fragmentManagerState.c.length; i5++) {
                        g a3 = fragmentManagerState.c[i5].a(this);
                        if (a) {
                            Log.v("FragmentManager", "restoreAllState: back stack #" + i5 + " (index " + a3.p + "): " + a3);
                            a3.a("  ", new PrintWriter(new android.support.v4.d.d("FragmentManager")), false);
                        }
                        this.i.add(a3);
                        if (a3.p >= 0) {
                            a(a3.p, a3);
        ...
        if ("fragment".equals(str)) {
            ...
            if (Fragment.b(this.o.g(), string)) {
                ...
                if (a2 == null) {
                    ...
                    a3.x = true;
                    a3.F = resourceId != 0 ? resourceId : id;
                    a3.G = id;
                    a3.H = string2;
                    a3.y = true;
                    a3.B = this;
                    a3.C = this.o;
                    a3.a(this.o.g(), attributeSet, a3.n);
                    a(a3, true);
                    fragment = a3;
                } else if (a2.y) {
                    ...
                    a2.C = this.o;
                    if (!a2.L) {
                        a2.a(this.o.g(), attributeSet, a2.n);
                    }
                    fragment = a2;
                }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public android.support.v4.view.n u() {
        return this;
    }
}
